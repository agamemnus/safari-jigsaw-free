    ...
    function x() {
        ...
        window.onerror = function(t, n, a, s) {
            ...
            "undefined" == typeof e.model && (e.model = ""), "undefined" == typeof e.uuid && (e.uuid = ""), i({
                file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (r.DEBUG ? "-beta" : "") + ".php?action=send_javascript_error&errormessage=" + t + "&url=" + n + "&line_number=" + a + "&column_number=" + s + "&device_model=" + e.model + "&device_uuid=" + e.uuid,
                success: function() {},
                error: function() {},
                request_method: "GET"
            })
