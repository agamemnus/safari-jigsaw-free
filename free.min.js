...
function() {
 ...
 function r(e) {
  ...
  var a = "undefined" != typeof e.charset ? e.charset : "",
   s = ("undefined" != typeof e.data ? e.data : "", "undefined" != typeof e.ignore_request_status ? e.ignore_request_status : !1, bt(e.file, e.data, n, a, t, void 0, void 0, e.request_method)),
   i = s.http_request;
 ...
 function gt(s) {
  function u() {
   if (1 == a.first_run && a.load_player_data_from_server(), e.ambient_music.load_ambient_music(t.ambient_music, t.ambient_music_start), "undefined" != typeof t.intro_audio && "" != t.intro_audio) {
    ...
    c.style.display = "none", i.appendChild(c);
   ...
   i.innerHTML = h, i.children.forEach(function(e) {
    n(e)
   }), "undefined" != typeof t.intro_audio && "" != t.intro_audio && i.appendChild(c);
   var r = i.querySelector("span"),
    s = i.querySelector(".jt-game-header");
   if (null != s && (r.style.display = "none", S({
     image: s,
     fix_ie_bug: !0,
     color: "#edd9a7",
     callback: function(e) {
      s.parentNode.appendChild(e), s.parentNode.removeChild(s), s = e, e.style.height = "100%", r.style.display = "block"
     }
    })), void
    function() {
     function t(t) {
     ...
     i.push(r), i.forEach(function(i) {
      ...
      var e = st(window.getComputedStyle(i).backgroundImage);
    ...
    u.className = "jt-select_mode_screen-mixnmatch jt-button", u.innerHTML = "Play Mix N' Match", r.appendChild(u), u.addEventListener(e.events.POINT, function() {
     o("mixnmatch")
    })
   }
   if ("undefined" != typeof t.jigsaw) {
    var d = document.createElement("div");
    d.className = "jt-select_mode_screen-jigsaw jt-button", d.innerHTML = "Play Jigsaw", r.appendChild(d), d.addEventListener(e.events.POINT, function() {
     o("select_jigsaw")
    }), setTimeout(function() {
     o("select_jigsaw")
    }, 2500)
 ...
 function mt(s) {
  function c() {
   ...
   function P(n) {
    ...
    n.children.forEach(function(a) {
     var f = a.rewards_container.top;
     f.innerHTML = "";
     var m = a.rewards_container.bottom;
     m.innerHTML = "";
     var s = a.level_id,
      _ = u.entry_list[s];
     if (_.reward_container) var y = _.reward_container;
     else var y = s;
     var o = [],
      w = !1;
     Array.prototype.slice.call([0, 1, 2, 3]).forEach(function(e) {
      o[e] = r.jigsaw.trophies.find(function(t) {
       return t == y + "|" + e
      }), "undefined" != typeof o[e] && (w = !0)
     });
     var c = r.jigsaw.ranks[s],
      h = "undefined" != typeof c;
     if (e["gray-filter_incomplete_images"] && (a.classList[h ? "remove" : "add"]("jt-select_screen-selection-item-greyed_out"), a.image_wrapper.classList[h ? "add" : "remove"]("jt-select_screen-selection-item-image_wrapper-greyed_out"), e.get_image(a.image, i, s, "mini" + (h ? "" : "-grey"))), h || "undefined" != typeof o)
      for (var n = 0; 4 > n; n++) {
       if ("undefined" != typeof o && "undefined" != typeof o[n]) {
        var T = v({
         mr_jigtato: t,
         gs: e,
         set_name: i,
       ...
       if ("undefined" != typeof c && "undefined" != typeof c[n]) {
        var p = document.createElement("div");
        p.className = "jt-select_screen-selection-item-rewards-rank_token_wrapper", f.appendChild(p);
        for (var x = c[n], b = l.rank[l.difficulty_levels[n].name], g = 0; x > g; g++) {
         var d = document.createElement("div");
   ...
   var M = a.challenge_a_friend_button = ft({
    select_screen: a,
    content_div: o,
    mr_jigtato: t,
    gs: e
  ...
  function d(i) {
   function n() {
    e.try_requesting_fullscreen && !e.IS_WEBVIEW && e.is_phone_or_tablet && C(document.documentElement);
   ...
   return r.challenge_a_friend_button.is_active ? void r.challenge_a_friend_button.select_puzzle(i.currentTarget) : void n()
  }
  var o = s.content_div,
   t = s.mr_jigtato,
   e = s.global_settings,
 ...
 function w() {
  function l() {
   ...
   if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], n.forEach(function(n) {
     var t = n.name,
      r = t.indexOf(".");
    ...
    }, this.get_image_url_from_server = function(a, i, r) {
     if ("trophy" == r) return "http://www.flyingsoftgames.com/mr_jigtato/sets/" + a + "/trophies/" + i + ".png";
     var n = t.game_data.entry_list[i].category;
     return "http://www.flyingsoftgames.com/mr_jigtato/resources/puzzle/" + n + "/" + i + ("mini" == r ? "-mini.jpg" : "mini-grey" == r ? "-mini-grey.png" : ".jpg") + "?" + ("undefined" != typeof e.account.user_id ? "&user_id=" + e.account.user_id : "") + ("undefined" != typeof e.account.internal_access_token ? "&internal_access_token=" + e.account.internal_access_token : "") + "&category_name=" + n
    }, this.get_image_url_from_local = function(s, i, a) {
     if ("trophy" != a) var n = t.game_data.entry_list[i].category;
     var r = (_ ? "content://" + k + ".free.expansion/" : e["/"]) + "sets/" + s;
     switch (a) {
      case "trophy":
       return r + "/puzzle/trophies/" + i + ".png";
      case "mini":
       return r + "/puzzle/categories/" + n + "/mini/" + i + "-mini.jpg";
      case "mini-grey":
       return r + "/puzzle/categories/" + n + "/mini-grey/" + i + "-mini.png";
      case "default":
      default:
       return r + "/puzzle/categories/" + n + "/" + i + ".jpg"
     }
   ...
   if (e.is_phone_or_tablet && (document.body.addEventListener("touchstart", function(e) {
    ...
    var o = window.plugins.GooglePlayQuery;
    o.getURI({
     success: function(t) {
     ...
     switch (e.page) {
      ...
      case "jigsaw":
       ut({
        ...
        global_settings: i,
        level_id: e.level
       }), !i.account.IS_PREMIUM && i.IS_WEBVIEW && "undefined" != typeof d && U({
        gs: i,
        mr_jigtato: t
       });
       break;
  ...
  if (n.className = "jt-content_div", t.parent = document.body, t.parent.appendChild(n), smoke.parent = n, i.is_phone_or_tablet) {
   smoke.custom_css = {
  ...
  }), xt(), t.play_intro_audio = function(a) {
   var c = a.level_id,
    s = a.count,
    r = t.game_data,
    o = r.entry_list[c],
 ...
 function U(i) {
  ...
  var e = i.gs,
   a = i.mr_jigtato,
   s = a.game_data.jigsaw.difficulty_levels[a.player_data.selected_difficulty],
   l = s.tile_x,
   h = s.tile_y,
  ...
  }), e.show_ad_counter >= 1 && (e.show_ad_counter = e.show_ad_counter - parseInt(e.show_ad_counter), Math.random() > .1 ? e.ad_control.run() : 0 == e.account.game_was_rated ? o() : e.ad_control.run())
 }
 ...
 function c(t) {
  ...
  i.initialize({
   error: t.error,
   success: function(i) {
    e.IS_CORDOVA ? (e.google_play_access_token = i, z(t)) : e.get_google_play_access_token({
     callback: function() {
      z(t)
     }
    })
 ...
 function ct() {
  ...
  return t.prototype.init = function(e, t) {
   ...
   return r
  }, n.testCurveCurveIntersection = function(B, j, G, K, D, N, W, X) {
   var I, O, E, z, i, n, a, c, o, h, l, s, B = new t(B[0], B[1]),
    j = new t(j[0], j[1]),
    G = new t(G[0], G[1]),
    K = new t(K[0], K[1]),
    D = new t(D[0], D[1]),
 ...
 function ut(q) {
  ...
  function Rt(e) {
   return "undefined" == typeof e && (e = {}), L.stop(), 4 == c.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
    L.resume()
  ...
  function Ot() {
   ...
   d.style.top = a + "px", d.style.height = n + "px", H.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", t.reposition_and_resize(), P(), "undefined" != typeof T && T.naturalHeight && (e.area && e.area.forEach(function(e) {
    e.height = n * e.height_ratio
   }), u.top = (n - T.height + (T.height - T.height)) / 2), it(), c.container.children.forEach(function(t) {
  ...
  function it() {
   if (!t.bg.image.complete) return void t.setTimeout(it, 50);
   if (0 == !!t.bg.refresh_bg && (t.bg.refresh_bg = !0, t.bg.width = "undefined" != typeof t.cached_width ? t.cached_width : t.width, t.bg.height = "undefined" != typeof t.cached_height ? t.cached_height : t.height, t.bg.getContext("2d").drawImage(t.bg.image, 0, 0, t.bg.image.naturalWidth, t.bg.image.naturalHeight, 0, 0, t.bg.width, t.bg.height), U({
     parent: t.stage,
     logical_parent: t.bg,
     canvas: t.bg,
     position: 0
    }), P()), t.background_image_drawn = !0, "undefined" == typeof u) return void t.setTimeout(it, 50);
   if ("undefined" == typeof u.left) return void t.setTimeout(it, 50);
   if (!u.base_image.complete) return void t.setTimeout(it, 50);
   t.bg.refresh_bg = !0;
   ...
   (1 == r.style.opacity || e.jigsaw_show_hint_rect) && (i.fillStyle = "white", i.fillRect(n, a, s, o), (1 == r.style.opacity || e.jigsaw_show_hint_image) && (i.globalAlpha = r.style.opacity, i.drawImage(r, n, a, s, o), i.globalAlpha = 1)), U({
    parent: t.stage,
    logical_parent: t.bg,
    canvas: t.bg,
    position: 0
  ...
  function Bt() {
   function n() {
    return 0 == !!t.first_render_complete || i.ad_control && !i.ad_control.ignore && i.ad_control.running || 0 == !!e.log_query_processed ? void d.inner.setTimeout(n, 50) : void qt()
   }
   ...
   if (r.set_size = function() {
    ...
    }, si(), "undefined" == typeof localStorage["puzzle_states." + tt + "." + k + "." + B.selected_difficulty]) {
    gt();
    ...
    Math.seedrandom(a), c.add_category("General"), oi({
     ...
     draw_settings: w,
     callback: function(t) {
      z = t, ii(z, c.current_category.piece_container), I = Array.prototype.slice.call(c.current_category.piece_container.children), St(I), st(c.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else Mt({
    callback: n
  ...
  function qt() {
   function n() {
    ...
    }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, x.addEventListener(i.events.POINT_START, Kt), document.addEventListener(i.events.POINT_MOVE, zt), i.is_phone_or_tablet ? (A({
     target: d.inner,
     result_function: Ut,
    ...
    }), x.addEventListener("touchend", Y), x.addEventListener("touchcancel", Y), x.addEventListener("touchleave", Y), g.addEventListener("touchend", Y)) : (document.addEventListener("mouseup", Y), window.addEventListener("blur", ft), window.addEventListener("mouseout", Ft), d.inner.addEventListener("mousewheel", Gt), d.inner.addEventListener("DOMMouseScroll", Gt))), p.setTimeout(function() {
     "undefined" != typeof i.ambient_music.last_on_state && (1 == i.ambient_music.last_on_state && (i.ambient_music_on = !0), delete i.ambient_music.last_on_state), C.play_intro_audio({
      level_id: q.level_id,
      parent: d.inner
     })
    }, 400)
   ...
   if (0 != s.length)
    for (var u = 0, i = 0, g = e.area.length; g > i; i++) {
     var n = e.area[i],
      ...
      f = n.width / p;
     if (B.selected_difficulty <= 1) var _ = 0,
      m = n.height / d;
  ...
  function Zt(l) {
   ...
   var t = r[k][e.difficulty_level];
   "undefined" == typeof t && (t = 86400), t > l && (t = r[k][e.difficulty_level] = l);
   ...
   return "undefined" == typeof o && (o = -1), i > o && (o = s[k][e.difficulty_level] = i), {
    best_time: t,
    rank_count: i,
    next_rank_point: c
   }
  ...
  function ut(s) {
   ...
   function y() {
    ...
    o.className = "jt-play-trophy_reward-text", o.innerHTML = _ ? "This level gave you the following trophy:" : "You've acquired a trophy on this level and difficulty:", s.appendChild(o);
    ...
    var p = "jt-play-main_image_border_width jt-play-trophy_reward-trophy_image",
     m = i.is_phone_or_tablet ? "" : "jt-play-trophy_reward-trophy_image-expanded",
     c = v({
      mr_jigtato: C,
      gs: i,
      set_name: K,
   ...
   function f() {
    var e = Z.rank[Z.difficulty_levels[B.selected_difficulty].name];
    ...
    var u = 1 == n ? e.name : e.plural;
    r.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + L.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + m + "</span> seconds.</p>", r.innerHTML += 0 == n ? '<p> No <span class="jt-play-show_rank-text-bright">' + u + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + x[n] + "</span> " + u + ".</p>";
    var o = document.createElement("div");
    ...
    if (r.appendChild(o), 0 == n) var f = 'Complete the puzzle in <span class="jt-play-show_rank-text-bright">' + c + "</span> seconds or less to gain a " + e.name + "!";
    else if (-1 != c) var f = 'Complete the puzzle in <span class="jt-play-show_rank-text-bright">' + c + "</span> seconds or less to gain more " + e.plural + "!";
    else var f = "You've achieved the highest rank for this puzzle and level!";
    var p = document.createElement("p");
    p.innerHTML = f, r.appendChild(p)
   }
   var s = s || {};
   localStorage.removeItem("puzzle_states." + tt + "." + k + "." + B.selected_difficulty);
   var o = s.user_gave_up || !1;
   i.ambient_music.last_on_state = i.ambient_music_on, i.ambient_music_on = !1;
   var p = _t[Math.floor(Math.random() * _t.length)];
   if (0 == o) {
    i.playAudio(i.audio_dir + "/" + p, {
     audio_type: "sound_effect",
     blocking: !1
    })
   }
   if (L.stop(), g.style.overflow = "hidden", 1 != e.zoom.scale || 0 != e.zoom.offset_x || 0 != e.zoom.offset_y) {
    var l = 750;
    TweenMax.to(e.zoom, l / 750, {
     parseTransform: !0,
     ease: Linear.ease,
     scale: 1,
     offset_x: 0,
   ...
   if (1 != o) {
    ...
    localStorage.player_data = JSON.stringify(B), 0 == o ? d.inner.setTimeout(u, l + (s.show_trophy_delay || 550)) : d.inner.setTimeout(u, l + (s.show_trophy_delay || 550))
   }
  }
  ...
  function Ht(e) {
   ...
   if (P(), u.children.forEach(function(e) {
     ...
     c.remove_category(e)
    }), u.base_image.style.opacity = 1, O(u.composite_image), it(), e.hide_controls) {
    var t = i.use_categories;
    i.use_categories = !1, p.autoshow_title(), i.use_categories = t, Yt.morph_to_back_button()
   }
  ...
  function Vt(t, n) {
   ...
   var a = l(n, d.inner),
    o = a[0],
    h = a[1];
   t.left = (o / g.desired_scale - e.zoom.offset_x) / e.zoom.scale + (i.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (h / g.desired_scale - e.zoom.offset_y) / e.zoom.scale + (i.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), P();
  ...
  function Kt(r) {
   var a = r.target;
   if (r.preventDefault(), "undefined" != typeof r.targetTouches) {
    if (r.touches.length > 1) {
     if (null != s) {
      ...
      console.dir(r), a == x && x.drag_start(r)
     }
     return
    }
    r = r.targetTouches[0]
   ...
   if (!G(r)) {
    ...
    if (0 == h.length) return void(a == x && x.drag_start(r));
    for (var a = h[0], v = +h[0].sprite.index, o = 1, m = h.length; m > o; o++) {
     var n = h[o]; + n.zIndex <= v || (v = +n.zIndex, a = n)
    }
    P(), i.playAudio(i.audio_dir + "/global-pick up.ogg", {
     audio_type: "sound_effect",
     blocking: !1
    });
  ...
  function Ft(e) {
   ...
   "undefined" == typeof i && (i = document.body.scrollTop), n >= 0 && n <= window.innerHeight + i && r >= 0 && r <= window.innerWidth + t || Y(e)
  }
  ...
  function Y(o) {
   if (null != x) {
    if ("undefined" == typeof o.touches) x.drag_end();
     ...
     "undefined" == typeof P && x.drag_end();
     var B = o.touches[Array.prototype.slice.call(o.touches).findIndex(function(e) {
      return e.identifier == s.touch_id
     })];
    ...
    if (null != s) {
     ...
     if (null != c.item_under_mouse) {
      var k = c.current_category;
      if (k != c.item_under_mouse) {
       v = !1, y = !0;
       var b = c.item_under_mouse.piece_container;
       b.appendChild(s), st(b, [s])
      }
     }
     var M = c.current_category.piece_container.children,
      a = s,
      l = i.jigsaw_piece_scale_to_actual,
      w = 2 * i.jigsaw_required_precision,
      n = [],
      R = s.left + (1 - l) / 2 * a.width_float - a.puzzle_left_min * l,
      L = s.top + (1 - l) / 2 * a.height_float - a.puzzle_top_min * l;
     if (M.forEach(function(e) {
       if (e != a)
        for (var c = e.virtual_left - e.width_float * l / 2 - e.puzzle_left_min * l, d = e.virtual_top - e.height_float * l / 2 - e.puzzle_top_min * l, r = Math.abs(c - R), s = Math.abs(d - L), t = 0, h = a.puzzle_width.length; h > t; t++)
      ...
      var a = s,
       n = n.concat([a]),
       f = u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale,
       m = 0,
       p = u.composite_image.height - 2 * e.piece_margin / e.piece_logical_scale,
       g = 0;
      n.forEach(function(e) {
       f > e.puzzle_left_min && (f = e.puzzle_left_min), p > e.puzzle_top_min && (p = e.puzzle_top_min), m < e.puzzle_left_min + e.width_float && (m = e.puzzle_left_min + e.width_float), g < e.puzzle_top_min + e.height_float && (g = e.puzzle_top_min + e.height_float)
      });
      var r = mt();
      return r.className = "jt-jigsaw-piece_deck-piece", r.piece_id = a.piece_id, r.x = [], r.y = [], r.puzzle_width = [], r.puzzle_height = [], r.puzzle_left = [], r.puzzle_top = [], r.puzzle_left_min = f, r.puzzle_top_min = p, r.side_set = at(n, !0), r.shape_string = J(at(n, i.jigsaw_combine_pieces), [-f, -p]), r.dummy_canvas = document.createElement("canvas"), r.path = new Path2D(r.shape_string), I.push(r), a.parentNode.appendChild(r), r.width_float = Math.round(1e3 * (m - f)) / 1e3, r.height_float = Math.round(1e3 * (g - p)) / 1e3, r.width = Math.ceil((r.width_float + 2 * e.piece_margin) / e.piece_logical_scale), r.height = Math.ceil((r.height_float + 2 * e.piece_margin) / e.piece_logical_scale), n.forEach(function(e) {
       ...
       O(e), I.splice(I.indexOf(e), 1), e.x.forEach(function(i, t) {
        z[e.x[t]][e.y[t]] = r
       ...
       calc_width: r.width_float,
       calc_height: r.height_float,
       left: u.left,
       top: u.top,
       onComplete: function() {
        Et(), d.inner.setTimeout(function() {
         ut({
          show_trophy_delay: 750
         })
        }, 100)
       }
      }), bt()), ot(r), O(s), s = null, vt(), t.refresh_piece_styling = !0, void V()
     }
     if (v)
      for (var _ = s, T = !1, E = s.calc_width / i.jigsaw_required_precision, C = s.calc_height / i.jigsaw_required_precision, S = s.left - u.left, A = s.top - u.top;;) {
       if (S + E < _.puzzle_left_min) break;
       if (S - E > _.puzzle_left_min) break;
       if (A + C < _.puzzle_top_min) break;
       if (A - C > _.puzzle_top_min) break;
       T = !0;
       break
      }
     ...
     if (ot(s), U({
      ...
      var D = h.puzzle_left_min + u.left,
  ...
  function Dt(n) {
   ...
   c.texture ? Lt(c) : U({
    ...
    position: 1,
    is_2d: !0
   }), c.sprite.x = u.left - e.piece_margin, c.sprite.y = u.top - e.piece_margin, O(n), n == s && (s = null), vt(), V(), Xt() && ut()
  }

  function ft(e) {
   if (null != s) {
    if (P(), "undefined" == typeof e && (e = {}), document.body.style.cursor = "", e.is_transferred_to_different_category || t.piece_sprite_container.addChild(s.sprite), s.visibility = "visible", !i.freestyle_mode || e.is_transferred_to_different_category) s.left = s.pickup_left, s.top = s.pickup_top;
    else {
    ...
    delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, ot(s), U({
     logical_parent: s,
     canvas: s.canvas
  ...
  function zt(e) {
   ...
   e.target;
   if (x.drag_active && e.touches) {
    var t = e.touches[Array.prototype.slice.call(e.touches).findIndex(function(e) {
     return e.identifier == x.touch_id
    })];
    x.drag_update(t)
   }
   "undefined" != typeof e.targetTouches && (e = e.targetTouches[0]), null != s && Vt(s, e)
  }
  ...
  function oi(b) {
   ...
   for (var c = (b.success || function() {}, b.source_image), m = b.size_x, v = b.size_y, N = b.width, j = b.height, D = b.draw_settings, y = [], M = ct(), G = 100 / m, W = 100 / v, n = 0; m >= n; n++) {
    y[n] = [];
    for (var r = 0; v >= r; r++) {
   ...
   for (var q = [
    ...
    for (var A = q[s], T = 0; T < A[4]; T++) O.push([A[0], A[1], A[2], A[3]]);
   var _ = [];
   for (vh = 0; 2 > vh; vh++) {
    _[vh] = [];
    for (var n = 0; m + vh > n; n++) {
     ...
     for (var r = 0; v + (1 - vh) > r; r++) {
      ...
      for (var B = new Array(h), s = 0; h > s; s++) B[s] = [t[s][0] / 100 * N, t[s][1] / 100 * j];
      if (_[vh][n][r] = B, B.length > 2 && r > 0 && n > 0 && vh > 0) {
       var t = _[vh][n][r];
   ...
   for (var z = [], V = "", H = 0, n = 0; m > n; n++) {
    ...
    for (var r = 0; v > r; r++) {
     ...
     var Y = a(o),
      ...
      l = mt();
     l.x = [n], l.y = [r], l.piece_id = H, l.width = Math.ceil(F + 2 * e.piece_margin) / e.piece_logical_scale, l.height = Math.ceil(U + 2 * e.piece_margin) / e.piece_logical_scale, l.width_float = F, l.height_float = U, l.puzzle_width = [F], l.puzzle_height = [U], l.puzzle_left_min = Y.x0, l.puzzle_top_min = Y.y0, l.puzzle_left = [o.x0], l.puzzle_top = [o.y0], l.side_set = [w], l.placed = !1, z[n][r] = l, H += 1
    }
   }
   var k = document.createElement("canvas"),
    I = k.getContext("2d");
   k.width = (N + 2 * e.piece_margin) / e.piece_logical_scale, k.height = (j + 2 * e.piece_margin) / e.piece_logical_scale;
  ...
  function It(i) {
   function u() {
    for (var i = 0; _ > i; i++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, O(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), xt(e, p), U({
       canvas: e.canvas,
       logical_parent: e
    ...
    l != c * o ? (t.refresh_piece_styling = !0, timeout = d.inner.setTimeout(u, 20)) : (ht = void 0, void
     function() {
      for (var r = {}, l = 0; c > l; l++)
       for (var h = 0; o > h; h++) {
        var e = s[l][h];
   ...
   var s = i.piece_grid,
    ...
    h = 0,
    r = 0;
   "undefined" != typeof ht && clearTimeout(ht), ht = void 0, u()
  }
  ...
  function U(i) {
   ...
   return n.addChildAt(e.sprite, o), P(), "undefined" != typeof n && n == t.piece_sprite_container && 1 == a && (n.is_cached = !1), e
  }

  function O(e, r) {
   if ("undefined" == typeof r && (r = !1), "undefined" != typeof e && e.texture) {
    var i = e.sprite.parent;
    "undefined" != typeof i && e.sprite.parent.removeChild(e.sprite), e.texture.destroy(!0), e.texture = null, e.sprite = null, "undefined" != typeof i && i == t.piece_sprite_container && 1 == r && (i.is_cached = !1), P()
   }
  }
  ...
  function kt(e) {
   ...
   Object.defineProperty(e, "children", {
    ...
    t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), P(), jt()
   }, e.removeChild = function(t) {
    e.children.splice(e.children.indexOf(t), 1), P(), jt()
  ...
  function xt(t, h, r) {
   ...
   var c = "undefined" == typeof r.render_stroke ? !0 : r.render_stroke,
   ...
   var p = J(t.side_set, [-t.puzzle_left_min + a + l, -t.puzzle_top_min + a + l], 1 / s);
   if (t.path = new Path2D(p), h instanceof HTMLImageElement) {
    var o = (u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale) * e.piece_logical_scale / u.base_image.naturalWidth;
    n.drawImage(h, t.puzzle_left_min / o, t.puzzle_top_min / o, i.width * s / o, i.height * s / o, 0, 0, i.width, i.height)
   ...
   n.restore(), _ && (n.save(), n.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), f({
    ...
    clear_stroke: !c,
    game_instance: e
   }), n.restore()), c && (n.save(), lt(i, d), n.restore())
  }
  ...
  var g = q.content_div,
   ...
   k = q.level_id;
  g.innerHTML = "";
  var Z = C.game_data.jigsaw,
   ui = C.game_data.trophy_list,
   B = C.player_data,
   rt = C.game_data.entry_list[k],
   K = C.set_name,
   tt = i.game_type,
   y = {},
   w = {},
   e = y.game_instance = {},
   $ = Z.difficulty_levels[B.selected_difficulty];
  ...
  }), i.ambient_music.last_on_state = i.ambient_music_on, i.ambient_music_on = !1, i.ambient_music.load_ambient_music(C.game_data.ambient_music, C.game_data.ambient_music_start), Qt();
  ...
  if (e.force_screen_refresh = 0, ci(), void
   ...
   }(), g.style.overflow = "hidden", n(g), y.menu_item_list = [C.menu.generic.about, C.menu.generic.ogle_trophies, {
    text: "Restart",
   ...
   }, C.menu.jigsaw.open_visual_settings_menu, C.menu.generic.open_audio_settings_menu], !i.is_kiosk && i.use_social_media_buttons) {
   var Tt = y.social_sharing_button_container = document.createElement("div");
   Tt.className = "jt-play-social_sharing_button_container", g.appendChild(Tt), D({
    parent: Tt,
  ...
  c.className = "jt-jigsaw-category_deck", c.item_under_mouse = null, p.appendChild(c), c.edit_button = document.createElement("img"), c.edit_button.className = "jt-op_button jt-op_button-edit" + (i.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), c.edit_button.src = i["/"] + "images/gui/gui-item_edit.png", c.appendChild(c.edit_button), c.add_button = document.createElement("img"), c.add_button.className = "jt-op_button jt-op_button-add" + (i.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), c.add_button.src = i["/"] + "images/gui/gui-item_expand_or_add.png", c.appendChild(c.add_button), c.basket_button = document.createElement("img"), c.basket_button.className = "jt-op_button jt-op_button-basket" + (i.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), c.basket_button.piece_list = [], c.basket_button.is_selected = !1, c.basket_button.src = i["/"] + "images/gui/gui-basket.png", c.appendChild(c.basket_button), c.remove_button = document.createElement("img"), c.remove_button.className = "jt-op_button jt-op_button-remove" + (i.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), c.remove_button.src = i["/"] + "images/gui/gui-item_remove.png", c.appendChild(c.remove_button), c.container = document.createElement("div"), c.container.className = "jt-jigsaw-category_deck-container", c.appendChild(c.container), c.add_category = function(s) {
   ...
   c.current_category = e, t.piece_container = e.piece_container, P(), c.refresh(), c.container.children.forEach(function(t) {
    if (t == e) var i = "add";
    else var i = "remove";
   ...
   L.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
    return "" === t ? void smoke.alert("You can't set a blank name!", function() {
     L.resume()
    }) : (L.resume(), void(t !== !1 && (c.set_category_name(e, t), V())))
   })
  ...
  W.addEventListener(i.events.POINT, function(r) {
   ...
   function t(t) {
    L.resume(), 0 != t && (c.remove_category(e), c.select_category(c.original_category), V())
   }
   L.stop();
   var e = c.current_category;
  ...
  y.timer_obj.style.display = i.show_timer ? "" : "none", n(L), y.refresh_gui_display = function() {
  ...
  rt.use_image_title ? S({
   image_src: i.get_set_directory(K) + "/puzzle/" + k + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  t.className = "jt-draw_area", i.is_webgl = function() {
   ...
   if (null != t) return i.canvas_context = "webgl", !0;
   var t = e.getContext("experimental-webgl");
   return null != t ? (i.canvas_context = "experimental-webgl", !0) : (i.canvas_context = "2d", !1)
  }();
  ...
  t.renderer = $t, t.stage = yt, t.piece_sprite_container = Nt, t.real_stage = dt, dt.addChild(yt), yt.addChild(Nt), t.load_opacity_transition = .5, t.style.pointerEvents = "none", t.bg = document.createElement("canvas"), t.bg.image = new Image, t.bg.image.src = C.background_image_url, t.reposition_and_resize = function() {
   var r = M(g),
    n = o(g),
    e = g.content_scale,
  ...
  var z, I, s = null;
  T.crossOrigin = "Anonymous", i.get_image(T, K, k, "default"), T.addEventListener("load", function() {
   null != d && d.inner.setTimeout(Bt, 30)
  });
  var _ = new Image;
  _.src = i.get_set_directory(C.set_name) + "/gui/gui-loading.png", _.logical_parent = t, t.loading_animation = _, _.defer_start = function(e) {
   d.inner.setTimeout(function() {
    _ && !_.game_initialized && (_.start(), nt(void 0, !0))
   }, e)
  }, _.start = function() {
   1 != !!_.game_initialized && (_.stage.alpha = 1, _.display = !0, dt.addChild(_.stage), P())
  }, _.stop = function() {
   _.stage && (_.stage.alpha = 1), _.game_initialized = !0, _.display && (_.display = !1, dt.removeChild(_.stage)), P()
   ...
   if (null != d && d.isAttached()) {
    ...
    var o = r.getContext("2d");
    o.drawImage(_, e, 0, e, i, 0, 0, e, i), _.outer = {}, U({
  ...
  g.cleanup = function() {
   if (i.IS_CORDOVA && i.audio_container[C.last_intro_audio] && (i.audio_container[C.last_intro_audio].src = "", delete i.audio_container[C.last_intro_audio], C.last_intro_audio = ""), t.fireworks && t.fireworks.destroy(), hi(), null != t.parentNode && document.body.removeChild(t), L.destroy(), document.removeEventListener(i.events.POINT_MOVE, zt), i.is_phone_or_tablet ? g.removeEventListener("touchend", Y) : (document.removeEventListener("mouseup", Y), window.addEventListener("blur", ft), window.removeEventListener("mouseout", Ft)), g.innerHTML = "", "undefined" != typeof i.ambient_music.last_on_state && (1 == i.ambient_music.last_on_state && (i.ambient_music_on = !0), delete i.ambient_music.last_on_state), "undefined" != typeof z)
    for (var r = 0; r < e.tile_x + 1; r++) {
     z[r] = [];
     for (var n = 0; n < e.tile_y + 1; n++) z[r][n] = void 0
    }
   ...
   }), t.piece_container.children = [], delete t.piece_container.piece_matrix, delete t.piece_container), O(u.base_image), O(t.bg), _.inner && O(_.inner), _.outer && O(_.outer), O(u.composite_image), t.stage.removeChild(t.piece_sprite_container), t.real_stage.removeChild(t.stage), t.real_stage.interactionManager.removeEvents(), t.renderer.destroy && t.renderer.destroy(), u.composite_image && (delete u.composite_image.set_size, delete u.composite_image), delete g.draw_area, delete _.logical_parent;
   for (var a in t) delete t[a];
   C = null, i = null, k = null, Z = null, ui = null, B = null, rt = null, K = null, tt = null, y = null, w = null, e = null, $ = null, P = null, wt = null, p = null, c = null, W = null, L = null, At = null, Yt = null, d = null, t = null, u = null, T = null, x = null, s = null, z = null, I = null, _ = null, gt = null, St = null, V = null, Mt = null, delete g.cleanup
  }, x.drag_active = !1, x.drag_start = function(e) {
   x.drag_active = !0, x.touch_id = e.identifier, x.drag_update(e, !0)
  }, x.drag_update = function(t, o) {
   if (console.dir(t), 0 != x.drag_active) {
    var i = l(t, d),
     r = i[0] / g.content_scale,
     n = i[1] / g.content_scale,
     h = e.zoom.scale,
     a = e.zoom.offset_x,
     s = e.zoom.offset_y;
    o || (a += r - x.drag_initial_x, s += n - x.drag_initial_y), e.zoom.offset_x = a, e.zoom.offset_y = s, x.drag_initial_x = r, x.drag_initial_y = n, x.drag_initial_scale = h
   }
  }, x.drag_end = function() {
  ...
  var ht = void 0,
   V = y.save_puzzle_state = function() {
    ...
    i[tt + "." + k + "." + B.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + tt + "." + k + "." + B.selected_difficulty] = JSON.stringify(t)
   },
   Mt = y.load_puzzle_state = function(s) {
    ...
    var t = JSON.parse(localStorage["puzzle_states." + tt + "." + k + "." + B.selected_difficulty]);
  ...
  y.redraw_main_image_and_pieces = function(p) {
   function S() {
    ...
    i.save(), m({
     ...
     lineWidth: 0,
     canvas: o
    }), i.clip(), i.drawImage(c, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), i.restore(), i.save(), i.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), lt(o), i.restore(), U({
     parent: t.stage,
     canvas: o,
     position: 1,
     is_2d: !0
 ...
 function ft(i) {
  ...
  var n = i.select_screen,
   ...
   o = n.header,
   e = document.createElement("div");
  return e.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-2 jt-button hoverable", e.title_list = ["Challenge a friend!", "Earn extra puzzle packs!", "Get 9 gems per friend!"], e.title_index = e.title_list.length - 1, s(), e.addEventListener(t.events.POINT, function() {
   e.toggle()
  }), e.toggle = function() {
   ...
   function _() {
    var a = smoke.prompt("Type in your frenemy's email(s) to send them your challenge!", function(a) {
     return a === !1 ? void e.deactivate() : void c({
      gs: t,
      error: function() {
    ...
    a.dialog.buttons.ok.innerHTML = "Send!"
   }
   var i = v.level_id,
    u = a.player_data,
 ...
 function T(e) {
  function i() {
   ht(), t.challenge_code_request_asked = !0;
 ...
 "undefined" != typeof module && null != module && (module.exports = e), window.addEventListener("load", function() {
  ...
  e.WEBGL_RENDERER = 0, e.CANVAS_RENDERER = 1, e.VERSION = "v1.6.1", e.blendModes = {
   ...
   if (0 !== t.length) {
    ...
    if (A.x === x.x && A.y === x.y) {
     ...
     var N = x.x + .5 * (A.x - x.x),
      j = x.y + .5 * (A.y - x.y);
     t.unshift(N, j), t.push(N, j)
    }
    var E, b, _, p, a, n, M, S, r, i, g, f, v, y, D, P, k, R, O, L, C, G, l, s = U.points,
     I = U.indices,
     T = t.length / 2,
     F = t.length,
     B = s.length / 6,
    ...
    for (_ = t[2 * (T - 2)], p = t[2 * (T - 2) + 1], a = t[2 * (T - 1)], n = t[2 * (T - 1) + 1], r = -(p - n), i = _ - a, l = Math.sqrt(r * r + i * i), r /= l, i /= l, r *= m, i *= m, s.push(a - r, n - i), s.push(u, c, d, h), s.push(a + r, n + i), s.push(u, c, d, h), I.push(B), o = 0; F > o; o++) I.push(B++);
    I.push(B - 1)
   }
  ...
  function B(t) {
   this.id = "particle_" + B.ID++, this.reset(!0), e.Util.setPrototypeByObject(this, t)
  }
  ...
  function h(t, i, r) {
   this.mouseTarget = e.Util.initValue(t, D), this.ease = e.Util.initValue(i, .7), this._allowEmitting = !1, this.initEventHandler(), h._super_.call(this, r)
  }
 ...
 if ((t._gsQueue || (t._gsQueue = [])).push(function() {
    ...
    function() {
     ...
     var W, gt, H, _t, ft, A, P = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
      ...
      Z = function(o, i, l, r, h) {
       var t, e, n, a = {},
        s = o.style;
       for (e in l) "cssText" !== e && "length" !== e && isNaN(e) && (i[e] !== (t = l[e]) || h && h[e]) && -1 === e.indexOf("Origin") && ("number" == typeof t || "string" == typeof t) && (a[e] = "auto" !== t || "left" !== e && "top" !== e ? "" !== t && "auto" !== t && "none" !== t || "string" != typeof i[e] || "" === i[e].replace(D, "") ? t : 0 : st(o, e), void 0 !== s[e] && (n = new X(s, e, s[e], n)));
       if (r)
     ...
     var ct = function(e, o, c, a) {
      ...
      s = (u._parseToProxy = function(p, u, a, e, d, s) {
       var o, t, i, r, c, n = e,
        ...
        f = a._transform,
        _ = z;
       for (a._transform = null, z = u, e = c = a.parse(p, u, e, d), z = _, s && (a._transform = f, n && (n._prev = null, n._prev && (n._prev._next = null))); e && e !== n;) {
      ...
      B = a.parseComplex = function(k, C, u, _, M, T, e, A, S, b) {
     ...
     e = mt.prototype, e.parseComplex = function(p, n, e, u, c, h) {
      ...
      return B(p, this.p, n, e, this.clrs, this.dflt, u, this.pr, c, h)
     ...
     var yt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
      ...
      E = u.getTransform = function(m, Q, P, J) {
       ...
       var o, t, v, R, X, L, z, w, y, q, Y, D, N, e = P ? m._gsTransform || new at : new at,
        nt = 0 > e.scaleX,
        M = 2e-5,
        u = 1e5,
        k = 179.99,
      ...
      U = u.set3DTransformRatio = function(R) {
       var w, v, y, m, b, x, p, f, M, T, d, s, A, E, _, S, t, r, i, n, B, I, P, e = this.data,
        L = this.t.style,
        a = e.rotation * c,
        o = e.scaleX,
        h = e.scaleY,
       ...
       if (a || e.skewX) r = Math.cos(a), i = Math.sin(a), w = r, b = i, e.skewX && (a -= e.skewX * c, r = Math.cos(a), i = Math.sin(a), "simple" === e.skewType && (n = Math.tan(e.skewX * c), n = Math.sqrt(1 + n * n), r *= n, i *= n)), v = -i, x = r;
        ...
        if (!(e.rotationY || e.rotationX || 1 !== u || g)) return void(L[l] = (e.xPercent || e.yPercent ? "translate(" + e.xPercent + "%," + e.yPercent + "%) translate3d(" : "translate3d(") + O + "px," + z + "px," + k + "px)" + (1 !== o || 1 !== h ? " scale(" + o + "," + h + ")" : ""));
        w = x = 1, v = b = 0
       }
      ...
      it = u.set2DTransformRatio = function(s) {
       var i, a, t, n, r, e = this.data,
        ...
        h = e.x,
        u = e.y;
       return e.rotationX || e.rotationY || e.z || e.force3D === !0 || "auto" === e.force3D && 1 !== s && 0 !== s ? (this.setRatio = U, void U.call(this, s)) : void(e.rotation || e.skewX ? (i = e.rotation * c, a = i - e.skewX * c, t = 1e5, n = e.scaleX * t, r = e.scaleY * t, o[l] = (e.xPercent || e.yPercent ? "translate(" + e.xPercent + "%," + e.yPercent + "%) matrix(" : "matrix(") + (0 | Math.cos(i) * n) / t + "," + (0 | Math.sin(i) * n) / t + "," + (0 | Math.sin(a) * -r) / t + "," + (0 | Math.cos(a) * r) / t + "," + h + "," + u + ")") : o[l] = (e.xPercent || e.yPercent ? "translate(" + e.xPercent + "%," + e.yPercent + "%) matrix(" : "matrix(") + e.scaleX + ",0,0," + e.scaleY + "," + h + "," + u + ")")
      };
     ...
     e = a.prototype, e._firstPT = null, e._onInitTween = function(i, c, y) {
      ...
      if (gt && "" === o.zIndex && (h = r(i, "zIndex", n), ("auto" === h || "" === h) && this._addLazySet(o, "zIndex", 0)), "string" == typeof c && (u = o.cssText, h = C(i, n), o.cssText = u + ";" + c, h = Z(i, h, C(i)).difs, !v && Ct.test(c) && (h.opacity = parseFloat(RegExp.$1)), c = h, o.cssText = u), this._firstPT = t = this.parse(i, c, null), this._transformType) {
       ...
       d = new s(i, "transform", 0, 0, null, 2), this._linkCSSP(d, null, e), d.setRatio = f && _ ? U : l ? it : St, d.data = this._transform || E(i, n, !0), G.pop()
      }
      if (T) {
       for (; t;) {
   ...
   if (!S.TweenLite) {
    var n, a, e, r, o, N = function(r) {
     ...
     F = function(e, r, t, a) {
      ...
      this.check = function(d) {
       ...
       if (0 === u && t)
        for (h = ("com.greensock." + e).split("."), c = h.pop(), o = N(h.join("."))[c] = this.gsClass = t.apply(t, n), a && (S[c] = o, "function" == typeof define && define.amd ? define((i.GreenSockAMDPath ? i.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], function() {
          return o
    ...
    e = D.prototype, e.addEventListener = function(s, l, h, c, i) {
     i = i || 0;
  ...
  function(t) {
   ...
   var l = t.GreenSockGlobals || t,
    ...
    _ = function(i, y, B, X, F) {
     o.test(i.innerHTML) && (i.innerHTML = i.innerHTML.replace(o, h));
     var w, p, b, s, _, E, x, n, f, l, m, z, O, M = r(i),
      ...
      C = y.linesClass;
     for (D && (C = C.split("++").join("")), b = L(), s = 0; u > s; s++) E = M.charAt(s), ")" === E && M.substr(s, 20) === h ? (b += R + "<BR/>", s !== u - 1 && (b += " " + L()), s += 19) : " " === E && " " !== M.charAt(s - 1) && s !== u - 1 ? (b += R, s !== u - 1 && (b += H + L())) : b += T && " " !== E ? V() + E + "</div>" : E;
     ...
     for (s = 0; u > s; s++) n = x[s], p = n.parentNode === i, "BR" !== n.nodeName ? (c && (m = n.style, v || p || (n._x += n.parentNode._x, n._y += n.parentNode._y), m.left = n._x + "px", m.top = n._y + "px", m.position = "absolute", m.display = "block", m.width = n._w + 1 + "px", m.height = n._h + "px"), v ? p ? X.push(n) : T && B.push(n) : p ? (i.removeChild(n), x.splice(s--, 1), u--) : !p && T && (f = !g && !c && n.nextSibling, i.appendChild(n), f || i.appendChild(document.createTextNode(" ")), B.push(n))) : g || c ? (i.removeChild(n), x.splice(s--, 1), u--) : v || i.appendChild(n);
     if (g) {
      for (c && (l = document.createElement("div"), i.appendChild(l), z = l.offsetWidth + "px", f = l.offsetParent === i ? 0 : i.offsetLeft, i.removeChild(l)), m = i.style.cssText, i.style.cssText = "display:none;"; i.firstChild;) i.removeChild(i.firstChild);
      for (O = !c || !v && !T, s = 0; s < g.length; s++) {
       ...
       v || T || (l.innerHTML = r(l).split(String.fromCharCode(160)).join(" ")), c && (l.style.width = z, l.style.height = n._h + "px"), i.appendChild(l)
      }
      i.style.cssText = m
     }
     c && (A > i.clientHeight && (i.style.height = A - G + "px", A > i.clientHeight && (i.style.height = A + N + "px")), S > i.clientWidth && (i.style.width = S - W + "px", S > i.clientWidth && (i.style.width = S + U + "px")))
    },
    n = i.prototype;
   n.split = function(t) {
  ...
  var Tt = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").get,
   Et = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").set;
