...
function() {
 ...
 function r(e) {
  ...
  var a = "undefined" != typeof e.charset ? e.charset : "",
   s = ("undefined" != typeof e.data ? e.data : "", "undefined" != typeof e.ignore_request_status ? e.ignore_request_status : !1, xt(e.file, e.data, n, a, t, void 0, void 0, e.request_method)),
   i = s.http_request;
   ...
   function() {
    function o(t, e) {
     "undefined" == typeof e && (e = i.errormessage), r({
      ...
      request_method: "GET",
      async: !0,
      ignore_request_status: i.IS_WEBVIEW,
      error: e,
      success: function(e) {
       n = e, s()
      }
    ...
    function f() {
     var e = new FileTransfer,
      i = encodeURI(c + "/" + t);
     e.download(i, _ + "/" + t, l, l, !1, {
      headers: {}
     })
    }
    var c = "http://animals.jigtato.com/sets/" + e,
     h = i.get_set_directory(e),
     _ = i.get_set_directory(e, !0),
     d = !1,
     p = !1,
     t = (!i.IS_CORDOVA, e);
    if (t += d ? "-beta.json" : ".json", p) return void o(h + "/" + t);
    var u = 1420082059;
    ...
    a.open("HEAD", c + "/" + t, !0), a.onreadystatechange = function() {
     if (4 == a.readyState) {
      ...
      u >= i ? o(h + "/" + t) : i > n ? (localStorage.json_file_version_date = JSON.stringify(+i), f()) : l()
     }
    }, a.send(null)
   }()
 ...
 function ot(i) {
  ...
  var e = i.gs,
   ...
   l = o.tile_x,
   h = o.tile_y,
   t = (e.show_ad_counter, Math.sqrt(l * h) / 8);
  t > 1 && (t = 1), e.show_ad_counter += t, e.ad_control = e.ad_control_list[Object.keys(e.ad_control_list_weights).indexOf(Math.weightedSample(e.ad_control_list_weights))], e.ad_control_list.forEach(function(t) {
 ...
 function J(n) {
  function l() {
   e.back.style.visibility = 0 == i ? "hidden" : "visible", e.next.style.visibility = i == a.length - 1 ? "hidden" : "visible", s.text.innerHTML = a[i], s.text.parentNode.classList[1 == i ? "add" : "remove"]("jt-play-show_credits-dialog")
  }
  ...
  var t = n.gs,
   ...
   u = c.set_name,
   a = [];
  n.gs.is_kiosk || (t.contact_info = '<a href="mailto:' + t.contact_info + '">' + t.contact_info + "</a>"), a[0] = o.about_text + t.contact_info + ". </p>", n.callback, a[1] = "Loading...", r({
   error: function(e) {
    t.errormessage(e, n.callback)
   },
   file: t.get_set_directory(u) + "/" + u + "-credits.txt",
   charset: "utf-8",
   plaintext: !0,
   request_method: "GET",
   ...
   success: function(t) {
    ...
    if (i) {
     var s = i.game_instance,
      ...
      r = o.trophy_list[o.entry_list[e].trophies[l]],
      u = r.display_name.capitalizeFirstLetter(),
      d = r.credit;
  ...
  var s = smoke.alert(o.about_text + t.contact_info + ". </p>", n.callback),
   e = s.buttons;
  e.back = s.buttons.ok.cloneNode(!0), e.back.style.cssFloat = "left", e.back.innerHTML = "< Back", e.appendChild(e.back), e.next = s.buttons.ok.cloneNode(!0), e.next.style.cssFloat = "right", e.next.innerHTML = "Next >", e.appendChild(e.next), e.back.addEventListener(t.events.POINT, function() {
   i = (i + a.length - 1) % a.length, l(i)
  }), e.next.addEventListener(t.events.POINT, function() {
   i = (i + a.length + 1) % a.length, l(i)
  });
  var i = 0;
  l(i), h(s), t.is_phone_or_tablet && (s.dialog.text.style.backgroundColor = "transparent")
 }
