void function() {
 ...
 function Q(r) {
  function l() {
   e.back.style.visibility = 0 == i ? "hidden" : "visible", e.next.style.visibility = i == n.length - 1 ? "hidden" : "visible", s.text.innerHTML = n[i], s.text.parentNode.classList[1 == i ? "add" : "remove"]("jt-play-show_credits-dialog")
  }
  ...
  n[0] = o.about_text + d + ". </p>", r.callback, n[1] = "Loading...", t({
   error: function(e) {
   ...
   success: function(t) {
    ...
    if (i) {
     var s = i.game_instance,
      ...
      d = a.credit;
     n[1] = t + '<span style="width: 1rem; height: .5rem; display: block"></span><h2> Puzzle image credits </h2><p><b>' + c + "</b>: " + h + '</p><span style="width: 1rem; height: .5rem; display: block"></span><h2> Trophy image credits </h2><p><b>' + u + "</b>: " + d + "</p>"
    } else n[1] = t
   }
  });
  var s = smoke.alert(o.about_text + a.contact_info + ". </p>", r.callback),
   e = s.buttons;
