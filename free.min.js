...
function() {
    function Tt(t) {
        function n(s, n, u, d) {
            ...
            "undefined" != typeof n && ("undefined" != typeof n.title && (e.title = n.title), "undefined" != typeof n.url && (e.url = n.url), "undefined" != typeof n.callback && (e.callback = n.callback), "undefined" == typeof e.url && (e.url = location.protocol + "//" + location.host + location.pathname + e.base_filename, e.url += t)), 1 == u ? (i[t] = {}, i[t].title = e.title, i[t].url = e.url, i[t].callback = e.callback) : e[r] = s[r], console.dir(i[t]);
            var c = i[t].title,
                f = i[t].url,
                l = i[t].callback;
        ...
        window.addEventListener("popstate", function(t) {
            ...
            "undefined" == typeof t && (t = {}), "undefined" == typeof i && (i = {}), t = s(t), i = s(i), 1 == a && 1 == e.overwrite_first_state && (l(t), "undefined" == typeof e[r] && (e[r] = e.initial_page)), "undefined" == typeof t[r] && (t[r] = e[r]), "undefined" != typeof e.onbeforestatechange ? e.onbeforestatechange(t, i, function() {
                n(t, i, !0)
            }) : n(t, i, !0)
        }
    }
    ...
    function st(s) {
        function u() {
            ...
            if (null != s && (i.style.display = "none", E({
                    image: s,
                    fix_ie_bug: !0,
                    color: "#edd9a7",
                    callback: function(e) {
    ...
    function at(a) {
        function c() {
            function E() {
                ...
                y.innerHTML = '<span style="position:relative; margin-left: 18px; top: -6px; line-height: 0; font-family:lato; font-size: 60px; vertical-align: middle">' + t + '</span><span style="position:relative; top: -3px; line-height: 0; font-family: flyingsoft-icons; font-size: 106px; vertical-align: middle">g</span>', c.setTimeout(E, 250)
            }
            ...
            y.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-1 jt-button hoverable", y.addEventListener(e.events.POINT, A), c.appendChild(y), E();
            var g = 12,
            ...
            z(), "undefined" == typeof e.select_menu_current_page[i] && (e.select_menu_current_page[i] = 0), w.onsort = function() {
                b({
        ...
        function d(i) {
            function a() {
                e.try_requesting_fullscreen && !e.IS_WEBVIEW && e.is_phone_or_tablet && O(document.documentElement);
    ...
    function y() {
        ...
        t.load_game_data = function(l) {
                    ...
                    function() {
                        ...
                        for (var i in t) {
                            ...
                            if ("undefined" == typeof e.puzzle_position && (e.puzzle_position = a), a += 1, "undefined" != typeof e.template) {
                                var s = t[e.template];
                                for (var r in s) "undefined" == typeof e[r] && (e[r] = g(s[r]));
            ...
            var e = "undefined" != typeof C ? C : "default";
        ...
        var f = t.history_control = new Tt({
                ...
                onstatechange: function(e, i) {
                    if (r.IS_CORDOVA || ("undefined" == typeof window.has_save_to_server_unload_event && (window.has_save_to_server_unload_event = {}), window.has_save_to_server_unload_event[e.page] || (window.has_save_to_server_unload_event[e.page] = !0, window.addEventListener("beforeunload", t.save_player_data_to_server))), s.cleanup) {
                        s.cleanup()
                    }
                    switch (e.page) {
                        case "select_mode":
                        ...
                        case "jigsaw":
                            ht({
                                ...
                                global_settings: r,
                                level_id: e.level
                            }), !r.account.IS_PREMIUM && r.IS_WEBVIEW && "undefined" != typeof p && Z({
                                gs: r,
                                mr_jigtato: t
                            });
                            break;
    ...
    function rt(a, s, t) {
        ...
        if ("undefined" == typeof i.misc_config_menu || null == i.misc_config_menu.parentNode) {
            var e = n(t.init);
            delete e.menu_item_list, i.misc_config_menu = N({
                callback: function(e) {
                    e.style.display = "none", e.parent_menu.style.display = "", e.parent_menu.refresh()
                },
                mr_jigtato: e.mr_jigtato,
    ...
    function ht(Y) {
        ...
        function Pt(e) {
            return "undefined" == typeof e && (e = {}), A.stop(), 4 == h.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
                A.resume()
        ...
        function jt() {
            ...
            var n = o + (a.jigsaw_minimal_ui ? 0 : s(p)),
            ...
            d.style.top = n + "px", d.style.height = r + "px", X.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", t.reposition_and_resize(), M(), "undefined" != typeof x && x.naturalHeight && (e.area && e.area.forEach(function(e) {
        ...
        function Z() {
            ...
            if (0 == !!t.bg.refresh_bg && (t.bg.refresh_bg = !0, t.bg.width = "undefined" != typeof t.cached_width ? t.cached_width : t.width, t.bg.height = "undefined" != typeof t.cached_height ? t.cached_height : t.height, t.bg.getContext("2d").drawImage(t.bg.image, 0, 0, t.bg.image.naturalWidth, t.bg.image.naturalHeight, 0, 0, t.bg.width, t.bg.height), N({
                    ...
                    canvas: t.bg,
                    position: 0
                }), M()), t.background_image_drawn = !0, "undefined" == typeof u) return void t.setTimeout(Z, 50);
            ...
            (1 == r.style.opacity || e.jigsaw_show_hint_rect) && (1 == r.style.opacity || e.jigsaw_show_hint_image ? (i.globalAlpha = r.style.opacity, i.drawImage(r, n, a, s, o), i.globalAlpha = 1) : (i.fillStyle = "white", i.fillRect(n, a, s, o))), N({
                parent: t.stage,
                logical_parent: t.bg,
                canvas: t.bg,
                position: 0
        ...
        function Nt() {
            ...
            if (i.set_size = function() {
                ...
                }, si(), "undefined" == typeof localStorage["puzzle_states." + K + "." + C + "." + D.selected_difficulty]) {
                ft();
                ...
                Math.seedrandom(n), h.add_category("General"), Jt({
                    ...
                    draw_settings: F,
                    callback: function(t) {
                        O = t, ri(O, h.current_category.piece_container), L = Array.prototype.slice.call(h.current_category.piece_container.children), gt(L), rt(h.current_category.piece_container), e.pieces_in_position_count = 0, r()
                    }
                })
            } else Gt({
                callback: r
        ...
        function ni() {
            function r() {
                ...
                }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, S.addEventListener(a.events.POINT_START, Qt), document.addEventListener(a.events.POINT_MOVE, Dt), a.is_phone_or_tablet ? (R({
                    target: d.inner,
                    result_function: Lt,
                ...
                }), S.addEventListener("touchend", q), S.addEventListener("touchcancel", q), S.addEventListener("touchleave", q), g.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", ot), window.addEventListener("mouseout", It), d.inner.addEventListener("mousewheel", kt), d.inner.addEventListener("DOMMouseScroll", kt))), p.setTimeout(function() {
        ...
        function hi(l) {
            ...
            return "undefined" == typeof o && (o = -1), i > o && (o = s[C][e.difficulty_level] = i), {
                best_time: t,
                rank_count: i,
                next_rank_point: c
            }
        ...
        function st(s) {
            ...
            var s = s || {};
            localStorage.removeItem("puzzle_states." + K + "." + C + "." + D.selected_difficulty);
        ...
        function Wt(e) {
            var e = e || {};
            if (M(), u.children.forEach(function(e) {
                    e.side_set && (u.removeChild(e), P(e))
                }), h.container.children.forEach(function(e) {
                    h.remove_category(e)
                }), u.base_image.style.opacity = 1, P(u.composite_image), Z(), e.hide_controls) {
                var t = a.use_categories;
                a.use_categories = !1, p.autoshow_title(), a.use_categories = t, zt.morph_to_back_button()
            }
        ...
        function Ct(t, r) {
            ...
            var n = o(r, d.inner),
                l = n[0],
                c = n[1];
            t.left = (l / g.desired_scale - e.zoom.offset_x) / e.zoom.scale + (a.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (c / g.desired_scale - e.zoom.offset_y) / e.zoom.scale + (a.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), M();
        ...
        function Qt(n) {
            if (null == c) {
                ...
                if (!U(n)) {
                    ...
                    M(), a.playAudio(a.audio_dir + "/global-pick up.ogg", {
                        audio_type: "sound_effect",
                        blocking: !1
                    });
        ...
        function q(g) {
            if (null != S && (S.drag_end(), null != c)) {
                ...
                var I = h.current_category.piece_container.children,
                    r = c,
                    s = a.jigsaw_piece_scale_to_actual,
                    x = 2 * a.jigsaw_required_precision,
                    n = [],
                    R = c.left + (1 - s) / 2 * r.width_float - r.puzzle_left_min * s,
                    M = c.top + (1 - s) / 2 * r.height_float - r.puzzle_top_min * s;
                if (I.forEach(function(e) {
                        if (e != r)
                            for (var c = e.virtual_left - e.width_float * s / 2 - e.puzzle_left_min * s, d = e.virtual_top - e.height_float * s / 2 - e.puzzle_top_min * s, a = Math.abs(c - R), o = Math.abs(d - M), t = 0, h = r.puzzle_width.length; h > t; t++)
                    ...
                    }), pt()), ut(i), P(c), c = null, Tt(), t.refresh_piece_styling = !0, void W()
                }
                if (y)
                    for (var f = c, v = !1, w = c.calc_width / a.jigsaw_required_precision, T = c.calc_height / a.jigsaw_required_precision, E = c.left - u.left, C = c.top - u.top;;) {
                        if (E + w < f.puzzle_left_min) break;
                        if (E - w > f.puzzle_left_min) break;
                        if (C + T < f.puzzle_top_min) break;
                        if (C - T > f.puzzle_top_min) break;
                        v = !0;
                        break
                    }
                ...
                if (ut(c), N({
                    ...
                    var z = o.puzzle_left_min + u.left,
                        B = o.puzzle_top_min + u.top;
        ...
        function Bt(r) {
            ...
            var E = _t(T),
                x = J(E, [-Math.floor(o), -Math.floor(l)]),
            ...
            b.forEach(function(t) {
                s.drawImage(u.base_image, t.puzzle_left_min / p, t.puzzle_top_min / p, t.width * e.piece_logical_scale / p, t.height * e.piece_logical_scale / p, (t.puzzle_left_min - o) / e.piece_logical_scale, (t.puzzle_top_min - l) / e.piece_logical_scale, t.width, t.height)
            ...
            h.texture ? Rt(h) : N({
                ...
                position: 1,
                is_2d: !0
            }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, P(r), r == c && (c = null), Tt(), W(), Ot() && st()
        }

        function ot(i) {
            if (null != c) {
                M(), "undefined" == typeof i && (i = {}), document.body.style.cursor = "";
                var e = c;
                ...
                delete c.border_adjust_count, ut(c), N({
                    logical_parent: c,
                    canvas: c.canvas
        ...
        function Dt(e) {
            ...
            S.drag_active && S.drag_update(e), null != c && Ct(c, e)
        }
        ...
        function Ut(i) {
            function u() {
                for (var i = 0; _ > i; i++) {
                    ...
                    if (1 == a || !e.placed) {
                        var m = !1;
                        0 == a && e.sprite && (m = !0, P(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), xt(e, p), N({
                            canvas: e.canvas,
                            logical_parent: e
        ...
        function N(i) {
            ...
            return n.addChildAt(e.sprite, o), M(), "undefined" != typeof n && n == t.piece_sprite_container && 1 == a && (n.is_cached = !1), e
        }

        function P(e, r) {
            if ("undefined" == typeof r && (r = !1), "undefined" != typeof e && e.texture) {
                var i = e.sprite.parent;
                "undefined" != typeof i && e.sprite.parent.removeChild(e.sprite), e.texture.destroy(!0), e.texture = null, e.sprite = null, "undefined" != typeof i && i == t.piece_sprite_container && 1 == r && (i.is_cached = !1), M()
            }
        }
        ...
        function Ht(e) {
            ...
            Object.defineProperty(e, "children", {
                ...
                t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), M()
            }, e.removeChild = function(t) {
                e.children.splice(e.children.indexOf(t), 1), M()
        ...
        function ut(t) {
            P(t), t.canvas = document.createElement("canvas"), xt({
                element: t,
                parent: u.base_image,
        ...
        var tt = w.game_data.jigsaw,
            ...
            D = w.player_data,
            nt = w.game_data.entry_list[C],
            Q = w.set_name,
            K = a.game_type,
            y = {},
            F = {},
            e = y.game_instance = {},
            et = tt.difficulty_levels[D.selected_difficulty];
        ...
        var M = (performance.now(), y.screen_refresh = function() {
        ...
        if (e.force_screen_refresh = 0, li(), void
            ...
            vt.className = "jt-play-social_sharing_button_container", g.appendChild(vt), z({
                parent: vt,
        ...
        X.className = "jt-play-bottom_bar jt-play-main_image_border_width", r(X), g.appendChild(p), p.hide_title = function(e) {
            var e = e || {};
            "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), a.jigsaw_minimal_ui && (e.duration = 0), h.style.display = "", 0 == e.duration ? (p.inner.style.top = p.hidden_top_value, h.style.top = 0, p.inner.style.display = "none", e.callback()) : (TweenMax.to(h, e.duration / 1e3, {
                parseTransform: !0,
                ease: Linear.ease,
                css: {
                    top: 0
            ...
            var e = e || {};
            "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), a.jigsaw_minimal_ui && (e.duration = 0), p.inner.style.display = "", 0 == e.duration ? (h.style.top = p.hidden_top_value, p.inner.style.top = 0, h.style.display = "none", e.callback()) : (TweenMax.to(p.inner, e.duration / 1e3, {
                parseTransform: !0,
                ease: Linear.ease,
                css: {
                    top: 0
        ...
        h.className = "jt-jigsaw-category_deck", h.item_under_mouse = null, p.appendChild(h), h.edit_button = document.createElement("img"), h.edit_button.className = "jt-op_button jt-op_button-edit" + (a.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), h.edit_button.src = a["/"] + "images/gui/gui-item_edit.png", h.appendChild(h.edit_button), h.add_button = document.createElement("img"), h.add_button.className = "jt-op_button jt-op_button-add" + (a.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), h.add_button.src = a["/"] + "images/gui/gui-item_expand_or_add.png", h.appendChild(h.add_button), h.basket_button = document.createElement("img"), h.basket_button.className = "jt-op_button jt-op_button-basket" + (a.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), h.basket_button.piece_list = [], h.basket_button.is_selected = !1, h.basket_button.src = a["/"] + "images/gui/gui-basket.png", h.appendChild(h.basket_button), h.remove_button = document.createElement("img"), h.remove_button.className = "jt-op_button jt-op_button-remove" + (a.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), h.remove_button.src = a["/"] + "images/gui/gui-item_remove.png", h.appendChild(h.remove_button), h.container = document.createElement("div"), h.container.className = "jt-jigsaw-category_deck-container", h.appendChild(h.container), h.add_category = function(s) {
            ...
            h.current_category = i, t.piece_container = i.piece_container, M();
            var r = L;
            if ("undefined" != typeof r)
            ...
            A.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
                return "" === t ? void smoke.alert("You can't set a blank name!", function() {
                    A.resume()
                }) : (A.resume(), void(t !== !1 && (h.set_category_name(e, t), W())))
            })
        ...
        G.addEventListener(a.events.POINT, function(i) {
            ...
            P(e), e.canvas = document.createElement("canvas"), xt({
                element: e,
                parent: u.base_image,
                use_3d_effect: a.jigsaw_use_3d_effect,
                render_stroke: !0,
            ...
            function t(t) {
                A.resume(), 0 != t && (h.remove_category(e), h.select_category(h.original_category), W())
            }
            A.stop();
            var e = h.current_category;
        ...
        nt.use_image_title ? E({
            image_src: a.get_set_directory(Q) + "/puzzle/" + C + "-title.png",
            fix_ie_bug: !0,
            color: "#edd9a7",
            callback: function(e) {
        ...
        t.renderer = Kt, t.stage = St, t.piece_sprite_container = Ft, t.real_stage = at, at.addChild(St), St.addChild(Ft), t.load_opacity_transition = .5, t.style.pointerEvents = "none", t.bg = document.createElement("canvas"), t.bg.image = new Image, t.bg.image.src = w.background_image_url, t.reposition_and_resize = function() {
            var i = I(g),
                r = s(g),
                e = g.content_scale,
        ...
        var O, L, c = null;
        x.crossOrigin = "Anonymous", a.get_image(x, Q, C, "default"), x.addEventListener("load", function() {
        ...
        m.src = a.get_set_directory(w.set_name) + "/gui/gui-loading.png", m.logical_parent = t, t.loading_animation = m, m.defer_start = function(e) {
            ...
            1 != !!m.game_initialized && (m.stage.alpha = 1, m.display = !0, at.addChild(m.stage), M())
        }, m.stop = function() {
            m.stage && (m.stage.alpha = 1), m.game_initialized = !0, m.display && (m.display = !1, at.removeChild(m.stage)), M()
            ...
            if (d.isAttached()) {
                ...
                o.drawImage(m, e, 0, e, i, 0, 0, e, i), m.outer = {}, N({
        ...
        g.cleanup = function() {
            if (a.IS_CORDOVA && a.audio_container[w.last_intro_audio] && (a.audio_container[w.last_intro_audio].src = "", delete a.audio_container[w.last_intro_audio], w.last_intro_audio = ""), t.fireworks && t.fireworks.destroy(), oi(), null != t.parentNode && document.body.removeChild(t), A.destroy(), document.removeEventListener(a.events.POINT_MOVE, Dt), a.is_phone_or_tablet ? g.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", ot), window.removeEventListener("mouseout", It)), g.innerHTML = "", "undefined" != typeof a.ambient_music.last_on_state && (1 == a.ambient_music.last_on_state && (a.ambient_music_on = !0), delete a.ambient_music.last_on_state), "undefined" != typeof O)
                for (var i = 0; i < e.tile_x + 1; i++) {
                    O[i] = [];
                    for (var r = 0; r < e.tile_y + 1; r++) O[i][r] = void 0
                }
            ...
            w = null, a = null, C = null, tt = null, ei = null, D = null, nt = null, Q = null, K = null, y = null, F = null, e = null, et = null, M = null, yt = null, p = null, h = null, G = null, A = null, Vt = null, zt = null, d = null, t = null, u = null, x = null, S = null, c = null, O = null, L = null, m = null, ft = null, gt = null, W = null, Gt = null, delete g.cleanup
        }, S.drag_active = !1, S.drag_start = function(e) {
            S.drag_active = !0, S.drag_update(e, !0)
        }, S.drag_update = function(s, l) {
            if (0 != S.drag_active) {
                var t = o(s, d),
                    ...
                    n = e.zoom.offset_x,
                    a = e.zoom.offset_y;
                l || (n += i - S.drag_initial_x, a += r - S.drag_initial_y), e.zoom.offset_x = n, e.zoom.offset_y = a, S.drag_initial_x = i, S.drag_initial_y = r, S.drag_initial_scale = h
            }
        }, S.drag_end = function() {
            S.drag_active = !1
        };
        var dt = void 0,
            W = y.save_puzzle_state = function() {
                ...
                i[K + "." + C + "." + D.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + K + "." + C + "." + D.selected_difficulty] = JSON.stringify(t)
            },
            Gt = y.load_puzzle_state = function(s) {
                ...
                var t = JSON.parse(localStorage["puzzle_states." + K + "." + C + "." + D.selected_difficulty]);
        ...
        y.redraw_main_image_and_pieces = function(p) {
            function E() {
                ...
                i.save(), f({
                    ...
                    lineWidth: 0,
                    canvas: o
                }), i.clip(), i.drawImage(c, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), i.restore(), i.save(), i.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), ht(o), i.restore(), N({
                    parent: t.stage,
                    canvas: o,
                    position: 1,
                    is_2d: !0
            ...
            for (var b = [], m = [], d = 0; d < L.length; d++) {
                ...
                if ("undefined" != typeof s && (i.width_float = Math.round(i.width_float * s * 1e3 / 1e3), i.height_float = Math.round(i.height_float * s * 1e3 / 1e3), i.puzzle_left_min = Math.round(i.puzzle_left_min * s * 1e3 / 1e3), i.puzzle_top_min = Math.round(i.puzzle_top_min * s * 1e3 / 1e3), i.width = Math.ceil(i.width_float / e.piece_logical_scale), i.height = Math.ceil(i.height_float / e.piece_logical_scale), i.puzzle_width.forEach(function(t, e) {
                    ...
                    for (var l = 0, y = i.x.length; y > l; l++) O[i.x[l]][i.y[l]] = i
                } else {
                    ...
                    for (var l = 0, y = r.x.length; y > l; l++) O[r.x[l]][r.y[l]] = r
                }
            }
            M();
            var C = _t(b),
