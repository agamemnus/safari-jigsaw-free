...
function() {
 ...
 function L(r, t) {
  ...
  if ("undefined" == typeof this || this == window) return new L(r, t);
  var e = this;
 ...
 function y() {
  function h() {
   ...
   if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], o.forEach(function(n) {
    ...
    }, this.get_image_url_from_local = function(a, t, r, s) {
     if ("trophy" != r) var n = i.game_data.entry_list[t].category;
     ...
     switch ("mini-grey" == r && (r = "mini"), r) {
      case "trophy":
       ...
       break;
      case "mini":
       var l = "/puzzle/categories/" + n + "/mini/" + t + "-mini.jpg";
       break;
      case "mini-grey":
       var l = "/puzzle/categories/" + n + "/mini-grey/" + t + "-mini.png";
       break;
      case "default":
      default:
       var l = "/puzzle/categories/" + n + "/" + t + ".jpg"
     }
     return o + l
    }, this.save_to_and_get_image_url_from_persistent_dir = function(a, t, r, o) {
     if ("trophy" != r) var s = i.game_data.entry_list[t].category;
     ...
     var c = encodeURI(e.get_image_url_from_server(a, t, r)),
      n = encodeURI(e.get_set_directory(a, !0) + l),
      h = new FileTransfer;
     ...
     function a() {
      ...
      e[r] = !0, localStorage["image_is_not_local_cache." + t] = JSON.stringify(e), s()
     }

     function s() {
      function a() {
       i.removeEventListener("error", a), e.save_to_and_get_image_url_from_persistent_dir(n, r, t, i)
      }
      i.src = e.get_image_url_from_local(n, r, t, !0), i.addEventListener("error", a)
     }
     ...
     return o[r] ? void s() : (i.src = e.get_image_url_from_local(n, r, t), void i.addEventListener("error", a))
  ...
  var f = 1420276045;
  "undefined" == typeof localStorage.app_version_date && (localStorage.app_version_date = JSON.stringify(+f)), s && window.plugins && window.plugins.AppVersion && window.plugins.AppVersion.getVersionCode && window.plugins.AppVersion.getVersionCode({
   error: function() {},
   success: function(e) {
    function t() {
  ...
  var n = i.history_control = new At({
    ...
    onstatechange: function(t, l) {
     ...
     switch (t.page) {
      ...
      case "select_jigsaw":
       if ("undefined" == typeof n.show_own_ad_at_end_of_play_chance && (n.show_own_ad_at_end_of_play_chance = 1), n.last_page && "jigsaw" == n.last_page && i.player_data.jigsaw.trophies.length >= 5 && Math.random() < n.show_own_ad_at_end_of_play_chance)
        if (1 == n.show_own_ad_at_end_of_play_chance ? n.show_own_ad_at_end_of_play_chance = .475 : n.show_own_ad_at_end_of_play_chance > .3 && (n.show_own_ad_at_end_of_play_chance *= .9), Math.random() < .85) {
         ...
         5 == i.player_data.jigsaw.trophies.length && (a = 1), r.gem_purchased_amount > 10 && (a = .25), r.gem_purchased_amount > 20 && (a = 0), Math.random() < a ? wt({
          ...
          mr_jigtato: i,
          callback: e
         }) : Math.random() < .65 && r.enable_game_tips && "jigsaw" == n.last_page ? N({
          gs: r,
          mr_jigtato: i,
          callback: e
         }) : e()
       ...
       else Math.random() < .65 && r.enable_game_tips && "jigsaw" == n.last_page ? N({
        gs: r,
        mr_jigtato: i,
        callback: e
       }) : e();
 ...
 function yt(X) {
  ...
  function Lt(e) {
   return "undefined" == typeof e && (e = {}), L.stop(), 4 == l.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
    L.resume()
  ...
  function et() {
   ...
   (1 == r.style.opacity || e.jigsaw_show_hint_rect) && (t.fillStyle = "white", t.fillRect(n, a, s, o), (1 == r.style.opacity || e.jigsaw_show_hint_image) && (t.globalAlpha = r.style.opacity, t.drawImage(r, n, a, s, o), t.globalAlpha = 1)), N({
    parent: i.stage,
    logical_parent: i.bg,
    canvas: i.bg,
    position: 0
  ...
  function Jt() {
   function n() {
    ...
    }, 1e3), x.event_listeners_loaded || (x.event_listeners_loaded = !0, w.addEventListener(r.events.POINT_START, Zt), document.addEventListener(r.events.POINT_MOVE, zt), r.is_phone_or_tablet ? (j({
     target: u.inner,
     result_function: Gt,
    ...
    }), w.addEventListener("touchend", q), w.addEventListener("touchcancel", q), w.addEventListener("touchleave", q), y.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", kt), window.addEventListener("mouseout", Nt), u.inner.addEventListener("mousewheel", Wt), u.inner.addEventListener("DOMMouseScroll", Wt))), p.setTimeout(function() {
  ...
  function ct(l) {
   ...
   function m() {
    ...
    t.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + L.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + b + "</span> seconds.</p>", t.innerHTML += 0 == n ? '<p> No <span class="jt-play-show_rank-text-bright">' + c + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + T[n] + "</span> " + c + ".</p>";
    var o = document.createElement("div");
   ...
   if (L.stop(), y.style.overflow = "hidden", i.controls_locked = !0, 1 != e.zoom.scale || 0 != e.zoom.offset_x || 0 != e.zoom.offset_y) {
    var s = 1e3;
  ...
  function qt(e) {
   ...
   if (P(), d.children.forEach(function(e) {
     e.side_set && (d.removeChild(e), D(e))
    }), l.container.children.forEach(function(e) {
     l.remove_category(e)
    }), d.base_image.style.opacity = 1, D(d.composite_image), et(), e.hide_controls) {
    var t = r.use_categories;
    r.use_categories = !1, p.autoshow_title(), r.use_categories = t, At.morph_to_back_button()
   }
  ...
  function Ht(t, n) {
   ...
   var a = c(n, u.inner),
    o = a[0],
    h = a[1];
   t.left = (o / y.desired_scale - e.zoom.offset_x) / e.zoom.scale + (r.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (h / y.desired_scale - e.zoom.offset_y) / e.zoom.scale + (r.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), P();
  ...
  function Zt(t) {
   if (t.preventDefault(), !i.controls_locked) {
    ...
    if (!V(t)) {
     var d = c(t, u.inner),
      f = (d[0] / y.desired_scale - e.zoom.offset_x) / e.zoom.scale,
      p = (d[1] / y.desired_scale - e.zoom.offset_y) / e.zoom.scale,
      h = [],
    ...
    if (null != s) {
     ...
     if (k.forEach(function(e) {
      ...
      return t.className = "jt-jigsaw-piece_deck-piece", t.piece_id = a.piece_id, t.x = [], t.y = [], t.puzzle_width = [], t.puzzle_height = [], t.puzzle_left = [], t.puzzle_top = [], t.puzzle_left_min = p, t.puzzle_top_min = u, t.side_set = ot(n, !0), t.shape_string = J(ot(n, r.jigsaw_combine_pieces), [-p, -u]), t.dummy_canvas = document.createElement("canvas"), t.path = new Path2D(t.shape_string), I.push(t), a.parentNode.appendChild(t), t.width_float = Math.round(1e3 * (_ - p)) / 1e3, t.height_float = Math.round(1e3 * (m - u)) / 1e3, t.width = Math.ceil((t.width_float + 2 * e.piece_margin) / e.piece_logical_scale), t.height = Math.ceil((t.height_float + 2 * e.piece_margin) / e.piece_logical_scale), n.forEach(function(e) {
       ...
       D(e), I.splice(I.indexOf(e), 1), e.x.forEach(function(r, i) {
        B[e.x[i]][e.y[i]] = t
     ...
     if (ut(s), N({
      ...
      var O = h.puzzle_left_min + d.left,
  ...
  function Ft(n) {
   ...
   for (var p = n.x, o = 0; o < p.length; o++) {
    var l = n.x[o],
     c = n.y[o];
   ...
   var t = d.composite_image,
    ...
    h = J(_, [0, 0]),
    a = t.getContext("2d");
   a.globalCompositeOperation = "copy", a.save(), m({
    x: e.piece_margin,
    y: e.piece_margin,
   ...
   a.drawImage(d.base_image, 0, 0, t.width * e.piece_logical_scale / u, t.height * e.piece_logical_scale / u, 0, 0, t.width, t.height), a.restore(), a.save(), a.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && f({
    canvas: t,
    draw_settings: T,
    ...
    game_instance: e
   }), ht(t), a.restore(), t.texture ? Pt(t) : N({
    parent: i.stage,
    canvas: t,
    position: 1,
    is_2d: !0
   }), t.sprite.x = d.left - e.piece_margin, t.sprite.y = d.top - e.piece_margin, D(n), n == s && (s = null), gt(), W(), Ut() && ct()
  }
  ...
  function li(b) {
    ...
    for (var n = 0; m + vh > n; n++) {
     ...
     for (var i = 0; v + (1 - vh) > i; i++) {
      ...
      if ((0 == i || i == v + 1 - vh - 1) && 0 == vh || (0 == n || n == m + vh - 1) && 1 == vh) t = [t[0], t[t.length - 1]];
       ...
       if ("undefined" != typeof p[3]) var Q = p[3] - 5 + 10 * Math.randBMT();
   ...
   I.drawImage(h, 0, 0, it, rt, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, h.width / e.piece_logical_scale, h.height / e.piece_logical_scale), I.save(), I.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && f({
    canvas: M,
    draw_settings: z,
  ...
  function Ot(t) {
   function d() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, D(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), mt(e, p), N({
       canvas: e.canvas,
       logical_parent: e
  ...
  function mt(t, c, n) {
   ...
   r.restore(), _ && (r.save(), r.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), f({
    canvas: i,
    draw_settings: T,
    stroke_width: T.stroke_width,
    cut_multiplier: T.cut_multiplier,
  ...
  function ut(t) {
   D(t), t.canvas = document.createElement("canvas"), mt({
    element: t,
    parent: d.base_image,
  ...
  var P = (performance.now(), x.screen_refresh = function() {
    e.do_screen_refresh = !0
   }),
   Bt = x.category_refresh = function() {
  ...
  if (e.force_screen_refresh = 0, ui(), void
   function() {
    ...
    action: function(t, e) {
     return i.controls_locked ? void smoke.alert("The game hasn't even started yet!", e) : (it(l.current_category.piece_container), W(), void x.help_menu_obj.close())
    }
   ...
   var Ct = x.social_sharing_button_container = document.createElement("div");
   Ct.className = "jt-play-social_sharing_button_container", y.appendChild(Ct), A({
    parent: Ct,
    button_class: "jt-social_button_small"
   })
  }
  var Tt = x.trophy_ribbon = ii({
    parent: y
   }),
  ...
  l.className = "jt-jigsaw-category_deck", l.item_under_mouse = null, p.appendChild(l), l.edit_button = document.createElement("img"), l.edit_button.className = "jt-op_button jt-op_button-edit" + (r.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), l.edit_button.src = r["/"] + "images/gui/gui-item_edit.png", l.appendChild(l.edit_button), l.add_button = document.createElement("img"), l.add_button.className = "jt-op_button jt-op_button-add" + (r.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), l.add_button.src = r["/"] + "images/gui/gui-item_expand_or_add.png", l.appendChild(l.add_button), l.basket_button = document.createElement("img"), l.basket_button.className = "jt-op_button jt-op_button-basket" + (r.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), l.basket_button.piece_list = [], l.basket_button.is_selected = !1, l.basket_button.src = r["/"] + "images/gui/gui-basket.png", l.appendChild(l.basket_button), l.remove_button = document.createElement("img"), l.remove_button.className = "jt-op_button jt-op_button-remove" + (r.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), l.remove_button.src = r["/"] + "images/gui/gui-item_remove.png", l.appendChild(l.remove_button), l.container = document.createElement("div"), l.container.className = "jt-jigsaw-category_deck-container", l.appendChild(l.container), l.add_category = function(s) {
   ...
   L.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
    return "" === t ? void smoke.alert("You can't set a blank name!", function() {
     L.resume()
    }) : (L.resume(), void(t !== !1 && (l.set_category_name(e, t), W())))
   })
  ...
  G.addEventListener(r.events.POINT, function(t) {
   ...
   D(e), e.canvas = document.createElement("canvas"), mt({
    element: e,
    parent: d.base_image,
    use_3d_effect: r.jigsaw_use_3d_effect,
    render_stroke: !0,
   ...
   function t(t) {
    L.resume(), 0 != t && (l.remove_category(e), l.select_category(l.original_category), W())
   }
   L.stop();
   var e = l.current_category;
  ...
  var L = x.timer_obj = St({
   parent: p
  });
  x.timer_obj.style.display = r.show_timer ? "" : "none", n(L), x.refresh_gui_display = function() {
   var e = x.trophy_ribbon;
   e.style.display = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? "" : "none", r.jigsaw_minimal_ui ? (u.style.borderWidth = 0, p.classList.add("minimal_ui"), p.classList.add("jt-play-title-minimal_ui"), p.inner.classList.add("jt-play-title-inner-minimal_ui"), y.classList.add("jt-play-action_area-minimal_ui"), x.menu_button_obj.classList.add("jt-play-menu_button-minimal_ui"), x.timer_obj.classList.add("jt-play-timer-minimal_ui"), x.menu_button_obj.setAttribute("current_text", "M"), y.appendChild(x.timer_obj), y.appendChild(x.menu_button_obj), y.appendChild(p), H.parentNode == y && y.removeChild(H)) : (u.style.borderWidth = "", p.classList.remove("jt-play-title-minimal_ui"), p.inner.classList.remove("jt-play-title-inner-minimal_ui"), u.classList.remove("jt-play-action_area-minimal_ui"), x.menu_button_obj.classList.remove("jt-play-menu_button-minimal_ui"), x.timer_obj.classList.remove("jt-play-timer-minimal_ui"), y.insertBefore(p, u), y.insertBefore(H, u.nextSibling), p.insertBefore(x.timer_obj, p.childNodes[0]), p.appendChild(x.menu_button_obj)), Dt()
  };
  var Xt = x.help_menu_obj = S({
    gs: r,
    parent: y,
    current_game: x,
  ...
  }) : (p.inner = document.createElement("div"), p.inner.className = "jt-play-title-inner", p.appendChild(p.inner), p.inner.text = document.createElement("p"), p.inner.text.innerHTML = at.name, p.inner.appendChild(p.inner.text), R(p.inner.text, {
   unit_type: "px",
   transform_scale: y.content_scale
  }));
  var u = document.createElement("div");
  u.className = "jt-play-action_area", u.style.overflow = "hidden", y.appendChild(u), r.is_phone_or_tablet || u.addEventListener("mousedown", function(e) {
   e.preventDefault()
  ...
  var d = x.main_image = document.createElement("div");
  ...
  }), x.refresh_gui_display(), nt(void 0, !0);
  var dt = x.set_base_image_size = function() {
    var t = si();
    ...
    }(), Dt(), d.left = (parseFloat(window.getComputedStyle(y).width) - E.width) / 2, d.width = E.width, d.height = E.height;
    var i = d.composite_image;
    i.set_size()
   },
   Et = x.size_pieces = function(e) {
    e.forEach(function(e) {
     e.calc_width = e.width_float * r.jigsaw_piece_scale_to_actual, e.calc_height = e.height_float * r.jigsaw_piece_scale_to_actual
    }), i.piece_sprite_container.is_cached = !1
   };
  y.cleanup = function() {
   if (r.IS_CORDOVA && r.audio_container[C.last_intro_audio] && (r.audio_container[C.last_intro_audio].src = "", delete r.audio_container[C.last_intro_audio], C.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), hi(), null != i.parentNode && document.body.removeChild(i), L.destroy(), document.removeEventListener(r.events.POINT_MOVE, zt), r.is_phone_or_tablet ? y.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", kt), window.removeEventListener("mouseout", Nt)), y.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof B)
   ...
   i.piece_container && (i.piece_container.children.forEach(function(e) {
    ...
    t && delete t[e.area][e.row][e.column], e.piece_matrix = null, e.width = 0, D(e), e = null
   }), i.piece_container.children = [], delete i.piece_container.piece_matrix, delete i.piece_container), D(d.base_image), D(i.bg), _.inner && D(_.inner), _.outer && D(_.outer), D(d.composite_image), i.stage.removeChild(i.piece_sprite_container), i.real_stage.removeChild(i.stage), i.real_stage.interactionManager.removeEvents(), i.renderer.destroy && i.renderer.destroy(), d.composite_image && (delete d.composite_image.set_size, delete d.composite_image), delete y.draw_area, delete _.logical_parent;
   for (var a in i) delete i[a];
   C = null, r = null, M = null, K = null, di = null, z = null, at = null, Q = null, $ = null, x = null, T = null, e = null, Z = null, P = null, Tt = null, p = null, l = null, G = null, L = null, Xt = null, At = null, u = null, i = null, d = null, E = null, w = null, s = null, B = null, I = null, _ = null, dt = null, Et = null, W = null, Mt = null, delete y.cleanup
  ...
  var lt = void 0,
   W = x.save_puzzle_state = function() {
    ...
    }, t.counter = x.timer_obj.counter, t.zoom = e.zoom, t.piece_list = [], I.forEach(function(e) {
     var e = It(e);
   ...
   Mt = x.load_puzzle_state = function(s) {
    function o() {
     var e = {};
    ...
    x.timer_obj.counter = t.counter, dt();
    var h = E.width / E.naturalWidth / i;
    e.zoom = t.zoom, B = [];
    for (var n = 0; n < e.tile_x; n++) B[n] = [];
    I = t.piece_list, x.redraw_main_image_and_pieces({
     piece_rescale: h,
     top_rescale: c,
     callback: o
    })
  ...
  x.redraw_main_image_and_pieces = function(p) {
   ...
   for (var g = [], u = 0; u < I.length; u++) {
    ...
    if ("undefined" != typeof s && (t.width_float = Math.round(t.width_float * s * 1e3 / 1e3), t.height_float = Math.round(t.height_float * s * 1e3 / 1e3), t.puzzle_left_min = Math.round(t.puzzle_left_min * s * 1e3 / 1e3), t.puzzle_top_min = Math.round(t.puzzle_top_min * s * 1e3 / 1e3), t.width = Math.ceil(t.width_float / e.piece_logical_scale), t.height = Math.ceil(t.height_float / e.piece_logical_scale), t.puzzle_width.forEach(function(i, e) {
     ...
     if (g.push(t), I[u].canvas) var n = I[u];
     else var n = ft();
   ...
   var _ = h.getContext("2d"),
    A = c.naturalWidth,
    M = c.naturalHeight;
   _.drawImage(c, 0, 0, A, M, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), _.save(), _.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && f({
    canvas: h,
    draw_settings: T,
    stroke_width: T.stroke_width,
    cut_multiplier: T.cut_multiplier,
