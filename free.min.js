...
function() {
 ...
 function P(e) {
  ...
  if ("undefined" == typeof this || this === window) return new P(e);
  var t = e.target,
   i = !1,
   a = void 0,
   s = void 0;
 ...
 function t(e) {
  ...
  var a = "undefined" != typeof e.charset ? e.charset : "",
   ...
   l = Tt(e.file, s, n, a, t, void 0, void 0, e.request_method),
   i = l.http_request;
 ...
 function w(i, t) {
  if ("undefined" == typeof t && (t = {}), t.play_howl) return new D(i, t);
 ...
 function D(r, t) {
  ...
  if ("undefined" == typeof this || this == window) return new D(r, t);
  var e = this;
 ...
 function x() {
  function l() {
   ...
   if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], o.forEach(function(n) {
     ...
     return i ? "cdvfile://localhost/persistent/sets/" + t : (d ? "content://" + k + ".free.expansion/" : e["/"]) + "sets/" + t
     ...
     var n = (d ? "content://" + k + ".free.expansion/" : e["/"]) + "sets/" + s;
  ...
  var _ = i.history_control = new At({
    onbeforestatechange: function(e, t, n) {
     ...
     t.title = c(e, t), "undefined" != typeof i.game_data ? n() : i.load_game_data({
  ...
  }), wt(), i.play_intro_audio = function(a) {
   var h = a.level_id,
    s = a.count,
    t = i.game_data,
    o = t.entry_list[h],
 ...
 function ct(r) {
  ...
  var e = r.gs,
   o = r.mr_jigtato;
  if (e.account.purchased_ad_removal) return void a();
  var l = o.game_data.jigsaw.difficulty_levels[o.player_data.selected_difficulty],
   c = l.tile_x,
   h = l.tile_y,
   i = (e.show_ad_counter, Math.sqrt(c * h) / 8);
  ...
  }), e.show_ad_counter >= 1 ? (e.show_ad_counter = e.show_ad_counter - parseInt(e.show_ad_counter), Math.random() > .1 ? e.ad_control && e.ad_control.run() : 0 == e.account.game_was_rated ? s() : e.ad_control.run()) : a()
 }
 ...
 function $(n, s, i) {
  ...
  if ("undefined" == typeof e.audio_settings_menu || null == e.audio_settings_menu.parentNode) {
   var t = a(i.init);
   delete t.menu_item_list, e.audio_settings_menu = Y({
    callback: function(e) {
 ...
 function tt(n, s, t) {
  ...
  if ("undefined" == typeof i.misc_config_menu || null == i.misc_config_menu.parentNode) {
   var e = a(t.init);
   delete e.menu_item_list, i.misc_config_menu = Q({
    callback: function(e) {
     e.style.display = "none", e.parent_menu.style.display = "", e.parent_menu.refresh()
    },
    mr_jigtato: e.mr_jigtato,
 ...
 function I(i) {
  ...
  r.open("HEAD", o + "/" + e, !0), r.onreadystatechange = function() {
   if (4 == r.readyState) {
    ...
    h >= i ? a(l + "/" + e, u) : i > o ? (localStorage.json_file_version_date = JSON.stringify(+i), m()) : n()
   }
  }, r.send(null)
 }
 ...
 function ht(a) {
  function u() {
   ...
   if (null != a && (t.style.display = "none", C({
     image: a,
     fix_ie_bug: !0,
     color: "#edd9a7",
     callback: function(e) {
  ...
  function s(t) {
   function i(t) {
    1 != e.DEBUG && e.challenge_code_request_asked || "undefined" == typeof e.account.internal_access_token ? t() : y({
     gs: e,
     callback: t,
 ...
 function ut(s) {
  function u() {
   ...
   var R = a.challenge_a_friend_button = mt({
    select_screen: a,
    content_div: o,
    mr_jigtato: t,
    gs: e
   ...
   var B = a.create_tab_container = function(r) {
     function l() {
      ...
      e.select_menu_current_category[i] = r[(l + 1) % r.length], e.select_menu_current_category = e.select_menu_current_category, f = e.select_menu_current_category[i], "undefined" == typeof e.select_menu_current_page[i][f] && (e.select_menu_current_page[i][f] = 0), s.innerHTML = n[f].shortcut, C(), o(), b.sort_levels()
     }
 ...
 function pt(q) {
  ...
  function nt(m, u) {
   ...
   if (e.do_screen_refresh_run) {
    if (!e.do_screen_refresh && (e.force_screen_refresh <= 0 || !i.background_image_drawn)) return void c();
    if (i.first_render_complete && document.body.appendChild(i), i.first_render_complete = !0, e.do_screen_refresh = !1, e.do_category_refresh && (h.refresh(), e.do_category_refresh = !1), void
     function() {
    ...
    var l = e.zoom.scale,
     d = e.zoom.offset_x,
     p = e.zoom.offset_y;
    t.x = d, t.y = p, l && (t.scale.x = l, t.scale.y = l), t.alpha = 1;
  ...
  function Rt(e) {
   return "undefined" == typeof e && (e = {}), k.stop(), 4 == h.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
    k.resume()
  ...
  function Ot() {
   ...
   d.style.top = a + "px", d.style.height = n + "px", X.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", i.reposition_and_resize(), L(), "undefined" != typeof T && T.naturalHeight && (e.area && e.area.forEach(function(e) {
    e.height = n * e.height_ratio
   }), u.top = (n - T.height + (T.height - T.height)) / 2), et(), h.container.children.forEach(function(t) {
  ...
  function et() {
   ...
   if (0 == !!i.bg.refresh_bg && (i.bg.refresh_bg = !0, i.bg.width = "undefined" != typeof i.cached_width ? i.cached_width : i.width, i.bg.height = "undefined" != typeof i.cached_height ? i.cached_height : i.height, i.bg.getContext("2d").drawImage(i.bg.image, 0, 0, i.bg.image.naturalWidth, i.bg.image.naturalHeight, 0, 0, i.bg.width, i.bg.height), F({
     ...
     canvas: i.bg,
     position: 0
    }), L()), i.background_image_drawn = !0, "undefined" == typeof u) return void i.setTimeout(et, 50);
  ...
  function jt() {
   ...
   e.jigsaw_initial_show_hint_image = r.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, e.jigsaw_show_hint_image = r.jigsaw_show_hint_image, e.piece_margin = r.jigsaw_get_scaled_piece_margin(e), e.piece_margin_style = r.jigsaw_piece_margin_style, d.inner.appendChild(x);
   ...
   if (t.set_size = function() {
    ...
    }, si(), "undefined" == typeof localStorage["puzzle_states." + $ + "." + M + "." + O.selected_difficulty]) {
    gt();
    var a = Math.round(1e6 * Math.random());
    Math.seedrandom(a), h.add_category("General"), oi({
     source_image: T,
     width: T.width,
     height: T.height,
     size_x: e.tile_x,
     ...
     draw_settings: w,
     callback: function(t) {
      j = t, ii(j, h.current_category.piece_container), I = Array.prototype.slice.call(h.current_category.piece_container.children), St(I), st(h.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else Mt({
    callback: n
  ...
  function qt() {
   function n() {
    ...
    }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, x.addEventListener(r.events.POINT_START, Kt), document.addEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? (P({
     target: d.inner,
     result_function: Ut,
    ...
    }), x.addEventListener("touchend", Y), x.addEventListener("touchcancel", Y), x.addEventListener("touchleave", Y), g.addEventListener("touchend", Y)) : (document.addEventListener("mouseup", Y), window.addEventListener("blur", pt), window.addEventListener("mouseout", Ft), d.inner.addEventListener("mousewheel", Gt), d.inner.addEventListener("DOMMouseScroll", Gt))), p.setTimeout(function() {
     "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), A.play_intro_audio({
      level_id: q.level_id,
      parent: d.inner
     })
    }, 400)
  ...
  function Jt(t) {
   ...
   r.playAudio(r.audio_dir + "/answer-give up.ogg", {
    audio_type: "sound_effect",
    blocking: !1
   }), h.select_category(h.original_category), Array.prototype.slice.call(h.container.childNodes).forEach(function(e) {
   ...
   var n = (e.piece_margin, h.current_category.piece_container.children);
  ...
  function ct(h) {
   ...
   function m() {
    ...
    r.playAudio(r.get_set_directory(Z) + "/audio/" + e.rank_audio[n] + ".m4a", {
     audio_type: "music",
     element: d.inner,
     restart: !0
    });
    ...
    c(s), s.dialog.buttons.ok.addEventListener(r.events.POINT, function() {
     n >= 1 && (!window.kiipInstance || r.account && r.account.purchased_ad_removal || (console.log(window.kiipInstance), window.kiipInstance.postMoment("rank_count: " + n + ", selected_difficulty: " + O.selected_difficulty))), i.fireworks = new _t({
      gs: r,
      draw_area: i
     })
    });
    ...
    t.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + k.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + x + "</span> seconds.</p>", t.innerHTML += 0 == n ? '<p> No <span class="jt-play-show_rank-text-bright">' + h + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + w[n] + "</span> " + h + ".</p>";
    var o = document.createElement("div");
    o.className = "jt-play-show_rank-image-container";
    for (var l = 0; n > l; l++) {
     var a = document.createElement("div");
     a.className = "jt-play-show_rank-image-item", o.appendChild(a), a.style.opacity = .01, a.style.backgroundImage = 'url("' + r.get_set_directory(Z) + "/gui/" + e.filename + '")', void
     function(t, i) {
      d.inner.setTimeout(function() {
       TweenMax.to(t, 2, {
        parseTransform: !0,
        ...
        t.addEventListener(r.events.POINT, function() {
         "undefined" != typeof e.click_audio && r.playAudio(r.get_set_directory(Z) + "/audio/" + e.click_audio + ".ogg", {
          element: d.inner,
          audio_type: "music"
         })
        })
   ...
   var h = h || {};
   localStorage.removeItem("puzzle_states." + $ + "." + M + "." + O.selected_difficulty);
   ...
   if (k.stop(), g.style.overflow = "hidden", a || (i.controls_locked = !0), 1 != e.zoom.scale || 0 != e.zoom.offset_x || 0 != e.zoom.offset_y) {
    var o = 1e3;
   ...
   if (a || d.inner.setTimeout(function() {
    ...
    localStorage.player_data = JSON.stringify(O), 0 == a ? d.inner.setTimeout(f, o + (h.show_trophy_delay || 550)) : d.inner.setTimeout(f, o + (h.show_trophy_delay || 550))
   }
  }

  function Ht(e) {
   var e = e || {};
   if (L(), u.children.forEach(function(e) {
     e.side_set && (u.removeChild(e), D(e))
    }), h.container.children.forEach(function(e) {
     h.remove_category(e)
    }), u.base_image.style.opacity = 1, D(u.composite_image), et(), e.hide_controls) {
  ...
  function Vt(t, n) {
   ...
   var a = l(n, d.inner),
    o = a[0],
    c = a[1];
   t.left = (o / g.desired_scale - e.zoom.offset_x) / e.zoom.scale + (r.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (c / g.desired_scale - e.zoom.offset_y) / e.zoom.scale + (r.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), L();
  ...
  function Kt(t) {
   if (t.preventDefault(), !i.controls_locked) {
    ...
    if ("undefined" != typeof t.targetTouches) {
     if (t.touches.length > 1) {
      if (null != s) {
       ...
       a != x || x.pinch_active || x.drag_start(t)
      }
      return
     }
     t = t.targetTouches[0]
    ...
    if (!W(t)) {
     ...
     if (y)
      for (var _ = y.piece_container, o = 0, m = _.children.length; m > o; o++) {
       ...
       if (!n.placed && !(f < n.left || p < n.top || f > n.left + n.calc_width || p > n.top + n.calc_height)) {
        var w = ((f - n.left) / r.jigsaw_piece_scale_to_actual + e.piece_margin) / e.piece_logical_scale,
     ...
     if (0 == c.length) return void(a != x || x.pinch_active || x.drag_start(t));
     for (var a = c[0], v = +c[0].sprite.index, o = 1, m = c.length; m > o; o++) {
      var n = c[o]; + n.zIndex <= v || (v = +n.zIndex, a = n)
     }
     L(), r.playAudio(r.audio_dir + "/global-pick up.ogg", {
      audio_type: "sound_effect",
      blocking: !1
     });
   ...
   if (null != x) {
    ...
    if (null != s) {
     ...
     if (null != h.item_under_mouse) {
      var M = h.current_category;
      if (M != h.item_under_mouse) {
       y = !1, g = !0;
       var v = h.item_under_mouse.piece_container;
       v.appendChild(s), st(v, [s])
      }
     }
     var A = h.current_category.piece_container.children,
      a = s,
     ...
     if (ot(s), F({
      ...
      var O = c.puzzle_left_min + u.left,
       z = c.puzzle_top_min + u.top;
      bt(), c.placed = !0, TweenMax.to(c, .35, {
       parseTransform: !0,
       ease: Linear.ease,
       left: O,
       top: z,
  ...
  function zt(n) {
   ...
   for (var y = [], b = [], S = [
     ...
     [2, -2, !1],
     [-2, 2, !1]
    ], d = {}, x = n.x, c = u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale, f = 0, l = u.composite_image.height - 2 * e.piece_margin / e.piece_logical_scale, g = 0, a = 0; a < x.length; a++) {
    var T = n.x[a],
     v = n.y[a];
    j[T][v] = Pt(n)
   }
   ...
   var C = (at(y, !0), Q(at(y, r.jigsaw_combine_pieces), [-Math.floor(c), -Math.floor(l)])),
    t = document.createElement("canvas");
   t.width_float = Math.round(1e3 * (f - c)) / 1e3, t.height_float = Math.round(1e3 * (g - l)) / 1e3, t.width = Math.ceil((t.width_float + 2 * e.piece_margin) / e.piece_logical_scale), t.height = Math.ceil((t.height_float + 2 * e.piece_margin) / e.piece_logical_scale);
   ...
   }), o.restore(), o.save(), o.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && _({
    canvas: t,
    draw_settings: w,
   ...
   h.texture ? Lt(h) : F({
    ...
    position: 1,
    is_2d: !0
   }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, D(n), n == s && (s = null), vt(), H(), Xt() && ct()
  }

  function pt(e) {
   if (null != s) {
    if (L(), "undefined" == typeof e && (e = {}), document.body.style.cursor = "", e.is_transferred_to_different_category || i.piece_sprite_container.addChild(s.sprite), s.visibility = "visible", !r.freestyle_mode || e.is_transferred_to_different_category) s.left = s.pickup_left, s.top = s.pickup_top;
    else {
    ...
    delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, ot(s), F({
     logical_parent: s,
     canvas: s.canvas
    }), s.calc_width = s.width_float * r.jigsaw_piece_scale_to_actual, s.calc_height = s.height_float * r.jigsaw_piece_scale_to_actual, s = null, h.item_under_mouse = null, vt(), H()
   }
  }
  ...
  function oi(b) {
   ...
   for (var h = (b.success || function() {}, b.source_image), m = b.size_x, v = b.size_y, N = b.width, B = b.height, z = b.draw_settings, y = [], M = G(), W = 100 / m, V = 100 / v, n = 0; m >= n; n++) {
    y[n] = [];
    for (var i = 0; v >= i; i++) {
     var tt = 0 == n || n == m ? 0 : .25 * Math.randBMT(),
    ...
    for (var n = 0; m + vh > n; n++) {
     ...
     for (var i = 0; v + (1 - vh) > i; i++) {
      ...
      for (var s = 0, c = t.length; c > s; s++) {
       ...
       t[s][0] = t[s][0] / 300 * W + y[n][i][0], t[s][1] = t[s][1] / 300 * V + y[n][i][1]
      }
      var c = t.length;
   ...
   for (var D = [], H = "", X = 0, n = 0; m > n; n++) {
    ...
    for (var i = 0; v > i; i++) {
     for (var w = [], C = [], E = "", S = "", o = {
      ...
      var L = 0,
       t = f[u % 2 == 0 ? 1 : 0][n + (2 == u ? 1 : 0)][i + (3 == u ? 1 : 0)],
       c = t.length;
      if (2 >= c) var o = {
       ...
       for (var s = 0; 4 > s; s += 3) var x = it(t[0 + s][0], t[0 + s][1], t[1 + s][0], t[1 + s][1], t[2 + s][0], t[2 + s][1], t[3 + s][0], t[3 + s][1]),
        o = {
   ...
   I.drawImage(h, 0, 0, rt, nt, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, h.width / e.piece_logical_scale, h.height / e.piece_logical_scale), I.save(), I.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && _({
    canvas: k,
    draw_settings: z,
  ...
  function It(t) {
   function u() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, D(e)), e.shape_string = Q(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), xt(e, p), F({
       canvas: e.canvas,
       logical_parent: e
  ...
  function F(t) {
   ...
   return n.addChildAt(e.sprite, o), L(), "undefined" != typeof n && n == i.piece_sprite_container && 1 == a && (n.is_cached = !1), e
  }

  function D(e, r) {
   if ("undefined" == typeof r && (r = !1), "undefined" != typeof e && e.texture) {
    var t = e.sprite.parent;
    "undefined" != typeof t && e.sprite.parent.removeChild(e.sprite), e.texture.destroy(!0), e.texture = null, e.sprite = null, "undefined" != typeof t && t == i.piece_sprite_container && 1 == r && (t.is_cached = !1), L()
   }
  }
  ...
  function kt(e) {
   ...
   Object.defineProperty(e, "children", {
    ...
    t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), L(), Bt()
   }, e.removeChild = function(t) {
    e.children.splice(e.children.indexOf(t), 1), L(), Bt()
  ...
  function xt(t, c, n) {
   ...
   var g = Q(t.side_set, [-t.puzzle_left_min + a + o, -t.puzzle_top_min + a + o], 1 / s);
   ...
   r.restore(), f && (r.save(), r.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), _({
    canvas: i,
    draw_settings: w,
    stroke_width: w.stroke_width,
    cut_multiplier: w.cut_multiplier,
  ...
  function ot(t) {
   D(t), t.canvas = document.createElement("canvas"), xt({
    element: t,
    parent: u.base_image,
  ...
  var g = q.content_div,
   ...
   M = q.level_id;
  g.innerHTML = "";
  var J = A.game_data.jigsaw,
   ui = A.game_data.trophy_list,
   O = A.player_data,
   it = A.game_data.entry_list[M],
   Z = A.set_name,
   $ = r.game_type,
   y = {},
   w = {},
   e = y.game_instance = {},
   tt = J.difficulty_levels[O.selected_difficulty];
  e.difficulty_level = O.selected_difficulty, e.get_piece_count = function() {
   return e.tile_x * e.tile_y
  }, e.intro_audio_count = 0, !r.is_kiosk && r.use_social_media_buttons && K();
  var ft = ["answer-correct-10865990.ogg", "answer-correct-23303730.ogg", "answer-correct-25513672.ogg", "answer-correct-25513693.ogg", "answer-correct-37240671.ogg", "answer-correct-37240686.ogg", "answer-correct-37241588.ogg", "answer-correct-37241627.ogg"],
   ni = ["global-pick up.ogg", "global-put down.ogg", "answer-give up.ogg", "fireworks-1.ogg", "fireworks-2.ogg", "fireworks-3.ogg", "fireworks-4.ogg"].concat(ft);
  lt({
   parent: r,
   dir: r.audio_dir + "/",
   audio_list: ni,
   type: "is_sound_effect"
  }), r.ambient_music.last_on_state = r.ambient_music_on, r.ambient_music_on = !1, r.ambient_music.load_ambient_music(A.game_data.ambient_music, A.game_data.ambient_music_start), Qt();
  var L = (performance.now(), y.screen_refresh = function() {
  ...
  if (e.force_screen_refresh = 0, hi(), void
   function() {
   ...
   }(), g.style.overflow = "hidden", n(g), y.menu_item_list = [A.menu.generic.about, A.menu.generic.ogle_trophies, {
    text: "Restart",
    action: function(r, e, t) {
    ...
    action: function() {
     st(h.current_category.piece_container), H(), y.help_menu_obj.close()
    }
   }, A.menu.jigsaw.toggle_categories, A.menu.jigsaw.open_misc_config_menu, A.menu.jigsaw.show_mini_hint_image, {
    text: "undefined" == typeof A.game_data.play_intro_audio_text ? "Play Puzzle Intro Audio" : A.game_data.play_intro_audio_text,
    action: function(i, t) {
     e.intro_audio_count += 1, A.play_intro_audio({
      level_id: q.level_id,
      count: e.intro_audio_count,
      parent: d.inner
     }), t()
    }
   }, A.menu.jigsaw.open_visual_settings_menu, A.menu.generic.open_audio_settings_menu], !r.is_kiosk && r.use_social_media_buttons) {
   var Tt = y.social_sharing_button_container = document.createElement("div");
   Tt.className = "jt-play-social_sharing_button_container", g.appendChild(Tt), N({
    parent: Tt,
  ...
  var X = y.bottom_bar = document.createElement("div");
  X.className = "jt-play-bottom_bar jt-play-main_image_border_width", n(X), g.appendChild(p), p.hide_title = function(e) {
   var e = e || {};
   ...
   r.eventCallback("onComplete", function() {
    e.parentNode && (g.removeChild(e), t.callback())
   }), setTimeout(function() {
    r.add(n())
   }, 0), TweenLite.set(e, {
    perspective: 700,
  ...
  var h = y.category_deck = document.createElement("div");
  h.className = "jt-jigsaw-category_deck", h.item_under_mouse = null, p.appendChild(h), h.edit_button = document.createElement("img"), h.edit_button.className = "jt-op_button jt-op_button-edit" + (r.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), h.edit_button.src = r["/"] + "images/gui/gui-item_edit.png", h.appendChild(h.edit_button), h.add_button = document.createElement("img"), h.add_button.className = "jt-op_button jt-op_button-add" + (r.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), h.add_button.src = r["/"] + "images/gui/gui-item_expand_or_add.png", h.appendChild(h.add_button), h.basket_button = document.createElement("img"), h.basket_button.className = "jt-op_button jt-op_button-basket" + (r.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), h.basket_button.piece_list = [], h.basket_button.is_selected = !1, h.basket_button.src = r["/"] + "images/gui/gui-basket.png", h.appendChild(h.basket_button), h.remove_button = document.createElement("img"), h.remove_button.className = "jt-op_button jt-op_button-remove" + (r.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), h.remove_button.src = r["/"] + "images/gui/gui-item_remove.png", h.appendChild(h.remove_button), h.container = document.createElement("div"), h.container.className = "jt-jigsaw-category_deck-container", h.appendChild(h.container), h.add_category = function(s) {
   var t = document.createElement("div");
   t.className = "jt-jigsaw-category_deck-category jt-play-main_image_border_width jt-button_generic hoverable", h.container.appendChild(t), t.inner = document.createElement("div"), t.appendChild(t.inner), h.set_category_name(t, s);
   ...
   return "undefined" == typeof h.current_category && (h.select_category(t), h.original_category = t), t.addEventListener(r.events.POINT, function(e) {
    h.select_category(e.currentTarget), H()
   ...
   t.parentNode && t.parentNode.removeChild(t), h.original_category && (e != h.original_category ? st(h.original_category.piece_container, i) : delete h.original_category), 1 == h.container.children.length && delete h.current_category, h.container.removeChild(e)
  }, h.select_category = function(e) {
   "undefined" != typeof e && (h.current_category = e, i.piece_container = e.piece_container, L(), h.refresh(), h.container.children.forEach(function(t) {
    if (t == e) var i = "add";
    else var i = "remove";
   ...
   k.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
    return "" === t ? void smoke.alert("You can't set a blank name!", function() {
     k.resume()
    }) : (k.resume(), void(t !== !1 && (h.set_category_name(e, t), H())))
   })
  }), h.add_button.addEventListener(r.events.POINT, Rt);
  var V = h.basket_button;
  V.addEventListener(r.events.POINT, function(t) {
   ...
   e.classList[e.is_selected ? "remove" : "add"]("jt-op_button-basket" + (r.is_phone_or_tablet ? "-colored" : "") + "-selected"), e.is_selected && !n && Rt({
    ...
    success: function(t) {
     ...
     }), st(t.piece_container), e.piece_list = [], H()
    }
   ...
   D(e), e.canvas = document.createElement("canvas"), xt({
    element: e,
    parent: u.base_image,
    use_3d_effect: r.jigsaw_use_3d_effect,
    render_stroke: !0,
   ...
   function t(t) {
    k.resume(), 0 != t && (h.remove_category(e), h.select_category(h.original_category), H())
   }
   k.stop();
   var e = h.current_category;
  ...
  it.use_image_title ? C({
   image_src: r.get_set_directory(Z) + "/puzzle/" + M + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  }) : (p.inner = document.createElement("div"), p.inner.className = "jt-play-title-inner", p.appendChild(p.inner), p.inner.text = document.createElement("p"), p.inner.text.innerHTML = it.name, p.inner.appendChild(p.inner.text), R(p.inner.text, {
   unit_type: "px",
   transform_scale: g.content_scale
  }));
  var d = document.createElement("div");
  d.className = "jt-play-action_area", d.style.overflow = "hidden", g.appendChild(d), r.is_phone_or_tablet || d.addEventListener("mousedown", function(e) {
   e.preventDefault()
  ...
  var ht = new PIXI.Stage,
   ...
   i = g.draw_area = document.createElement("canvas");
  ...
  i.renderer = $t, i.stage = yt, i.piece_sprite_container = Nt, i.real_stage = ht, ht.addChild(yt), yt.addChild(Nt), i.load_opacity_transition = .5, i.style.pointerEvents = "none", i.bg = document.createElement("canvas"), i.bg.image = new Image, i.bg.image.src = A.background_image_url, i.reposition_and_resize = function() {
   var t = B(g),
    n = o(g),
    e = g.content_scale,
    a = parseFloat(getComputedStyle(d).top),
    l = r.jigsaw_minimal_ui ? 0 : o(X);
  ...
  var j, I, s = null;
  T.crossOrigin = "Anonymous", r.get_image(T, Z, M, "default"), T.addEventListener("load", function() {
   null != d && d.inner.setTimeout(jt, 30)
  });
  var f = new Image;
  f.src = r.get_set_directory(A.set_name) + "/gui/gui-loading.png", f.logical_parent = i, i.loading_animation = f, f.defer_start = function(e) {
   d.inner.setTimeout(function() {
    f && !f.game_initialized && (f.start(), nt(void 0, !0))
   }, e)
  }, f.start = function() {
   1 != !!f.game_initialized && (f.stage.alpha = 1, f.display = !0, ht.addChild(f.stage), L())
  }, f.stop = function() {
   f.stage && (f.stage.alpha = 1), f.game_initialized = !0, f.display && (f.display = !1, ht.removeChild(f.stage)), L()
  ...
  var gt = y.set_base_image_size = function() {
    var t = ai();
    T.width = t.width, T.height = t.height, 2 == r.jigsaw_arrange_pieces_on_entire_area && T.naturalHeight <= T.naturalWidth && (e.jigsaw_arrange_pieces_on_entire_area = !0), void
    function() {
  ...
  g.cleanup = function() {
   if (r.IS_CORDOVA && r.audio_container[A.last_intro_audio] && (r.audio_container[A.last_intro_audio].src = "", delete r.audio_container[A.last_intro_audio], A.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), ci(), null != i.parentNode && document.body.removeChild(i), k.destroy(), document.removeEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? g.removeEventListener("touchend", Y) : (document.removeEventListener("mouseup", Y), window.addEventListener("blur", pt), window.removeEventListener("mouseout", Ft)), g.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof j)
    for (var t = 0; t < e.tile_x + 1; t++) {
     j[t] = [];
     for (var n = 0; n < e.tile_y + 1; n++) j[t][n] = void 0
    }
   ...
   if (0 != x.drag_active) {
    var t = l(s, d),
     ...
     n = e.zoom.offset_x,
     a = e.zoom.offset_y;
    o || (n += i - x.drag_initial_x, a += r - x.drag_initial_y), e.zoom.offset_x = n, e.zoom.offset_y = a, x.drag_initial_x = i, x.drag_initial_y = r, x.drag_initial_scale = c
   }
  }, x.drag_end = function() {
  ...
  var ut = void 0,
   H = y.save_puzzle_state = function() {
    ...
    }), t.category_deck.current_category_name = h.current_category.childNodes[0].innerHTML;
    var i = JSON.parse(localStorage["puzzle_states.$keys"]);
    i[$ + "." + M + "." + O.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + $ + "." + M + "." + O.selected_difficulty] = JSON.stringify(t)
   },
   Mt = y.load_puzzle_state = function(s) {
    function o() {
     ...
     r.forEach(function(t) {
      var r = h.add_category(t.innerHTML),
       n = t.pieces,
       a = r.piece_container;
      n.forEach(function(t) {
       var i = e[t.piece_id];
       a.appendChild(i)
      }), t.innerHTML == i && h.select_category(r), St(r.piece_container.children)
     }), Xt() && ct(), s.callback()
    }
    var t = JSON.parse(localStorage["puzzle_states." + $ + "." + M + "." + O.selected_difficulty]);
  ...
  y.redraw_main_image_and_pieces = function(p) {
   function S() {
    ...
    t.save(), m({
     ...
     lineWidth: 0,
     canvas: o
    }), t.clip(), t.drawImage(h, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), t.restore(), t.save(), t.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), dt(o), t.restore(), F({
     parent: i.stage,
     canvas: o,
     position: 1,
     is_2d: !0
   ...
   for (var b = [], g = [], d = 0; d < I.length; d++) {
    ...
    if ("undefined" != typeof s && (t.width_float = Math.round(t.width_float * s * 1e3 / 1e3), t.height_float = Math.round(t.height_float * s * 1e3 / 1e3), t.puzzle_left_min = Math.round(t.puzzle_left_min * s * 1e3 / 1e3), t.puzzle_top_min = Math.round(t.puzzle_top_min * s * 1e3 / 1e3), t.width = Math.ceil(t.width_float / e.piece_logical_scale), t.height = Math.ceil(t.height_float / e.piece_logical_scale), t.puzzle_width.forEach(function(i, e) {
     ...
     for (var l = 0, x = t.x.length; x > l; l++) j[t.x[l]][t.y[l]] = t
    } else {
     if (g.push(t), I[d].canvas) var n = I[d];
     else var n = mt();
   ...
   L();
   var M = at(b, r.jigsaw_combine_pieces),
    y = [];
   ...
   var f = h.getContext("2d"),
    k = c.naturalWidth,
    C = c.naturalHeight;
   f.drawImage(c, 0, 0, k, C, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), f.save(), f.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && _({
    canvas: h,
    draw_settings: w,
    stroke_width: w.stroke_width,
    cut_multiplier: w.cut_multiplier,
 ...
 function mt(r) {
  ...
  return e.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-2 jt-button hoverable", e.title_list = ["Tell a friend!", "Earn extra puzzle packs!", "Get 10 gems per friend!"], e.title_index = e.title_list.length - 1, s(), e.addEventListener(i.events.POINT, function() {
  ...
  }, e.select_puzzle = function(f) {
   function _() {
    function a(a) {
     return i.log_user_action("Tell-a-friend: email entered: " + a), a === !1 ? void e.deactivate() : void h({
      gs: i,
      error: function() {
   ...
   var r = f.level_id,
    c = a.player_data,
    n = c.selected_difficulty,
    s = i.jigsaw_show_hint_image,
    o = c.jigsaw.best_times[+s];
   if ("undefined" == typeof o[r]) {
    s = !s;
    var o = c.jigsaw.best_times[+s]
   }
   if ("undefined" == typeof o[r]);
   else {
 ...
 if ((r._gsQueue || (r._gsQueue = [])).push(function() {
  ...
  var Ct = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").get,
   St = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").set;
 ...
 var p;
 1 == !!window.IS_READY ? p = x() : window.addEventListener("load", function() {
