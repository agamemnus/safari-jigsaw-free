...
function() {
 ...
 function t(e) {
  ...
  var a = "undefined" != typeof e.charset ? e.charset : "",
   ...
   l = st(e.file, s, n, a, t, void 0, void 0, e.request_method),
   i = l.http_request;
 ...
 function y() {
     ...
     switch (t.page) {
      ...
      case "select_jigsaw":
       if ("undefined" == typeof n.show_own_ad_at_end_of_play_chance && (n.show_own_ad_at_end_of_play_chance = 1), n.last_page && "jigsaw" == n.last_page && i.player_data.jigsaw.trophies.length >= 5 && Math.random() < n.show_own_ad_at_end_of_play_chance)
        if (1 == n.show_own_ad_at_end_of_play_chance ? n.show_own_ad_at_end_of_play_chance = .675 : n.show_own_ad_at_end_of_play_chance > .3 && (n.show_own_ad_at_end_of_play_chance *= .9), Math.random() < .8) {
         var a = .9;
         r.gem_purchased_amount > 10 && (a = .3), r.gem_purchased_amount > 20 && (a = 0), Math.random() < a ? gt({
          gs: r,
          mr_jigtato: i,
          callback: e
         }) : e()
        } else 0 == r.account.game_was_rated ? W({
         gs: r,
         mr_jigtato: i,
         callback: e
        }) : e();
      ...
      case "jigsaw":
       mt({
        ...
        global_settings: r,
        level_id: t.level
       }), r.IS_WEBVIEW && "undefined" != typeof f && ot({
        gs: r,
        mr_jigtato: i
       });
       break;
  ...
  }), r.IS_CORDOVA || ct(), i.play_intro_audio = function(a) {
   var h = a.level_id,
    s = a.count,
    t = i.game_data,
    o = t.entry_list[h],
 ...
 function ot(r) {
  ...
  var n = t.game_data.jigsaw.difficulty_levels[t.player_data.selected_difficulty],
   a = n.tile_x,
   s = n.tile_y,
  ...
  }), e.show_ad_counter >= 1 ? (e.show_ad_counter = e.show_ad_counter - parseInt(e.show_ad_counter), Math.random() > .1 ? e.ad_control && e.ad_control.run() : 0 == e.account.game_was_rated ? W() : e.ad_control.run()) : R({
   gs: e,
   mr_jigtato: t
  })
 }
   ...
   if (null != a && (t.style.display = "none", G({
    ...
    function() {
     ...
     r.push(t), r.forEach(function(t) {
      ...
      var e = H(window.getComputedStyle(t).backgroundImage);
 ...
 function ft(s) {
  function u() {
   ...
   var L = a.challenge_a_friend_button = vt({
    select_screen: a,
    content_div: o,
    mr_jigtato: t,
    gs: e
   ...
   b.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-1 jt-gem_amount_container jt-button hoverable", b.addEventListener(e.events.POINT, C), u.appendChild(b), M(), e.do_open_gem_purchase_screen && (e.do_open_gem_purchase_screen = !1, C()), void
   function() {
   ...
   var z = a.create_tab_container = function(r) {
     function l() {
      ...
      e.select_menu_current_category[i] = r[(l + 1) % r.length], e.select_menu_current_category = e.select_menu_current_category, f = e.select_menu_current_category[i], "undefined" == typeof e.select_menu_current_page[i][f] && (e.select_menu_current_page[i][f] = 0), s.innerHTML = n[f].shortcut, A(), o(), w.sort_levels()
     }
 ...
 function mt(q) {
  ...
  function it(m, u) {
   function h() {
    u || (e.show_pieces_deferred = window.requestAnimationFrame(it))
   }
  ...
  function Ot() {
   ...
   d.style.top = a + "px", d.style.height = n + "px", V.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", i.reposition_and_resize(), P(), "undefined" != typeof E && E.naturalHeight && (e.area && e.area.forEach(function(e) {
    e.height = n * e.height_ratio
   }), u.top = (n - E.height + (E.height - E.height)) / 2), Z(), l.container.children.forEach(function(t) {
  ...
  function Z() {
   ...
   if (0 == !!i.bg.refresh_bg && (i.bg.refresh_bg = !0, i.bg.width = "undefined" != typeof i.cached_width ? i.cached_width : i.width, i.bg.height = "undefined" != typeof i.cached_height ? i.cached_height : i.height, i.bg.getContext("2d").drawImage(i.bg.image, 0, 0, i.bg.image.naturalWidth, i.bg.image.naturalHeight, 0, 0, i.bg.width, i.bg.height), F({
     ...
     canvas: i.bg,
     position: 0
    }), P()), i.background_image_drawn = !0, "undefined" == typeof u) return void i.setTimeout(Z, 50);
   if ("undefined" == typeof u.left) return void i.setTimeout(Z, 50);
   if (!u.base_image.complete) return void i.setTimeout(Z, 50);
   i.bg.refresh_bg = !0;
  ...
  function jt() {
   ...
   if (t.set_size = function() {
    ...
    }, si(), "undefined" == typeof localStorage["puzzle_states." + K + "." + k + "." + O.selected_difficulty]) {
    _t();
    ...
    Math.seedrandom(a), l.add_category("General"), oi({
     ...
     draw_settings: T,
     callback: function(t) {
      B = t, ii(B, l.current_category.piece_container), I = Array.prototype.slice.call(l.current_category.piece_container.children), Ct(I), nt(l.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else Mt({
    callback: n
  ...
  function Yt() {
   function n() {
    ...
    }), w.addEventListener("touchend", H), w.addEventListener("touchcancel", H), w.addEventListener("touchleave", H), m.addEventListener("touchend", H)) : (document.addEventListener("mouseup", H), window.addEventListener("blur", ht), window.addEventListener("mouseout", Ft), d.inner.addEventListener("mousewheel", Gt), d.inner.addEventListener("DOMMouseScroll", Gt))), f.setTimeout(function() {
  ...
  function ei() {
   if (tt.reward_container) var t = tt.reward_container;
   else var t = k;
  ...
  function Zt(l) {
   ...
   var t = n[k][e.difficulty_level];
   "undefined" == typeof t && (t = 86400), t > l && (t = n[k][e.difficulty_level] = l);
   var i = Y.difficulty_levels[e.difficulty_level].point_cutoffs_visible;
   0 == e.jigsaw_initial_show_hint_image && (i *= Y.difficulty_levels[e.difficulty_level].point_cutoffs_hidden_multiplier);
   ...
   var r = a + 1,
    ...
    s = O.jigsaw.ranks;
   "undefined" == typeof s[k] && (s[k] = {});
   var o = s[k][e.difficulty_level];
   return "undefined" == typeof o && (o = -1), r > o && (o = s[k][e.difficulty_level] = r), {
    best_time: t,
    rank_count: r,
    next_rank_point: h
   }
  ...
  function st(c) {
   ...
   function g() {
    ...
    h(s), s.dialog.buttons.ok.addEventListener(r.events.POINT, function() {
     n >= 1 && (!window.kiipInstance || r.account && r.account.purchased_ad_removal || window.kiipInstance.postMoment("rank_count: " + n + ", selected_difficulty: " + O.selected_difficulty)), i.fireworks = new yt({
      gs: r,
      draw_area: i
     })
    });
   ...
   var c = c || {};
   localStorage.removeItem("puzzle_states." + K + "." + k + "." + O.selected_difficulty);
  ...
  function Ht(e) {
   ...
   if (P(), u.children.forEach(function(e) {
     ...
     l.remove_category(e)
    }), u.base_image.style.opacity = 1, z(u.composite_image), Z(), e.hide_controls) {
  ...
  function Ft(e) {
   ...
   "undefined" == typeof i && (i = document.body.scrollTop), n >= 0 && n <= window.innerHeight + i && r >= 0 && r <= window.innerWidth + t || H(e)
  }
  ...
  function zt(n) {
   ...
   var C = (rt(y, !0), J(rt(y, r.jigsaw_combine_pieces), [-Math.floor(c), -Math.floor(l)])),
   ...
   h.texture ? Lt(h) : F({
    ...
    position: 1,
    is_2d: !0
   }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, z(n), n == s && (s = null), gt(), W(), Xt() && st()
  }
  ...
  function ht(e) {
   if (null != s) {
    ...
    delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, at(s), F({
     logical_parent: s,
     canvas: s.canvas
  ...
  function It(t) {
   function u() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, z(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), vt(e, p), F({
       canvas: e.canvas,
       logical_parent: e
    ...
    l != h * o ? (i.refresh_piece_styling = !0, timeout = d.inner.setTimeout(u, 20)) : (lt = void 0, void
     function() {
      for (var r = {}, l = 0; h > l; l++)
       for (var c = 0; o > c; c++) {
        var e = s[l][c];
   ...
   var s = t.piece_grid,
    ...
    c = 0,
    r = 0;
   "undefined" != typeof lt && clearTimeout(lt), lt = void 0, u()
  }
  ...
  function vt(t, c, n) {
   ...
   r.restore(), _ && (r.save(), r.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), p({
    ...
    clear_stroke: !f,
    game_instance: e
   }), r.restore()), f && (r.save(), ct(i, y), r.restore())
  }
  ...
  var m = q.content_div,
   ...
   k = q.level_id;
  m.innerHTML = "";
  var Y = C.game_data.jigsaw,
   ui = C.game_data.trophy_list,
   O = C.player_data,
   tt = C.game_data.entry_list[k],
   Q = C.set_name,
   K = r.game_type,
   y = {},
   T = {},
   e = y.game_instance = {},
   $ = Y.difficulty_levels[O.selected_difficulty];
  ...
  if (e.force_screen_refresh = 0, hi(), void
   function() {
    ...
    action: function() {
     nt(l.current_category.piece_container), W(), y.help_menu_obj.close()
    }
   ...
   Tt.className = "jt-play-social_sharing_button_container", m.appendChild(Tt), M({
    parent: Tt,
  ...
  var V = y.bottom_bar = document.createElement("div");
  V.className = "jt-play-bottom_bar jt-play-main_image_border_width", n(V), m.appendChild(f), f.hide_title = function(e) {
   var e = e || {};
  ...
  l.className = "jt-jigsaw-category_deck", l.item_under_mouse = null, f.appendChild(l), l.edit_button = document.createElement("img"), l.edit_button.className = "jt-op_button jt-op_button-edit" + (r.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), l.edit_button.src = r["/"] + "images/gui/gui-item_edit.png", l.appendChild(l.edit_button), l.add_button = document.createElement("img"), l.add_button.className = "jt-op_button jt-op_button-add" + (r.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), l.add_button.src = r["/"] + "images/gui/gui-item_expand_or_add.png", l.appendChild(l.add_button), l.basket_button = document.createElement("img"), l.basket_button.className = "jt-op_button jt-op_button-basket" + (r.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), l.basket_button.piece_list = [], l.basket_button.is_selected = !1, l.basket_button.src = r["/"] + "images/gui/gui-basket.png", l.appendChild(l.basket_button), l.remove_button = document.createElement("img"), l.remove_button.className = "jt-op_button jt-op_button-remove" + (r.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), l.remove_button.src = r["/"] + "images/gui/gui-item_remove.png", l.appendChild(l.remove_button), l.container = document.createElement("div"), l.container.className = "jt-jigsaw-category_deck-container", l.appendChild(l.container), l.add_category = function(s) {
   ...
   Y.difficulty_levels[e.difficulty_level];
   i.piece_matrix = [];
   ...
   "undefined" != typeof e && (l.current_category = e, i.piece_container = e.piece_container, P(), l.refresh(), l.container.children.forEach(function(t) {
    if (t == e) var i = "add";
    else var i = "remove";
  ...
  var R = y.timer_obj = wt({
   parent: f
  });
  y.timer_obj.style.display = r.show_timer ? "" : "none", n(R), y.refresh_gui_display = function() {
   var e = y.trophy_ribbon;
   e.style.display = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? "" : "none", r.jigsaw_minimal_ui ? (d.style.borderWidth = 0, f.classList.add("minimal_ui"), f.classList.add("jt-play-title-minimal_ui"), f.inner.classList.add("jt-play-title-inner-minimal_ui"), m.classList.add("jt-play-action_area-minimal_ui"), y.menu_button_obj.classList.add("jt-play-menu_button-minimal_ui"), y.timer_obj.classList.add("jt-play-timer-minimal_ui"), y.menu_button_obj.setAttribute("current_text", "M"), m.appendChild(y.timer_obj), m.appendChild(y.menu_button_obj), m.appendChild(f), V.parentNode == m && m.removeChild(V)) : (d.style.borderWidth = "", f.classList.remove("jt-play-title-minimal_ui"), f.inner.classList.remove("jt-play-title-inner-minimal_ui"), d.classList.remove("jt-play-action_area-minimal_ui"), y.menu_button_obj.classList.remove("jt-play-menu_button-minimal_ui"), y.timer_obj.classList.remove("jt-play-timer-minimal_ui"), m.insertBefore(f, d), m.insertBefore(V, d.nextSibling), f.insertBefore(y.timer_obj, f.childNodes[0]), f.appendChild(y.menu_button_obj)), Ot()
  };
  var St = y.help_menu_obj = S({
    gs: r,
    parent: m,
    current_game: y,
  ...
  tt.use_image_title ? G({
   image_src: r.get_set_directory(Q) + "/puzzle/" + k + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  }) : (f.inner = document.createElement("div"), f.inner.className = "jt-play-title-inner", f.appendChild(f.inner), f.inner.text = document.createElement("p"), f.inner.text.innerHTML = tt.name, f.inner.appendChild(f.inner.text), L(f.inner.text, {
   unit_type: "px",
   transform_scale: m.content_scale
  }));
  ...
  i.renderer = $t, i.stage = mt, i.piece_sprite_container = Nt, i.real_stage = ot, ot.addChild(mt), mt.addChild(Nt), i.load_opacity_transition = .5, i.style.pointerEvents = "none", i.bg = document.createElement("canvas"), i.bg.image = new Image, i.bg.image.src = C.background_image_url, i.reposition_and_resize = function() {
   var t = U(m),
    n = o(m),
    e = m.content_scale,
  ...
  var B, I, s = null;
  E.crossOrigin = "Anonymous", r.get_image(E, Q, k, "default"), E.addEventListener("load", function() {
  ...
  _.src = r.get_set_directory(C.set_name) + "/gui/gui-loading.png", _.logical_parent = i, i.loading_animation = _, _.defer_start = function(e) {
   d.inner.setTimeout(function() {
    _ && !_.game_initialized && (_.start(), it(void 0, !0))
   }, e)
  }, _.start = function() {
   1 != !!_.game_initialized && (_.stage.alpha = 1, _.display = !0, ot.addChild(_.stage), P())
  }, _.stop = function() {
   _.stage && (_.stage.alpha = 1), _.game_initialized = !0, _.display && (_.display = !1, ot.removeChild(_.stage)), P()
   ...
   if (null != d && d.isAttached()) {
    ...
    o.drawImage(_, 0, 0), _.inner = {}, F({
     ...
     parent: _.stage,
     canvas: n
    }), _.inner.sprite.x = a, _.inner.sprite.y = s, _.inner.sprite.width = e, _.inner.sprite.height = t, _.start(), it(void 0, !0)
   }
  ...
  var _t = y.set_base_image_size = function() {
   ...
   Ct = y.size_pieces = function(e) {
    e.forEach(function(e) {
     e.calc_width = e.width_float * r.jigsaw_piece_scale_to_actual, e.calc_height = e.height_float * r.jigsaw_piece_scale_to_actual
    }), i.piece_sprite_container.is_cached = !1
   };
  m.cleanup = function() {
   if (r.IS_CORDOVA && r.audio_container[C.last_intro_audio] && (r.audio_container[C.last_intro_audio].src = "", delete r.audio_container[C.last_intro_audio], C.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), ci(), null != i.parentNode && document.body.removeChild(i), R.destroy(), document.removeEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? m.removeEventListener("touchend", H) : (document.removeEventListener("mouseup", H), window.addEventListener("blur", ht), window.removeEventListener("mouseout", Ft)), m.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof B)
   ...
   C = null, r = null, k = null, Y = null, ui = null, O = null, tt = null, Q = null, K = null, y = null, T = null, e = null, $ = null, P = null, bt = null, f = null, l = null, N = null, R = null, St = null, qt = null, d = null, i = null, u = null, E = null, w = null, s = null, B = null, I = null, _ = null, _t = null, Ct = null, W = null, Mt = null, delete m.cleanup
  ...
  var lt = void 0,
   W = y.save_puzzle_state = function() {
    ...
    i[K + "." + k + "." + O.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + K + "." + k + "." + O.selected_difficulty] = JSON.stringify(t)
   },
    ...
    function o() {
     ...
     r.forEach(function(t) {
      ...
      n.forEach(function(t) {
       var i = e[t.piece_id];
       a.appendChild(i)
      }), t.innerHTML == i && l.select_category(r), Ct(r.piece_container.children)
     }), Xt() && st(), s.callback()
    }
    var t = JSON.parse(localStorage["puzzle_states." + K + "." + k + "." + O.selected_difficulty]);
  ...
  y.redraw_main_image_and_pieces = function(f) {
   function S() {
    ...
    t.save(), g({
     ...
     lineWidth: 0,
     canvas: o
    }), t.clip(), t.drawImage(h, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), t.restore(), t.save(), t.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), ct(o), t.restore(), F({
     parent: i.stage,
     canvas: o,
     position: 1,
     is_2d: !0
   ...
   for (var b = [], m = [], d = 0; d < I.length; d++) {
    ...
    if ("undefined" != typeof s && (t.width_float = Math.round(t.width_float * s * 1e3 / 1e3), t.height_float = Math.round(t.height_float * s * 1e3 / 1e3), t.puzzle_left_min = Math.round(t.puzzle_left_min * s * 1e3 / 1e3), t.puzzle_top_min = Math.round(t.puzzle_top_min * s * 1e3 / 1e3), t.width = Math.ceil(t.width_float / e.piece_logical_scale), t.height = Math.ceil(t.height_float / e.piece_logical_scale), t.puzzle_width.forEach(function(i, e) {
     ...
     e.pieces_in_position_count += t.x.length, t.shape_string = J(t.side_set, [-t.puzzle_left_min, -t.puzzle_top_min]), b.push(t);
   ...
   P();
   var M = rt(b, r.jigsaw_combine_pieces),
    y = [];
