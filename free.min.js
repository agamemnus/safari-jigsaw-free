...
function() {
 ...
 function w() {
  function l() {
   ...
   if (e.is_phone_or_tablet && (document.body.addEventListener("touchstart", function(e) {
    ...
    function() {
     ...
     var t = i.target;
     if ("a" == t.tagName.toLowerCase() || null != t.parentNode && "a" == t.parentNode.tagName.toLowerCase()) {
      i.preventDefault();
  ...
  t.load_game_data = function(l) {
   ...
   var n = void 0;
   r({
    file: i.get_set_directory(e) + "/" + e + ".json",
    request_method: "GET",
    async: !0,
 ...
 function ot(i) {
  function a() {
   ...
   var t = smoke.confirm(a, function(t) {
     e.ad_control.running = !1, 0 != t && ("undefined" != typeof e.google_play_access_token && r({
  ...
  }), e.show_ad_counter >= 1 ? (e.show_ad_counter = e.show_ad_counter - parseInt(e.show_ad_counter), Math.random() > .1 ? e.ad_control.run() : 0 == e.account.game_was_rated ? a() : e.ad_control.run()) : Math.random() > .1 && 0 == e.account.game_was_rated && a()
 }
 ...
 function ht() {
  ...
  return t.prototype.init = function(e, t) {
   ...
   return r
  }, n.testCurveCurveIntersection = function(z, j, G, K, B, U, W, X) {
   var I, O, E, D, i, n, a, c, o, h, l, s, z = new t(z[0], z[1]),
    ...
    W = new t(W[0], W[1]),
    X = new t(X[0], X[1]);
   I = z.multiply(-1), O = j.multiply(3), E = G.multiply(-3), D = I.add(O.add(E.add(K))), i = new r(D.x, D.y), I = z.multiply(3), O = j.multiply(-6), E = G.multiply(3), D = I.add(O.add(E)), n = new r(D.x, D.y), I = z.multiply(-3), O = j.multiply(3), E = I.add(O), a = new r(E.x, E.y), c = new r(z.x, z.y), I = B.multiply(-1), O = U.multiply(3), E = W.multiply(-3), D = I.add(O.add(E.add(X))), o = new r(D.x, D.y), I = B.multiply(3), O = U.multiply(-6), E = W.multiply(3), D = I.add(O.add(E)), h = new r(D.x, D.y), I = B.multiply(-3), O = U.multiply(3), E = I.add(O), l = new r(E.x, E.y), s = new r(B.x, B.y);
 ...
 function ct(Y) {
  ...
  function zt() {
   ...
   if (r.set_size = function() {
    ...
    Math.seedrandom(a), c.add_category("General"), oi({
     ...
     draw_settings: w,
     callback: function(t) {
      B = t, ii(B, c.current_category.piece_container), O = Array.prototype.slice.call(c.current_category.piece_container.children), St(O), st(c.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else Mt({
    callback: n
   ...
   function n() {
    i.jigsaw_minimal_ui ? p.show_title_animation({
     ...
     start_effect: function() {
      i.jigsaw_pinch_controls_not_run && (i.log_user_action("Pinch controls: run for the first time."), i.pinch_controls_not_run = !1), x.drag_end(), x.pinch_active = !0
     },
     end_effect: function() {
      x.pinch_active = !1
     }
  ...
  function Zt(l) {
   var r = D.jigsaw.best_times[+e.jigsaw_initial_show_hint_image];
   "undefined" == typeof r[L] && (r[L] = {});
   var t = r[L][e.difficulty_level];
   "undefined" == typeof t && (t = 86400), t > l && (t = r[L][e.difficulty_level] = l);
   for (var n = Z.difficulty_levels[e.difficulty_level][e.jigsaw_initial_show_hint_image ? "point_cutoffs_visible" : "point_cutoffs_hidden"], a = n.length; a >= 0; a--) {
    var h = Math.round(n[a] * e.get_piece_count());
    if (h >= l) break
   }
   var i = a + 1,
    c = i == n.length ? -1 : Math.round(n[i] * e.get_piece_count()),
    s = D.jigsaw.ranks;
   "undefined" == typeof s[L] && (s[L] = {});
   var o = s[L][e.difficulty_level];
   return "undefined" == typeof o && (o = -1), i > o && (o = s[L][e.difficulty_level] = i), {
    best_time: t,
    rank_count: i,
    next_rank_point: c
   }
  ...
  function lt(c) {
   ...
   function m() {
    var e = Z.rank[Z.difficulty_levels[D.selected_difficulty].name];
    i.playAudio(i.get_set_directory(K) + "/audio/" + e.rank_audio[n] + ".m4a", {
     audio_type: "music",
     element: d.inner,
     restart: !0
    });
    ...
    for (var l = 0; n > l; l++) {
     var a = document.createElement("div");
     a.className = "jt-play-show_rank-image-item", o.appendChild(a), a.style.opacity = .01, a.style.backgroundImage = 'url("' + i.get_set_directory(K) + "/gui/" + e.filename + '")', void
     function(t, r) {
      d.inner.setTimeout(function() {
       TweenMax.to(t, 2, {
        parseTransform: !0,
        ...
        t.addEventListener(i.events.POINT, function() {
         "undefined" != typeof e.click_audio && i.playAudio(i.get_set_directory(K) + "/audio/" + e.click_audio + ".ogg", {
          element: d.inner,
          audio_type: "music"
         })
        })
  ...
  function Bt(n) {
   ...
   var C = (at(y, !0), J(at(y, i.jigsaw_combine_pieces), [-Math.floor(h), -Math.floor(l)])),
  ...
  function oi(b) {
   ...
   for (var c = (b.success || function() {}, b.source_image), m = b.size_x, v = b.size_y, U = b.width, j = b.height, B = b.draw_settings, y = [], M = ht(), G = 100 / m, W = 100 / v, n = 0; m >= n; n++) {
    y[n] = [];
    for (var r = 0; v >= r; r++) {
   ...
   for (vh = 0; 2 > vh; vh++) {
    ...
    for (var n = 0; m + vh > n; n++) {
     ...
     for (var r = 0; v + (1 - vh) > r; r++) {
      ...
      for (var z = new Array(h), s = 0; h > s; s++) z[s] = [t[s][0] / 100 * U, t[s][1] / 100 * j];
   ...
   var k = document.createElement("canvas"),
    I = k.getContext("2d");
   k.width = (U + 2 * e.piece_margin) / e.piece_logical_scale, k.height = (j + 2 * e.piece_margin) / e.piece_logical_scale;
   ...
   I.drawImage(c, 0, 0, it, rt, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), I.save(), I.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), i.jigsaw_use_3d_effect && f({
    ...
    cut_multiplier: B.cut_multiplier,
    shape_string: V,
    scale: 1 / e.piece_logical_scale,
    clear_stroke: "undefined" == typeof e.piece_margin_style,
    game_instance: e
  ...
  function It(i) {
   function u() {
    for (var i = 0; _ > i; i++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, z(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), xt(e, p), N({
       canvas: e.canvas,
       logical_parent: e
  ...
  function kt(e) {
   ...
   Object.defineProperty(e, "children", {
    ...
    t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), I(), jt()
   }, e.removeChild = function(t) {
    e.children.splice(e.children.indexOf(t), 1), I(), jt()
  ...
  var Z = k.game_data.jigsaw,
   ...
   w = {},
   e = y.game_instance = {},
   it = Z.difficulty_levels[D.selected_difficulty];
  ...
  var I = (performance.now(), y.screen_refresh = function() {
   ...
   jt = y.category_refresh = function() {
  ...
  c.className = "jt-jigsaw-category_deck", c.item_under_mouse = null, p.appendChild(c), c.edit_button = document.createElement("img"), c.edit_button.className = "jt-op_button jt-op_button-edit" + (i.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), c.edit_button.src = i["/"] + "images/gui/gui-item_edit.png", c.appendChild(c.edit_button), c.add_button = document.createElement("img"), c.add_button.className = "jt-op_button jt-op_button-add" + (i.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), c.add_button.src = i["/"] + "images/gui/gui-item_expand_or_add.png", c.appendChild(c.add_button), c.basket_button = document.createElement("img"), c.basket_button.className = "jt-op_button jt-op_button-basket" + (i.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), c.basket_button.piece_list = [], c.basket_button.is_selected = !1, c.basket_button.src = i["/"] + "images/gui/gui-basket.png", c.appendChild(c.basket_button), c.remove_button = document.createElement("img"), c.remove_button.className = "jt-op_button jt-op_button-remove" + (i.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), c.remove_button.src = i["/"] + "images/gui/gui-item_remove.png", c.appendChild(c.remove_button), c.container = document.createElement("div"), c.container.className = "jt-jigsaw-category_deck-container", c.appendChild(c.container), c.add_category = function(s) {
   ...
   Z.difficulty_levels[e.difficulty_level];
   r.piece_matrix = [];
  ...
  rt.use_image_title ? S({
   image_src: i.get_set_directory(K) + "/puzzle/" + L + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  var B, O, s = null;
  T.crossOrigin = "Anonymous", i.get_image(T, K, L, "default"), T.addEventListener("load", function() {
  ...
  g.cleanup = function() {
   if (i.IS_CORDOVA && i.audio_container[k.last_intro_audio] && (i.audio_container[k.last_intro_audio].src = "", delete i.audio_container[k.last_intro_audio], k.last_intro_audio = ""), t.fireworks && t.fireworks.destroy(), hi(), null != t.parentNode && document.body.removeChild(t), P.destroy(), document.removeEventListener(i.events.POINT_MOVE, Dt), i.is_phone_or_tablet ? g.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", ft), window.removeEventListener("mouseout", Ft)), g.innerHTML = "", "undefined" != typeof i.ambient_music.last_on_state && (1 == i.ambient_music.last_on_state && (i.ambient_music_on = !0), delete i.ambient_music.last_on_state), "undefined" != typeof B)
    for (var r = 0; r < e.tile_x + 1; r++) {
     B[r] = [];
     for (var n = 0; n < e.tile_y + 1; n++) B[r][n] = void 0
    }
   ...
   k = null, i = null, L = null, Z = null, ui = null, D = null, rt = null, K = null, $ = null, y = null, w = null, e = null, it = null, I = null, wt = null, p = null, c = null, W = null, P = null, At = null, qt = null, d = null, t = null, u = null, T = null, x = null, s = null, B = null, O = null, _ = null, gt = null, St = null, V = null, Mt = null, delete g.cleanup
  ...
  y.redraw_main_image_and_pieces = function(p) {
   ...
   for (var b = [], g = [], d = 0; d < O.length; d++) {
    ...
    if ("undefined" != typeof s && (r.width_float = Math.round(r.width_float * s * 1e3 / 1e3), r.height_float = Math.round(r.height_float * s * 1e3 / 1e3), r.puzzle_left_min = Math.round(r.puzzle_left_min * s * 1e3 / 1e3), r.puzzle_top_min = Math.round(r.puzzle_top_min * s * 1e3 / 1e3), r.width = Math.ceil(r.width_float / e.piece_logical_scale), r.height = Math.ceil(r.height_float / e.piece_logical_scale), r.puzzle_width.forEach(function(t, e) {
     ...
     e.pieces_in_position_count += r.x.length, r.shape_string = J(r.side_set, [-r.puzzle_left_min, -r.puzzle_top_min]), b.push(r);
 ...
 "undefined" != typeof module && null != module && (module.exports = e), window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame, window.cancelAnimationFrame = window.cancelAnimationFrame || window.mozancelAnimationFrame || window.webkitCancelAnimationFrame, ! function() {
  ...
  e.WEBGL_RENDERER = 0, e.CANVAS_RENDERER = 1, e.VERSION = "v1.6.1", e.blendModes = {
   ...
   if (0 !== t.length) {
    ...
    if (A.x === x.x && A.y === x.y) {
     ...
     var U = x.x + .5 * (A.x - x.x),
      j = x.y + .5 * (A.y - x.y);
     t.unshift(U, j), t.push(U, j)
    }
    var E, b, _, p, a, n, M, S, r, i, g, f, v, y, B, P, k, R, O, L, C, G, l, s = N.points,
     I = N.indices,
     T = t.length / 2,
     F = t.length,
     z = s.length / 6,
  ...
  function j(t, i, r) {
   j._super_.call(this), this.massPan = e.Util.setSpanValue(t, i, r)
  }
  ...
  function h(t, i, r) {
   this.mouseTarget = e.Util.initValue(t, B), this.ease = e.Util.initValue(i, .7), this._allowEmitting = !1, this.initEventHandler(), h._super_.call(this, r)
  }
  ...
  }, e.Velocity = b, e.V = b, e.Util.inherits(j, e.Initialize), j.prototype.initialize = function(e) {
   e.mass = this.massPan.getValue()
  }, e.Mass = j, e.Util.inherits(M, e.Initialize), M.prototype.reset = function(t, i, r) {
 ...
 if ((t._gsQueue || (t._gsQueue = [])).push(function() {
    ...
    function() {
     ...
     var W, gt, H, _t, ft, A, P = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
      ...
      Z = function(o, i, l, r, h) {
       var t, e, n, a = {},
        s = o.style;
       for (e in l) "cssText" !== e && "length" !== e && isNaN(e) && (i[e] !== (t = l[e]) || h && h[e]) && -1 === e.indexOf("Origin") && ("number" == typeof t || "string" == typeof t) && (a[e] = "auto" !== t || "left" !== e && "top" !== e ? "" !== t && "auto" !== t && "none" !== t || "string" != typeof i[e] || "" === i[e].replace(B, "") ? t : 0 : st(o, e), void 0 !== s[e] && (n = new X(s, e, s[e], n)));
       if (r)
      ...
      $ = function(e, r) {
       ...
       return null == i ? i = "0" : "center" === i && (i = "50%"), ("center" === t || isNaN(parseFloat(t)) && -1 === (t + "").indexOf("=")) && (t = "50%"), r && (r.oxp = -1 !== t.indexOf("%"), r.oyp = -1 !== i.indexOf("%"), r.oxr = "=" === t.charAt(1), r.oyr = "=" === i.charAt(1), r.ox = parseFloat(t.replace(B, "")), r.oy = parseFloat(i.replace(B, ""))), t + " " + i + (n.length > 2 ? " " + n[2] : "")
      },
      rt = function(e, t) {
      ...
      S = function(i, n, l, s) {
       var t, a, e, r, o = 1e-6;
       return null == i ? r = n : "number" == typeof i ? r = i : (t = 360, a = i.split("_"), e = Number(a[0].replace(B, "")) * (-1 === i.indexOf("rad") ? 1 : b) - ("=" === i.charAt(1) ? 0 : n), a.length && (s && (s[l] = n + e), -1 !== i.indexOf("short") && (e %= t, e !== e % (t / 2) && (e = 0 > e ? e + t : e - t)), -1 !== i.indexOf("_cw") && 0 > e ? e = (e + 9999999999 * t) % t - (0 | e / t) * t : -1 !== i.indexOf("ccw") && e > 0 && (e = (e - 9999999999 * t) % t - (0 | e / t) * t)), r = n + e), o > r && r > -o && (r = 0), r
      },
      w = {
       aqua: [0, 255, 255],
       lime: [0, 255, 0],
     ...
     var ct = function(e, o, c, a) {
       ...
       return t ? r = o ? function(o) {
        ...
        if (_ = (o.match(x) || [s])[0], p = o.split(_).join("").match(j) || [], e = p.length, t > e--)
     ...
     var yt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
      ...
      E = u.getTransform = function(m, Q, P, J) {
       ...
       var o, t, v, R, X, L, D, w, y, Y, q, B, U, e = P ? m._gsTransform || new at : new at,
        nt = 0 > e.scaleX,
        M = 2e-5,
        u = 1e5,
        k = 179.99,
   ...
   if (!S.TweenLite) {
    ...
    var B = u("events.EventDispatcher", function(e) {
     this._listeners = {}, this._eventTarget = e || this
    });
    e = B.prototype, e.addEventListener = function(s, l, h, c, i) {
     i = i || 0;
    ...
    u("Ticker", function(_, f) {
     ...
     B.call(e), e.time = e.frame = 0, e.tick = function() {
      u(!0)
    ...
    var j = function() {
     o && E() - C > 2e3 && r.wake(), setTimeout(j, 2e3)
    };
    j(), e.play = function(e, t) {
   ...
   var l = t.GreenSockGlobals || t,
    ...
    _ = function(i, y, z, X, F) {
     ...
     var w, p, b, s, _, E, x, n, f, l, m, D, O, M = r(i),
      ...
      L = a(y.wordsClass),
      V = a(y.charsClass),
      B = -1 !== (y.linesClass || "").indexOf("++"),
      C = y.linesClass;
     for (B && (C = C.split("++").join("")), b = L(), s = 0; u > s; s++) E = M.charAt(s), ")" === E && M.substr(s, 20) === h ? (b += R + "<BR/>", s !== u - 1 && (b += " " + L()), s += 19) : " " === E && " " !== M.charAt(s - 1) && s !== u - 1 ? (b += R, s !== u - 1 && (b += H + L())) : b += T && " " !== E ? V() + E + "</div>" : E;
