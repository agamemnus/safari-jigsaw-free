...
function() {
 ...
 function k(e) {
  ...
  if ("undefined" == typeof this || this === window) return new k(e);
  var t = e.target,
   i = !1,
   a = void 0,
   s = void 0;
 ...
 function I(r, t) {
  ...
  if ("undefined" == typeof this || this == window) return new I(r, t);
  var e = this;
 ...
 function y() {
  function h() {
   ...
   if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], o.forEach(function(n) {
     ...
     return i ? "cdvfile://localhost/persistent/sets/" + t : (_ ? "content://" + B + ".free.expansion/" : e["/"]) + "sets/" + t
     ...
     var n = (_ ? "content://" + B + ".free.expansion/" : e["/"]) + "sets/" + s;
  ...
  i.load_game_data = function(c) {
   ...
   var e = "undefined" != typeof z ? z : "default";
  ...
  var n = i.history_control = new St({
     ...
     switch (t.page) {
      ...
      case "select_jigsaw":
       if ("undefined" == typeof n.show_own_ad_at_end_of_play_chance && (n.show_own_ad_at_end_of_play_chance = 1), n.last_page && "jigsaw" == n.last_page && i.player_data.jigsaw.trophies.length >= 5 && Math.random() < n.show_own_ad_at_end_of_play_chance)
        if (1 == n.show_own_ad_at_end_of_play_chance ? n.show_own_ad_at_end_of_play_chance = .675 : n.show_own_ad_at_end_of_play_chance > .3 && (n.show_own_ad_at_end_of_play_chance *= .9), Math.random() < .8) {
         var a = .9;
         r.gem_purchased_amount > 10 && (a = .3), r.gem_purchased_amount > 20 && (a = 0), Math.random() < a ? xt({
          gs: r,
          mr_jigtato: i,
          callback: e
         }) : e()
        } else 0 == r.account.game_was_rated ? gt({
         gs: r,
         mr_jigtato: i,
         callback: e
        }) : e();
      ...
      case "jigsaw":
       mt({
        ...
        global_settings: r,
        level_id: t.level
       }), r.IS_WEBVIEW && "undefined" != typeof f && ct({
        gs: r,
        mr_jigtato: i
       });
       break;
 ...
 function gt(r) {
  ...
  var i = smoke.confirm(s, function(i) {
   ...
   a = i.dialog.text.childNodes[1];
  i.dialog.text.childNodes[0].classList.add("jt-common-instruction_text-title"), a.classList.add("jt-common-instruction_text"), a.style.fontSize = "55px", a.style.lineHeight = "150%", a.style.height = "auto", i.dialog.text.style.height = window.getComputedStyle(i.dialog.text).maxHeight, i.buttons.ok.innerHTML = "Rate it.", i.buttons.cancel.innerHTML = "Don't rate it.", Math.random() > .5 && i.buttons.cancel.parentNode.appendChild(i.buttons.ok), n(i.buttons), i.buttons.ok.classList.add("hoverable"), i.buttons.cancel.classList.add("hoverable")
 }
 ...
 function bt(r) {
  ...
  i.ad_control && (i.ad_control.running = !0);
  ...
  e.dialog.text.childNodes[0].classList.add("jt-common-instruction_text-title"), t.classList.add("jt-common-instruction_text"), t.style.fontSize = "55px", t.style.lineHeight = "150%", t.style.height = t.style.maxHeight = "862px", e.dialog.text.style.height = window.getComputedStyle(e.dialog.text).maxHeight, setTimeout(function() {
   i.ad_control && (i.ad_control.running = !1), null != e.parentNode && e.parentNode.removeChild(e)
  }, 12e3)
 }
 ...
 function S(a) {
  function o(l) {
   ...
   e.className = "jt-play-trophy_room-item_name", e.style.color = a.text_color, e.innerHTML = a.display_name.capitalizeFirstLetter(), t.appendChild(e), r.is_chromium || r.is_android ? (e.style.textShadow = "none", e.style.WebkitTextStrokeColor = a.text_outline_color.split(",")[0].trim(), v({
    ...
    size: "3px",
    color: ""
   })) : R(e, a.text_outline_color || "black");
 ...
 function rt(n, s, i) {
  ...
  if ("undefined" == typeof t.visual_settings_menu || null == t.visual_settings_menu.parentNode) {
   var e = a(i.init);
   delete e.menu_item_list, t.visual_settings_menu = Rt({
    callback: function(e) {
     e.style.display = "none", e.parent_menu.style.display = "", e.parent_menu.refresh()
    },
    parent: t,
 ...
 function nt(n, s, t) {
  ...
  if ("undefined" == typeof i.misc_config_menu || null == i.misc_config_menu.parentNode) {
   var e = a(t.init);
   delete e.menu_item_list, i.misc_config_menu = At({
    callback: function(e) {
     e.style.display = "none", e.parent_menu.style.display = "", e.parent_menu.refresh()
    },
    mr_jigtato: e.mr_jigtato,
 ...
 function l(t) {
  ...
  i.initialize({
   error: t.error,
   success: function(i) {
    e.IS_CORDOVA ? (e.google_play_access_token = i, C(t)) : e.get_google_play_access_token({
     callback: function() {
      C(t)
     }
    })
 ...
 function pt(a) {
  function u() {
   ...
   if (null != a && (t.style.display = "none", D({
     image: a,
     fix_ie_bug: !0,
     color: "#edd9a7",
     callback: function(e) {
    ...
    function() {
     ...
     r.push(t), r.forEach(function(t) {
      ...
      var e = Q(window.getComputedStyle(t).backgroundImage);
 ...
 function ft(s) {
  function u() {
   ...
   var P = [t.menu.generic.about, t.menu.generic.ogle_trophies, t.menu.jigsaw.toggle_categories, t.menu.jigsaw.open_misc_config_menu, t.menu.jigsaw.open_visual_settings_menu, t.menu.generic.open_audio_settings_menu],
    L = U({
     gs: e,
     parent: o,
     menu_item_list: P,
   ...
   var R = a.challenge_a_friend_button = vt({
    select_screen: a,
    content_div: o,
    mr_jigtato: t,
    gs: e
   ...
   var j = a.create_tab_container = function(r) {
     function l() {
      var n = t.game_data.category_list,
       r = [];
      for (var a in n) r.push(a);
      var l = r.indexOf(e.select_menu_current_category[i]);
      e.select_menu_current_category[i] = r[(l + 1) % r.length], e.select_menu_current_category = e.select_menu_current_category, f = e.select_menu_current_category[i], "undefined" == typeof e.select_menu_current_page[i][f] && (e.select_menu_current_page[i][f] = 0), s.innerHTML = n[f].shortcut, S(), o(), w.sort_levels()
     }
    ...
    z = a.create_selection_tab_container = function() {
 ...
 function mt(Y) {
  ...
  function jt() {
   function n() {
    return 0 == !!i.first_render_complete || r.ad_control && !r.ad_control.ignore && r.ad_control.running || 0 == !!e.log_query_processed ? void d.inner.setTimeout(n, 50) : void Yt()
   }
   ...
   if (t.set_size = function() {
    ...
    }, si(), "undefined" == typeof localStorage["puzzle_states." + Z + "." + M + "." + j.selected_difficulty]) {
    _t();
  ...
  function Yt() {
   function n() {
    ...
    }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, w.addEventListener(r.events.POINT_START, Kt), document.addEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? (k({
     target: d.inner,
     result_function: Ut,
    ...
    }), w.addEventListener("touchend", q), w.addEventListener("touchcancel", q), w.addEventListener("touchleave", q), m.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", dt), window.addEventListener("mouseout", Ft), d.inner.addEventListener("mousewheel", Gt), d.inner.addEventListener("DOMMouseScroll", Gt))), f.setTimeout(function() {
  ...
  function Zt(l) {
   var n = j.jigsaw.best_times[+e.jigsaw_initial_show_hint_image];
  ...
  function Jt(t) {
   ...
   }), xt(), d.inner.setTimeout(Et, 800), d.inner.setTimeout(function() {
    Ht({
     callback: t.callback
    })
  ...
  function ot(c) {
   ...
   function g() {
    var e = J.rank[J.difficulty_levels[j.selected_difficulty].name];
    ...
    h(s), s.dialog.buttons.ok.addEventListener(r.events.POINT, function() {
     n >= 1 && (!window.kiipInstance || r.account && r.account.purchased_ad_removal || window.kiipInstance.postMoment("rank_count: " + n + ", selected_difficulty: " + j.selected_difficulty)), i.fireworks = new yt({
      gs: r,
      draw_area: i
     })
    });
   ...
   var c = c || {};
   localStorage.removeItem("puzzle_states." + Z + "." + M + "." + j.selected_difficulty);
   var a = c.user_gave_up || !1;
   r.ambient_music.last_on_state = r.ambient_music_on, r.ambient_music_on = !1;
   var _ = pt[Math.floor(Math.random() * pt.length)];
   if (0 == a) {
   ...
   if (a || d.inner.setTimeout(function() {
    ...
    localStorage.player_data = JSON.stringify(j), 0 == a ? d.inner.setTimeout(f, o + (c.show_trophy_delay || 550)) : d.inner.setTimeout(f, o + (c.show_trophy_delay || 550))
   }
  }
  ...
  function Ht(e) {
   ...
   if (P(), u.children.forEach(function(e) {
    ...
    r.use_categories = !1, f.autoshow_title(), r.use_categories = t, qt.morph_to_back_button()
   }
   ...
   if (null != w) {
    ...
    if (null != s) {
     ...
     if (null != l.item_under_mouse) {
      var M = l.current_category;
      if (M != l.item_under_mouse) {
       y = !1, g = !0;
       var v = l.item_under_mouse.piece_container;
       v.appendChild(s), at(v, [s])
      }
     }
     var A = l.current_category.piece_container.children,
      a = s,
      c = r.jigsaw_piece_scale_to_actual,
      x = 2 * r.jigsaw_required_precision,
      n = [],
      k = s.left + (1 - c) / 2 * a.width_float - a.puzzle_left_min * c,
      R = s.top + (1 - c) / 2 * a.height_float - a.puzzle_top_min * c;
     if (A.forEach(function(e) {
       if (e != a)
        for (var h = e.virtual_left - e.width_float * c / 2 - e.puzzle_left_min * c, d = e.virtual_top - e.height_float * c / 2 - e.puzzle_top_min * c, r = Math.abs(h - k), s = Math.abs(d - R), t = 0, l = a.puzzle_width.length; l > t; t++)
     ...
     if (st(s), F({
      ...
      xt(), h.placed = !0, TweenMax.to(h, .35, {
       parseTransform: !0,
       ease: Linear.ease,
       left: O,
       top: D,
  ...
  function zt(n) {
   ...
   h.texture ? Lt(h) : F({
    ...
    position: 1,
    is_2d: !0
   }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, z(n), n == s && (s = null), gt(), V(), Xt() && ot()
  }
  ...
  function dt(e) {
   if (null != s) {
    ...
    delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, st(s), F({
     logical_parent: s,
     canvas: s.canvas
    }), s.calc_width = s.width_float * r.jigsaw_piece_scale_to_actual, s.calc_height = s.height_float * r.jigsaw_piece_scale_to_actual, s = null, l.item_under_mouse = null, gt(), V()
   }
  }
  ...
  function oi(b) {
   ...
   for (var h = (b.success || function() {}, b.source_image), m = b.size_x, v = b.size_y, N = b.width, B = b.height, z = b.draw_settings, y = [], M = ut(), G = 100 / m, W = 100 / v, n = 0; m >= n; n++) {
    y[n] = [];
    for (var i = 0; v >= i; i++) {
   ...
   for (var D = [], V = "", H = 0, n = 0; m > n; n++) {
    ...
    for (var i = 0; v > i; i++) {
     ...
     var q = a(o),
      ...
      l = ft();
     l.x = [n], l.y = [i], l.piece_id = H, l.width = Math.ceil(F + 2 * e.piece_margin) / e.piece_logical_scale, l.height = Math.ceil(U + 2 * e.piece_margin) / e.piece_logical_scale, l.width_float = F, l.height_float = U, l.puzzle_width = [F], l.puzzle_height = [U], l.puzzle_left_min = q.x0, l.puzzle_top_min = q.y0, l.puzzle_left = [o.x0], l.puzzle_top = [o.y0], l.side_set = [w], l.placed = !1, D[n][i] = l, H += 1
    }
   }
   var k = document.createElement("canvas"),
    I = k.getContext("2d");
   k.width = (N + 2 * e.piece_margin) / e.piece_logical_scale, k.height = (B + 2 * e.piece_margin) / e.piece_logical_scale;
  ...
  function It(t) {
   function u() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, z(e)), e.shape_string = Q(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), vt(e, p), F({
       canvas: e.canvas,
       logical_parent: e
  ...
  function st(t) {
   z(t), t.canvas = document.createElement("canvas"), vt({
    element: t,
    parent: u.base_image,
  ...
  var J = C.game_data.jigsaw,
   ...
   T = {},
   e = y.game_instance = {},
   tt = J.difficulty_levels[j.selected_difficulty];
  e.difficulty_level = j.selected_difficulty, e.get_piece_count = function() {
   return e.tile_x * e.tile_y
  }, e.intro_audio_count = 0, !r.is_kiosk && r.use_social_media_buttons && et();
  var pt = ["answer-correct-10865990.ogg", "answer-correct-23303730.ogg", "answer-correct-25513672.ogg", "answer-correct-25513693.ogg", "answer-correct-37240671.ogg", "answer-correct-37240686.ogg", "answer-correct-37241588.ogg", "answer-correct-37241627.ogg"],
   ni = ["global-pick up.ogg", "global-put down.ogg", "answer-give up.ogg", "fireworks-1.ogg", "fireworks-2.ogg", "fireworks-3.ogg", "fireworks-4.ogg"].concat(pt);
  X({
   parent: r,
   dir: r.audio_dir + "/",
   audio_list: ni,
  ...
  if (e.force_screen_refresh = 0, hi(), void
   function() {
    ...
    action: function() {
     at(l.current_category.piece_container), V(), y.help_menu_obj.close()
    }
   ...
   var wt = y.social_sharing_button_container = document.createElement("div");
   wt.className = "jt-play-social_sharing_button_container", m.appendChild(wt), A({
    parent: wt,
    button_class: "jt-social_button_small"
   })
  }
  var bt = y.trophy_ribbon = ti({
    parent: m
   }),
  ...
  l.className = "jt-jigsaw-category_deck", l.item_under_mouse = null, f.appendChild(l), l.edit_button = document.createElement("img"), l.edit_button.className = "jt-op_button jt-op_button-edit" + (r.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), l.edit_button.src = r["/"] + "images/gui/gui-item_edit.png", l.appendChild(l.edit_button), l.add_button = document.createElement("img"), l.add_button.className = "jt-op_button jt-op_button-add" + (r.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), l.add_button.src = r["/"] + "images/gui/gui-item_expand_or_add.png", l.appendChild(l.add_button), l.basket_button = document.createElement("img"), l.basket_button.className = "jt-op_button jt-op_button-basket" + (r.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), l.basket_button.piece_list = [], l.basket_button.is_selected = !1, l.basket_button.src = r["/"] + "images/gui/gui-basket.png", l.appendChild(l.basket_button), l.remove_button = document.createElement("img"), l.remove_button.className = "jt-op_button jt-op_button-remove" + (r.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), l.remove_button.src = r["/"] + "images/gui/gui-item_remove.png", l.appendChild(l.remove_button), l.container = document.createElement("div"), l.container.className = "jt-jigsaw-category_deck-container", l.appendChild(l.container), l.add_category = function(s) {
   ...
   return "undefined" == typeof l.current_category && (l.select_category(t), l.original_category = t), t.addEventListener(r.events.POINT, function(e) {
    l.select_category(e.currentTarget), V()
   ...
   R.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
    return "" === t ? void smoke.alert("You can't set a blank name!", function() {
     R.resume()
    }) : (R.resume(), void(t !== !1 && (l.set_category_name(e, t), V())))
   })
  ...
  G.addEventListener(r.events.POINT, function(t) {
   ...
   e.classList[e.is_selected ? "remove" : "add"]("jt-op_button-basket" + (r.is_phone_or_tablet ? "-colored" : "") + "-selected"), e.is_selected && !n && Rt({
    ...
    success: function(t) {
     ...
     }), at(t.piece_container), e.piece_list = [], V()
    }
   ...
   z(e), e.canvas = document.createElement("canvas"), vt({
    element: e,
    parent: u.base_image,
    use_3d_effect: r.jigsaw_use_3d_effect,
    render_stroke: !0,
   ...
   function t(t) {
    R.resume(), 0 != t && (l.remove_category(e), l.select_category(l.original_category), V())
   }
   R.stop();
   var e = l.current_category;
  ...
  var _t = y.set_base_image_size = function() {
    ...
    function() {
     ...
     switch (e.tile_x = tt.tile_x, e.tile_y = tt.tile_y, r) {
      case .8:
  ...
  m.cleanup = function() {
   if (r.IS_CORDOVA && r.audio_container[C.last_intro_audio] && (r.audio_container[C.last_intro_audio].src = "", delete r.audio_container[C.last_intro_audio], C.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), ci(), null != i.parentNode && document.body.removeChild(i), R.destroy(), document.removeEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? m.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", dt), window.removeEventListener("mouseout", Ft)), m.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof B)
   ...
   C = null, r = null, M = null, J = null, ui = null, j = null, it = null, K = null, Z = null, y = null, T = null, e = null, tt = null, P = null, bt = null, f = null, l = null, G = null, R = null, At = null, qt = null, d = null, i = null, u = null, E = null, w = null, s = null, B = null, I = null, _ = null, _t = null, St = null, V = null, Mt = null, delete m.cleanup
  ...
  var ct = void 0,
   V = y.save_puzzle_state = function() {
    ...
    i[Z + "." + M + "." + j.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + Z + "." + M + "." + j.selected_difficulty] = JSON.stringify(t)
   },
   Mt = y.load_puzzle_state = function(s) {
    ...
    var t = JSON.parse(localStorage["puzzle_states." + Z + "." + M + "." + j.selected_difficulty]);
  ...
  y.redraw_main_image_and_pieces = function(f) {
   ...
   P();
   var M = nt(b, r.jigsaw_combine_pieces),
    y = [];
   ...
   var _ = h.getContext("2d"),
    k = c.naturalWidth,
    C = c.naturalHeight;
   _.drawImage(c, 0, 0, k, C, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), _.save(), _.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && p({
    canvas: h,
    draw_settings: T,
    stroke_width: T.stroke_width,
    cut_multiplier: T.cut_multiplier,
 ...
 var z = "safari",
  B = "com.flyingsoft.safari.jigsaw",
  s = !0,
  _ = !0;
 ! function(s, r) {
  var i, a, t, e, n;
 ...
 if ((r._gsQueue || (r._gsQueue = [])).push(function() {
    ...
    function() {
     ...
     var yt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
      ...
      E = u.getTransform = function(m, Q, P, J) {
       ...
       var o, t, v, R, X, L, D, w, y, Y, q, z, N, e = P ? m._gsTransform || new at : new at,
        nt = 0 > e.scaleX,
        M = 2e-5,
        u = 1e5,
        k = 179.99,
  ...
  var Mt = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").get,
