...
function() {
 ...
 function t(e) {
  ...
  var a = "undefined" != typeof e.charset ? e.charset : "",
   ...
   l = ot(e.file, s, n, a, t, void 0, void 0, e.request_method),
   i = l.http_request;
 ...
 function ot(a, t, r, i, n, o, c, s) {
  ...
  return e.open(s, a, n), "undefined" != typeof o && (e.responseType = o), r === !0 ? (e.setRequestHeader("Content-type", "application/x-www-form-urlencoded" + i), "undefined" != typeof e.overrideMimeType && e.overrideMimeType("text/plain; charset=x-user-defined")) : e.setRequestHeader("Content-type", "application/x-www-form-urlencoded" + i), e.send(t), {
   http_request: e
  }
 }
 ...
 function O(r, t) {
  ...
  if ("undefined" == typeof this || this == window) return new O(r, t);
  var e = this;
 ...
 function y() {
  function h() {
   ...
   e.mr_jigtato = i, this.DEBUG = !1, "undefined" != typeof IS_DEBUG_MODE && (this.DEBUG = IS_DEBUG_MODE), this.errormessage = function(e, i, t) {
    ...
    if ("undefined" == typeof i.model && (i.model = ""), "undefined" == typeof i.uuid && (i.uuid = ""), "undefined" != typeof e.account.user_id) var n = "&user_id=" + e.account.user_id + "&internal_access_token=" + e.account.internal_access_token;
    else var n = "";
    t({
     file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (e.DEBUG ? "-beta" : "") + ".php?action=log_user_action" + n + "&message=" + encodeURIComponent(r) + "&device_model=" + i.model + "&device_uuid=" + i.uuid,
     success: function() {},
     error: function() {},
     request_method: "GET"
    })
    ...
    var i = i || {},
     ...
     r = i.error || e.errormessage;
    return "undefined" == typeof e.account.internal_access_token ? void r() : void t({
   ...
   var r = {};
   r.jigsaw_colored_borders = function(t, i) {
   ...
   var o = [{
    ...
    "default": function() {
     return r.jigsaw_colored_borders(e.jigsaw_colored_borders, "margin")
    }
   }, {
    name: "jigsaw_piece_margin_style",
    "default": function() {
     return r.jigsaw_colored_borders(e.jigsaw_colored_borders, "margin_style")
    }
   }, {
   ...
   if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], o.forEach(function(n) {
     ...
     else if (e[t] in e || (e[t] = "function" == typeof n.default ? n.default() : n.default), -1 != i) var a = e[s][o];
     else var a = e[t];
     Object.defineProperty(e, t, {
      ...
      set: function(e) {
       a = e, r[t] && r[t](e), localStorage["settings." + t] = JSON.stringify(e)
      }
     }), -1 != i ? e[s][o] = a : e[t] = a
    ...
    }, this.get_image_url_from_server = function(a, r, t) {
     if ("trophy" == t) return "http://www.flyingsoftgames.com/mr_jigtato/sets/" + a + "/trophies/" + r + ".png";
    ...
    }, this.get_image_url_from_local = function(s, t, r) {
     if ("trophy" != r) var a = i.game_data.entry_list[t].category;
     var n = (_ ? "content://" + F + ".free.expansion/" : e["/"]) + "sets/" + s;
     switch ("undefined" != typeof e.account.user_id && (e.account.user_id > 606 || 1 == e.account.user_id) && "mini-grey" == r && (r = "mini"), r) {
      case "trophy":
       return n + "/puzzle/trophies/" + t + ".png";
      case "mini":
       return n + "/puzzle/categories/" + a + "/mini/" + t + "-mini.jpg";
      case "mini-grey":
       return n + "/puzzle/categories/" + a + "/mini-grey/" + t + "-mini.png";
      case "default":
      default:
       return n + "/puzzle/categories/" + a + "/" + t + ".jpg"
     }
    }, this.get_image = function(i, n, r, t) {
     function a() {
      i.removeEventListener("error", a);
      var s = JSON.parse(localStorage["image_is_not_local_cache." + t]);
      s[r] = !0, localStorage["image_is_not_local_cache." + t] = JSON.stringify(s), i.src = e.get_image_url_from_server(n, r, t)
     }
     ...
     var s = JSON.parse(localStorage["image_is_not_local_cache." + t]);
     return s[r] ? void(i.src = e.get_image_url_from_server(n, r, t)) : (i.src = e.get_image_url_from_local(n, r, t), void i.addEventListener("error", a))
    }, e.jigsaw_piece_margin = 8, this.audio_container = {}, this.select_mode_visited_count = 0, e.ambient_music = function() {
     var t = {};
     return t.load_ambient_music = function(r, l) {
      var n = l.split(","),
       a = n[0].trim().toLowerCase(),
       s = n[1].trim().toLowerCase();
      if (!t.loaded) {
       if (t.loaded = !0, t.playlist_list = r, "undefined" != typeof e.ambient_music_playlist_name) var o = r.find(function(t) {
      ...
      var r = t.playlist;
      t.current_track_index = (t.current_track_index + 1) % r.length, t.current_track = e.playAudio(e.get_set_directory(i.set_name) + "/audio/" + r[t.current_track_index].file, {
      ...
      var r = t.playlist = n.list;
      t.current_track_index = Math.floor(Math.random() * r.length), t.current_track_index = (t.current_track_index + r.length - 1) % r.length, t.play_next_track()
     }, t.play = function() {
     ...
     var n = t.audio_type || "sound_effect",
      o = e[n + ("sound_effect" == n ? "s" : "") + "_on"];
     if (t.play_howl = !1, t.play_howl && "ambient_music" == n && (t.preload_buffer_file = r.substr(0, r.length - 4) + "-preview" + r.substr(-4)), o || "undefined" != typeof t.start && 0 == t.start)
      if (t.element) var l = t.element,
       i = l.playAudio(r, t);
      else var i = w(r, t);
     if (!o) return i;
     switch (t.restart && (i.currentTime = 0), n) {
      case "sound_effect":
     ...
     if (i["is_" + n] = !0, "undefined" == typeof t.blocking || 1 == t.blocking) {
      var c = void 0;
   ...
   if (e.is_phone_or_tablet && (document.body.addEventListener("touchstart", function(e) {
    ...
    !e.account.purchased_ad_removal && e.IS_WEBVIEW && "undefined" != typeof f && (e.ad_control_list = [], e.ad_control_list.destroy = function() {
     ...
     admob: 85,
     adbuddiz: 15
    }, Object.keys(e.ad_control_list_weights).forEach(function(r) {
     var t = f({
      gs: e,
      ad_network: r
     });
  ...
  var i = {};
  i.send_javascript_error = function(i, n, a, s) {
   ...
   r.account && r.account.user_id && 497 == r.account.user_id && console.log("Loading player data from server.");
   var n = n || {},
  ...
  var n = i.history_control = new kt({
    onbeforestatechange: function(e, t, n) {
     ...
     t.title = d(e, t), "undefined" != typeof i.game_data ? n() : i.load_game_data({
    ...
    onstatechange: function(t, l) {
     ...
     switch (t.page) {
      case "select_mode":
       ...
       break;
      case "select_jigsaw":
       if ("undefined" == typeof n.show_own_ad_at_end_of_play_chance && (n.show_own_ad_at_end_of_play_chance = 1), n.last_page && "jigsaw" == n.last_page && i.player_data.jigsaw.trophies.length >= 5 && Math.random() < n.show_own_ad_at_end_of_play_chance)
        if (1 == n.show_own_ad_at_end_of_play_chance ? n.show_own_ad_at_end_of_play_chance = .475 : n.show_own_ad_at_end_of_play_chance > .3 && (n.show_own_ad_at_end_of_play_chance *= .9), Math.random() < .85) {
         var a = .35;
         5 == i.player_data.jigsaw.trophies.length && (a = 1), r.gem_purchased_amount > 10 && (a = .25), r.gem_purchased_amount > 20 && (a = 0), Math.random() < a ? wt({
          gs: r,
          mr_jigtato: i,
          callback: e
         }) : Math.random() < .65 && r.enable_game_tips && "jigsaw" == n.last_page ? W({
          gs: r,
          mr_jigtato: i,
          callback: e
         }) : e()
       ...
       else Math.random() < .65 && r.enable_game_tips && "jigsaw" == n.last_page ? W({
        gs: r,
        mr_jigtato: i,
        callback: e
       }) : e();
      ...
      case "jigsaw":
       yt({
        ...
        global_settings: r,
        level_id: t.level
       }), r.IS_WEBVIEW && "undefined" != typeof f && lt({
        gs: r,
        mr_jigtato: i
       });
       break;
  ...
  if (o.className = "jt-content_div", o.id = "content_div", i.parent = document.body, i.parent.appendChild(o), smoke.parent = o, r.is_phone_or_tablet) {
   smoke.custom_css = {
 ...
 function ft(r) {
  ...
  var i = smoke.confirm(s, function(i) {
   ...
   }), e.account.game_was_rated = !0, e.open_url(e.google_play_store_url)), r.callback && r.callback()
  });
 ...
 function Q(r) {
  function l() {
   e.back.style.visibility = 0 == i ? "hidden" : "visible", e.next.style.visibility = i == n.length - 1 ? "hidden" : "visible", o.text.innerHTML = n[i], o.text.parentNode.classList[1 == i ? "add" : "remove"]("jt-play-show_credits-dialog")
  }
  ...
  n[0] = s.about_text + d + ". </p>", r.callback, n[1] = "Loading...", t({
   error: function(e) {
  ...
  return "undefined" == typeof e.google_play_access_token ? void("undefined" != typeof i.error && i.error()) : void t({
   ...
   success: function(r) {
    ...
    function() {
     ...
     var i = 27e5;
     setTimeout(t, i)
    }(), e.paid_puzzles = r.paid_puzzles, "undefined" != typeof r.message && (e.pending_message = r.message), i.success()
   }
  })
 }
 ...
 function I(i) {
  ...
  r.open("HEAD", l + "/" + e, !0), r.onreadystatechange = function() {
   if (4 == r.readyState) {
    ...
    o >= i ? a(c + "/" + e, u) : i > l ? (localStorage.json_file_version_date = JSON.stringify(+i), m()) : n()
   }
  }, r.send(null)
 }
 ...
 function dt(s) {
  function o() {
   for (var t in r) {
    {
     r[t], e.google_play_store.product_list.ad_removal
    }
  ...
  if (e.IS_CORDOVA && window.store) {
   ...
   i.validator = function(r, n) {
    t({
     file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new.php?action=check_purchase&internal_access_token=" + e.account.internal_access_token + "&user_id=" + e.account.user_id + "&signature=" + encodeURIComponent(r.transaction.signature) + "&receipt=" + encodeURIComponent(r.transaction.receipt),
     success: function(t) {
 ...
 function pt() {
  ...
  return t.prototype.init = function(e, t) {
   ...
   return r
  }, n.testCurveCurveIntersection = function(j, B, G, K, z, N, W, X) {
   var I, O, E, D, i, n, a, h, o, c, l, s, j = new t(j[0], j[1]),
    B = new t(B[0], B[1]),
    G = new t(G[0], G[1]),
    K = new t(K[0], K[1]),
    z = new t(z[0], z[1]),
    ...
    W = new t(W[0], W[1]),
    X = new t(X[0], X[1]);
   I = j.multiply(-1), O = B.multiply(3), E = G.multiply(-3), D = I.add(O.add(E.add(K))), i = new r(D.x, D.y), I = j.multiply(3), O = B.multiply(-6), E = G.multiply(3), D = I.add(O.add(E)), n = new r(D.x, D.y), I = j.multiply(-3), O = B.multiply(3), E = I.add(O), a = new r(E.x, E.y), h = new r(j.x, j.y), I = z.multiply(-1), O = N.multiply(3), E = W.multiply(-3), D = I.add(O.add(E.add(X))), o = new r(D.x, D.y), I = z.multiply(3), O = N.multiply(-6), E = W.multiply(3), D = I.add(O.add(E)), c = new r(D.x, D.y), I = z.multiply(-3), O = N.multiply(3), E = I.add(O), l = new r(E.x, E.y), s = new r(z.x, z.y);
   for (var R = h.x * h.x, it = h.x * h.x * h.x, T = h.y * h.y, nt = h.y * h.y * h.y, g = a.x * a.x, F = a.x * a.x * a.x, y = a.y * a.y, U = a.y * a.y * a.y, f = n.x * n.x, L = n.x * n.x * n.x, p = n.y * n.y, b = n.y * n.y * n.y, d = i.x * i.x, m = i.x * i.x * i.x, u = i.y * i.y, _ = i.y * i.y * i.y, A = s.x * s.x, ot = s.x * s.x * s.x, S = s.y * s.y, st = s.y * s.y * s.y, w = l.x * l.x, $ = l.x * l.x * l.x, x = l.y * l.y, k = c.x * c.x, tt = c.x * c.x * c.x, v = c.y * c.y, C = o.x * o.x, lt = o.x * o.x * o.x, M = o.y * o.y, et = o.y * o.y * o.y, rt = new e(-m * et + _ * lt - 3 * i.x * u * C * o.y + 3 * d * i.y * o.x * M, -6 * i.x * c.x * u * o.x * o.y + 6 * d * i.y * c.y * o.x * o.y + 3 * c.x * _ * C - 3 * m * c.y * M - 3 * i.x * u * c.y * C + 3 * d * c.x * i.y * M, -6 * l.x * i.x * u * o.x * o.y - 6 * i.x * c.x * u * c.y * o.x + 6 * d * c.x * i.y * c.y * o.y + 3 * l.x * _ * C + 3 * k * _ * o.x + 3 * l.x * d * i.y * M - 3 * i.x * l.y * u * C - 3 * i.x * k * u * o.y + d * i.y * o.x * (6 * l.y * o.y + 3 * v) + m * (-l.y * M - 2 * v * o.y - o.y * (2 * l.y * o.y + v)), a.x * n.y * i.x * i.y * o.x * o.y - a.y * n.x * i.x * i.y * o.x * o.y + 6 * l.x * c.x * _ * o.x + 3 * a.x * n.x * i.x * i.y * M + 6 * h.x * i.x * u * o.x * o.y - 3 * a.x * n.x * u * o.x * o.y - 3 * a.y * n.y * i.x * i.y * C - 6 * h.y * d * i.y * o.x * o.y - 6 * s.x * i.x * u * o.x * o.y + 3 * a.y * n.y * d * o.x * o.y - 2 * n.x * p * i.x * o.x * o.y - 6 * l.x * i.x * c.x * u * o.y - 6 * l.x * i.x * u * c.y * o.x - 6 * i.x * l.y * c.x * u * o.x + 6 * l.x * d * i.y * c.y * o.y + 2 * f * n.y * i.y * o.x * o.y + tt * _ - 3 * h.x * _ * C + 3 * h.y * m * M + 3 * s.x * _ * C + b * i.x * C - L * i.y * M - 3 * h.x * d * i.y * M + 3 * h.y * i.x * u * C - 2 * a.x * n.y * d * M + a.x * n.y * u * C - a.y * n.x * d * M + 2 * a.y * n.x * u * C + 3 * s.x * d * i.y * M - n.x * p * i.y * C - 3 * s.y * i.x * u * C + f * n.y * i.x * M - 3 * i.x * k * u * c.y + d * i.y * o.x * (6 * s.y * o.y + 6 * l.y * c.y) + d * c.x * i.y * (6 * l.y * o.y + 3 * v) + m * (-2 * l.y * c.y * o.y - s.y * M - c.y * (2 * l.y * o.y + v) - o.y * (2 * s.y * o.y + 2 * l.y * c.y)), 6 * a.x * n.x * i.x * i.y * c.y * o.y + a.x * n.y * i.x * c.x * i.y * o.y + a.x * n.y * i.x * i.y * c.y * o.x - a.y * n.x * i.x * c.x * i.y * o.y - a.y * n.x * i.x * i.y * c.y * o.x - 6 * a.y * n.y * i.x * c.x * i.y * o.x - 6 * h.x * c.x * _ * o.x + 6 * s.x * c.x * _ * o.x + 6 * h.y * m * c.y * o.y + 2 * b * i.x * c.x * o.x - 2 * L * i.y * c.y * o.y + 6 * h.x * i.x * c.x * u * o.y + 6 * h.x * i.x * u * c.y * o.x + 6 * h.y * i.x * c.x * u * o.x - 3 * a.x * n.x * c.x * u * o.y - 3 * a.x * n.x * u * c.y * o.x + 2 * a.x * n.y * c.x * u * o.x + 4 * a.y * n.x * c.x * u * o.x - 6 * h.x * d * i.y * c.y * o.y - 6 * h.y * d * c.x * i.y * o.y - 6 * h.y * d * i.y * c.y * o.x - 4 * a.x * n.y * d * c.y * o.y - 6 * s.x * i.x * c.x * u * o.y - 6 * s.x * i.x * u * c.y * o.x - 2 * a.y * n.x * d * c.y * o.y + 3 * a.y * n.y * d * c.x * o.y + 3 * a.y * n.y * d * c.y * o.x - 2 * n.x * p * i.x * c.x * o.y - 2 * n.x * p * i.x * c.y * o.x - 2 * n.x * p * c.x * i.y * o.x - 6 * s.y * i.x * c.x * u * o.x - 6 * l.x * i.x * l.y * u * o.x - 6 * l.x * i.x * c.x * u * c.y + 6 * s.x * d * i.y * c.y * o.y + 2 * f * n.y * i.x * c.y * o.y + 2 * f * n.y * c.x * i.y * o.y + 2 * f * n.y * i.y * c.y * o.x + 3 * l.x * k * _ + 3 * w * _ * o.x - 3 * i.x * l.y * k * u - 3 * w * i.x * u * o.y + d * c.x * i.y * (6 * s.y * o.y + 6 * l.y * c.y) + d * i.y * o.x * (6 * s.y * c.y + 3 * x) + l.x * d * i.y * (6 * l.y * o.y + 3 * v) + m * (-2 * s.y * c.y * o.y - o.y * (2 * s.y * c.y + x) - l.y * (2 * l.y * o.y + v) - c.y * (2 * s.y * o.y + 2 * l.y * c.y)), a.x * l.x * n.y * i.x * i.y * o.y + a.x * n.y * i.x * l.y * i.y * o.x + a.x * n.y * i.x * c.x * i.y * c.y - a.y * n.x * l.x * i.x * i.y * o.y - a.y * n.x * i.x * l.y * i.y * o.x - a.y * n.x * i.x * c.x * i.y * c.y - 6 * a.y * l.x * n.y * i.x * i.y * o.x - 6 * h.x * l.x * _ * o.x + 6 * s.x * l.x * _ * o.x + 2 * l.x * b * i.x * o.x + 6 * h.x * l.x * i.x * u * o.y + 6 * h.x * i.x * l.y * u * o.x + 6 * h.x * i.x * c.x * u * c.y + 6 * h.y * l.x * i.x * u * o.x - 3 * a.x * n.x * l.x * u * o.y - 3 * a.x * n.x * l.y * u * o.x - 3 * a.x * n.x * c.x * u * c.y + 2 * a.x * l.x * n.y * u * o.x + 4 * a.y * n.x * l.x * u * o.x - 6 * h.y * l.x * d * i.y * o.y - 6 * h.y * d * l.y * i.y * o.x - 6 * h.y * d * c.x * i.y * c.y - 6 * s.x * l.x * i.x * u * o.y - 6 * s.x * i.x * l.y * u * o.x - 6 * s.x * i.x * c.x * u * c.y + 3 * a.y * l.x * n.y * d * o.y - 3 * a.y * n.y * i.x * k * i.y + 3 * a.y * n.y * d * l.y * o.x + 3 * a.y * n.y * d * c.x * c.y - 2 * n.x * l.x * p * i.x * o.y - 2 * n.x * l.x * p * i.y * o.x - 2 * n.x * p * i.x * l.y * o.x - 2 * n.x * p * i.x * c.x * c.y - 6 * s.y * l.x * i.x * u * o.x - 6 * l.x * i.x * l.y * c.x * u + 6 * s.y * d * l.y * i.y * o.x + 2 * f * l.x * n.y * i.y * o.y + 2 * f * n.y * l.y * i.y * o.x + 2 * f * n.y * c.x * i.y * c.y - 3 * h.x * k * _ + 3 * s.x * k * _ + 3 * w * c.x * _ + b * i.x * k + 3 * h.y * i.x * k * u + a.x * n.y * k * u + 2 * a.y * n.x * k * u - n.x * p * k * i.y - 3 * s.y * i.x * k * u - 3 * w * i.x * u * c.y + f * n.y * i.x * (2 * l.y * o.y + v) + a.x * n.x * i.x * i.y * (6 * l.y * o.y + 3 * v) + l.x * d * i.y * (6 * s.y * o.y + 6 * l.y * c.y) + L * i.y * (-2 * l.y * o.y - v) + h.y * m * (6 * l.y * o.y + 3 * v) + a.y * n.x * d * (-2 * l.y * o.y - v) + a.x * n.y * d * (-4 * l.y * o.y - 2 * v) + h.x * d * i.y * (-6 * l.y * o.y - 3 * v) + d * c.x * i.y * (6 * s.y * c.y + 3 * x) + s.x * d * i.y * (6 * l.y * o.y + 3 * v) + m * (-2 * s.y * l.y * o.y - c.y * (2 * s.y * c.y + x) - s.y * (2 * l.y * o.y + v) - l.y * (2 * s.y * o.y + 2 * l.y * c.y)), -h.x * a.x * n.y * i.x * i.y * o.y + h.x * a.y * n.x * i.x * i.y * o.y + 6 * h.x * a.y * n.y * i.x * i.y * o.x - 6 * h.y * a.x * n.x * i.x * i.y * o.y - h.y * a.x * n.y * i.x * i.y * o.x + h.y * a.y * n.x * i.x * i.y * o.x + a.x * a.y * n.x * n.y * i.x * o.y - a.x * a.y * n.x * n.y * i.y * o.x + a.x * s.x * n.y * i.x * i.y * o.y + a.x * s.y * n.y * i.x * i.y * o.x + a.x * l.x * n.y * i.x * i.y * c.y + a.x * n.y * i.x * l.y * c.x * i.y - s.x * a.y * n.x * i.x * i.y * o.y - 6 * s.x * a.y * n.y * i.x * i.y * o.x - a.y * n.x * s.y * i.x * i.y * o.x - a.y * n.x * l.x * i.x * i.y * c.y - a.y * n.x * i.x * l.y * c.x * i.y - 6 * a.y * l.x * n.y * i.x * c.x * i.y - 6 * h.x * s.x * _ * o.x - 6 * h.x * l.x * c.x * _ - 2 * h.x * b * i.x * o.x + 6 * s.x * l.x * c.x * _ + 2 * s.x * b * i.x * o.x + 2 * l.x * b * i.x * c.x + 2 * h.y * L * i.y * o.y - 6 * h.x * h.y * i.x * u * o.x + 3 * h.x * a.x * n.x * u * o.y - 2 * h.x * a.x * n.y * u * o.x - 4 * h.x * a.y * n.x * u * o.x + 3 * h.y * a.x * n.x * u * o.x + 6 * h.x * h.y * d * i.y * o.y + 6 * h.x * s.x * i.x * u * o.y - 3 * h.x * a.y * n.y * d * o.y + 2 * h.x * n.x * p * i.x * o.y + 2 * h.x * n.x * p * i.y * o.x + 6 * h.x * s.y * i.x * u * o.x + 6 * h.x * l.x * i.x * u * c.y + 6 * h.x * i.x * l.y * c.x * u + 4 * h.y * a.x * n.y * d * o.y + 6 * h.y * s.x * i.x * u * o.x + 2 * h.y * a.y * n.x * d * o.y - 3 * h.y * a.y * n.y * d * o.x + 2 * h.y * n.x * p * i.x * o.x + 6 * h.y * l.x * i.x * c.x * u - 3 * a.x * s.x * n.x * u * o.y + 2 * a.x * s.x * n.y * u * o.x + a.x * a.y * p * i.x * o.x - 3 * a.x * n.x * s.y * u * o.x - 3 * a.x * n.x * l.x * u * c.y - 3 * a.x * n.x * l.y * c.x * u + 2 * a.x * l.x * n.y * c.x * u + 4 * s.x * a.y * n.x * u * o.x + 4 * a.y * n.x * l.x * c.x * u - 2 * h.x * f * n.y * i.y * o.y - 6 * h.y * s.x * d * i.y * o.y - 6 * h.y * s.y * d * i.y * o.x - 6 * h.y * l.x * d * i.y * c.y - 2 * h.y * f * n.y * i.x * o.y - 2 * h.y * f * n.y * i.y * o.x - 6 * h.y * d * l.y * c.x * i.y - a.x * a.y * f * i.y * o.y - 2 * a.x * y * i.x * i.y * o.x + 3 * s.x * a.y * n.y * d * o.y - 2 * s.x * n.x * p * i.x * o.y - 2 * s.x * n.x * p * i.y * o.x - 6 * s.x * s.y * i.x * u * o.x - 6 * s.x * l.x * i.x * u * c.y - 6 * s.x * i.x * l.y * c.x * u + 3 * a.y * s.y * n.y * d * o.x + 3 * a.y * l.x * n.y * d * c.y + 3 * a.y * n.y * d * l.y * c.x - 2 * n.x * s.y * p * i.x * o.x - 2 * n.x * l.x * p * i.x * c.y - 2 * n.x * l.x * p * c.x * i.y - 2 * n.x * p * i.x * l.y * c.x - 6 * s.y * l.x * i.x * c.x * u - y * n.x * n.y * i.x * o.x + 2 * s.x * f * n.y * i.y * o.y + 6 * s.y * d * l.y * c.x * i.y + 2 * g * a.y * i.x * i.y * o.y + g * n.x * n.y * i.y * o.y + 2 * f * s.y * n.y * i.y * o.x + 2 * f * l.x * n.y * i.y * c.y + 2 * f * n.y * l.y * c.x * i.y + $ * _ + 3 * R * _ * o.x - 3 * T * m * o.y + 3 * A * _ * o.x + U * d * o.x - F * u * o.y - a.x * y * d * o.y + g * a.y * u * o.x - 3 * R * i.x * u * o.y + 3 * T * d * i.y * o.x - g * p * i.x * o.y + y * f * i.y * o.x - 3 * w * i.x * l.y * u - 3 * A * i.x * u * o.y + 3 * S * d * i.y * o.x + a.x * n.x * i.x * i.y * (6 * s.y * o.y + 6 * l.y * c.y) + L * i.y * (-2 * s.y * o.y - 2 * l.y * c.y) + h.y * m * (6 * s.y * o.y + 6 * l.y * c.y) + a.y * n.x * d * (-2 * s.y * o.y - 2 * l.y * c.y) + f * n.y * i.x * (2 * s.y * o.y + 2 * l.y * c.y) + a.x * n.y * d * (-4 * s.y * o.y - 4 * l.y * c.y) + h.x * d * i.y * (-6 * s.y * o.y - 6 * l.y * c.y) + s.x * d * i.y * (6 * s.y * o.y + 6 * l.y * c.y) + l.x * d * i.y * (6 * s.y * c.y + 3 * x) + m * (-2 * s.y * l.y * c.y - S * o.y - l.y * (2 * s.y * c.y + x) - s.y * (2 * s.y * o.y + 2 * l.y * c.y)), -h.x * a.x * n.y * i.x * i.y * c.y + h.x * a.y * n.x * i.x * i.y * c.y + 6 * h.x * a.y * n.y * i.x * c.x * i.y - 6 * h.y * a.x * n.x * i.x * i.y * c.y - h.y * a.x * n.y * i.x * c.x * i.y + h.y * a.y * n.x * i.x * c.x * i.y + a.x * a.y * n.x * n.y * i.x * c.y - a.x * a.y * n.x * n.y * c.x * i.y + a.x * s.x * n.y * i.x * i.y * c.y + a.x * s.y * n.y * i.x * c.x * i.y + a.x * l.x * n.y * i.x * l.y * i.y - s.x * a.y * n.x * i.x * i.y * c.y - 6 * s.x * a.y * n.y * i.x * c.x * i.y - a.y * n.x * s.y * i.x * c.x * i.y - a.y * n.x * l.x * i.x * l.y * i.y - 6 * h.x * s.x * c.x * _ - 2 * h.x * b * i.x * c.x + 2 * s.x * b * i.x * c.x + 2 * h.y * L * i.y * c.y - 6 * h.x * h.y * i.x * c.x * u + 3 * h.x * a.x * n.x * u * c.y - 2 * h.x * a.x * n.y * c.x * u - 4 * h.x * a.y * n.x * c.x * u + 3 * h.y * a.x * n.x * c.x * u + 6 * h.x * h.y * d * i.y * c.y + 6 * h.x * s.x * i.x * u * c.y - 3 * h.x * a.y * n.y * d * c.y + 2 * h.x * n.x * p * i.x * c.y + 2 * h.x * n.x * p * c.x * i.y + 6 * h.x * s.y * i.x * c.x * u + 6 * h.x * l.x * i.x * l.y * u + 4 * h.y * a.x * n.y * d * c.y + 6 * h.y * s.x * i.x * c.x * u + 2 * h.y * a.y * n.x * d * c.y - 3 * h.y * a.y * n.y * d * c.x + 2 * h.y * n.x * p * i.x * c.x - 3 * a.x * s.x * n.x * u * c.y + 2 * a.x * s.x * n.y * c.x * u + a.x * a.y * p * i.x * c.x - 3 * a.x * n.x * s.y * c.x * u - 3 * a.x * n.x * l.x * l.y * u + 4 * s.x * a.y * n.x * c.x * u - 2 * h.x * f * n.y * i.y * c.y - 6 * h.y * s.x * d * i.y * c.y - 6 * h.y * s.y * d * c.x * i.y - 6 * h.y * l.x * d * l.y * i.y - 2 * h.y * f * n.y * i.x * c.y - 2 * h.y * f * n.y * c.x * i.y - a.x * a.y * f * i.y * c.y - 2 * a.x * y * i.x * c.x * i.y + 3 * s.x * a.y * n.y * d * c.y - 2 * s.x * n.x * p * i.x * c.y - 2 * s.x * n.x * p * c.x * i.y - 6 * s.x * s.y * i.x * c.x * u - 6 * s.x * l.x * i.x * l.y * u + 3 * a.y * s.y * n.y * d * c.x + 3 * a.y * l.x * n.y * d * l.y - 2 * n.x * s.y * p * i.x * c.x - 2 * n.x * l.x * p * i.x * l.y - y * n.x * n.y * i.x * c.x + 2 * s.x * f * n.y * i.y * c.y - 3 * a.y * w * n.y * i.x * i.y + 6 * s.y * l.x * d * l.y * i.y + 2 * g * a.y * i.x * i.y * c.y + g * n.x * n.y * i.y * c.y + 2 * f * s.y * n.y * c.x * i.y + 2 * f * l.x * n.y * l.y * i.y - 3 * h.x * w * _ + 3 * s.x * w * _ + 3 * R * c.x * _ - 3 * T * m * c.y + 3 * A * c.x * _ + w * b * i.x + U * d * c.x - F * u * c.y + 3 * h.y * w * i.x * u - a.x * y * d * c.y + a.x * w * n.y * u + 2 * a.y * n.x * w * u + g * a.y * c.x * u - n.x * w * p * i.y - 3 * s.y * w * i.x * u - 3 * R * i.x * u * c.y + 3 * T * d * c.x * i.y - g * p * i.x * c.y + y * f * c.x * i.y - 3 * A * i.x * u * c.y + 3 * S * d * c.x * i.y + f * n.y * i.x * (2 * s.y * c.y + x) + a.x * n.x * i.x * i.y * (6 * s.y * c.y + 3 * x) + L * i.y * (-2 * s.y * c.y - x) + h.y * m * (6 * s.y * c.y + 3 * x) + a.y * n.x * d * (-2 * s.y * c.y - x) + a.x * n.y * d * (-4 * s.y * c.y - 2 * x) + h.x * d * i.y * (-6 * s.y * c.y - 3 * x) + s.x * d * i.y * (6 * s.y * c.y + 3 * x) + m * (-2 * s.y * x - S * c.y - s.y * (2 * s.y * c.y + x)), -h.x * a.x * n.y * i.x * l.y * i.y + h.x * a.y * n.x * i.x * l.y * i.y + 6 * h.x * a.y * l.x * n.y * i.x * i.y - 6 * h.y * a.x * n.x * i.x * l.y * i.y - h.y * a.x * l.x * n.y * i.x * i.y + h.y * a.y * n.x * l.x * i.x * i.y - a.x * a.y * n.x * l.x * n.y * i.y + a.x * a.y * n.x * n.y * i.x * l.y + a.x * s.x * n.y * i.x * l.y * i.y + 6 * a.x * n.x * s.y * i.x * l.y * i.y + a.x * s.y * l.x * n.y * i.x * i.y - s.x * a.y * n.x * i.x * l.y * i.y - 6 * s.x * a.y * l.x * n.y * i.x * i.y - a.y * n.x * s.y * l.x * i.x * i.y - 6 * h.x * s.x * l.x * _ - 2 * h.x * l.x * b * i.x + 6 * h.y * s.y * m * l.y + 2 * s.x * l.x * b * i.x + 2 * h.y * L * l.y * i.y - 2 * L * s.y * l.y * i.y - 6 * h.x * h.y * l.x * i.x * u + 3 * h.x * a.x * n.x * l.y * u - 2 * h.x * a.x * l.x * n.y * u - 4 * h.x * a.y * n.x * l.x * u + 3 * h.y * a.x * n.x * l.x * u + 6 * h.x * h.y * d * l.y * i.y + 6 * h.x * s.x * i.x * l.y * u - 3 * h.x * a.y * n.y * d * l.y + 2 * h.x * n.x * l.x * p * i.y + 2 * h.x * n.x * p * i.x * l.y + 6 * h.x * s.y * l.x * i.x * u + 4 * h.y * a.x * n.y * d * l.y + 6 * h.y * s.x * l.x * i.x * u + 2 * h.y * a.y * n.x * d * l.y - 3 * h.y * a.y * l.x * n.y * d + 2 * h.y * n.x * l.x * p * i.x - 3 * a.x * s.x * n.x * l.y * u + 2 * a.x * s.x * l.x * n.y * u + a.x * a.y * l.x * p * i.x - 3 * a.x * n.x * s.y * l.x * u + 4 * s.x * a.y * n.x * l.x * u - 6 * h.x * s.y * d * l.y * i.y - 2 * h.x * f * n.y * l.y * i.y - 6 * h.y * s.x * d * l.y * i.y - 6 * h.y * s.y * l.x * d * i.y - 2 * h.y * f * l.x * n.y * i.y - 2 * h.y * f * n.y * i.x * l.y - a.x * a.y * f * l.y * i.y - 4 * a.x * s.y * n.y * d * l.y - 2 * a.x * y * l.x * i.x * i.y + 3 * s.x * a.y * n.y * d * l.y - 2 * s.x * n.x * l.x * p * i.y - 2 * s.x * n.x * p * i.x * l.y - 6 * s.x * s.y * l.x * i.x * u - 2 * a.y * n.x * s.y * d * l.y + 3 * a.y * s.y * l.x * n.y * d - 2 * n.x * s.y * l.x * p * i.x - y * n.x * l.x * n.y * i.x + 6 * s.x * s.y * d * l.y * i.y + 2 * s.x * f * n.y * l.y * i.y + 2 * g * a.y * i.x * l.y * i.y + g * n.x * n.y * l.y * i.y + 2 * f * s.y * l.x * n.y * i.y + 2 * f * s.y * n.y * i.x * l.y + 3 * R * l.x * _ - 3 * T * m * l.y + 3 * A * l.x * _ + U * l.x * d - F * l.y * u - 3 * S * m * l.y - a.x * y * d * l.y + g * a.y * l.x * u - 3 * R * i.x * l.y * u + 3 * T * l.x * d * i.y - g * p * i.x * l.y + y * f * l.x * i.y - 3 * A * i.x * l.y * u + 3 * S * l.x * d * i.y, h.x * h.y * a.x * n.y * i.x * i.y - h.x * h.y * a.y * n.x * i.x * i.y + h.x * a.x * a.y * n.x * n.y * i.y - h.y * a.x * a.y * n.x * n.y * i.x - h.x * a.x * s.y * n.y * i.x * i.y + 6 * h.x * s.x * a.y * n.y * i.x * i.y + h.x * a.y * n.x * s.y * i.x * i.y - h.y * a.x * s.x * n.y * i.x * i.y - 6 * h.y * a.x * n.x * s.y * i.x * i.y + h.y * s.x * a.y * n.x * i.x * i.y - a.x * s.x * a.y * n.x * n.y * i.y + a.x * a.y * n.x * s.y * n.y * i.x + a.x * s.x * s.y * n.y * i.x * i.y - s.x * a.y * n.x * s.y * i.x * i.y - 2 * h.x * s.x * b * i.x + 2 * h.y * L * s.y * i.y - 3 * h.x * h.y * a.x * n.x * u - 6 * h.x * h.y * s.x * i.x * u + 3 * h.x * h.y * a.y * n.y * d - 2 * h.x * h.y * n.x * p * i.x - 2 * h.x * a.x * s.x * n.y * u - h.x * a.x * a.y * p * i.x + 3 * h.x * a.x * n.x * s.y * u - 4 * h.x * s.x * a.y * n.x * u + 3 * h.y * a.x * s.x * n.x * u + 6 * h.x * h.y * s.y * d * i.y + 2 * h.x * h.y * f * n.y * i.y + 2 * h.x * a.x * y * i.x * i.y + 2 * h.x * s.x * n.x * p * i.y + 6 * h.x * s.x * s.y * i.x * u - 3 * h.x * a.y * s.y * n.y * d + 2 * h.x * n.x * s.y * p * i.x + h.x * y * n.x * n.y * i.x + h.y * a.x * a.y * f * i.y + 4 * h.y * a.x * s.y * n.y * d - 3 * h.y * s.x * a.y * n.y * d + 2 * h.y * s.x * n.x * p * i.x + 2 * h.y * a.y * n.x * s.y * d + a.x * s.x * a.y * p * i.x - 3 * a.x * s.x * n.x * s.y * u - 2 * h.x * f * s.y * n.y * i.y - 6 * h.y * s.x * s.y * d * i.y - 2 * h.y * s.x * f * n.y * i.y - 2 * h.y * g * a.y * i.x * i.y - h.y * g * n.x * n.y * i.y - 2 * h.y * f * s.y * n.y * i.x - 2 * a.x * s.x * y * i.x * i.y - a.x * a.y * f * s.y * i.y + 3 * s.x * a.y * s.y * n.y * d - 2 * s.x * n.x * s.y * p * i.x - s.x * y * n.x * n.y * i.x + 3 * T * a.x * n.x * i.x * i.y + 3 * a.x * n.x * S * i.x * i.y + 2 * s.x * f * s.y * n.y * i.y - 3 * R * a.y * n.y * i.x * i.y + 2 * g * a.y * s.y * i.x * i.y + g * n.x * s.y * n.y * i.y - 3 * A * a.y * n.y * i.x * i.y - it * _ + nt * m + ot * _ - st * m - 3 * h.x * A * _ - h.x * U * d + 3 * R * s.x * _ + h.y * F * u + 3 * h.y * S * m + s.x * U * d + R * b * i.x - 3 * T * s.y * m - T * L * i.y + A * b * i.x - F * s.y * u - L * S * i.y - h.x * g * a.y * u + h.y * a.x * y * d - 3 * h.x * T * d * i.y - h.x * y * f * i.y + h.y * g * p * i.x - a.x * y * s.y * d + 3 * R * h.y * i.x * u + R * a.x * n.y * u + 2 * R * a.y * n.x * u - 2 * T * a.x * n.y * d - T * a.y * n.x * d + g * s.x * a.y * u - 3 * h.x * S * d * i.y + 3 * h.y * A * i.x * u + a.x * A * n.y * u - 2 * a.x * S * n.y * d + s.x * y * f * i.y - a.y * n.x * S * d - R * n.x * p * i.y - 3 * R * s.y * i.x * u + 3 * T * s.x * d * i.y + T * f * n.y * i.x - g * s.y * p * i.x + 2 * A * a.y * n.x * u + 3 * s.x * S * d * i.y - A * n.x * p * i.y - 3 * A * s.y * i.x * u + f * S * n.y * i.x), Z = rt.getRootsInInterval(0, 1), Y = 0; Y < Z.length; Y++) {
    var P = Z[Y],
 ...
 function f(r) {
  if (this == window) return new f(r);
  var e = this,
   i = void 0,
   r = r || {};
  return e.gs = r.gs, e.ad_network = r.ad_network, e.init = function() {
  ...
  function s(t) {
   ...
   function r(i) {
    if (e.ambient_music_on_question_asked) i();
     ...
     t.buttons.ok.innerHTML = "Keep ambient music on.", t.buttons.cancel.innerHTML = "Turn ambient music off.", n(t.buttons)
    }
   }
 ...
 function mt(s) {
  function u() {
   ...
   u.className = "jt-select_screen-header", o.appendChild(u), n(u);
   ...
   var z = a.create_tab_container = function(r) {
     function l() {
      var n = t.game_data.category_list,
       r = [];
      for (var a in n) r.push(a);
      var l = r.indexOf(e.select_menu_current_category[i]);
      e.select_menu_current_category[i] = r[(l + 1) % r.length], e.select_menu_current_category = e.select_menu_current_category, f = e.select_menu_current_category[i], "undefined" == typeof e.select_menu_current_page[i][f] && (e.select_menu_current_page[i][f] = 0), s.innerHTML = n[f].shortcut, k(), o(), w.sort_levels()
     }
 ...
 function gt(c) {
  ...
  function d() {
   ...
   function d(n) {
    t({
     file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (e.DEBUG ? "-beta" : "") + ".php?action=puzzle_pack_purchase&user_id=" + e.account.user_id + "&internal_access_token=" + e.account.internal_access_token + "&puzzle_pack_id=" + n.puzzle_pack_id,
     error: e.errormessage,
     request_method: "POST",
     async: !0,
     success: function(t) {
      e.account.gem_amount = t.gem_amount, e.account.users_to_puzzle_packs[n.puzzle_pack_id] = n.puzzle_pack_id;
   ...
   function m(i) {
    function n(l) {
     ...
     c.forEach(function(a) {
      var t = document.createElement("div");
      t.className = "jt-select_screen-selection-item jt-pack_preview_screen-selection-item", n.appendChild(t);
      var i = document.createElement("div");
 ...
 function yt(X) {
  function Kt() {
   if ("undefined" == typeof r.account.internal_access_token) return void(e.log_query_processed = !0);
  ...
  function Dt() {
   var s = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? o(Tt) : 0,
    c = o(u);
   ...
   var a = s + (r.jigsaw_minimal_ui ? 0 : o(f)),
    h = r.jigsaw_minimal_ui || null == H.parentNode ? 0 : o(H);
   if (u.style.height = "", r.jigsaw_minimal_ui) {
    e.area && e.area.forEach(function(e) {
     e.margin_top = 128
    });
    var n = o(u.parentNode)
   } else {
    e.area && e.area.forEach(function(e) {
     e.margin_top = 0
    });
    var n = o(u.parentNode) - a - h
   }
   u.style.top = a + "px", u.style.height = n + "px", H.style.top = parseFloat(u.style.top) + parseFloat(u.style.height) + "px", i.reposition_and_resize(), P(), "undefined" != typeof E && E.naturalHeight && (e.area && e.area.forEach(function(e) {
    e.height = n * e.height_ratio
   }), d.top = (n - E.height + (E.height - E.height)) / 2), et(), l.container.children.forEach(function(t) {
  ...
  function et() {
   ...
   if (0 == !!i.bg.refresh_bg && (i.bg.refresh_bg = !0, i.bg.width = "undefined" != typeof i.cached_width ? i.cached_width : i.width, i.bg.height = "undefined" != typeof i.cached_height ? i.cached_height : i.height, i.bg.getContext("2d").drawImage(i.bg.image, 0, 0, i.bg.image.naturalWidth, i.bg.image.naturalHeight, 0, 0, i.bg.width, i.bg.height), F({
     ...
     canvas: i.bg,
     position: 0
    }), P()), i.background_image_drawn = !0, "undefined" == typeof d) return void i.setTimeout(et, 50);
   ...
   var n = d.left,
    ...
    s = d.width,
    o = d.height,
    r = (e.piece_margin, d.base_image);
   (1 == r.style.opacity || e.jigsaw_show_hint_rect) && (t.fillStyle = "white", t.fillRect(n, a, s, o), (1 == r.style.opacity || e.jigsaw_show_hint_image) && (t.globalAlpha = r.style.opacity, t.drawImage(r, n, a, s, o), t.globalAlpha = 1)), F({
    parent: i.stage,
    logical_parent: i.bg,
    canvas: i.bg,
    position: 0
  ...
  function jt() {
   function n() {
    return 0 == !!i.first_render_complete || r.ad_control && !r.ad_control.ignore && r.ad_control.running || 0 == !!e.log_query_processed ? void u.inner.setTimeout(n, 50) : void Jt()
   }
   e.jigsaw_initial_show_hint_image = r.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, e.jigsaw_show_hint_image = r.jigsaw_show_hint_image, e.piece_margin = r.jigsaw_get_scaled_piece_margin(e), e.piece_margin_style = r.jigsaw_piece_margin_style, u.inner.appendChild(w);
   var t = d.composite_image = document.createElement("canvas");
   if (t.set_size = function() {
     t.width = (E.width + 2 * e.piece_margin) / e.piece_logical_scale, t.height = (E.height + 2 * e.piece_margin) / e.piece_logical_scale, t.cached_sprite_data = {
      width: d.width + 2 * e.piece_margin,
      height: d.height + 2 * e.piece_margin,
      x: d.left - e.piece_margin,
      y: d.top - e.piece_margin
     }
    }, oi(), rt = [], "undefined" == typeof localStorage["puzzle_states." + $ + "." + M + "." + z.selected_difficulty]) {
    dt();
    var a = Math.round(1e6 * Math.random());
    Math.seedrandom(a), l.add_category("General"), li({
     source_image: E,
     width: E.width,
     height: E.height,
     size_x: e.tile_x,
     ...
     draw_settings: T,
     callback: function(t) {
      B = t, ri(B, l.current_category.piece_container), I = Array.prototype.slice.call(l.current_category.piece_container.children), Et(I), it(l.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else Mt({
    callback: n
  ...
  function Jt() {
   function n() {
    r.jigsaw_minimal_ui ? f.show_title_animation({
     callback: R.resume
    }) : f.setTimeout(function() {
     f.autoshow_title({
      callback: R.resume
     })
    }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, w.addEventListener(r.events.POINT_START, Zt), document.addEventListener(r.events.POINT_MOVE, zt), r.is_phone_or_tablet ? (D({
     target: u.inner,
     result_function: Gt,
    ...
    }), w.addEventListener("touchend", q), w.addEventListener("touchcancel", q), w.addEventListener("touchleave", q), m.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", kt), window.addEventListener("mouseout", Nt), u.inner.addEventListener("mousewheel", Wt), u.inner.addEventListener("DOMMouseScroll", Wt))), f.setTimeout(function() {
   ...
   if (i.controls_locked = !1, i.loading_animation.stop(), "undefined" == typeof e.pending_message || "" == e.pending_message) n();
   else {
    var t = smoke.alert(e.pending_message, function() {
     e.pending_message_audio_post && (r.playAudio(r.audio_dir + "/" + e.pending_message_audio_post + ".ogg", {
      audio_type: "sound_effect",
      blocking: !1
     }), delete e.pending_message_audio_post), delete e.pending_message, n()
    });
    e.pending_message_audio_pre && (r.playAudio(r.audio_dir + "/" + e.pending_message_audio_pre + ".ogg", {
     audio_type: "sound_effect",
     blocking: !1
  ...
  function ri(l, c) {
   ...
   for (var t = 0, a = 0; a < e.tile_x; a++)
    for (var s = 0; s < e.tile_y; s++) n[i[t]] = l[a][s], t += 1;
   ...
   if (0 != s.length)
    for (var u = 0, i = 0, g = e.area.length; g > i; i++) {
     ...
     for (var r = 0; d > r; r++) {
      ...
      for (var a = 0; p > a; a++) {
       var t = c[i][r][a] = s[u];
       if ((1 == o || "undefined" != typeof c[i][r][a]) && !(1 == o && "undefined" != typeof c[i][r][a] || t.puzzle_width.length > 1 || (t.area = i, t.row = r, t.column = a, t.left = f / 2 + a * f + n.left - t.calc_width / 2, t.top = _ + m / 2 + r * m + n.top - t.calc_height / 2, t.piece_matrix = c, u += 1, 1 != o || s.length != u))) return
      }
     }
    }
  }
  ...
  function ti() {
   if (at.reward_container) var t = at.reward_container;
   else var t = M;
  ...
  function ei(l) {
   var n = z.jigsaw.best_times[+e.jigsaw_initial_show_hint_image];
   "undefined" == typeof n[M] && (n[M] = {});
   var t = n[M][e.difficulty_level];
   "undefined" == typeof t && (t = 86400), t > l && (t = n[M][e.difficulty_level] = l);
   var i = K.difficulty_levels[e.difficulty_level].point_cutoffs_visible;
   0 == e.jigsaw_initial_show_hint_image && (i *= K.difficulty_levels[e.difficulty_level].point_cutoffs_hidden_multiplier);
   for (var a = i.length; a >= 0; a--) {
    var c = Math.round(i[a] * e.get_piece_count());
    if (c >= l) break
   }
   var r = a + 1,
    h = r == i.length ? -1 : Math.round(i[r] * e.get_piece_count()),
    s = z.jigsaw.ranks;
   "undefined" == typeof s[M] && (s[M] = {});
   var o = s[M][e.difficulty_level];
   return "undefined" == typeof o && (o = -1), r > o && (o = s[M][e.difficulty_level] = r), {
    best_time: t,
    rank_count: r,
    next_rank_point: h
   }
  ...
  function Qt(t) {
   ...
   var n = (e.piece_margin, l.current_category.piece_container.children);
   ...
   }), bt(), u.inner.setTimeout(wt, 800), u.inner.setTimeout(function() {
    qt({
     callback: t.callback
    })
  ...
  function ct(l) {
   ...
   function w() {
    ...
    n.className = "jt-play-trophy_reward-trophy_name", n.style.color = "undefined" != typeof t.text_color ? t.text_color : t.background_color, s.appendChild(n);
    var d = t.display_name.substr(t.display_name.length - 1);
    if (n.innerHTML = t.display_name.capitalizeFirstLetter() + ("!" == d || "." == d ? "" : "."), "undefined" != typeof t.text_outline_color) {
   ...
   function g() {
    var e = K.rank[K.difficulty_levels[z.selected_difficulty].name];
    r.playAudio(r.get_set_directory(Q) + "/audio/" + e.rank_audio[n] + ".m4a", {
     audio_type: "music",
     element: u.inner,
     restart: !0
    });
    ...
    h(s), s.dialog.buttons.ok.addEventListener(r.events.POINT, function() {
     n >= 1 && (!window.kiipInstance || r.account && r.account.purchased_ad_removal || window.kiipInstance.postMoment("rank_count: " + n + ", selected_difficulty: " + z.selected_difficulty)), i.fireworks = new xt({
      gs: r,
      draw_area: i
     })
    });
    ...
    t.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + R.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + b + "</span> seconds.</p>", t.innerHTML += 0 == n ? '<p> No <span class="jt-play-show_rank-text-bright">' + c + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + T[n] + "</span> " + c + ".</p>";
    var o = document.createElement("div");
    o.className = "jt-play-show_rank-image-container";
    for (var l = 0; n > l; l++) {
     var a = document.createElement("div");
     a.className = "jt-play-show_rank-image-item", o.appendChild(a), a.style.opacity = .01, a.style.backgroundImage = 'url("' + r.get_set_directory(Q) + "/gui/" + e.filename + '")', void
     function(t, i) {
      u.inner.setTimeout(function() {
       TweenMax.to(t, 2, {
        parseTransform: !0,
        ...
        t.addEventListener(r.events.POINT, function() {
         "undefined" != typeof e.click_audio && r.playAudio(r.get_set_directory(Q) + "/audio/" + e.click_audio + ".ogg", {
          element: u.inner,
          audio_type: "music"
         })
        })
   ...
   var l = l || {};
   localStorage.removeItem("puzzle_states." + $ + "." + M + "." + z.selected_difficulty);
   var c = l.user_gave_up || !1;
   r.ambient_music.last_on_state = r.ambient_music_on, r.ambient_music_on = !1;
   var _ = _t[Math.floor(Math.random() * _t.length)];
   if (0 == c) {
   ...
   if (c || u.inner.setTimeout(function() {
     i.controls_locked = !1
    }, s), 1 != c) {
    var a = ti(),
     t = a.trophy_item,
    ...
    localStorage.player_data = JSON.stringify(z), 0 == c ? u.inner.setTimeout(f, s + (l.show_trophy_delay || 550)) : u.inner.setTimeout(f, s + (l.show_trophy_delay || 550))
   }
  }
  ...
  function qt(e) {
   ...
   if (P(), d.children.forEach(function(e) {
     e.side_set && (d.removeChild(e), O(e))
    }), l.container.children.forEach(function(e) {
     l.remove_category(e)
    }), d.base_image.style.opacity = 1, O(d.composite_image), et(), e.hide_controls) {
    var t = r.use_categories;
    r.use_categories = !1, f.autoshow_title(), r.use_categories = t, At.morph_to_back_button()
   }
  ...
  function Ht(t, n) {
   ...
   var a = c(n, u.inner),
    o = a[0],
    h = a[1];
   t.left = (o / m.desired_scale - e.zoom.offset_x) / e.zoom.scale + (r.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (h / m.desired_scale - e.zoom.offset_y) / e.zoom.scale + (r.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), P();
   ...
   "undefined" != typeof s && Vt(s)
  }

  function Vt(t, n) {
   if (null != s && (!n || s.last_border_color_x != s.left || s.last_border_color_y != s.top) && (s.last_border_color_x = s.left, s.last_border_color_y = s.top, u.inner.setTimeout(function() {
     Vt(t, n)
  ...
  function Zt(t) {
   if (t.preventDefault(), !i.controls_locked) {
    ...
    if (!V(t)) {
     var d = c(t, u.inner),
      f = (d[0] / m.desired_scale - e.zoom.offset_x) / e.zoom.scale,
      p = (d[1] / m.desired_scale - e.zoom.offset_y) / e.zoom.scale,
      h = [],
     ...
     if (y)
      for (var _ = y.piece_container, o = 0, g = _.children.length; g > o; o++) {
       ...
       if (!n.placed && !(f < n.left || p < n.top || f > n.left + n.calc_width || p > n.top + n.calc_height)) {
        var b = ((f - n.left) / r.jigsaw_piece_scale_to_actual + e.piece_margin) / e.piece_logical_scale,
         T = ((p - n.top) / r.jigsaw_piece_scale_to_actual + e.piece_margin) / e.piece_logical_scale,
     ...
     P(), r.playAudio(r.audio_dir + "/global-pick up.ogg", {
      audio_type: "sound_effect",
      blocking: !1
     });
     ...
     if (O(a), F({
       ...
       canvas: a.canvas,
       is_2d: !0
      }), s = a, s.touch_id = t.identifier, s.pickup_left = s.left, s.pickup_top = s.top, s.calc_width = s.width_float, s.calc_height = s.height_float, i.piece_sprite_container.removeChild(a.sprite), i.stage.addChild(a.sprite), 0 == r.jigsaw_center_piece_on_move) {
      var d = c(t, u.inner),
       f = d[0],
       p = d[1];
     ...
     document.body.style.cursor = "pointer", a.visibility = "hidden", s.visibility = "visible", Ht(s, t)
    }
   }
  }
   ...
   if (null != w) {
    ...
    if (null != s) {
     ...
     if (k.forEach(function(e) {
       if (e != a)
        for (var h = e.virtual_left - e.width_float * c / 2 - e.puzzle_left_min * c, d = e.virtual_top - e.height_float * c / 2 - e.puzzle_top_min * c, r = Math.abs(h - M), s = Math.abs(d - R), t = 0, l = a.puzzle_width.length; l > t; t++)
      ...
      var a = s,
       n = n.concat([a]),
       p = d.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale,
       _ = 0,
       u = d.composite_image.height - 2 * e.piece_margin / e.piece_logical_scale,
       m = 0;
      n.forEach(function(e) {
      ...
      var t = ft();
      return t.className = "jt-jigsaw-piece_deck-piece", t.piece_id = a.piece_id, t.x = [], t.y = [], t.puzzle_width = [], t.puzzle_height = [], t.puzzle_left = [], t.puzzle_top = [], t.puzzle_left_min = p, t.puzzle_top_min = u, t.side_set = ot(n, !0), t.shape_string = J(ot(n, r.jigsaw_combine_pieces), [-p, -u]), t.dummy_canvas = document.createElement("canvas"), t.path = new Path2D(t.shape_string), I.push(t), a.parentNode.appendChild(t), t.width_float = Math.round(1e3 * (_ - p)) / 1e3, t.height_float = Math.round(1e3 * (m - u)) / 1e3, t.width = Math.ceil((t.width_float + 2 * e.piece_margin) / e.piece_logical_scale), t.height = Math.ceil((t.height_float + 2 * e.piece_margin) / e.piece_logical_scale), n.forEach(function(e) {
       e.parentNode.removeChild(e)
      }), n.forEach(function(e) {
       O(e), I.splice(I.indexOf(e), 1), e.x.forEach(function(r, i) {
        B[e.x[i]][e.y[i]] = t
      ...
      }), t.calc_width = t.width_float * r.jigsaw_piece_scale_to_actual, t.calc_height = t.height_float * r.jigsaw_piece_scale_to_actual, t.left = (t.puzzle_left_min - n[0].puzzle_left_min) * r.jigsaw_piece_scale_to_actual + n[0].left, t.top = (t.puzzle_top_min - n[0].puzzle_top_min) * r.jigsaw_piece_scale_to_actual + n[0].top, t.x.length == e.tile_x * e.tile_y && (i.single_piece_left = t, ct()), ut(t), O(s), s = null, gt(), i.refresh_piece_styling = !0, void W()
     }
     if (y)
      for (var f = s, b = !1, T = s.calc_width / r.jigsaw_required_precision, E = s.calc_height / r.jigsaw_required_precision, C = s.left - d.left, S = s.top - d.top;;) {
     ...
     if (ut(s), F({
      ...
      var D = h.puzzle_left_min + d.left,
       j = h.puzzle_top_min + d.top;
  ...
  function Ft(n) {
   e.pieces_in_position_count += n.x.length, n.parentNode.removeChild(n), document.body.style.cursor = "", n.placed = !0;
   for (var f = n.x, o = 0; o < f.length; o++) {
    var l = n.x[o],
     c = n.y[o];
    B[l][c] = It(n), rt.push(B[l][c])
   }
   var t = d.composite_image,
    _ = ot(rt, r.jigsaw_combine_pieces),
    h = J(_, [0, 0]),
    a = t.getContext("2d");
   a.globalCompositeOperation = "copy", a.save(), g({
    x: e.piece_margin,
    y: e.piece_margin,
   ...
   var u = (d.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale) * e.piece_logical_scale / d.base_image.naturalWidth;
   a.drawImage(d.base_image, 0, 0, t.width * e.piece_logical_scale / u, t.height * e.piece_logical_scale / u, 0, 0, t.width, t.height), a.restore(), a.save(), a.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && p({
    canvas: t,
    draw_settings: T,
    ...
    game_instance: e
   }), ht(t), a.restore(), t.texture ? Pt(t) : F({
    parent: i.stage,
    canvas: t,
    position: 1,
    is_2d: !0
   }), t.sprite.x = d.left - e.piece_margin, t.sprite.y = d.top - e.piece_margin, O(n), n == s && (s = null), gt(), W(), Ut() && ct()
  }

  function kt(e) {
   if (null != s) {
    if (P(), "undefined" == typeof e && (e = {}), document.body.style.cursor = "", e.is_transferred_to_different_category || i.piece_sprite_container.addChild(s.sprite), s.visibility = "visible", !r.freestyle_mode || e.is_transferred_to_different_category) s.left = s.pickup_left, s.top = s.pickup_top;
    else {
     ...
     if (s.virtual_top - .25 * s.calc_height < 0) s.virtual_top = .25 * s.calc_height;
      ...
      var n = parseFloat(window.getComputedStyle(u.inner).height);
      s.virtual_top + .25 * s.calc_height > n && (s.virtual_top = n - .25 * s.calc_height)
     }
    }
    delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, ut(s), F({
     logical_parent: s,
     canvas: s.canvas
    }), s.calc_width = s.width_float * r.jigsaw_piece_scale_to_actual, s.calc_height = s.height_float * r.jigsaw_piece_scale_to_actual, s = null, l.item_under_mouse = null, gt(), W()
   }
  }
  ...
  function li(b) {
   ...
   for (var h = (b.success || function() {}, b.source_image), m = b.size_x, v = b.size_y, N = b.width, B = b.height, z = b.draw_settings, y = [], A = pt(), G = 100 / m, W = 100 / v, n = 0; m >= n; n++) {
    y[n] = [];
    for (var i = 0; v >= i; i++) {
     var et = 0 == n || n == m ? 0 : .25 * Math.randBMT(),
   ...
   for (vh = 0; 2 > vh; vh++) {
    ...
    for (var n = 0; m + vh > n; n++) {
     ...
     for (var i = 0; v + (1 - vh) > i; i++) {
      ...
      if ((0 == i || i == v + 1 - vh - 1) && 0 == vh || (0 == n || n == m + vh - 1) && 1 == vh) t = [t[0], t[t.length - 1]];
      else {
      ...
      for (var s = 0, c = t.length; c > s; s++) {
       ...
       t[s][0] = t[s][0] / 300 * G + y[n][i][0], t[s][1] = t[s][1] / 300 * W + y[n][i][1]
      }
      var c = t.length;
      t[c - 1] = 0 == vh ? [y[n + 1][i][0], y[n + 1][i][1]] : [y[n][i + 1][0], y[n][i + 1][1]];
      for (var s = 0; c > s; s++) t[s][0] = t[s][0].toFixed(4), t[s][1] = t[s][1].toFixed(4);
      for (var j = new Array(c), s = 0; c > s; s++) j[s] = [t[s][0] / 100 * N, t[s][1] / 100 * B];
      if (_[vh][n][i] = j, j.length > 2 && i > 0 && n > 0 && vh > 0) {
       var t = _[vh][n][i];
       ...
       if (0 == vh) {
        if (g(vh, n, i, 1 - vh, n, i) && Math.random() > .01) {
         i -= 1;
         continue
        }
        if (i > 0 && g(vh, n, i, 1 - vh, n, i - 1) && Math.random() > .01) {
         i -= 1;
         continue
        }
        if (i > 0 && m - 1 > n && g(vh, n, i, 1 - vh, n + 1, i - 1) && Math.random() > .01) {
         i -= 1;
         continue
        }
        if (m - 1 > n && g(vh, n, i, 1 - vh, n + 1, i) && Math.random() > .01) {
         i -= 1;
         continue
        }
       } else {
        ...
        if (n > 0 && g(vh, n, i, 1 - vh, n - 1, i) && Math.random() > .01) {
         i -= 1;
         continue
        }
        if (n > 0 && v - 1 > i && g(vh, n, i, 1 - vh, n - 1, i + 1) && Math.random() > .01) {
         i -= 1;
         continue
        }
        if (v - 1 > i && g(vh, n, i, 1 - vh, n, i + 1) && Math.random() > .01) {
         i -= 1;
         continue
        }
       }
   ...
   for (var D = [], V = "", H = 0, n = 0; m > n; n++) {
    ...
    for (var i = 0; v > i; i++) {
     for (var w = [], C = [], E = "", S = "", o = {
       ...
       x1: 0,
       y1: 0
      }, d = (_[0][n][i][0][0], _[0][n][i][0][1], []), u = 0; 4 > u; u++) {
      var L = 0,
       t = _[u % 2 == 0 ? 1 : 0][n + (2 == u ? 1 : 0)][i + (3 == u ? 1 : 0)],
       c = t.length;
      if (2 >= c) var o = {
     ...
     var Y = a(o),
      ...
      l = ft();
     l.x = [n], l.y = [i], l.piece_id = H, l.width = Math.ceil(F + 2 * e.piece_margin) / e.piece_logical_scale, l.height = Math.ceil(U + 2 * e.piece_margin) / e.piece_logical_scale, l.width_float = F, l.height_float = U, l.puzzle_width = [F], l.puzzle_height = [U], l.puzzle_left_min = Y.x0, l.puzzle_top_min = Y.y0, l.puzzle_left = [o.x0], l.puzzle_top = [o.y0], l.side_set = [w], l.placed = !1, D[n][i] = l, H += 1
    }
   }
   ...
   var P = h.naturalWidth / h.width,
    ...
    rt = P * h.height <= h.naturalHeight ? P * h.height : h.naturalHeight;
   I.drawImage(h, 0, 0, it, rt, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, h.width / e.piece_logical_scale, h.height / e.piece_logical_scale), I.save(), I.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && p({
    canvas: M,
    draw_settings: z,
  ...
  function Ot(t) {
   function d() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, O(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), mt(e, p), F({
       canvas: e.canvas,
       logical_parent: e
      }), 0 == m && i.piece_sprite_container.removeChild(e.sprite), 1 == n && (e.zIndex = l)
     }
     if (l += 1, r += 1, r == o && (r = 0, c += 1), c == h) break
    }
    l != h * o ? (i.refresh_piece_styling = !0, timeout = u.inner.setTimeout(d, 20)) : (lt = void 0, void
     function() {
      for (var r = {}, l = 0; h > l; l++)
       for (var c = 0; o > c; c++) {
        var e = s[l][c];
        0 == n && e.placed || (e.parentNode == i.piece_container || null == e.parentNode) && (r[e.zIndex] = e)
       }
      for (var u = a(i.piece_sprite_container.children), t = 0, d = u.length; d > t; t++) i.piece_sprite_container.removeChild(u[t]);
      for (var t in r) i.piece_sprite_container.addChild(r[t].sprite);
   ...
   var s = t.piece_grid,
    ...
    c = 0,
    r = 0;
   "undefined" != typeof lt && clearTimeout(lt), lt = void 0, d()
  }
  ...
  function ht(n, i, a) {
   ...
   if ("undefined" != typeof r) {
    ...
    t.lineJoin = "round", t.lineCap = "round", t.lineWidth = e.piece_margin / e.jigsaw_scale_low_power_sizer * T.border_scale, "clear" == i ? (t.strokeStyle = "rgba(0,0,0,1)", t.globalCompositeOperation = "destination-out", t.stroke(), t.globalCompositeOperation = "source-in") : (t.strokeStyle = r, t.stroke())
   }
  }
  ...
  function ot(b, w) {
   ...
   for (var x = [
    ...
    l[i] = [];
    for (var r = -1; r < e.tile_y + 2; r++) l[i][r] = [0, 0, 0, 0]
   }
   for (var i = -1; i < e.tile_x + 1; i++) {
    c[i] = [];
    for (var r = -1; r < e.tile_y + 1; r++) c[i][r] = void 0
   }
   b.forEach(function(e) {
   ...
   for (var v = [], i = 0; i < e.tile_x; i++)
    for (var r = 0; r < e.tile_y; r++)
     if (c[i][r])
      for (var p = 0; 4 > p; p++)
       if (!l[i][r][p]) {
        for (var g = [], t = p, m = 0, y = !1, a = i, n = r;;) {
         var o = a + x[t][0],
          s = n + x[t][1];
         if (l[a][n][t] = 1, l[o][s][(t + 2) % 4] = 1, c[o][s]) {
          if (3 == m) break;
          m += 1, t = (t + 3) % 4, a = o, n = s
         } else {
          if (0 == y) {
           ...
           var h = a,
            u = n;
           o > a && (h += 1, 2 == t && (u += 1)), s > n && (u += 1, 1 == t && (h += 1)), a > o && 2 == t && (u += 1), n > s && 1 == t && (h += 1);
           var f = h,
            _ = u
          } else {
           var f = a,
            _ = n;
           if (o > a && (f += 1, 2 == t && (_ += 1)), s > n && (_ += 1, 1 == t && (f += 1)), a > o && 2 == t && (_ += 1), n > s && 1 == t && (f += 1), h == f && u == _) break
          }
          g.push([a, n, t]), l[a][n][t] = 1, l[o][s][(t + 2) % 4] = 1, t = (t + 1) % 4, m = 0
         }
        }
        g.length > 0 && v.push(g)
       }
  ...
  function F(t) {
   ...
   if (e.sprite && "undefined" == typeof t.position && -1 != n.children.indexOf(e.sprite) && (o -= 1), (e.canvas || e == r) && O(e), c && r != e ? (r.texture = new PIXI.Texture.fromCanvas(r), e.texture = r.texture, delete r.texture) : e.texture = new PIXI.Texture.fromCanvas(r), e.sprite = new PIXI.Sprite(e.texture), e.sprite.logical_parent = e, e.canvas = e.texture.baseTexture.source, "undefined" != typeof s)
    for (var l in s) e.sprite[l] = s[l];
   return n.addChildAt(e.sprite, o), P(), "undefined" != typeof n && n == i.piece_sprite_container && 1 == a && (n.is_cached = !1), e
  }

  function O(e, r) {
   if ("undefined" == typeof r && (r = !1), "undefined" != typeof e && e.texture) {
    var t = e.sprite.parent;
    "undefined" != typeof t && e.sprite.parent.removeChild(e.sprite), e.texture.destroy(!0), e.texture = null, e.sprite = null, "undefined" != typeof t && t == i.piece_sprite_container && 1 == r && (t.is_cached = !1), P()
   }
  }
  ...
  function mt(t, c, n) {
   ...
   r.save(), g({
    ...
    lineWidth: 0,
    canvas: i
   }), r.clip(), t.dummy_canvas = document.createElement("canvas");
   var m = J(t.side_set, [-t.puzzle_left_min + a + o, -t.puzzle_top_min + a + o], 1 / s);
   if (t.path = new Path2D(m), c instanceof HTMLImageElement) {
    var l = (d.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale) * e.piece_logical_scale / d.base_image.naturalWidth,
     h = i.width * s / l,
     u = i.height * s / l;
    h > r.width && (h = r.width), u > r.height && (u = r.height), r.drawImage(c, t.puzzle_left_min / l, t.puzzle_top_min / l, h, u, 0, 0, i.width, i.height)
   } else r.drawImage(c, (t.puzzle_left_min + a) / s, (t.puzzle_top_min + a) / s, i.width, i.height, 0, 0, i.width, i.height);
   r.restore(), _ && (r.save(), r.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), p({
    canvas: i,
    draw_settings: T,
    stroke_width: T.stroke_width,
    cut_multiplier: T.cut_multiplier,
    ...
    clear_stroke: !f,
    game_instance: e
   }), r.restore()), f && (r.save(), ht(i, y), r.restore())
  }

  function ut(t) {
   O(t), t.canvas = document.createElement("canvas"), mt({
    element: t,
    parent: d.base_image,
  ...
  var m = X.content_div,
   ...
   M = X.level_id;
  m.innerHTML = "";
  var K = C.game_data.jigsaw,
   di = C.game_data.trophy_list,
   z = C.player_data,
   at = C.game_data.entry_list[M],
   Q = C.set_name,
   $ = r.game_type,
   y = {},
   T = {},
   e = y.game_instance = {},
   Z = K.difficulty_levels[z.selected_difficulty];
  e.difficulty_level = z.selected_difficulty, e.get_piece_count = function() {
   return e.tile_x * e.tile_y
  }, e.intro_audio_count = 0, !r.is_kiosk && r.use_social_media_buttons && tt();
  var _t = ["answer-correct-10865990.ogg", "answer-correct-23303730.ogg", "answer-correct-25513672.ogg", "answer-correct-25513693.ogg", "answer-correct-37240671.ogg", "answer-correct-37240686.ogg", "answer-correct-37241588.ogg", "answer-correct-37241627.ogg"],
   ai = ["global-pick up.ogg", "global-put down.ogg", "answer-give up.ogg", "fireworks-1.ogg", "fireworks-2.ogg", "fireworks-3.ogg", "fireworks-4.ogg"].concat(_t);
  Y({
   parent: r,
   dir: r.audio_dir + "/",
   audio_list: ai,
  ...
  if (e.force_screen_refresh = 0, ui(), void
   function() {
    var i, t = {},
     r = void 0,
     n = void 0;
     ...
     set: function(e) {
      if ("undefined" != typeof u) {
       if (e > 0) e = 0;
        ...
        var n = parseFloat(window.getComputedStyle(u).width),
         t = (1 - i) * n;
        t > e && (e = t)
       }
     ...
     set: function(e) {
      if ("undefined" != typeof u) {
       if (e > 0) e = 0;
        ...
        var r = parseFloat(window.getComputedStyle(u).height),
         t = (1 - i) * r;
        t > e && (e = t)
       }
   ...
   }(), m.style.overflow = "hidden", n(m), y.menu_item_list = [C.menu.generic.about, C.menu.generic.ogle_trophies, {
    text: "Restart",
    ...
    action: function(t, e) {
     return i.controls_locked ? void smoke.alert("The game hasn't even started yet!", e) : (it(l.current_category.piece_container), W(), void y.help_menu_obj.close())
    }
   ...
   var St = y.social_sharing_button_container = document.createElement("div");
   St.className = "jt-play-social_sharing_button_container", m.appendChild(St), A({
    parent: St,
    button_class: "jt-social_button_small"
   })
  }
  var Tt = y.trophy_ribbon = ii({
    parent: m
   }),
   f = y.game_title = document.createElement("div");
  f.className = "jt-play-title", f.hidden_top_value = "-155%", n(f);
  var H = y.bottom_bar = document.createElement("div");
  H.className = "jt-play-bottom_bar jt-play-main_image_border_width", n(H), m.appendChild(f), f.hide_title = function(e) {
   var e = e || {};
   "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), r.jigsaw_minimal_ui && (e.duration = 0), l.style.display = "", 0 == e.duration ? (f.inner.style.top = f.hidden_top_value, l.style.top = 0, f.inner.style.display = "none", e.callback()) : (TweenMax.to(l, e.duration / 1e3, {
    parseTransform: !0,
    ease: Linear.ease,
    css: {
     top: 0
   ...
   var e = e || {};
   "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), r.jigsaw_minimal_ui && (e.duration = 0), f.inner.style.display = "", 0 == e.duration ? (l.style.top = f.hidden_top_value, f.inner.style.top = 0, l.style.display = "none", e.callback()) : (TweenMax.to(f.inner, e.duration / 1e3, {
    parseTransform: !0,
    ease: Linear.ease,
    css: {
     top: 0
   ...
   f[r.use_categories ? "hide_title" : "show_title"](e)
  ...
  l.className = "jt-jigsaw-category_deck", l.item_under_mouse = null, f.appendChild(l), l.edit_button = document.createElement("img"), l.edit_button.className = "jt-op_button jt-op_button-edit" + (r.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), l.edit_button.src = r["/"] + "images/gui/gui-item_edit.png", l.appendChild(l.edit_button), l.add_button = document.createElement("img"), l.add_button.className = "jt-op_button jt-op_button-add" + (r.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), l.add_button.src = r["/"] + "images/gui/gui-item_expand_or_add.png", l.appendChild(l.add_button), l.basket_button = document.createElement("img"), l.basket_button.className = "jt-op_button jt-op_button-basket" + (r.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), l.basket_button.piece_list = [], l.basket_button.is_selected = !1, l.basket_button.src = r["/"] + "images/gui/gui-basket.png", l.appendChild(l.basket_button), l.remove_button = document.createElement("img"), l.remove_button.className = "jt-op_button jt-op_button-remove" + (r.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), l.remove_button.src = r["/"] + "images/gui/gui-item_remove.png", l.appendChild(l.remove_button), l.container = document.createElement("div"), l.container.className = "jt-jigsaw-category_deck-container", l.appendChild(l.container), l.add_category = function(s) {
   ...
   i.className = "jt-jigsaw-piece_container", Rt(i);
   K.difficulty_levels[e.difficulty_level];
   i.piece_matrix = [];
   for (var n = 0, o = e.area.length; o > n; n++) {
    var c = e.area[n];
    i.piece_matrix[n] = [];
    for (var a = 0; a < c.piece_row_max; a++) i.piece_matrix[n][a] = []
   }
   return "undefined" == typeof l.current_category && (l.select_category(t), l.original_category = t), t.addEventListener(r.events.POINT, function(e) {
   ...
   t.parentNode && t.parentNode.removeChild(t), l.original_category && (e != l.original_category ? it(l.original_category.piece_container, i) : delete l.original_category), 1 == l.container.children.length && delete l.current_category, l.container.removeChild(e)
   ...
   if ("undefined" != typeof t)
    for (var r = 0, a = t.length; a > r; r++) {
     ...
     if ("undefined" != typeof e && null != e)
      if (n.parentNode != l.current_category.piece_container && n.parentNode != d) {
  ...
  }), l.add_button.addEventListener(r.events.POINT, Lt);
  var N = l.basket_button;
  N.addEventListener(r.events.POINT, function(t) {
   var e = t.currentTarget,
    n = 0 == e.piece_list.length;
   e.classList[e.is_selected ? "remove" : "add"]("jt-op_button-basket" + (r.is_phone_or_tablet ? "-colored" : "") + "-selected"), e.is_selected && !n && Lt({
    error: function() {
     e.piece_list = []
    },
    complete: function() {
    ...
    success: function(t) {
     ...
     }), it(t.piece_container), e.piece_list = [], W()
    }
   ...
   O(e), e.canvas = document.createElement("canvas"), mt({
    element: e,
    parent: d.base_image,
    use_3d_effect: r.jigsaw_use_3d_effect,
    render_stroke: !0,
  ...
  y.timer_obj.style.display = r.show_timer ? "" : "none", n(R), y.refresh_gui_display = function() {
   var e = y.trophy_ribbon;
   e.style.display = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? "" : "none", r.jigsaw_minimal_ui ? (u.style.borderWidth = 0, f.classList.add("minimal_ui"), f.classList.add("jt-play-title-minimal_ui"), f.inner.classList.add("jt-play-title-inner-minimal_ui"), m.classList.add("jt-play-action_area-minimal_ui"), y.menu_button_obj.classList.add("jt-play-menu_button-minimal_ui"), y.timer_obj.classList.add("jt-play-timer-minimal_ui"), y.menu_button_obj.setAttribute("current_text", "M"), m.appendChild(y.timer_obj), m.appendChild(y.menu_button_obj), m.appendChild(f), H.parentNode == m && m.removeChild(H)) : (u.style.borderWidth = "", f.classList.remove("jt-play-title-minimal_ui"), f.inner.classList.remove("jt-play-title-inner-minimal_ui"), u.classList.remove("jt-play-action_area-minimal_ui"), y.menu_button_obj.classList.remove("jt-play-menu_button-minimal_ui"), y.timer_obj.classList.remove("jt-play-timer-minimal_ui"), m.insertBefore(f, u), m.insertBefore(H, u.nextSibling), f.insertBefore(y.timer_obj, f.childNodes[0]), f.appendChild(y.menu_button_obj)), Dt()
  };
  var Xt = y.help_menu_obj = S({
    gs: r,
    parent: m,
    current_game: y,
  ...
  at.use_image_title ? G({
   image_src: r.get_set_directory(Q) + "/puzzle/" + M + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  }) : (f.inner = document.createElement("div"), f.inner.className = "jt-play-title-inner", f.appendChild(f.inner), f.inner.text = document.createElement("p"), f.inner.text.innerHTML = at.name, f.inner.appendChild(f.inner.text), L(f.inner.text, {
   unit_type: "px",
   transform_scale: m.content_scale
  }));
  var u = document.createElement("div");
  u.className = "jt-play-action_area", u.style.overflow = "hidden", m.appendChild(u), r.is_phone_or_tablet || u.addEventListener("mousedown", function(e) {
   e.preventDefault()
  }), u.inner = document.createElement("div"), u.inner.style.position = "absolute", u.inner.style.width = "100%", u.inner.style.height = "100%", u.inner.style.transformOrigin = "0 0", u.appendChild(u.inner), e.zoom = {
   scale: 1,
   offset_x: 0,
   offset_y: 0
  };
  ...
  var $t = new PIXI[1 == r.is_webgl ? "WebGLRenderer" : "CanvasRenderer"](1, 1, {
   transparent: !0,
   clearBeforeRender: !1,
   view: i
  });
  i.renderer = $t, i.stage = yt, i.piece_sprite_container = Yt, i.real_stage = st, st.addChild(yt), yt.addChild(Yt), i.load_opacity_transition = .5, i.style.pointerEvents = "none", i.bg = document.createElement("canvas"), i.bg.image = new Image, i.bg.image.src = C.background_image_url, i.reposition_and_resize = function() {
   var t = U(m),
    n = o(m),
    e = m.content_scale,
  ...
  function() {
   switch (e.jigsaw_scale_low_power_sizer = e.difficulty_level >= r.jigsaw_reduce_texture_size ? 2 : 1, e.difficulty_level) {
    case 0:
  ...
  var d = y.main_image = document.createElement("div");
  d.className = "jt-play-main_image jt-jigsaw-main_image", n(d), Rt(d), d.classList.add("jt-jigsaw-main_image-active");
  var E = d.base_image = document.createElement("img"),
   w = document.createElement("div");
  w.className = "jt-jigsaw-piece_deck";
  var B, I, rt, s = null;
  E.crossOrigin = "Anonymous", r.get_image(E, Q, M, "default"), E.addEventListener("load", function() {
   null != u && u.inner.setTimeout(jt, 30)
  });
  var _ = new Image;
  _.src = r.get_set_directory(C.set_name) + "/gui/gui-loading.png", _.logical_parent = i, i.loading_animation = _, _.defer_start = function(e) {
   ...
   1 != !!_.game_initialized && (_.stage.alpha = 1, _.display = !0, st.addChild(_.stage), P())
  }, _.stop = function() {
   _.stage && (_.stage.alpha = 1), _.game_initialized = !0, _.display && (_.display = !1, st.removeChild(_.stage)), P()
  ...
  var dt = y.set_base_image_size = function() {
    var t = si();
    E.width = t.width, E.height = t.height, 2 == r.jigsaw_arrange_pieces_on_entire_area && E.naturalHeight <= E.naturalWidth && (e.jigsaw_arrange_pieces_on_entire_area = !0), void
    function() {
     var r = Math.round(E.naturalWidth / E.naturalHeight * 1e3) / 1e3;
     switch (e.tile_x = Z.tile_x, e.tile_y = Z.tile_y, r) {
      case .8:
     ...
     var i = e.tile_x * e.tile_y / Z.piece_column_max / 2;
     e.area = [{
      top: 0,
      height_ratio: 1,
      piece_row_max: i,
      piece_column_max: Z.piece_column_max
     }, {
      top: 0,
      height_ratio: 1,
      piece_row_max: i,
    ...
    }(), Dt(), d.left = (parseFloat(window.getComputedStyle(m).width) - E.width) / 2, d.width = E.width, d.height = E.height;
    var i = d.composite_image;
    i.set_size()
   },
   Et = y.size_pieces = function(e) {
    e.forEach(function(e) {
     e.calc_width = e.width_float * r.jigsaw_piece_scale_to_actual, e.calc_height = e.height_float * r.jigsaw_piece_scale_to_actual
    }), i.piece_sprite_container.is_cached = !1
   };
  m.cleanup = function() {
   if (r.IS_CORDOVA && r.audio_container[C.last_intro_audio] && (r.audio_container[C.last_intro_audio].src = "", delete r.audio_container[C.last_intro_audio], C.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), hi(), null != i.parentNode && document.body.removeChild(i), R.destroy(), document.removeEventListener(r.events.POINT_MOVE, zt), r.is_phone_or_tablet ? m.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", kt), window.removeEventListener("mouseout", Nt)), m.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof B)
    for (var t = 0; t < e.tile_x + 1; t++) {
     B[t] = [];
     for (var n = 0; n < e.tile_y + 1; n++) B[t][n] = void 0
    }
   ...
   }), i.piece_container.children = [], delete i.piece_container.piece_matrix, delete i.piece_container), O(d.base_image), O(i.bg), _.inner && O(_.inner), _.outer && O(_.outer), O(d.composite_image), i.stage.removeChild(i.piece_sprite_container), i.real_stage.removeChild(i.stage), i.real_stage.interactionManager.removeEvents(), i.renderer.destroy && i.renderer.destroy(), d.composite_image && (delete d.composite_image.set_size, delete d.composite_image), delete m.draw_area, delete _.logical_parent;
   for (var a in i) delete i[a];
   C = null, r = null, M = null, K = null, di = null, z = null, at = null, Q = null, $ = null, y = null, T = null, e = null, Z = null, P = null, Tt = null, f = null, l = null, N = null, R = null, Xt = null, At = null, u = null, i = null, d = null, E = null, w = null, s = null, B = null, I = null, _ = null, dt = null, Et = null, W = null, Mt = null, delete m.cleanup
   ...
   if (0 != w.drag_active) {
    var t = c(s, u),
     ...
     r = t[1] / m.content_scale,
     l = e.zoom.scale,
     n = e.zoom.offset_x,
     a = e.zoom.offset_y;
    o || (n += i - w.drag_initial_x, a += r - w.drag_initial_y), e.zoom.offset_x = n, e.zoom.offset_y = a, w.drag_initial_x = i, w.drag_initial_y = r, w.drag_initial_scale = l
   }
  }, w.drag_end = function() {
  ...
  var lt = void 0,
   W = y.save_puzzle_state = function() {
    ...
    i[$ + "." + M + "." + z.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + $ + "." + M + "." + z.selected_difficulty] = JSON.stringify(t)
   },
   Mt = y.load_puzzle_state = function(s) {
    function o() {
     var e = {};
     ...
     r.forEach(function(t) {
      var r = l.add_category(t.innerHTML),
       n = t.pieces,
       a = r.piece_container;
      n.forEach(function(t) {
       var i = e[t.piece_id];
       a.appendChild(i)
      }), t.innerHTML == i && l.select_category(r), Et(r.piece_container.children)
     }), Ut() && ct(), s.callback()
    }
    var t = JSON.parse(localStorage["puzzle_states." + $ + "." + M + "." + z.selected_difficulty]);
    e.jigsaw_initial_show_hint_image = t.game_instance.jigsaw_initial_show_hint_image, e.jigsaw_show_hint_image = r.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, e.jigsaw_arrange_pieces_on_entire_area = t.game_instance.jigsaw_arrange_pieces_on_entire_area;
    var a = t.game_instance.action_area_height,
     i = t.game_instance.base_image_width_to_naturalWidth;
    if ("undefined" == typeof i && (i = 1), "undefined" != typeof a) var c = parseFloat(window.getComputedStyle(u.inner).height) / a;
    y.timer_obj.counter = t.counter, dt();
    var h = E.width / E.naturalWidth / i;
    e.zoom = t.zoom, B = [];
    for (var n = 0; n < e.tile_x; n++) B[n] = [];
  ...
  y.redraw_main_image_and_pieces = function(f) {
   function w() {
    ...
    t.save(), g({
     ...
     position: 1,
     is_2d: !0
    }), o.sprite.x = d.left - e.piece_margin, o.sprite.y = d.top - e.piece_margin, "undefined" != typeof b && b()
   }
   ...
   for (var m = [], u = 0; u < I.length; u++) {
    ...
    if ("undefined" != typeof s && (t.width_float = Math.round(t.width_float * s * 1e3 / 1e3), t.height_float = Math.round(t.height_float * s * 1e3 / 1e3), t.puzzle_left_min = Math.round(t.puzzle_left_min * s * 1e3 / 1e3), t.puzzle_top_min = Math.round(t.puzzle_top_min * s * 1e3 / 1e3), t.width = Math.ceil(t.width_float / e.piece_logical_scale), t.height = Math.ceil(t.height_float / e.piece_logical_scale), t.puzzle_width.forEach(function(i, e) {
     ...
     }), t.side_set = ci(t.side_set, s)), t.width = Math.ceil((t.width_float + 2 * e.piece_margin) / e.piece_logical_scale), t.height = Math.ceil((t.height_float + 2 * e.piece_margin) / e.piece_logical_scale), t.placed) {
     e.pieces_in_position_count += t.x.length, t.shape_string = J(t.side_set, [-t.puzzle_left_min, -t.puzzle_top_min]), rt.push(t);
     for (var l = 0, y = t.x.length; y > l; l++) B[t.x[l]][t.y[l]] = t
    } else {
     if (m.push(t), I[u].canvas) var n = I[u];
     else var n = ft();
     n.x = a(t.x), n.y = a(t.y), n.zIndex = a(t.zIndex), n.piece_id = t.piece_id, n.width_float = t.width_float, n.height_float = t.height_float, n.width = t.width, n.height = t.height, n.virtual_left = t.virtual_left, n.virtual_top = t.virtual_top * S, n.puzzle_width = a(t.puzzle_width), n.puzzle_height = a(t.puzzle_height), n.puzzle_left_min = t.puzzle_left_min, n.puzzle_top_min = t.puzzle_top_min, n.puzzle_left = a(t.puzzle_left), n.puzzle_top = a(t.puzzle_top), n.side_set = a(t.side_set), n.placed = !1, I[u] = n;
     for (var l = 0, y = n.x.length; y > l; l++) B[n.x[l]][n.y[l]] = n
    }
   }
   P();
   var k = ot(rt, r.jigsaw_combine_pieces),
    v = [];
   ...
   var _ = h.getContext("2d"),
    A = c.naturalWidth,
    M = c.naturalHeight;
   _.drawImage(c, 0, 0, A, M, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), _.save(), _.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && p({
    canvas: h,
    draw_settings: T,
    stroke_width: T.stroke_width,
    cut_multiplier: T.cut_multiplier,
 ...
 function bt(r) {
  ...
  return e.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-2 jt-button hoverable", e.title_list = ["Tell a friend!", "Earn extra puzzle packs!", "Get 10 gems per friend!"], e.title_index = e.title_list.length - 1, a(), e.addEventListener(i.events.POINT, function() {
   ...
   function c() {
    function r(r) {
     return i.log_user_action("Tell-a-friend: email entered: " + r), r === !1 ? void e.deactivate() : void l({
      gs: i,
      error: function() {
 ...
 function z(e) {
  var i = e.gs,
   ...
   n = (e.error, function(t) {
    if (i.challenge_code_processed = !0, "undefined" == typeof t || "undefined" == typeof t.gem_amount) return void e.success();
    var n = "" == r ? "auto-" : "";
    smoke.alert("CHALLENGE code provided by your friend, " + t.challenger_name + ", " + n + 'accepted. You have received 10 gems and access to the "' + t.puzzle_name.capitalize() + '" puzzle!', e.success), "undefined" != typeof t.gem_amount && (i.account.gem_amount = t.gem_amount)
   });
  t({
   ...
   error: function(t) {
    return "" == r ? void n() : void i.errormessage(t, e.error)
   },
   request_method: "POST",
   async: !0,
   success: n
 ...
 ! function(s, r) {
  ...
  s.Kiip || (e = {
   ...
   readyStateChange: function() {
    4 === this.request.readyState && ("moment" === this.request._type && (this.request.status >= 200 && this.request.status < 300 || 0 === this.request.status ? this._handleSuccess() : this._handleFailure()), this.busy = !1, this.request._type = r, this.nextMoment())
   },
   ...
   _handleMessages: function(t) {
    var r, i;
    r = t && t.data ? t.data : "", i = r.split("|"), e.parseFrameCommand(i[0], i[1])
   },
   ...
   parseFrameCommand: function(t, i) {
    ...
    clearTimeout(this._iframeTimeout), "webid" === t && (this.busy = !1, this.validateWebID(i), this.nextMoment()), "ready" === t && e && this.instance.callback(e), "destroy" === t && e && e.destroy(), e = r
   },
   validateWebID: function(e) {
    e && e.match(/^blocked;/) && (e = e.split(";")[1], e = this.getLocalWebID(e)), this.device_id = e, this.webIDFrame.parentNode.removeChild(this.webIDFrame), this.webIDFrame = r
   },
   ...
   nextUnit: function() {
    ...
    this.currentUnit = r, e && this.createUnit(e)
   },
   nextMoment: function() {
   ...
   setCookie: function(i, a, e, r, n, s) {
    ...
    return document.cookie = encodeURIComponent(i) + "=" + encodeURIComponent(a) + t + (n ? "; domain=" + n : "") + (r ? "; path=" + r : "") + (s ? "; secure" : ""), !0
   }
  }, t = {
   ...
   Options: function(r) {
    var i = {};
    return e.testMode && (i.test = !0), e.web_user_id && (i.web_user_id = e.web_user_id), "[object Object]" === t.typeOf(r) && t.merge(i, r), i.app_key = e.app_key, i.user_data = e.userData, i.protocol = t.protocol, i.sdk_version = "1.0", i.device_id = e.device_id, i
   },
   toQueryString: function(i) {
    var e, r, t, n = [];
    for (t in i) e = i[t], r = t + "=" + encodeURIComponent(e), e && n.push(r);
    return n.join("&")
   },
   merge: function(r, i) {
    var e;
    for (e in i) "[object Function]" !== t.typeOf(i[e]) && i[e] && (r[e] = i[e]);
    return r
   },
   now: function() {
    return +new Date
   ...
   uniqueID: function() {
    return n || (n = t.now()), (n++).toString(36)
   }
  }, i = function(i, r) {
   ...
   (!window.JSON || t.isBadIE) && (e.disabled = !0), e.app_key = i, "[object Function]" === t.typeOf(r) && (this.callback = r), e.instance = this
   ...
   return e.email = r, e.container = r, e.currentUnit && e.currentUnit.destroy(), e.request && e.request.abort(), window.removeEventListener ? window.removeEventListener("message", e._handleMessages, !1) : window.detachEvent("onmessage", e._handleMessages), e.instance = null, r
  }, i.version = e.version, a = function(r) {
   var i, a, n;
   this.id = t.uniqueID(), r += "&domain=" + encodeURIComponent(t.protocol + "://" + window.location.hostname + (window.location.port ? ":" + window.location.port : "")), r += "&frame_id=" + this.id, r += "&overlay=" + (e.container ? "false" : "true"), i = document.createElement("iframe"), i.setAttribute("frameborder", "0"), i.setAttribute("src", r), i.style.zIndex = "2147483647", i.style.width = "100%", i.style.height = "100%", i.style.minWidth = "320px", i.style.minHeight = "330px", e.container ? (i.style.position = "relative", e.container.appendChild(i)) : (i.style.position = "fixed", i.style.top = "-999999px", i.style.left = "-999999px", document.body.appendChild(i)), this.setID = function(e) {
    return i.id = e, this
   }, this.show = function(r) {
    return n ? this : (n = !0, i.style.top = "0px", i.style.left = "0px", "[object Function]" === t.typeOf(r) && (a = r), i.contentWindow.postMessage("show", t.getOrigin()), e.email && i.contentWindow.postMessage("email=" + e.email, t.getOrigin()), this)
   }, this.destroy = function() {
    return n ? (n = !1, i.parentNode.removeChild(i), a && a(), e.nextUnit(), this) : this
 ...
 var e = {
  ...
  decompressFromBase64: function(t) {
   ...
   var i, o, l, c, p, u, n, a, s = "",
    ...
    r = 0,
    h = e._f;
   for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); r < t.length;) p = e._keyStr.indexOf(t.charAt(r++)), u = e._keyStr.indexOf(t.charAt(r++)), n = e._keyStr.indexOf(t.charAt(r++)), a = e._keyStr.indexOf(t.charAt(r++)), o = p << 2 | u >> 4, l = (15 & u) << 4 | n >> 2, c = (3 & n) << 6 | a, d % 2 == 0 ? (i = o << 8, 64 != n && (s += h(i | l)), 64 != a && (i = c << 8)) : (s += h(i | o), 64 != n && (i = l << 8), 64 != a && (s += h(i | c))), d += 3;
  ...
  compressToUTF16: function(a) {
   ...
   for (a = e.compress(a), s = 0; s < a.length; s++) switch (t = a.charCodeAt(s), o++) {
    ...
    case 13:
     ...
     break;
    case 14:
     r += n(i + (t >> 15) + 32, (32767 & t) + 32), o = 0
   }
   return r + n(i + 32)
  },
  decompressFromUTF16: function(a) {
   if (null == a) return "";
   for (var i, t, r = "", o = 0, s = 0, n = e._f; s < a.length;) {
  ...
  compress: function(_) {
    ...
    if (h = _.charAt(f), Object.prototype.hasOwnProperty.call(u, h) || (u[h] = m++, d[h] = !0), p = a + h, Object.prototype.hasOwnProperty.call(u, p)) a = p;
     ...
     if (Object.prototype.hasOwnProperty.call(d, a)) {
      if (a.charCodeAt(0) < 256) {
       for (r = 0; s > r; r++) t <<= 1, 15 == i ? (i = 0, o += c(t), t = 0) : i++;
       for (n = a.charCodeAt(0), r = 0; 8 > r; r++) t = t << 1 | 1 & n, 15 == i ? (i = 0, o += c(t), t = 0) : i++, n >>= 1
      } else {
       for (n = 1, r = 0; s > r; r++) t = t << 1 | n, 15 == i ? (i = 0, o += c(t), t = 0) : i++, n = 0;
       for (n = a.charCodeAt(0), r = 0; 16 > r; r++) t = t << 1 | 1 & n, 15 == i ? (i = 0, o += c(t), t = 0) : i++, n >>= 1
      }
      l--, 0 == l && (l = Math.pow(2, s), s++), delete d[a]
     } else
      for (n = u[a], r = 0; s > r; r++) t = t << 1 | 1 & n, 15 == i ? (i = 0, o += c(t), t = 0) : i++, n >>= 1;
   ...
   for (n = 2, r = 0; s > r; r++) t = t << 1 | 1 & n, 15 == i ? (i = 0, o += c(t), t = 0) : i++, n >>= 1;
   for (;;) {
    if (t <<= 1, 15 == i) {
     o += c(t);
     break
 ...
 "undefined" != typeof module && null != module && (module.exports = e), ! function(n, a, i, e, u, g, s, o, l) {
  function y(a) {
   var l, s = a.length,
    i = this,
    r = 0,
  ...
  e.WEBGL_RENDERER = 0, e.CANVAS_RENDERER = 1, e.VERSION = "v1.6.1", e.blendModes = {
   ...
   if (0 !== t.length) {
    ...
    var E, b, _, p, a, n, A, S, r, i, g, f, v, y, z, P, M, R, O, L, C, G, l, s = U.points,
     I = U.indices,
     T = t.length / 2,
     F = t.length,
     j = s.length / 6,
   ...
   for (var E = 0; S - 2 > E; E++) {
    ...
    r.transform(k / b, R / b, A / b, L / b, M / b, P / b), r.drawImage(y.texture.baseTexture.source, 0, 0), r.restore()
   }
  ...
  function D(t, i, r) {
   D._super_.call(this), this.lifePan = e.Util.setSpanValue(t, i, r)
  }
  ...
  function c(t, i, r) {
   this.mouseTarget = e.Util.initValue(t, z), this.ease = e.Util.initValue(i, .7), this._allowEmitting = !1, this.initEventHandler(), c._super_.call(this, r)
  }
  ...
  function R(e, t, i, r) {
   R._super_.call(this), this.x = e, this.y = t, this.width = i, this.height = r
  }
  ...
  }, e.RectZone = R, e.Util.inherits(h, e.Zone), h.prototype.reset = function(t, i, r, n) {
 ...
 if ((r._gsQueue || (r._gsQueue = [])).push(function() {
    ...
    function() {
     ...
     var W, gt, H, _t, ft, k, P = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
      ...
      Z = function(o, i, l, r, c) {
       var t, e, n, a = {},
        s = o.style;
       for (e in l) "cssText" !== e && "length" !== e && isNaN(e) && (i[e] !== (t = l[e]) || c && c[e]) && -1 === e.indexOf("Origin") && ("number" == typeof t || "string" == typeof t) && (a[e] = "auto" !== t || "left" !== e && "top" !== e ? "" !== t && "auto" !== t && "none" !== t || "string" != typeof i[e] || "" === i[e].replace(z, "") ? t : 0 : st(o, e), void 0 !== s[e] && (n = new X(s, e, s[e], n)));
       if (r)
      ...
      $ = function(e, r) {
       ...
       return null == i ? i = "0" : "center" === i && (i = "50%"), ("center" === t || isNaN(parseFloat(t)) && -1 === (t + "").indexOf("=")) && (t = "50%"), r && (r.oxp = -1 !== t.indexOf("%"), r.oyp = -1 !== i.indexOf("%"), r.oxr = "=" === t.charAt(1), r.oyr = "=" === i.charAt(1), r.ox = parseFloat(t.replace(z, "")), r.oy = parseFloat(i.replace(z, ""))), t + " " + i + (n.length > 2 ? " " + n[2] : "")
      },
      rt = function(e, t) {
      ...
      S = function(i, n, l, s) {
       var t, a, e, r, o = 1e-6;
       return null == i ? r = n : "number" == typeof i ? r = i : (t = 360, a = i.split("_"), e = Number(a[0].replace(z, "")) * (-1 === i.indexOf("rad") ? 1 : b) - ("=" === i.charAt(1) ? 0 : n), a.length && (s && (s[l] = n + e), -1 !== i.indexOf("short") && (e %= t, e !== e % (t / 2) && (e = 0 > e ? e + t : e - t)), -1 !== i.indexOf("_cw") && 0 > e ? e = (e + 9999999999 * t) % t - (0 | e / t) * t : -1 !== i.indexOf("ccw") && e > 0 && (e = (e - 9999999999 * t) % t - (0 | e / t) * t)), r = n + e), o > r && r > -o && (r = 0), r
      },
      w = {
       aqua: [0, 255, 255],
       lime: [0, 255, 0],
     ...
     var ht = function(e, o, h, a) {
      ...
      s = (u._parseToProxy = function(p, u, a, e, d, s) {
       var o, t, i, r, h, n = e,
        ...
        f = a._transform,
        _ = D;
       for (a._transform = null, D = u, e = h = a.parse(p, u, e, d), D = _, s && (a._transform = f, n && (n._prev = null, n._prev && (n._prev._next = null))); e && e !== n;) {
     ...
     e._addLazySet = function(t, i, r) {
      ...
      return i.className && (e = this._classNamePT) && (t = e.xfirst, t && t._prev ? this._linkCSSP(t._prev, e._next, t._prev._prev) : t === this._firstPT && (this._firstPT = e._next), e._next && this._linkCSSP(e._next, e._next._next, t._prev), this._classNamePT = null), R.prototype._kill.call(this, r)
     };
   ...
   if (!S.TweenLite) {
    ...
    var t = u("TweenLite", function(e, c, h) {
     ...
     Y = function(t, r) {
      var e, i = {};
      for (e in t) D[e] || e in r && "transform" !== e && "x" !== e && "y" !== e && "width" !== e && "height" !== e && "className" !== e && "border" !== e || !(!g[e] || g[e] && g[e]._autoCSS) || (i[e] = t[e], delete t[e]);
      t.css = i
     };
    ...
    e._init = function() {
     ...
     if (i.startAt) {
      ...
      if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
       ...
       e = {};
       for (n in i) D[n] && "autoCSS" !== n || (e[n] = i[n]);
     ...
     for (t in this.vars) {
      if (r = this.vars[t], D[t]) r && (r instanceof Array || r.push && v(r)) && -1 !== r.join("").indexOf("{self}") && (this.vars[t] = r = this._swapSelfInParams(r, this));
  ...
  function(t) {
   ...
   var l = t.GreenSockGlobals || t,
    ...
    _ = function(i, y, j, X, F) {
     ...
     var w, p, b, s, _, E, x, n, f, l, m, D, O, A = r(i),
     ...
     if (g) {
      ...
      for (O = !h || !v && !T, s = 0; s < g.length; s++) {
       ...
       v || T || (l.innerHTML = r(l).split(String.fromCharCode(160)).join(" ")), h && (l.style.width = D, l.style.height = n._h + "px"), i.appendChild(l)
      }
      i.style.cssText = m
     }
