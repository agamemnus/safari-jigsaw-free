...
function() {
 ...
 function yt(q) {
  ...
  function jt() {
   ...
   e.jigsaw_initial_show_hint_image = r.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, e.jigsaw_show_hint_image = r.jigsaw_show_hint_image, e.piece_margin = r.jigsaw_get_scaled_piece_margin(e), e.piece_margin_style = r.jigsaw_piece_margin_style, d.inner.appendChild(w);
  ...
  i.className = "jt-draw_area", i.controls_locked = !1, r.is_webgl = function() {
