...
function() {
    ...
    function z(e) {
        ...
        function n(r) {
            ...
            var u = h(r.touches[0], t),
                n = u[0],
                o = u[1],
                d = h(r.touches[1], t),
                l = d[0],
                c = d[1];
            return (e.always_recalculate_zoom_target === !0 || 0 == i) && (a = (n + l) / 2, s = (o + c) / 2), i = Math.sqrt(Math.pow(Math.abs(n - l), 2) + Math.pow(Math.abs(o - c), 2)), "touchstart" == r.type ? void("undefined" != typeof e.start_effect && e.start_effect(r, n, o, l, c)) : (e.result_function(i / p, a, s), void("undefined" != typeof e.move_effect && e.move_effect(r)))
        }
    ...
    function e(e) {
        ...
        var a = "undefined" != typeof e.charset ? e.charset : "",
            ...
            l = wt(e.file, s, n, a, t, void 0, void 0, e.request_method),
            i = l.http_request;
    ...
    function P(r, t) {
        ...
        if ("undefined" == typeof this || this == window) return new P(r, t);
        var e = this;
    ...
    function y() {
        function l() {
            ...
            }, this.log_user_action = function(r) {
            ...
            if (t.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], t.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], o.forEach(function(n) {
                    ...
                    return i ? "cdvfile://localhost/persistent/sets/" + e : (d ? "content://" + R + ".free.expansion/" : t["/"]) + "sets/" + e
                ...
                }, this.get_image_url_from_local = function(s, e, r) {
                    if ("trophy" != r) var a = i.game_data.entry_list[e].category;
                    var n = (d ? "content://" + R + ".free.expansion/" : t["/"]) + "sets/" + s;
                    switch ("undefined" != typeof t.account.user_id && (t.account.user_id > 606 || 1 == t.account.user_id) && "mini-grey" == r && (r = "mini"), r) {
                        case "trophy":
                            return n + "/puzzle/trophies/" + e + ".png";
                        case "mini":
                            return n + "/puzzle/categories/" + a + "/mini/" + e + "-mini.jpg";
                        case "mini-grey":
                            return n + "/puzzle/categories/" + a + "/mini-grey/" + e + "-mini.png";
                        case "default":
                        default:
                            return n + "/puzzle/categories/" + a + "/" + e + ".jpg"
                    }
                }, this.get_image = function(i, n, r, e) {
                    function a() {
                        i.removeEventListener("error", a);
                        var s = JSON.parse(localStorage["image_is_not_local_cache." + e]);
                        s[r] = !0, localStorage["image_is_not_local_cache." + e] = JSON.stringify(s), i.src = t.get_image_url_from_server(n, r, e)
                    }
                    ...
                    var s = JSON.parse(localStorage["image_is_not_local_cache." + e]);
                    return s[r] ? void(i.src = t.get_image_url_from_server(n, r, e)) : (i.src = t.get_image_url_from_local(n, r, e), void i.addEventListener("error", a))
            ...
            if (t.is_phone_or_tablet && (document.body.addEventListener("touchstart", function(e) {
                ...
                !t.account.purchased_ad_removal && t.IS_WEBVIEW && "undefined" != typeof _ && (t.ad_control_list = [], t.ad_control_list.destroy = function() {
        ...
        window.onerror = function(i, n, a, s) {
            ...
            "undefined" == typeof t.model && (t.model = ""), "undefined" == typeof t.uuid && (t.uuid = ""), e({
                file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (r.DEBUG ? "-beta" : "") + ".php?action=send_javascript_error&errormessage=" + encodeURIComponent(i) + "&url=" + encodeURIComponent(n) + "&line_number=" + a + "&column_number=" + s + "&device_model=" + encodeURIComponent(t.model) + "&device_uuid=" + t.uuid,
                success: function() {},
                error: function() {},
                request_method: "GET"
            })
        }, "undefined" == typeof s && (s = !1), "undefined" == typeof d && (d = !1);
        var p = 1420276045;
        ...
        i.load_game_data = function(c) {
            ...
            var e = "undefined" != typeof S ? S : "default";
        ...
        var f = i.history_control = new St({
                ...
                onstatechange: function(e, t) {
                    ...
                    switch (e.page) {
                        case "select_mode":
                            if (r.IS_CORDOVA && (r.select_mode_visited_count += 1, console.log(r.select_mode_visited_count), r.select_mode_visited_count > 1 && r.is_android)) return r.ad_control_list && r.ad_control_list.destroy(), void i.save_player_data_to_server({
                        ...
                        case "jigsaw":
                            dt({
                                ...
                                global_settings: r,
                                level_id: e.level
                            }), r.IS_WEBVIEW && "undefined" != typeof _ && pt({
                                gs: r,
                                mr_jigtato: i
                            });
                            break;
    ...
    function pt(r) {
        function a() {
            Math.random() <= .1 && 0 == t.account.game_was_rated && s()
        }

        function s() {
            t.own_ad_shown = !0, t.ad_control && (t.ad_control.running = !0);
            var a = "<p> Like this game?</p>";
            a += '<p>This game is an independent developer production -- made by 1 developer. If you like this game, please rate it. The more good ratings this game has, the easier it will be for others to find! You can also email me with questions or comments at: <a href="mailto:' + t.contact_info + '">' + t.contact_info + "</a>.</p>";
            var i = smoke.confirm(a, function(i) {
                    t.ad_control && (t.ad_control.running = !1), 0 != i && ("undefined" != typeof t.account.user_id && e({
                    ...
                    }), t.account.game_was_rated = !0, t.open_url(t.google_play_store_url))
                }),
                r = i.dialog.text.childNodes[1];
            console.dir(i.dialog.text), i.dialog.text.childNodes[0].classList.add("jt-common-instruction_text-title"), r.classList.add("jt-common-instruction_text"), r.style.fontSize = "55px", r.style.lineHeight = "150%", r.style.height = "auto", i.dialog.text.style.height = window.getComputedStyle(i.dialog.text).maxHeight, i.buttons.ok.innerHTML = "Rate it.", i.buttons.cancel.innerHTML = "Don't rate it.", n(i.buttons), i.buttons.ok.classList.add("hoverable"), i.buttons.cancel.classList.add("hoverable")
        }
        var t = r.gs,
            o = r.mr_jigtato;
        if (t.account.purchased_ad_removal) return void a();
        var l = o.game_data.jigsaw.difficulty_levels[o.player_data.selected_difficulty],
            c = l.tile_x,
            h = l.tile_y,
            i = (t.show_ad_counter, Math.sqrt(c * h) / 8);
        i > 1 && (i = 1), t.show_ad_counter += i, t.ad_control = t.ad_control_list[Object.keys(t.ad_control_list_weights).indexOf(Math.weightedSample(t.ad_control_list_weights))], t.ad_control_list.forEach(function(e) {
            e.is_active = e == t.ad_control
        }), t.show_ad_counter >= 1 ? (t.show_ad_counter = t.show_ad_counter - parseInt(t.show_ad_counter), Math.random() > .1 ? t.ad_control && t.ad_control.run() : 0 == t.account.game_was_rated ? s() : t.ad_control.run()) : a()
    }
    ...
    function H(r) {
        function c() {
            t.back.style.visibility = 0 == i ? "hidden" : "visible", t.next.style.visibility = i == n.length - 1 ? "hidden" : "visible", s.text.innerHTML = n[i], s.text.parentNode.classList[1 == i ? "add" : "remove"]("jt-play-show_credits-dialog")
        }
        ...
        n[0] = o.about_text + d + ". </p>", r.callback, n[1] = "Loading...", e({
            error: function(e) {
        ...
        var s = smoke.alert(o.about_text + a.contact_info + ". </p>", r.callback),
            t = s.buttons;
        t.back = s.buttons.ok.cloneNode(!0), t.back.style.cssFloat = "left", t.back.innerHTML = "< Back", t.appendChild(t.back), t.next = s.buttons.ok.cloneNode(!0), t.next.style.cssFloat = "right", t.next.innerHTML = "Next >", t.appendChild(t.next), t.back.addEventListener(a.events.POINT, function() {
            i = (i + n.length - 1) % n.length, c(i)
        }), t.next.addEventListener(a.events.POINT, function() {
            i = (i + n.length + 1) % n.length, c(i)
        });
        var i = 0;
        c(i), l(s), a.is_phone_or_tablet && (s.dialog.text.style.backgroundColor = "transparent")
    }
    ...
    function U(a) {
        function o(l) {
            ...
            t.innerHTML = "";
            var e = document.createElement("span");
            e.className = "jt-play-trophy_room-item_name", e.style.color = a.text_color, e.innerHTML = a.display_name.capitalizeFirstLetter(), t.appendChild(e), r.is_chromium || r.is_android ? (e.style.textShadow = "none", e.style.WebkitTextStrokeColor = a.text_outline_color.split(",")[0].trim(), x({
                element: e,
                size: "3px",
                color: ""
            ...
            t.appendChild(c);
            var n = document.createElement("span");
            n.className = "jt-play-trophy_room-puzzle_name", n.style.color = s.title_color, n.innerHTML = '"' + s.name + '"', t.appendChild(n), r.is_chromium || r.is_android ? (n.style.textShadow = "none", n.style.WebkitTextStrokeColor = s.border_color.split(",")[0].trim(), x({
                element: n,
                size: "3px",
                color: ""
    ...
    function Z(n, s, i) {
        ...
        if ("undefined" == typeof e.audio_settings_menu || null == e.audio_settings_menu.parentNode) {
            var t = a(i.init);
            delete t.menu_item_list, e.audio_settings_menu = q({
                callback: function(e) {
    ...
    function $(n, s, i) {
        ...
        if ("undefined" == typeof t.visual_settings_menu || null == t.visual_settings_menu.parentNode) {
            var e = a(i.init);
            delete e.menu_item_list, t.visual_settings_menu = J({
                callback: function(e) {
                    e.style.display = "none", e.parent_menu.style.display = "", e.parent_menu.refresh()
                },
                parent: t,
    ...
    function I(i) {
        ...
        r.open("HEAD", o + "/" + t, !0), r.onreadystatechange = function() {
            if (4 == r.readyState) {
                ...
                h >= i ? a(l + "/" + t, u) : i > o ? (localStorage.json_file_version_date = JSON.stringify(+i), m()) : n()
            }
        }, r.send(null)
    }
    ...
    function ct(a) {
        function u() {
            ...
            if (null != a && (e.style.display = "none", B({
                    image: a,
                    fix_ie_bug: !0,
                    color: "#edd9a7",
                    callback: function(t) {
                ...
                function() {
                    ...
                    r.push(e), r.forEach(function(t) {
                        ...
                        var e = xt(window.getComputedStyle(t).backgroundImage);
    ...
    function ht(s) {
        function u() {
            ...
            var R = a.challenge_a_friend_button = _t({
                select_screen: a,
                content_div: o,
                mr_jigtato: t,
                gs: e
            ...
            u.appendChild(L);
            var v = a.gem_purchase_button = document.createElement("div");
            v.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-1 jt-gem_amount_container jt-button hoverable", v.addEventListener(e.events.POINT, P), u.appendChild(v), A(), void
            function() {
            ...
            var y = 12,
                S = a.create_puzzle_selection_array = function() {
                    _.splice(0, _.length);
                    for (var t in r) {
                        var e = r[t];
            ...
            var B = a.create_tab_container = function(r) {
                    function l() {
                        ...
                        e.select_menu_current_category[i] = r[(l + 1) % r.length], e.select_menu_current_category = e.select_menu_current_category, f = e.select_menu_current_category[i], "undefined" == typeof e.select_menu_current_page[i][f] && (e.select_menu_current_page[i][f] = 0), s.innerHTML = n[f].shortcut, S(), o(), b.sort_levels()
                    }
            ...
            if ("undefined" != typeof e.pending_message) {
                var k = smoke.alert(e.pending_message);
        ...
        function p(i) {
            function n() {
                e.try_requesting_fullscreen && !e.IS_WEBVIEW && e.is_phone_or_tablet && F(document.documentElement);
    ...
    function dt(J) {
        ...
        function Rt(e) {
            return "undefined" == typeof e && (e = {}), A.stop(), 4 == c.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
                ...
                "undefined" != typeof e.success && (e.complete(), e.success(i)), H()
            })
        }
        ...
        function Ot() {
            ...
            d.style.top = a + "px", d.style.height = n + "px", Y.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", i.reposition_and_resize(), R(), "undefined" != typeof T && T.naturalHeight && (t.area && t.area.forEach(function(e) {
                e.height = n * e.height_ratio
            }), u.top = (n - T.height + (T.height - T.height)) / 2), tt(), c.container.children.forEach(function(e) {
                e.piece_container.children.forEach(function(e) {
                    t.area[e.area];
                    e.top = e.top * (n / l)
                }), y.size_pieces(e.piece_container.children)
            })
        }

        function tt() {
            if (!i.bg.image.complete) return void i.setTimeout(tt, 50);
            if (0 == !!i.bg.refresh_bg && (i.bg.refresh_bg = !0, i.bg.width = "undefined" != typeof i.cached_width ? i.cached_width : i.width, i.bg.height = "undefined" != typeof i.cached_height ? i.cached_height : i.height, i.bg.getContext("2d").drawImage(i.bg.image, 0, 0, i.bg.image.naturalWidth, i.bg.image.naturalHeight, 0, 0, i.bg.width, i.bg.height), F({
                    ...
                    canvas: i.bg,
                    position: 0
                }), R()), i.background_image_drawn = !0, "undefined" == typeof u) return void i.setTimeout(tt, 50);
            if ("undefined" == typeof u.left) return void i.setTimeout(tt, 50);
            if (!u.base_image.complete) return void i.setTimeout(tt, 50);
            i.bg.refresh_bg = !0;
            ...
            (1 == r.style.opacity || t.jigsaw_show_hint_rect) && (e.fillStyle = "white", e.fillRect(n, a, s, o), (1 == r.style.opacity || t.jigsaw_show_hint_image) && (e.globalAlpha = r.style.opacity, e.drawImage(r, n, a, s, o), e.globalAlpha = 1)), F({
                parent: i.stage,
                logical_parent: i.bg,
                canvas: i.bg,
                position: 0
        ...
        function jt() {
            function n() {
                return 0 == !!i.first_render_complete || r.ad_control && !r.ad_control.ignore && r.ad_control.running || 0 == !!t.log_query_processed ? void d.inner.setTimeout(n, 50) : void qt()
            }
            t.jigsaw_initial_show_hint_image = r.jigsaw_show_hint_image, t.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, t.jigsaw_show_hint_image = r.jigsaw_show_hint_image, t.piece_margin = r.jigsaw_get_scaled_piece_margin(t), t.piece_margin_style = r.jigsaw_piece_margin_style, d.inner.appendChild(v);
            var e = u.composite_image = document.createElement("canvas");
            if (e.set_size = function() {
                ...
                }, si(), "undefined" == typeof localStorage["puzzle_states." + et + "." + S + "." + I.selected_difficulty]) {
                gt();
                var a = Math.round(1e6 * Math.random());
                Math.seedrandom(a), c.add_category("General"), oi({
                    source_image: T,
                    width: T.width,
                    height: T.height,
                    size_x: t.tile_x,
                    ...
                    draw_settings: w,
                    callback: function(e) {
                        D = e, ii(D, c.current_category.piece_container), P = Array.prototype.slice.call(c.current_category.piece_container.children), St(P), ot(c.current_category.piece_container), t.pieces_in_position_count = 0, n()
                    }
                })
            } else Mt({
                callback: n
        ...
        function qt() {
            function n() {
                r.jigsaw_minimal_ui ? p.show_title_animation({
                ...
                }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, v.addEventListener(r.events.POINT_START, Kt), document.addEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? (z({
                    target: d.inner,
                    result_function: Ut,
                    ...
                    start_effect: function() {
                        r.jigsaw_pinch_controls_not_run && (r.log_user_action("Pinch controls: run for the first time."), r.jigsaw_pinch_controls_not_run = !1), v.drag_end(), v.pinch_active = !0
                    },
                    end_effect: function() {
                        v.pinch_active = !1
                    }
                }), v.addEventListener("touchend", q), v.addEventListener("touchcancel", q), v.addEventListener("touchleave", q), _.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", pt), window.addEventListener("mouseout", Ft), d.inner.addEventListener("mousewheel", Gt), d.inner.addEventListener("DOMMouseScroll", Gt))), p.setTimeout(function() {
            ...
            if (i.loading_animation.stop(), "undefined" == typeof t.pending_message || "" == t.pending_message) n();
            else {
            ...
            if (0 != s.length)
                for (var u = 0, i = 0, g = t.area.length; g > i; i++) {
                    var n = t.area[i],
                        ...
                        f = n.width / p;
                    if (I.selected_difficulty <= 1) var _ = 0,
                        m = n.height / d;
        ...
        function Zt(l) {
            var n = I.jigsaw.best_times[+t.jigsaw_initial_show_hint_image];
            "undefined" == typeof n[S] && (n[S] = {});
            var e = n[S][t.difficulty_level];
            "undefined" == typeof e && (e = 86400), e > l && (e = n[S][t.difficulty_level] = l);
            var i = K.difficulty_levels[t.difficulty_level].point_cutoffs_visible;
            0 == t.jigsaw_initial_show_hint_image && (i *= K.difficulty_levels[t.difficulty_level].point_cutoffs_hidden_multiplier);
            ...
            var r = a + 1,
                ...
                s = I.jigsaw.ranks;
            "undefined" == typeof s[S] && (s[S] = {});
            var o = s[S][t.difficulty_level];
            return "undefined" == typeof o && (o = -1), r > o && (o = s[S][t.difficulty_level] = r), {
                best_time: e,
                rank_count: r,
                next_rank_point: h
            }
        ...
        function ri() {
            A.style.visibility = "hidden", A.counter = 0, t.zoom = {
                scale: 1,
                offset_x: 0,
                offset_y: 0
            }, jt()
        ...
        function Jt(e) {
            ...
            var n = (t.piece_margin, c.current_category.piece_container.children);
            ...
            }), bt(), d.inner.setTimeout(Ct, 800), d.inner.setTimeout(function() {
                Ht({
                    callback: e.callback
                })
        ...
        function ct(h) {
            ...
            function b() {
                ...
                if (n.innerHTML = e.display_name.capitalizeFirstLetter() + ("!" == u || "." == u ? "" : "."), "undefined" != typeof e.text_outline_color) {
                    ...
                    r.is_chromium || r.is_android ? (n.style.textShadow = "none", n.style.WebkitTextStrokeColor = a, x({
                        element: n,
                        size: "4px",
                        color: ""
            ...
            function g() {
                var e = K.rank[K.difficulty_levels[I.selected_difficulty].name];
                r.playAudio(r.get_set_directory($) + "/audio/" + e.rank_audio[n] + ".m4a", {
                    audio_type: "music",
                    element: d.inner,
                    restart: !0
                });
                var s = smoke.alert("");
                l(s), s.dialog.buttons.ok.addEventListener(r.events.POINT, function() {
                    n >= 1 && (!window.kiipInstance || r.account && r.account.purchased_ad_removal || (console.log(window.kiipInstance), window.kiipInstance.postMoment("rank_count: " + n + ", selected_difficulty: " + I.selected_difficulty))), i.fireworks = new ft({
                        gs: r,
                        draw_area: i
                    })
                });
                ...
                t.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + A.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + v + "</span> seconds.</p>", t.innerHTML += 0 == n ? '<p> No <span class="jt-play-show_rank-text-bright">' + h + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + w[n] + "</span> " + h + ".</p>";
                var o = document.createElement("div");
                o.className = "jt-play-show_rank-image-container";
                for (var c = 0; n > c; c++) {
                    var a = document.createElement("div");
                    a.className = "jt-play-show_rank-image-item", o.appendChild(a), a.style.opacity = .01, a.style.backgroundImage = 'url("' + r.get_set_directory($) + "/gui/" + e.filename + '")', void
                    function(t, i) {
                        d.inner.setTimeout(function() {
                            TweenMax.to(t, 2, {
                                parseTransform: !0,
                                ...
                                t.addEventListener(r.events.POINT, function() {
                                    "undefined" != typeof e.click_audio && r.playAudio(r.get_set_directory($) + "/audio/" + e.click_audio + ".ogg", {
                                        element: d.inner,
                                        audio_type: "music"
                                    })
                                })
            ...
            var h = h || {};
            localStorage.removeItem("puzzle_states." + et + "." + S + "." + I.selected_difficulty);
            var a = h.user_gave_up || !1;
            r.ambient_music.last_on_state = r.ambient_music_on, r.ambient_music_on = !1;
            var m = _t[Math.floor(Math.random() * _t.length)];
            if (0 == a) {
                r.playAudio(r.audio_dir + "/" + m, {
                    audio_type: "sound_effect",
                    blocking: !1
                })
            }
            if (A.stop(), _.style.overflow = "hidden", a || (i.controls_locked = !0), 1 != t.zoom.scale || 0 != t.zoom.offset_x || 0 != t.zoom.offset_y) {
                var o = 1e3;
                TweenMax.to(t.zoom, o / 1e3, {
                    parseTransform: !0,
                    ease: Linear.ease,
                    scale: 1,
                    offset_x: 0,
            ...
            if (i.single_piece_left) {
                var c = i.single_piece_left;
                delete i.single_piece_left, u.appendChild(c), i.piece_container = u, TweenMax.to(c, o / 1e3, {
                    parseTransform: !0,
                    ease: Cubic.easeInOut,
                    calc_width: c.width_float,
                    calc_height: c.height_float,
                    left: u.left,
                    top: u.top,
                    onComplete: function() {
                        Ct()
            ...
            if (a || d.inner.setTimeout(function() {
                ...
                localStorage.player_data = JSON.stringify(I), 0 == a ? d.inner.setTimeout(f, o + (h.show_trophy_delay || 550)) : d.inner.setTimeout(f, o + (h.show_trophy_delay || 550))
            }
        }

        function Ht(e) {
            var e = e || {};
            if (R(), u.children.forEach(function(e) {
                    e.side_set && (u.removeChild(e), O(e))
                }), c.container.children.forEach(function(e) {
                    c.remove_category(e)
                }), u.base_image.style.opacity = 1, O(u.composite_image), tt(), e.hide_controls) {
                var t = r.use_categories;
                r.use_categories = !1, p.autoshow_title(), r.use_categories = t, Yt.morph_to_back_button()
            }
        ...
        function Vt(e, n) {
            ...
            var a = h(n, d.inner),
                o = a[0],
                l = a[1];
            e.left = (o / _.desired_scale - t.zoom.offset_x) / t.zoom.scale + (r.jigsaw_center_piece_on_move ? -e.calc_width / 2 : -e.initial_offset_left - e.calc_width / 2), e.top = (l / _.desired_scale - t.zoom.offset_y) / t.zoom.scale + (r.jigsaw_center_piece_on_move ? -e.calc_height / 2 : -e.initial_offset_top - e.calc_height / 2), R();
        ...
        function Ut(n, i, r) {
            var a = t.zoom.scale;
            i /= _.content_scale, r /= _.content_scale;
            var e = a * n;
        ...
        function Kt(e) {
            if (e.preventDefault(), !i.controls_locked) {
                ...
                if ("undefined" != typeof e.targetTouches) {
                    if (e.touches.length > 1) {
                        if (null != s) {
                            ...
                            a != v || v.pinch_active || v.drag_start(e)
                        }
                        return
                    }
                    e = e.targetTouches[0]
                ...
                if (!X(e)) {
                    var u = h(e, d.inner),
                        f = (u[0] / _.desired_scale - t.zoom.offset_x) / t.zoom.scale,
                        p = (u[1] / _.desired_scale - t.zoom.offset_y) / t.zoom.scale,
                        l = [],
                        y = c.current_category;
                    if (y)
                        for (var m = y.piece_container, o = 0, g = m.children.length; g > o; o++) {
                            var n = m.children[o];
                    ...
                    if (0 == l.length) return void(a != v || v.pinch_active || v.drag_start(e));
                    for (var a = l[0], x = +l[0].sprite.index, o = 1, g = l.length; g > o; o++) {
                        var n = l[o]; + n.zIndex <= x || (x = +n.zIndex, a = n)
                    }
                    R(), r.playAudio(r.audio_dir + "/global-pick up.ogg", {
                        audio_type: "sound_effect",
                        blocking: !1
                    });
                    ...
                    if (O(a), F({
                            ...
                            canvas: a.canvas,
                            is_2d: !0
                        }), s = a, s.touch_id = e.identifier, s.pickup_left = s.left, s.pickup_top = s.top, s.calc_width = s.width_float, s.calc_height = s.height_float, i.piece_sprite_container.removeChild(a.sprite), i.stage.addChild(a.sprite), 0 == r.jigsaw_center_piece_on_move) {
                        var u = h(e, d.inner),
                            f = u[0],
                            p = u[1];
                        s.initial_offset_left = (f / _.desired_scale - t.zoom.offset_x) / t.zoom.scale - a.virtual_left, s.initial_offset_top = (p / _.desired_scale - t.zoom.offset_y) / t.zoom.scale - a.virtual_top
                    }
                    document.body.style.cursor = "pointer", a.visibility = "hidden", s.visibility = "visible", Vt(s, e)
                }
            }
        }
        ...
        function q(o) {
            if (null != v) {
                if ("undefined" == typeof o.touches) v.drag_end();
                else {
                    var L = o.touches[Array.prototype.slice.call(o.touches).findIndex(function(e) {
                        return e.identifier == v.touch_id
                    })];
                    if ("undefined" == typeof L && v.drag_end(), null != s) {
                ...
                if (null != s) {
                    ...
                    if (null != c.item_under_mouse) {
                        ...
                        if (M != c.item_under_mouse) {
                            ...
                            x.appendChild(s), ot(x, [s])
                        }
                    }
                    var A = c.current_category.piece_container.children,
                        a = s,
                        l = r.jigsaw_piece_scale_to_actual,
                        b = 2 * r.jigsaw_required_precision,
                        n = [],
                        k = s.left + (1 - l) / 2 * a.width_float - a.puzzle_left_min * l,
                        R = s.top + (1 - l) / 2 * a.height_float - a.puzzle_top_min * l;
                    if (A.forEach(function(e) {
                            if (e != a)
                                for (var h = e.virtual_left - e.width_float * l / 2 - e.puzzle_left_min * l, d = e.virtual_top - e.height_float * l / 2 - e.puzzle_top_min * l, r = Math.abs(h - k), s = Math.abs(d - R), t = 0, c = a.puzzle_width.length; c > t; t++)
                        ...
                        var e = mt();
                        return e.className = "jt-jigsaw-piece_deck-piece", e.piece_id = a.piece_id, e.x = [], e.y = [], e.puzzle_width = [], e.puzzle_height = [], e.puzzle_left = [], e.puzzle_top = [], e.puzzle_left_min = p, e.puzzle_top_min = d, e.side_set = st(n, !0), e.shape_string = Z(st(n, r.jigsaw_combine_pieces), [-p, -d]), e.dummy_canvas = document.createElement("canvas"), e.path = new Path2D(e.shape_string), P.push(e), a.parentNode.appendChild(e), e.width_float = Math.round(1e3 * (_ - p)) / 1e3, e.height_float = Math.round(1e3 * (m - d)) / 1e3, e.width = Math.ceil((e.width_float + 2 * t.piece_margin) / t.piece_logical_scale), e.height = Math.ceil((e.height_float + 2 * t.piece_margin) / t.piece_logical_scale), n.forEach(function(e) {
                            e.parentNode.removeChild(e)
                        }), n.forEach(function(t) {
                            O(t), P.splice(P.indexOf(t), 1), t.x.forEach(function(r, i) {
                                D[t.x[i]][t.y[i]] = e
                    ...
                    if (lt(s), F({
                        ...
                        var j = h.puzzle_left_min + u.left,
                            z = h.puzzle_top_min + u.top;
        ...
        function zt(n) {
            t.pieces_in_position_count += n.x.length, n.parentNode.removeChild(n), document.body.style.cursor = "", n.placed = !0;
            for (var y = [], b = [], S = [
                    [0, 0, !0],
                    [-1, 0, !0],
                    [0, -1, !0],
                    ...
                    [2, -2, !1],
                    [-2, 2, !1]
                ], d = {}, x = n.x, c = u.composite_image.width - 2 * t.piece_margin / t.piece_logical_scale, f = 0, l = u.composite_image.height - 2 * t.piece_margin / t.piece_logical_scale, _ = 0, a = 0; a < x.length; a++) {
                var T = n.x[a],
                    v = n.y[a];
                D[T][v] = Pt(n)
            }
            ...
            var C = (st(y, !0), Z(st(y, r.jigsaw_combine_pieces), [-Math.floor(c), -Math.floor(l)])),
                e = document.createElement("canvas");
            e.width_float = Math.round(1e3 * (f - c)) / 1e3, e.height_float = Math.round(1e3 * (_ - l)) / 1e3, e.width = Math.ceil((e.width_float + 2 * t.piece_margin) / t.piece_logical_scale), e.height = Math.ceil((e.height_float + 2 * t.piece_margin) / t.piece_logical_scale);
            ...
            var p = (u.composite_image.width - 2 * t.piece_margin / t.piece_logical_scale) * t.piece_logical_scale / u.base_image.naturalWidth;
            b.forEach(function(e) {
                o.drawImage(u.base_image, e.puzzle_left_min / p, e.puzzle_top_min / p, e.width * t.piece_logical_scale / p, e.height * t.piece_logical_scale / p, (e.puzzle_left_min - c) / t.piece_logical_scale, (e.puzzle_top_min - l) / t.piece_logical_scale, e.width, e.height)
            }), o.restore(), o.save(), o.translate(t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale), r.jigsaw_use_3d_effect && g({
                canvas: e,
                draw_settings: w,
            ...
            E.globalCompositeOperation = "source-over", E.drawImage(e, c / t.piece_logical_scale, l / t.piece_logical_scale, e.width, e.height), e.width = 0, e.height = 0;
            ...
            h.texture ? Lt(h) : F({
                ...
                position: 1,
                is_2d: !0
            }), h.sprite.x = u.left - t.piece_margin, h.sprite.y = u.top - t.piece_margin, O(n), n == s && (s = null), vt(), H(), Xt() && ct()
        }

        function pt(e) {
            if (null != s) {
                if (R(), "undefined" == typeof e && (e = {}), document.body.style.cursor = "", e.is_transferred_to_different_category || i.piece_sprite_container.addChild(s.sprite), s.visibility = "visible", !r.freestyle_mode || e.is_transferred_to_different_category) s.left = s.pickup_left, s.top = s.pickup_top;
                else {
                ...
                delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, lt(s), F({
                    logical_parent: s,
                    canvas: s.canvas
                }), s.calc_width = s.width_float * r.jigsaw_piece_scale_to_actual, s.calc_height = s.height_float * r.jigsaw_piece_scale_to_actual, s = null, c.item_under_mouse = null, vt(), H()
            }
        }
        ...
        function oi(b) {
            function m(i, r, n, a, s, o) {
                var e = f[i][r][n],
                    t = f[a][s][o];
                return M.testCurveCurveIntersection(e[0], e[1], e[2], e[3], t[0], t[1], t[2], t[3]) ? !0 : M.testCurveCurveIntersection(e[3], e[4], e[5], e[6], t[0], t[1], t[2], t[3]) ? !0 : M.testCurveCurveIntersection(e[0], e[1], e[2], e[3], t[3], t[4], t[5], t[6]) ? !0 : M.testCurveCurveIntersection(e[3], e[4], e[5], e[6], t[3], t[4], t[5], t[6]) ? !0 : !1
            }

            function it(n, s, l, c, p, _, f, g) {
            ...
            for (var h = (b.success || function() {}, b.source_image), _ = b.size_x, v = b.size_y, N = b.width, B = b.height, z = b.draw_settings, y = [], M = G(), W = 100 / _, V = 100 / v, n = 0; _ >= n; n++) {
                y[n] = [];
                for (var i = 0; v >= i; i++) {
                    var tt = 0 == n || n == _ ? 0 : .25 * Math.randBMT(),
                        et = 0 == i || i == v ? 0 : .25 * Math.randBMT();
                    y[n][i] = [(n + tt) * W, (i + et) * V]
                }
            }
            for (var J = [
                ...
                for (var A = J[s], T = 0; T < A[4]; T++) O.push([A[0], A[1], A[2], A[3]]);
            var f = [];
            for (vh = 0; 2 > vh; vh++) {
                f[vh] = [];
                for (var n = 0; _ + vh > n; n++) {
                    f[vh][n] = [];
                    for (var i = 0; v + (1 - vh) > i; i++) {
                        ...
                        if ((0 == i || i == v + 1 - vh - 1) && 0 == vh || (0 == n || n == _ + vh - 1) && 1 == vh) e = [e[0], e[e.length - 1]];
                        else {
                            var $ = Math.randInt(0, O.length - 1),
                                p = O[$];
                            e[1] = [p[0][0] - 10 + 20 * Math.randBMT(), p[0][1] - 10 + 20 * Math.randBMT()], e[5] = [p[1][0] - 10 + 20 * Math.randBMT(), p[1][1] - 10 + 20 * Math.randBMT()], "undefined" != typeof p[2] && (e[2][0] = p[2][0], e[4][0] = p[2][1]);
                            var Z = Math.randInt(0, 1);
                            if (1 == Z) {
                                var Y = e[1][0];
                                e[1][0] = 300 - e[5][0], e[5][0] = 300 - Y
                            }
                            if ("undefined" != typeof p[3]) var K = p[3] - 5 + 10 * Math.randBMT();
                            else if (0 != Math.randInt(0, 4)) var K = 70 + 20 * Math.randBMT();
                            else var K = 60 + 40 * Math.randBMT();
                            e[2][1] = e[3][1] = e[4][1] = K;
                            var Q = Math.randInt(0, 1);
                            if (1 == Q)
                                for (var s = 1, c = e.length; c - 1 > s; s++) e[s][1] = -e[s][1]
                        }
                        for (var s = 0, c = e.length; c > s; s++) {
                            ...
                            e[s][0] = e[s][0] / 300 * W + y[n][i][0], e[s][1] = e[s][1] / 300 * V + y[n][i][1]
                        }
                        var c = e.length;
                        e[c - 1] = 0 == vh ? [y[n + 1][i][0], y[n + 1][i][1]] : [y[n][i + 1][0], y[n][i + 1][1]];
                        for (var s = 0; c > s; s++) e[s][0] = e[s][0].toFixed(4), e[s][1] = e[s][1].toFixed(4);
                        for (var j = new Array(c), s = 0; c > s; s++) j[s] = [e[s][0] / 100 * N, e[s][1] / 100 * B];
                        if (f[vh][n][i] = j, j.length > 2 && i > 0 && n > 0 && vh > 0) {
                            var e = f[vh][n][i];
                            if (M.testCurveCurveIntersection(e[0], e[1], e[2], e[3], e[3], e[4], e[5], e[6]) && Math.random() > .01) {
                                i -= 1;
                                continue
                            }
                            if (0 == vh) {
                                if (m(vh, n, i, 1 - vh, n, i) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                                if (i > 0 && m(vh, n, i, 1 - vh, n, i - 1) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                                if (i > 0 && _ - 1 > n && m(vh, n, i, 1 - vh, n + 1, i - 1) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                                if (_ - 1 > n && m(vh, n, i, 1 - vh, n + 1, i) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                            } else {
                                ...
                                if (n > 0 && m(vh, n, i, 1 - vh, n - 1, i) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                                if (n > 0 && v - 1 > i && m(vh, n, i, 1 - vh, n - 1, i + 1) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                                if (v - 1 > i && m(vh, n, i, 1 - vh, n, i + 1) && Math.random() > .01) {
                                    i -= 1;
                                    continue
                                }
                            }
            ...
            for (var D = [], H = "", X = 0, n = 0; _ > n; n++) {
                ...
                for (var i = 0; v > i; i++) {
                    for (var w = [], C = [], E = "", S = "", o = {
                            ...
                            x1: 0,
                            y1: 0
                        }, d = (f[0][n][i][0][0], f[0][n][i][0][1], []), u = 0; 4 > u; u++) {
                        var L = 0,
                            e = f[u % 2 == 0 ? 1 : 0][n + (2 == u ? 1 : 0)][i + (3 == u ? 1 : 0)],
                            c = e.length;
                        if (2 >= c) var o = {
                            x0: e[0][0] < o.x0 ? e[0][0] : o.x0,
                            y0: e[0][1] < o.y0 ? e[0][1] : o.y0,
                            x1: e[1][0] > o.x1 ? e[1][0] : o.x1,
                            y1: e[1][1] > o.y1 ? e[1][1] : o.y1
                        };
                        else
                            for (var s = 0; 4 > s; s += 3) var x = it(e[0 + s][0], e[0 + s][1], e[1 + s][0], e[1 + s][1], e[2 + s][0], e[2 + s][1], e[3 + s][0], e[3 + s][1]),
                                o = {
                        ...
                        for (var s = u % 3 == 0 ? c - 1 : 0, T = 0; c > T; T++)(0 == u || 2 >= c || 0 != T) && (T % 3 == 1 && c > 2 && ("M" != E && d.push({
                            ...
                            s: w.length,
                            p: d
                        }), d = []), L += 1, E = "C", S += " C "), S += e[s][0].toFixed(4) + "," + e[s][1].toFixed(4), C.push([parseFloat(e[s][0].toFixed(4)), parseFloat(e[s][1].toFixed(4))]), T != c - 1 && (S += " ")), u % 3 == 0 ? s-- : s++
                    }
                    d.push({
                        type: E,
                        points: C
                    ...
                    var q = a(o),
                        ...
                        l = mt();
                    l.x = [n], l.y = [i], l.piece_id = X, l.width = Math.ceil(F + 2 * t.piece_margin) / t.piece_logical_scale, l.height = Math.ceil(U + 2 * t.piece_margin) / t.piece_logical_scale, l.width_float = F, l.height_float = U, l.puzzle_width = [F], l.puzzle_height = [U], l.puzzle_left_min = q.x0, l.puzzle_top_min = q.y0, l.puzzle_left = [o.x0], l.puzzle_top = [o.y0], l.side_set = [w], l.placed = !1, D[n][i] = l, X += 1
                }
            }
            var k = document.createElement("canvas"),
                I = k.getContext("2d");
            k.width = (N + 2 * t.piece_margin) / t.piece_logical_scale, k.height = (B + 2 * t.piece_margin) / t.piece_logical_scale;
            var P = h.naturalWidth / h.width,
                rt = P * h.width <= h.naturalWidth ? P * h.width : h.naturalWidth,
                nt = P * h.height <= h.naturalHeight ? P * h.height : h.naturalHeight;
            I.drawImage(h, 0, 0, rt, nt, t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale, h.width / t.piece_logical_scale, h.height / t.piece_logical_scale), I.save(), I.translate(t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale), r.jigsaw_use_3d_effect && g({
                canvas: k,
                draw_settings: z,
        ...
        function It(e) {
            function u() {
                for (var t = 0; _ > t; t++) {
                    ...
                    if (1 == n || !e.placed) {
                        var m = !1;
                        0 == n && e.sprite && (m = !0, O(e)), e.shape_string = Z(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), xt(e, p), F({
                            canvas: e.canvas,
                            logical_parent: e
        ...
        function F(t) {
            ...
            return n.addChildAt(e.sprite, o), R(), "undefined" != typeof n && n == i.piece_sprite_container && 1 == a && (n.is_cached = !1), e
        }

        function O(e, r) {
            if ("undefined" == typeof r && (r = !1), "undefined" != typeof e && e.texture) {
                var t = e.sprite.parent;
                "undefined" != typeof t && e.sprite.parent.removeChild(e.sprite), e.texture.destroy(!0), e.texture = null, e.sprite = null, "undefined" != typeof t && t == i.piece_sprite_container && 1 == r && (t.is_cached = !1), R()
            }
        }
        ...
        function kt(e) {
            ...
            Object.defineProperty(e, "children", {
                ...
                t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), R(), Bt()
            }, e.removeChild = function(t) {
                e.children.splice(e.children.indexOf(t), 1), R(), Bt()
        ...
        function xt(e, c, n) {
            ...
            r.save(), m({
                ...
                lineWidth: 0,
                canvas: i
            }), r.clip(), e.dummy_canvas = document.createElement("canvas");
            var _ = Z(e.side_set, [-e.puzzle_left_min + a + o, -e.puzzle_top_min + a + o], 1 / s);
            if (e.path = new Path2D(_), c instanceof HTMLImageElement) {
            ...
            r.restore(), f && (r.save(), r.translate(t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale), g({
                canvas: i,
                draw_settings: w,
                stroke_width: w.stroke_width,
                cut_multiplier: w.cut_multiplier,
                ...
                clear_stroke: !p,
                game_instance: t
            }), r.restore()), p && (r.save(), dt(i, y), r.restore())
        }
        ...
        var K = C.game_data.jigsaw,
            ...
            I = C.player_data,
            nt = C.game_data.entry_list[S],
            $ = C.set_name,
            et = r.game_type,
            y = {},
            w = {},
            t = y.game_instance = {},
            it = K.difficulty_levels[I.selected_difficulty];
        t.difficulty_level = I.selected_difficulty, t.get_piece_count = function() {
            return t.tile_x * t.tile_y
        }, t.intro_audio_count = 0, !r.is_kiosk && r.use_social_media_buttons && Q();
        ...
        if (t.force_screen_refresh = 0, hi(), void
            function() {
            ...
            }(), _.style.overflow = "hidden", n(_), y.menu_item_list = [C.menu.generic.about, C.menu.generic.ogle_trophies, {
                text: "Restart",
                action: function(r, e, t) {
                ...
                action: function() {
                    ot(c.current_category.piece_container), H(), y.help_menu_obj.close()
                }
            ...
            var Et = y.social_sharing_button_container = document.createElement("div");
            Et.className = "jt-play-social_sharing_button_container", _.appendChild(Et), N({
                parent: Et,
        ...
        Y.className = "jt-play-bottom_bar jt-play-main_image_border_width", n(Y), _.appendChild(p), p.hide_title = function(e) {
            var e = e || {};
            "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), r.jigsaw_minimal_ui && (e.duration = 0), c.style.display = "", 0 == e.duration ? (p.inner.style.top = p.hidden_top_value, c.style.top = 0, p.inner.style.display = "none", e.callback()) : (TweenMax.to(c, e.duration / 1e3, {
                parseTransform: !0,
                ease: Linear.ease,
                css: {
                    top: 0
            ...
            var e = e || {};
            "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), r.jigsaw_minimal_ui && (e.duration = 0), p.inner.style.display = "", 0 == e.duration ? (c.style.top = p.hidden_top_value, p.inner.style.top = 0, c.style.display = "none", e.callback()) : (TweenMax.to(p.inner, e.duration / 1e3, {
                parseTransform: !0,
                ease: Linear.ease,
                css: {
                    top: 0
        ...
        c.className = "jt-jigsaw-category_deck", c.item_under_mouse = null, p.appendChild(c), c.edit_button = document.createElement("img"), c.edit_button.className = "jt-op_button jt-op_button-edit" + (r.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), c.edit_button.src = r["/"] + "images/gui/gui-item_edit.png", c.appendChild(c.edit_button), c.add_button = document.createElement("img"), c.add_button.className = "jt-op_button jt-op_button-add" + (r.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), c.add_button.src = r["/"] + "images/gui/gui-item_expand_or_add.png", c.appendChild(c.add_button), c.basket_button = document.createElement("img"), c.basket_button.className = "jt-op_button jt-op_button-basket" + (r.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), c.basket_button.piece_list = [], c.basket_button.is_selected = !1, c.basket_button.src = r["/"] + "images/gui/gui-basket.png", c.appendChild(c.basket_button), c.remove_button = document.createElement("img"), c.remove_button.className = "jt-op_button jt-op_button-remove" + (r.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), c.remove_button.src = r["/"] + "images/gui/gui-item_remove.png", c.appendChild(c.remove_button), c.container = document.createElement("div"), c.container.className = "jt-jigsaw-category_deck-container", c.appendChild(c.container), c.add_category = function(s) {
            var e = document.createElement("div");
            ...
            i.className = "jt-jigsaw-piece_container", kt(i);
            K.difficulty_levels[t.difficulty_level];
            i.piece_matrix = [];
            ...
            return "undefined" == typeof c.current_category && (c.select_category(e), c.original_category = e), e.addEventListener(r.events.POINT, function(e) {
                c.select_category(e.currentTarget), H()
            }), e.is_category_deck_item = !0, e
        }, c.set_category_name = function(e, t) {
            var i = p.style.display;
            p.style.display = "block", e.inner.innerHTML = t, e.style.padding = 0, e.style.border = "none", k(e.inner, {
                unit_type: "px",
            ...
            t.parentNode && t.parentNode.removeChild(t), c.original_category && (e != c.original_category ? ot(c.original_category.piece_container, i) : delete c.original_category), 1 == c.container.children.length && delete c.current_category, c.container.removeChild(e)
        }, c.select_category = function(e) {
            "undefined" != typeof e && (c.current_category = e, i.piece_container = e.piece_container, R(), c.refresh(), c.container.children.forEach(function(t) {
                if (t == e) var i = "add";
                else var i = "remove";
            ...
            if ("undefined" != typeof t)
                for (var r = 0, a = t.length; a > r; r++) {
                    ...
                    if ("undefined" != typeof e && null != e)
                        if (n.parentNode != c.current_category.piece_container && n.parentNode != u) {
        ...
        }, c.edit_button.addEventListener(r.events.POINT, function() {
            ...
            A.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
                return "" === t ? void smoke.alert("You can't set a blank name!", function() {
                    A.resume()
                }) : (A.resume(), void(t !== !1 && (c.set_category_name(e, t), H())))
            })
        }), c.add_button.addEventListener(r.events.POINT, Rt);
        var V = c.basket_button;
        V.addEventListener(r.events.POINT, function(t) {
            var e = t.currentTarget,
            ...
            e.classList[e.is_selected ? "remove" : "add"]("jt-op_button-basket" + (r.is_phone_or_tablet ? "-colored" : "") + "-selected"), e.is_selected && !n && Rt({
                ...
                success: function(t) {
                    ...
                    }), ot(t.piece_container), e.piece_list = [], H()
                }
            }), e.is_selected = !e.is_selected
        }), V.toggle_piece = function(e, t) {
            -1 != V.piece_list.indexOf(e) ? V.remove_piece(e, t) : V.add_piece(e, t)
        }, V.remove_piece = function(t, e) {
            "undefined" == typeof e && (e = {});
            var r = "undefined" == typeof e.modify_array ? !0 : e.modify_array;
            if (r) {
                var i = V.piece_list.indexOf(t); - 1 != i && V.piece_list.splice(i, 1)
            }
            lt(t)
        }, V.add_piece = function(e, t) {
            ...
            O(e), e.canvas = document.createElement("canvas"), xt({
                ...
                canvas: e.canvas,
                invalidate: !0
            }), i && V.piece_list.push(e)
        }, c.remove_button.addEventListener(r.events.POINT, function() {
            function t(t) {
                A.resume(), 0 != t && (c.remove_category(e), c.select_category(c.original_category), H())
            }
            A.stop();
            var e = c.current_category;
        ...
        var A = y.timer_obj = rt({
            parent: p
        });
        y.timer_obj.style.display = r.show_timer ? "" : "none", n(A), y.refresh_gui_display = function() {
            var e = y.trophy_ribbon;
            e.style.display = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? "" : "none", r.jigsaw_minimal_ui ? (d.style.borderWidth = 0, p.classList.add("minimal_ui"), p.classList.add("jt-play-title-minimal_ui"), p.inner.classList.add("jt-play-title-inner-minimal_ui"), _.classList.add("jt-play-action_area-minimal_ui"), y.menu_button_obj.classList.add("jt-play-menu_button-minimal_ui"), y.timer_obj.classList.add("jt-play-timer-minimal_ui"), y.menu_button_obj.setAttribute("current_text", "M"), _.appendChild(y.timer_obj), _.appendChild(y.menu_button_obj), _.appendChild(p), Y.parentNode == _ && _.removeChild(Y)) : (d.style.borderWidth = "", p.classList.remove("jt-play-title-minimal_ui"), p.inner.classList.remove("jt-play-title-inner-minimal_ui"), d.classList.remove("jt-play-action_area-minimal_ui"), y.menu_button_obj.classList.remove("jt-play-menu_button-minimal_ui"), y.timer_obj.classList.remove("jt-play-timer-minimal_ui"), _.insertBefore(p, d), _.insertBefore(Y, d.nextSibling), p.insertBefore(y.timer_obj, p.childNodes[0]), p.appendChild(y.menu_button_obj)), Ot()
        };
        var At = y.help_menu_obj = M({
                gs: r,
                parent: _,
                current_game: y,
        ...
        nt.use_image_title ? B({
            image_src: r.get_set_directory($) + "/puzzle/" + S + "-title.png",
            fix_ie_bug: !0,
            color: "#edd9a7",
            callback: function(e) {
        ...
        }) : (p.inner = document.createElement("div"), p.inner.className = "jt-play-title-inner", p.appendChild(p.inner), p.inner.text = document.createElement("p"), p.inner.text.innerHTML = nt.name, p.inner.appendChild(p.inner.text), k(p.inner.text, {
            unit_type: "px",
            transform_scale: _.content_scale
        }));
        var d = document.createElement("div");
        d.className = "jt-play-action_area", d.style.overflow = "hidden", _.appendChild(d), r.is_phone_or_tablet || d.addEventListener("mousedown", function(e) {
            e.preventDefault()
        ...
        i.renderer = $t, i.stage = yt, i.piece_sprite_container = Nt, i.real_stage = ht, ht.addChild(yt), yt.addChild(Nt), i.load_opacity_transition = .5, i.style.pointerEvents = "none", i.bg = document.createElement("canvas"), i.bg.image = new Image, i.bg.image.src = C.background_image_url, i.reposition_and_resize = function() {
            var t = L(_),
                n = o(_),
                e = _.content_scale,
                a = parseFloat(getComputedStyle(d).top),
                l = r.jigsaw_minimal_ui ? 0 : o(Y);
        ...
        u.className = "jt-play-main_image jt-jigsaw-main_image", n(u), kt(u), u.classList.add("jt-jigsaw-main_image-active");
        var T = u.base_image = document.createElement("img"),
            v = document.createElement("div");
        v.className = "jt-jigsaw-piece_deck";
        var D, P, s = null;
        T.crossOrigin = "Anonymous", r.get_image(T, $, S, "default"), T.addEventListener("load", function() {
            null != d && d.inner.setTimeout(jt, 30)
        });
        var f = new Image;
        f.src = r.get_set_directory(C.set_name) + "/gui/gui-loading.png", f.logical_parent = i, i.loading_animation = f, f.defer_start = function(e) {
            d.inner.setTimeout(function() {
                f && !f.game_initialized && (f.start(), at(void 0, !0))
            }, e)
        }, f.start = function() {
            1 != !!f.game_initialized && (f.stage.alpha = 1, f.display = !0, ht.addChild(f.stage), R())
        }, f.stop = function() {
            f.stage && (f.stage.alpha = 1), f.game_initialized = !0, f.display && (f.display = !1, ht.removeChild(f.stage)), R()
            ...
            if (null != d && d.isAttached()) {
                ...
                o.drawImage(f, e, 0, e, t, 0, 0, e, t), f.outer = {}, F({
                ...
                o.drawImage(f, 0, 0), f.inner = {}, F({
                    logical_parent: f.inner,
                    parent: f.stage,
                    canvas: n
                }), f.inner.sprite.x = a, f.inner.sprite.y = s, f.inner.sprite.width = e, f.inner.sprite.height = t, f.start(), at(void 0, !0)
            }
        }), y.refresh_gui_display(), at(void 0, !0);
        var gt = y.set_base_image_size = function() {
                var e = ai();
                ...
                }(), Ot(), u.left = (parseFloat(window.getComputedStyle(_).width) - T.width) / 2, u.width = T.width, u.height = T.height;
        ...
        _.cleanup = function() {
            if (r.IS_CORDOVA && r.audio_container[C.last_intro_audio] && (r.audio_container[C.last_intro_audio].src = "", delete r.audio_container[C.last_intro_audio], C.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), ci(), null != i.parentNode && document.body.removeChild(i), A.destroy(), document.removeEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? _.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", pt), window.removeEventListener("mouseout", Ft)), _.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof D)
                for (var e = 0; e < t.tile_x + 1; e++) {
                    D[e] = [];
                    for (var n = 0; n < t.tile_y + 1; n++) D[e][n] = void 0
                }
            ...
            C = null, r = null, S = null, K = null, ui = null, I = null, nt = null, $ = null, et = null, y = null, w = null, t = null, it = null, R = null, wt = null, p = null, c = null, V = null, A = null, At = null, Yt = null, d = null, i = null, u = null, T = null, v = null, s = null, D = null, P = null, f = null, gt = null, St = null, H = null, Mt = null, delete _.cleanup
        }, v.drag_active = !1, v.drag_start = function(e) {
            v.drag_active = !0, v.touch_id = e.identifier, v.drag_update(e, !0)
        }, v.drag_update = function(s, o) {
            if (0 != v.drag_active) {
                var e = h(s, d),
                    i = e[0] / _.content_scale,
                    r = e[1] / _.content_scale,
                    l = t.zoom.scale,
                    n = t.zoom.offset_x,
                    a = t.zoom.offset_y;
                o || (n += i - v.drag_initial_x, a += r - v.drag_initial_y), t.zoom.offset_x = n, t.zoom.offset_y = a, v.drag_initial_x = i, v.drag_initial_y = r, v.drag_initial_scale = l
            }
        }, v.drag_end = function() {
            v.touch_id = null, v.drag_active = !1
        };
        var ut = void 0,
            H = y.save_puzzle_state = function() {
                var e = {};
                e.game_instance = {
                ...
                }, e.counter = y.timer_obj.counter, e.zoom = t.zoom, e.piece_list = [], P.forEach(function(t) {
                    var t = Pt(t);
                    delete t.width, delete t.height, e.piece_list.push(t)
                }), e.category_deck = {};
                var r = e.category_deck.container = [];
                ...
                i[et + "." + S + "." + I.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + et + "." + S + "." + I.selected_difficulty] = JSON.stringify(e)
            },
            Mt = y.load_puzzle_state = function(s) {
                function o() {
                    ...
                    r.forEach(function(e) {
                        var r = c.add_category(e.innerHTML),
                            n = e.pieces,
                            a = r.piece_container;
                        n.forEach(function(e) {
                            var i = t[e.piece_id];
                            a.appendChild(i)
                        }), e.innerHTML == i && c.select_category(r), St(r.piece_container.children)
                    }), Xt() && ct(), s.callback()
                }
                var e = JSON.parse(localStorage["puzzle_states." + et + "." + S + "." + I.selected_difficulty]);
                t.jigsaw_initial_show_hint_image = e.game_instance.jigsaw_initial_show_hint_image, t.jigsaw_show_hint_image = r.jigsaw_show_hint_image, t.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, t.jigsaw_arrange_pieces_on_entire_area = e.game_instance.jigsaw_arrange_pieces_on_entire_area;
                var a = e.game_instance.action_area_height,
                    i = e.game_instance.base_image_width_to_naturalWidth;
                if ("undefined" == typeof i && (i = 1), "undefined" != typeof a) var l = parseFloat(window.getComputedStyle(d.inner).height) / a;
                y.timer_obj.counter = e.counter, gt();
                var h = T.width / T.naturalWidth / i;
                t.zoom = e.zoom, D = [];
                for (var n = 0; n < t.tile_x; n++) D[n] = [];
                P = e.piece_list, y.redraw_main_image_and_pieces({
                    piece_rescale: h,
                    top_rescale: l,
                    callback: o
                })
        ...
        y.redraw_main_image_and_pieces = function(p) {
            function S() {
                ...
                e.save(), m({
                    ...
                    lineWidth: 0,
                    canvas: o
                }), e.clip(), e.drawImage(h, -t.piece_margin / t.piece_logical_scale, -t.piece_margin / t.piece_logical_scale), e.restore(), e.save(), e.translate(t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale), dt(o), e.restore(), F({
                    parent: i.stage,
                    canvas: o,
                    position: 1,
                    is_2d: !0
                }), o.sprite.x = u.left - t.piece_margin, o.sprite.y = u.top - t.piece_margin, "undefined" != typeof E && E()
            }
            "undefined" == typeof p && (p = {});
            var s = p.piece_rescale,
                A = p.top_rescale || 1,
                E = p.callback;
            t.pieces_in_position_count = 0;
            for (var b = [], _ = [], d = 0; d < P.length; d++) {
                var e = P[d];
                if ("undefined" != typeof s && (e.width_float = Math.round(e.width_float * s * 1e3 / 1e3), e.height_float = Math.round(e.height_float * s * 1e3 / 1e3), e.puzzle_left_min = Math.round(e.puzzle_left_min * s * 1e3 / 1e3), e.puzzle_top_min = Math.round(e.puzzle_top_min * s * 1e3 / 1e3), e.width = Math.ceil(e.width_float / t.piece_logical_scale), e.height = Math.ceil(e.height_float / t.piece_logical_scale), e.puzzle_width.forEach(function(i, t) {
                    ...
                    }), e.side_set = li(e.side_set, s)), e.width = Math.ceil((e.width_float + 2 * t.piece_margin) / t.piece_logical_scale), e.height = Math.ceil((e.height_float + 2 * t.piece_margin) / t.piece_logical_scale), e.placed) {
                    t.pieces_in_position_count += e.x.length, e.shape_string = Z(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), b.push(e);
                    for (var l = 0, x = e.x.length; x > l; l++) D[e.x[l]][e.y[l]] = e
                } else {
                    if (_.push(e), P[d].canvas) var n = P[d];
                    else var n = mt();
                    n.x = a(e.x), n.y = a(e.y), n.zIndex = a(e.zIndex), n.piece_id = e.piece_id, n.width_float = e.width_float, n.height_float = e.height_float, n.width = e.width, n.height = e.height, n.virtual_left = e.virtual_left, n.virtual_top = e.virtual_top * A, n.puzzle_width = a(e.puzzle_width), n.puzzle_height = a(e.puzzle_height), n.puzzle_left_min = e.puzzle_left_min, n.puzzle_top_min = e.puzzle_top_min, n.puzzle_left = a(e.puzzle_left), n.puzzle_top = a(e.puzzle_top), n.side_set = a(e.side_set), n.placed = !1, P[d] = n;
                    for (var l = 0, x = n.x.length; x > l; l++) D[n.x[l]][n.y[l]] = n
                }
            }
            R();
            var M = st(b, r.jigsaw_combine_pieces),
                y = [];
            ...
            var f = h.getContext("2d"),
                k = c.naturalWidth,
                C = c.naturalHeight;
            f.drawImage(c, 0, 0, k, C, t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale, c.width / t.piece_logical_scale, c.height / t.piece_logical_scale), f.save(), f.translate(t.piece_margin / t.piece_logical_scale, t.piece_margin / t.piece_logical_scale), r.jigsaw_use_3d_effect && g({
                canvas: h,
                draw_settings: w,
                stroke_width: w.stroke_width,
                cut_multiplier: w.cut_multiplier,
    ...
    function _t(r) {
        function s() {
            t.is_active || (t.title_index = (t.title_index + 1) % t.title_list.length, t.innerHTML = t.title_list[t.title_index]), t.setTimeout(s, 4e3)
        }
        var n = r.select_screen,
            a = (r.content_div, r.mr_jigtato),
            i = r.gs,
            o = n.header,
            t = document.createElement("div");
        return t.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-2 jt-button hoverable", t.title_list = ["Tell a friend!", "Earn extra puzzle packs!", "Get 10 gems per friend!"], t.title_index = t.title_list.length - 1, s(), t.addEventListener(i.events.POINT, function() {
            t.toggle()
        }), t.toggle = function() {
            ...
            c({
                ...
                success: function() {
                    t.is_active = !0, o.querySelectorAll(".jt-button").forEach(function(e) {
            ...
            t.is_active = !1, o.querySelectorAll(".jt-button").forEach(function(e) {
        ...
        }, t.select_puzzle = function(f) {
            function _() {
                function a(a) {
                    return i.log_user_action("Tell-a-friend: email entered: " + a), a === !1 ? void t.deactivate() : void c({
                        gs: i,
                        error: function() {
                        ...
                        success: function() {
                            e({
                                file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (i.DEBUG ? "-beta" : "") + ".php?action=social_challenge_a_friend&user_id=" + i.account.user_id + "&internal_access_token=" + i.account.internal_access_token + "&puzzle_name=" + r + "&selected_difficulty=" + n + "&best_time=" + l + "&email_address_list=" + a,
                                error: function(e) {
            ...
            if ("undefined" == typeof o[r]);
                ...
                if ("undefined" == typeof o[r][n]) {
                    var n = 0;
                    for (var u in o[r]) u > n && (n = u)
                } {
                    var p = a.game_data.jigsaw.difficulty_levels[n].name.capitalize(),
                        l = o[r][n],
                        d = (l - l % 60) / 60,
                        m = l % 60,
                        g = (d > 0 ? d + " minutes, " : "") + m + " seconds",
                        y = a.game_data.entry_list[r].name;
                    'Your best time on "' + y.capitalize().replace(/_/g, " ") + '" in ' + p + " mode is " + g + ", with the hint image " + (1 == s ? "ON" : "OFF") + "."
                }
            }
            _()
        }, t
    ...
    function A(t) {
        var i = t.gs,
            ...
            n = (t.error, function(e) {
                ...
                smoke.alert("CHALLENGE code provided by your friend, " + e.challenger_name + ", " + auto_accept + 'accepted. You have received 10 gems and access to the "' + e.puzzle_name.capitalize() + '" puzzle!', t.success), "undefined" != typeof e.gem_amount && (i.account.gem_amount = e.gem_amount)
            });
        e({
    ...
    var S = "safari",
        R = "com.flyingsoft.safari.jigsaw",
        s = !0,
        d = !0;
    ! function(s, r) {
        var i, a, t, e, n;
    ...
    "undefined" != typeof module && null != module && (module.exports = t), ! function(n, a, i, e, u, g, s, o, l) {
        ...
        e.WEBGL_RENDERER = 0, e.CANVAS_RENDERER = 1, e.VERSION = "v1.6.1", e.blendModes = {
            ...
            if (0 !== t.length) {
                ...
                var E, b, _, p, a, n, M, S, r, i, g, f, v, y, z, P, k, R, O, L, C, G, l, s = U.points,
                    I = U.indices,
                    T = t.length / 2,
                    F = t.length,
                    j = s.length / 6,
            ...
            if (1e-8 > u || 0 === c) n.push(a, o);
                ...
                var p = t * t + e * e,
                    ...
                    A = Math.atan2(C - h, E - d);
                this.arc(d + a, h + o, c, S, A, e * r > i * t)
            }
            return this.dirty = !0, this
            ...
            for (var E = 0; S - 2 > E; E++) {
                ...
                var b = g * d + f * _ + m * o - d * _ - f * m - g * o,
                    ...
                    M = g * c + l * _ + m * h - c * _ - l * m - g * h,
                    k = g * d * h + f * c * _ + l * m * o - l * d * _ - f * m * h - g * c * o,
                    R = u * d + f * p + s * o - d * p - f * s - u * o,
                    L = g * s + u * _ + m * p - s * _ - u * m - g * p,
                    P = g * d * p + f * s * _ + u * m * o - u * d * _ - f * m * p - g * s * o;
                r.transform(A / b, R / b, M / b, L / b, k / b, P / b), r.drawImage(y.texture.baseTexture.source, 0, 0), r.restore()
            }
                                ...
                                if (n = y[s], "color" == s) {
                                    for (e = new t.ColorTimeline(n.length), e.slotIndex = b, a = 0, r = 0, l = n.length; l > r; r++) {
                                        ...
                                        var d = i.color,
                                            ...
                                            M = t.SkeletonJson.toColor(d, 3);
                                        e.setFrame(a, i.time, C, S, A, M), t.SkeletonJson.readCurve(e, a, i), a++
                                    }
        ...
        function M(t, i, r) {
            M._super_.call(this), this.radius = e.Util.setSpanValue(t, i, r)
        }
        ...
        function k(e, t) {
            k._super_.call(this), this.x = e, this.y = t
        }
        ...
        }, e.Mass = B, e.Util.inherits(M, e.Initialize), M.prototype.reset = function(t, i, r) {
        ...
        }, e.Radius = M, e.Util.inherits(A, e.Initialize), A.prototype.initialize = function(t) {
        ...
        }, e.CircleZone = m, e.Util.inherits(k, e.Zone), k.prototype.getPosition = function() {
            return this.vector.x = this.x, this.vector.y = this.y, this.vector
        }, k.prototype.crossing = function() {
            this.alert && (alert("Sorry PointZone does not support crossing method"), this.alert = !1)
        }, e.PointZone = k, e.Util.inherits(R, e.Zone), R.prototype.getPosition = function() {
    ...
    if ((r._gsQueue || (r._gsQueue = [])).push(function() {
            ...
            r._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(n, u, t) {
                    ...
                    return e.constructor = r, e.kill()._gc = !1, r.version = "1.13.1", e.invalidate = function() {
                        ...
                        if (r >= v ? (this._locked || (this._totalTime = v, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (y = !0, h = "onComplete", 0 === this._duration && (0 === r || 0 > s || s === i) && s !== r && this._first && (u = !0, s > i && (h = "onReverseComplete"))), this._rawPrevTime = this._duration || !a || r || this._rawPrevTime === r ? r : i, this._yoyo && 0 !== (1 & this._cycle) ? this._time = r = 0 : (this._time = n, r = n + 1e-4)) : 1e-7 > r ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== c || 0 === n && s !== i && (s > 0 || 0 > r && s >= 0) && !this._locked) && (h = "onReverseComplete", y = this._reversed), 0 > r ? (this._active = !1, s >= 0 && this._first && (u = !0), this._rawPrevTime = r) : (this._rawPrevTime = n || !a || r || this._rawPrevTime === r ? r : i, r = 0, this._initted || (u = !0))) : (0 === n && 0 > s && (u = !0), this._time = this._rawPrevTime = r, this._locked || (this._totalTime = r, 0 !== this._repeat && (m = n + this._repeatDelay, this._cycle = this._totalTime / m >> 0, 0 !== this._cycle && this._cycle === this._totalTime / m && this._cycle--, this._time = this._totalTime - this._cycle * m, this._yoyo && 0 !== (1 & this._cycle) && (this._time = n - this._time), this._time > n ? (this._time = n, r = n + 1e-4) : 0 > this._time ? this._time = r = 0 : r = this._time))), this._cycle !== f && !this._locked) {
                            ...
                            this._time = A, this._totalTime = E, this._cycle = C, this._rawPrevTime = S
                        }
                ...
                function() {
                    ...
                    var W, gt, H, _t, ft, A, P = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
                        ...
                        M = y.defaultView ? y.defaultView.getComputedStyle : function() {},
                        i = a.getStyle = function(i, t, r, a, n) {
                            var e;
                            return v || "opacity" !== t ? (!a && i.style[t] ? e = i.style[t] : (r = r || M(i)) ? e = r[t] || r.getPropertyValue(t) || r.getPropertyValue(t.replace(lt, "-$1").toLowerCase()) : i.currentStyle && (e = i.currentStyle[t]), null == n || e && "none" !== e && "auto" !== e && "auto auto" !== e ? e : n) : nt(i)
                        },
                        ...
                        At = function(e, s, t) {
                            var r = parseFloat("width" === s ? e.offsetWidth : e.offsetHeight),
                                n = Mt[s],
                                a = n.length;
                            for (t = t || M(e, null); --a > -1;) r -= parseFloat(i(e, "padding" + n[a], t, !0)) || 0, r -= parseFloat(i(e, "border" + n[a] + "Width", t, !0)) || 0;
                            return r
                        },
                        $ = function(e, r) {
                    ...
                    var ht = function(e, o, h, a) {
                        ...
                        j = a.parseComplex = function(k, C, u, _, M, T, e, A, S, b) {
                            u = u || T || "", e = new s(k, C, 0, 0, e, b ? 2 : 1, null, !1, A, u, _), _ += "";
                            ...
                            for ((-1 !== _.indexOf(",") || -1 !== u.indexOf(",")) && (n = n.join(" ").replace(d, ", ").split(" "), p = p.join(" ").replace(d, ", ").split(" "), m = n.length), m !== p.length && (n = (T || "").split(" "), m = n.length), e.plugin = S, e.setRatio = b, r = 0; m > r; r++)
                                ...
                                else if (M && ("#" === t.charAt(0) || w[t] || ot.test(t))) a = "," === i.charAt(i.length - 1) ? ")," : ")", t = q(t), i = q(i), l = t.length + i.length > 6, l && !v && 0 === i[3] ? (e["xs" + e.l] += e.l ? " transparent" : "transparent", e.e = e.e.split(p[r]).join("transparent")) : (v || (l = !1), e.appendXtra(l ? "rgba(" : "rgb(", t[0], i[0] - t[0], ",", !0, !0).appendXtra("", t[1], i[1] - t[1], ",", !0).appendXtra("", t[2], i[2] - t[2], l ? "," : a, !0), l && (t = 4 > t.length ? 1 : t[3], e.appendXtra("", t, (4 > i.length ? 1 : i[3]) - t, a, !1)));
                            else if (g = t.match(P)) {
                    ...
                    var mt = function(t, e) {
                            e = e || {}, this.p = e.prefix ? k(t) || t : t, f[t] = f[this.p] = this, this.format = e.formatter || ht(e.defaultValue, e.color, e.collapsible, e.multi), e.parser && (this.parse = e.parser), this.clrs = e.color, this.multi = e.multi, this.keyword = e.keyword, this.dflt = e.defaultValue, this.pr = e.priority || 0
                        },
                    ...
                    var yt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                        ...
                        U = u.set3DTransformRatio = function(R) {
                            var w, v, y, m, b, x, p, f, M, T, d, s, A, E, _, S, t, r, i, n, j, I, P, e = this.data,
                                ...
                                k = e.z,
                                g = e.perspective;
                            if (!(1 !== R && 0 !== R || "auto" !== e.force3D || e.rotationY || e.rotationX || 1 !== u || g || k)) return void it.call(this, R);
                            if (_t) {
                                var C = 1e-4;
                    ...
                    t("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
                        parser: function(w, R, u, x, r, k, M) {
                            if (x._transform) return r;
                            var o, b, d, h, g, v, p, t = x._transform = E(w, n, !0, M.parseTransform),
                                T = w.style,
                                C = 1e-6,
                                A = yt.length,
                                e = M,
                    ...
                    e = a.prototype, e._firstPT = null, e._onInitTween = function(r, h, y) {
                        ...
                        this._target = r, this._tween = y, this._vars = h, W = h.autoRound, T = !1, L = h.suffixMap || a.suffixMap, n = M(r, ""), G = this._overwriteProps;
            ...
            if (!S.TweenLite) {
                ...
                var T = i.requestAnimationFrame,
                    ...
                    C = E();
                for (n = ["ms", "moz", "webkit", "o"], a = n.length; --a > -1 && !T;) T = i[n[a] + "RequestAnimationFrame"], k = i[n[a] + "CancelAnimationFrame"] || i[n[a] + "CancelRequestAnimationFrame"];
                u("Ticker", function(_, f) {
                    ...
                    z.call(e), e.time = e.frame = 0, e.tick = function() {
                        ...
                        null != t && (n && k ? k(t) : clearTimeout(t), h = H, t = null, e === r && (o = !1))
                    }, e.wake = function() {
                ...
                e._init = function() {
                    ...
                    if (this._time !== c || r) {
                        ...
                        for (this._lazy !== !1 && (this._lazy = !1), this._active || !this._paused && this._time !== c && e >= 0 && (this._active = !0), 0 === c && (this._startAt && (e >= 0 ? this._startAt.render(e, l, r) : a || (a = "_dummyGS")), this.vars.onStart && (0 !== this._time || 0 === n) && (l || this.vars.onStart.apply(this.vars.onStartScope || this, this.vars.onStartParams || M))), i = this._firstPT; i;) i.f ? i.t[i.p](i.c * this.ratio + i.s) : i.t[i.p] = i.c * this.ratio + i.s, i = i._next;
                        this._onUpdate && (0 > e && this._startAt && this._startTime && this._startAt.render(e, l, r), l || (this._time !== c || h) && this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || M)), a && (!this._gc || r) && (0 > e && this._startAt && !this._onUpdate && this._startTime && this._startAt.render(e, l, r), h && (this._timeline.autoRemoveChildren && this._enabled(!1, !1), this._active = !1), !l && this.vars[a] && this.vars[a].apply(this.vars[a + "Scope"] || this, this.vars[a + "Params"] || M), 0 === n && this._rawPrevTime === s && p !== s && (this._rawPrevTime = 0))
                    }
        ...
        function(t) {
            ...
            var l = t.GreenSockGlobals || t,
                ...
                _ = function(i, y, j, X, F) {
                    ...
                    var w, p, b, s, _, E, x, n, f, l, m, D, O, M = r(i),
                        k = y.type || y.split || "chars,words,lines",
                        g = -1 !== k.indexOf("lines") ? [] : null,
                        v = -1 !== k.indexOf("words"),
                        T = -1 !== k.indexOf("chars"),
                        ...
                        C = y.linesClass;
                    for (z && (C = C.split("++").join("")), b = L(), s = 0; u > s; s++) E = M.charAt(s), ")" === E && M.substr(s, 20) === c ? (b += R + "<BR/>", s !== u - 1 && (b += " " + L()), s += 19) : " " === E && " " !== M.charAt(s - 1) && s !== u - 1 ? (b += R, s !== u - 1 && (b += H + L())) : b += T && " " !== E ? V() + E + "</div>" : E;
                    ...
                    h && (A > i.clientHeight && (i.style.height = A - G + "px", A > i.clientHeight && (i.style.height = A + N + "px")), S > i.clientWidth && (i.style.width = S - W + "px", S > i.clientWidth && (i.style.width = S + U + "px")))
                },
                n = i.prototype;
            n.split = function(t) {
        ...
        var Et = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").get,
            Ct = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").set;
    ...
    var p;
    1 == !!window.IS_READY ? p = y() : window.addEventListener("load", function() {
