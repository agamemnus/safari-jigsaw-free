void function() {
 ...
 function yt(q) {
  ...
  function Ot() {
   var s = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? o(wt) : 0,
    c = o(d);
   ...
   d.style.top = a + "px", d.style.height = n + "px", H.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", i.reposition_and_resize(), P(), "undefined" != typeof E && E.naturalHeight && (e.area && e.area.forEach(function(e) {
    e.height = n * e.height_ratio
   }), u.top = (n - E.height + (E.height - E.height)) / 2), $(), l.container.children.forEach(function(t) {
  ...
  function jt() {
   function n() {
    return 0 == !!i.first_render_complete || r.ad_control && !r.ad_control.ignore && r.ad_control.running || 0 == !!e.log_query_processed ? void d.inner.setTimeout(n, 50) : void qt()
   }
   i.controls_locked = !1, e.jigsaw_initial_show_hint_image = r.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = r.jigsaw_show_hint_rect, e.jigsaw_show_hint_image = r.jigsaw_show_hint_image, e.piece_margin = r.jigsaw_get_scaled_piece_margin(e), e.piece_margin_style = r.jigsaw_piece_margin_style, d.inner.appendChild(w);
   ...
   if (t.set_size = function() {
    ...
    Math.seedrandom(a), l.add_category("General"), oi({
     ...
     draw_settings: T,
     callback: function(t) {
      B = t, ii(B, l.current_category.piece_container), I = Array.prototype.slice.call(l.current_category.piece_container.children), St(I), at(l.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else At({
    callback: n
  ...
  function qt() {
   function n() {
    ...
    }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, w.addEventListener(r.events.POINT_START, Kt), document.addEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? (D({
     target: d.inner,
     result_function: Ut,
   ...
   if (i.loading_animation.stop(), "undefined" == typeof e.pending_message || "" == e.pending_message) n();
   else {
  ...
  function Zt(l) {
   var n = O.jigsaw.best_times[+e.jigsaw_initial_show_hint_image];
  ...
  function ot(l) {
   ...
   function w() {
    ...
    if (n.innerHTML = t.display_name.capitalizeFirstLetter() + ("!" == u || "." == u ? "" : "."), "undefined" != typeof t.text_outline_color) {
   ...
   function g() {
    ...
    h(s), s.dialog.buttons.ok.addEventListener(r.events.POINT, function() {
     n >= 1 && (!window.kiipInstance || r.account && r.account.purchased_ad_removal || window.kiipInstance.postMoment("rank_count: " + n + ", selected_difficulty: " + O.selected_difficulty)), i.fireworks = new xt({
      gs: r,
      draw_area: i
     })
    });
   ...
   if (c || d.inner.setTimeout(function() {
    ...
    localStorage.player_data = JSON.stringify(O), 0 == c ? d.inner.setTimeout(f, s + (l.show_trophy_delay || 550)) : d.inner.setTimeout(f, s + (l.show_trophy_delay || 550))
   }
  }
  ...
  function Ht(e) {
   ...
   if (P(), u.children.forEach(function(e) {
    ...
    r.use_categories = !1, f.autoshow_title(), r.use_categories = t, Yt.morph_to_back_button()
   }
  ...
  function Ft(e) {
   ...
   "undefined" == typeof i && (i = document.body.scrollTop), n >= 0 && n <= window.innerHeight + i && r >= 0 && r <= window.innerWidth + t || X(e)
  }
  ...
  function zt(n) {
   ...
   for (var y = [], b = [], S = [
     ...
     [2, -2, !1],
     [-2, 2, !1]
    ], d = {}, x = n.x, c = u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale, _ = 0, l = u.composite_image.height - 2 * e.piece_margin / e.piece_logical_scale, m = 0, a = 0; a < x.length; a++) {
    var w = n.x[a],
     v = n.y[a];
    B[w][v] = Pt(n)
   }
   ...
   var C = (nt(y, !0), Q(nt(y, r.jigsaw_combine_pieces), [-Math.floor(c), -Math.floor(l)])),
   ...
   }), o.restore(), o.save(), o.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && p({
    canvas: t,
    draw_settings: T,
   ...
   h.texture ? Lt(h) : F({
    ...
    position: 1,
    is_2d: !0
   }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, z(n), n == s && (s = null), gt(), W(), Xt() && ot()
  }
  ...
  function It(t) {
   function u() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, z(e)), e.shape_string = Q(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), yt(e, p), F({
       canvas: e.canvas,
       logical_parent: e
  ...
  function F(t) {
   ...
   if (e.sprite && "undefined" == typeof t.position && -1 != n.children.indexOf(e.sprite) && (o -= 1), (e.canvas || e == r) && z(e), c && r != e ? (r.texture = new PIXI.Texture.fromCanvas(r), e.texture = r.texture, delete r.texture) : e.texture = new PIXI.Texture.fromCanvas(r), e.sprite = new PIXI.Sprite(e.texture), e.sprite.logical_parent = e, e.canvas = e.texture.baseTexture.source, "undefined" != typeof s)
  ...
  function yt(t, c, n) {
   ...
   if (t.path = new Path2D(m), c instanceof HTMLImageElement) {
    var l = (u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale) * e.piece_logical_scale / u.base_image.naturalWidth,
     h = i.width * s / l,
     d = i.height * s / l;
    h > r.width && (h = r.width), d > r.height && (d = r.height), r.drawImage(c, t.puzzle_left_min / l, t.puzzle_top_min / l, h, d, 0, 0, i.width, i.height)
  ...
  var dt = ["answer-correct-10865990.ogg", "answer-correct-23303730.ogg", "answer-correct-25513672.ogg", "answer-correct-25513693.ogg", "answer-correct-37240671.ogg", "answer-correct-37240686.ogg", "answer-correct-37241588.ogg", "answer-correct-37241627.ogg"],
   ni = ["global-pick up.ogg", "global-put down.ogg", "answer-give up.ogg", "fireworks-1.ogg", "fireworks-2.ogg", "fireworks-3.ogg", "fireworks-4.ogg"].concat(dt);
  Y({
   parent: r,
   dir: r.audio_dir + "/",
   audio_list: ni,
   type: "is_sound_effect"
  }), r.ambient_music.last_on_state = r.ambient_music_on, r.ambient_music_on = !1, r.ambient_music.load_ambient_music(C.game_data.ambient_music, C.game_data.ambient_music_start), Qt();
  ...
  if (e.force_screen_refresh = 0, hi(), void
   function() {
    ...
    action: function(t, e) {
     return i.controls_locked ? void smoke.alert("The game hasn't even started yet!", e) : (at(l.current_category.piece_container), W(), void y.help_menu_obj.close())
    }
  ...
  }), l.add_button.addEventListener(r.events.POINT, Rt);
  var N = l.basket_button;
  N.addEventListener(r.events.POINT, function(t) {
   var e = t.currentTarget,
    n = 0 == e.piece_list.length;
   e.classList[e.is_selected ? "remove" : "add"]("jt-op_button-basket" + (r.is_phone_or_tablet ? "-colored" : "") + "-selected"), e.is_selected && !n && Rt({
    error: function() {
     e.piece_list = []
    },
    complete: function() {
  ...
  it.use_image_title ? G({
   image_src: r.get_set_directory(K) + "/puzzle/" + M + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  d.className = "jt-play-action_area", d.style.overflow = "hidden", m.appendChild(d), r.is_phone_or_tablet || d.addEventListener("mousedown", function(e) {
   e.preventDefault()
  ...
  u.className = "jt-play-main_image jt-jigsaw-main_image", n(u), Mt(u), u.classList.add("jt-jigsaw-main_image-active");
  var E = u.base_image = document.createElement("img"),
   w = document.createElement("div");
  w.className = "jt-jigsaw-piece_deck";
  var B, I, s = null;
  E.crossOrigin = "Anonymous", r.get_image(E, K, M, "default"), E.addEventListener("load", function() {
  ...
  }), y.refresh_gui_display(), rt(void 0, !0);
  ...
  m.cleanup = function() {
   if (r.IS_CORDOVA && r.audio_container[C.last_intro_audio] && (r.audio_container[C.last_intro_audio].src = "", delete r.audio_container[C.last_intro_audio], C.last_intro_audio = ""), i.fireworks && i.fireworks.destroy(), ci(), null != i.parentNode && document.body.removeChild(i), R.destroy(), document.removeEventListener(r.events.POINT_MOVE, Dt), r.is_phone_or_tablet ? m.removeEventListener("touchend", X) : (document.removeEventListener("mouseup", X), window.addEventListener("blur", ut), window.removeEventListener("mouseout", Ft)), m.innerHTML = "", "undefined" != typeof r.ambient_music.last_on_state && (1 == r.ambient_music.last_on_state && (r.ambient_music_on = !0), delete r.ambient_music.last_on_state), "undefined" != typeof B)
   ...
   C = null, r = null, M = null, J = null, ui = null, O = null, it = null, K = null, Z = null, y = null, T = null, e = null, et = null, P = null, wt = null, f = null, l = null, N = null, R = null, kt = null, Yt = null, d = null, i = null, u = null, E = null, w = null, s = null, B = null, I = null, _ = null, _t = null, St = null, W = null, At = null, delete m.cleanup
    ...
    function o() {
     ...
     r.forEach(function(t) {
      ...
      n.forEach(function(t) {
       var i = e[t.piece_id];
       a.appendChild(i)
      }), t.innerHTML == i && l.select_category(r), St(r.piece_container.children)
     }), Xt() && ot(), s.callback()
    }
  ...
  y.redraw_main_image_and_pieces = function(f) {
   ...
   var _ = h.getContext("2d"),
    M = c.naturalWidth,
    C = c.naturalHeight;
   _.drawImage(c, 0, 0, M, C, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), _.save(), _.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && p({
    canvas: h,
    draw_settings: T,
    stroke_width: T.stroke_width,
    cut_multiplier: T.cut_multiplier,
