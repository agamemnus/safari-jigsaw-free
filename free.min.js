void function() {
 ...
 function yt(X) {
  ...
  function ui() {
   e.do_screen_refresh_run = !0, e.show_pieces_deferred = window.requestAnimationFrame(rt)
  }
  ...
  function rt(m, u) {
   function h() {
    u || (e.show_pieces_deferred = window.requestAnimationFrame(rt))
   }
  ...
  function Dt() {
   var s = !r.jigsaw_minimal_ui && r.show_trophy_ribbon ? o(Ct) : 0,
    c = o(u);
  ...
  function jt() {
   ...
   if (t.set_size = function() {
    ...
    }, oi(), bt = [], "undefined" == typeof localStorage["puzzle_states." + Z + "." + M + "." + z.selected_difficulty]) {
    Et();
    ...
    Math.seedrandom(a), l.add_category("General"), li({
     ...
     draw_settings: T,
     callback: function(t) {
      B = t, ri(B, l.current_category.piece_container), I = Array.prototype.slice.call(l.current_category.piece_container.children), wt(I), it(l.current_category.piece_container), e.pieces_in_position_count = 0, n()
     }
    })
   } else Mt({
    callback: n
  ...
  function Jt() {
   function n() {
    ...
    }), w.addEventListener("touchend", q), w.addEventListener("touchcancel", q), w.addEventListener("touchleave", q), y.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", dt), window.addEventListener("mouseout", Nt), u.inner.addEventListener("mousewheel", Wt), u.inner.addEventListener("DOMMouseScroll", Wt))), p.setTimeout(function() {
  ...
  function Qt(t) {
   ...
   }), _t(), u.inner.setTimeout(gt, 800), u.inner.setTimeout(function() {
    qt({
     callback: t.callback
    })
  ...
  function at(l) {
   ...
   var l = l || {};
   localStorage.removeItem("puzzle_states." + Z + "." + M + "." + z.selected_difficulty);
  ...
  function Ft(n) {
   ...
   for (var _ = n.x, o = 0; o < _.length; o++) {
    var c = n.x[o],
     h = n.y[o];
    B[c][h] = It(n), l.push(B[c][h])
   }
   var t = d.composite_image,
    l = ct(l, r.jigsaw_combine_pieces),
    u = J(l, [0, 0]),
    a = t.getContext("2d");
   ...
   var p = (d.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale) * e.piece_logical_scale / d.base_image.naturalWidth;
   a.drawImage(d.base_image, 0, 0, t.width * e.piece_logical_scale / p, t.height * e.piece_logical_scale / p, 0, 0, t.width, t.height), a.restore(), a.save(), a.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), r.jigsaw_use_3d_effect && f({
    canvas: t,
    draw_settings: T,
    ...
    game_instance: e
   }), lt(t), a.restore(), t.texture ? Pt(t) : N({
    parent: i.stage,
    canvas: t,
    position: 1,
    is_2d: !0
   }), t.sprite.x = d.left - e.piece_margin, t.sprite.y = d.top - e.piece_margin, D(n), n == s && (s = null), yt(), W(), Ut() && at()
  }
  ...
  function dt(e) {
   if (null != s) {
    ...
    delete s.border_adjust_count, delete s.pickup_left, delete s.pickup_top, ht(s), N({
     logical_parent: s,
     canvas: s.canvas
    }), s.calc_width = s.width_float * r.jigsaw_piece_scale_to_actual, s.calc_height = s.height_float * r.jigsaw_piece_scale_to_actual, s = null, l.item_under_mouse = null, yt(), W()
   }
  }
  ...
  function Ot(t) {
   function d() {
    for (var t = 0; _ > t; t++) {
     ...
     if (1 == n || !e.placed) {
      var m = !1;
      0 == n && e.sprite && (m = !0, D(e)), e.shape_string = J(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), kt(e, p), N({
       canvas: e.canvas,
       logical_parent: e
    ...
    l != h * o ? (i.refresh_piece_styling = !0, timeout = u.inner.setTimeout(d, 20)) : (ot = void 0, void
     function() {
      for (var r = {}, l = 0; h > l; l++)
       for (var c = 0; o > c; c++) {
        var e = s[l][c];
   ...
   var s = t.piece_grid,
    ...
    c = 0,
    r = 0;
   "undefined" != typeof ot && clearTimeout(ot), ot = void 0, d()
  }
  ...
  function kt(t, c, n) {
   ...
   r.restore(), _ && (r.save(), r.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), f({
    ...
    clear_stroke: !p,
    game_instance: e
   }), r.restore()), p && (r.save(), lt(i, y), r.restore())
  }

  function ht(t) {
   D(t), t.canvas = document.createElement("canvas"), kt({
    element: t,
    parent: d.base_image,
  ...
  var K = C.game_data.jigsaw,
   ...
   z = C.player_data,
   nt = C.game_data.entry_list[M],
   Q = C.set_name,
   Z = r.game_type,
   x = {},
   T = {},
   e = x.game_instance = {},
   $ = K.difficulty_levels[z.selected_difficulty];
  ...
  var mt = ["answer-correct-10865990.ogg", "answer-correct-23303730.ogg", "answer-correct-25513672.ogg", "answer-correct-25513693.ogg", "answer-correct-37240671.ogg", "answer-correct-37240686.ogg", "answer-correct-37241588.ogg", "answer-correct-37241627.ogg"],
   ai = ["global-pick up.ogg", "global-put down.ogg", "answer-give up.ogg", "fireworks-1.ogg", "fireworks-2.ogg", "fireworks-3.ogg", "fireworks-4.ogg"].concat(mt);
  Y({
   parent: r,
   dir: r.audio_dir + "/",
   audio_list: ai,
  ...
  if (e.force_screen_refresh = 0, ui(), void
   ...
   var ut = x.social_sharing_button_container = document.createElement("div");
   ut.className = "jt-play-social_sharing_button_container", y.appendChild(ut), A({
    parent: ut,
    button_class: "jt-social_button_small"
   })
  }
  var Ct = x.trophy_ribbon = ii({
    parent: y
   }),
  ...
  G.addEventListener(r.events.POINT, function(t) {
   ...
   D(e), e.canvas = document.createElement("canvas"), kt({
    element: e,
    parent: d.base_image,
    use_3d_effect: r.jigsaw_use_3d_effect,
    render_stroke: !0,
  ...
  var st = new PIXI.Stage,
   Tt = new PIXI.DisplayObjectContainer,
  ...
  i.renderer = $t, i.stage = Tt, i.piece_sprite_container = Yt, i.real_stage = st, st.addChild(Tt), Tt.addChild(Yt), i.load_opacity_transition = .5, i.style.pointerEvents = "none", i.bg = document.createElement("canvas"), i.bg.image = new Image, i.bg.image.src = C.background_image_url, i.reposition_and_resize = function() {
   var t = F(y),
    n = o(y),
    e = y.content_scale,
  ...
  _.src = r.get_set_directory(C.set_name) + "/gui/gui-loading.png", _.logical_parent = i, i.loading_animation = _, _.defer_start = function(e) {
   u.inner.setTimeout(function() {
    _ && !_.game_initialized && (_.start(), rt(void 0, !0))
   }, e)
  }, _.start = function() {
   ...
   if (null != u && u.isAttached()) {
    ...
    o.drawImage(_, 0, 0), _.inner = {}, N({
     ...
     parent: _.stage,
     canvas: n
    }), _.inner.sprite.x = a, _.inner.sprite.y = s, _.inner.sprite.width = e, _.inner.sprite.height = t, _.start(), rt(void 0, !0)
   }
  }), x.refresh_gui_display(), rt(void 0, !0);
  var Et = x.set_base_image_size = function() {
    var t = si();
    ...
    function() {
     ...
     switch (e.tile_x = $.tile_x, e.tile_y = $.tile_y, r) {
      case .8:
     ...
     var i = e.tile_x * e.tile_y / $.piece_column_max / 2;
     e.area = [{
      top: 0,
      height_ratio: 1,
      piece_row_max: i,
      piece_column_max: $.piece_column_max
     }, {
      top: 0,
      height_ratio: 1,
      piece_row_max: i,
  ...
  y.cleanup = function() {
   ...
   C = null, r = null, M = null, K = null, di = null, z = null, nt = null, Q = null, Z = null, x = null, T = null, e = null, $ = null, P = null, Ct = null, p = null, l = null, G = null, L = null, Xt = null, At = null, u = null, i = null, d = null, E = null, w = null, s = null, B = null, I = null, _ = null, Et = null, wt = null, W = null, Mt = null, delete y.cleanup
  ...
  var ot = void 0,
   W = x.save_puzzle_state = function() {
    ...
    i[Z + "." + M + "." + z.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + Z + "." + M + "." + z.selected_difficulty] = JSON.stringify(t)
   },
   Mt = x.load_puzzle_state = function(s) {
    function o() {
     ...
     r.forEach(function(t) {
      ...
      n.forEach(function(t) {
       var i = e[t.piece_id];
       a.appendChild(i)
      }), t.innerHTML == i && l.select_category(r), wt(r.piece_container.children)
     }), Ut() && at(), s.callback()
    }
    var t = JSON.parse(localStorage["puzzle_states." + Z + "." + M + "." + z.selected_difficulty]);
    ...
    x.timer_obj.counter = t.counter, Et();
  ...
  x.redraw_main_image_and_pieces = function(p) {
   function w() {
    ...
    t.save(), m({
     ...
     lineWidth: 0,
     canvas: o
    }), t.clip(), t.drawImage(h, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), t.restore(), t.save(), t.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), lt(o), t.restore(), N({
     parent: i.stage,
     canvas: o,
     position: 1,
     is_2d: !0
   ...
   for (var g = [], u = 0; u < I.length; u++) {
    ...
    if ("undefined" != typeof s && (t.width_float = Math.round(t.width_float * s * 1e3 / 1e3), t.height_float = Math.round(t.height_float * s * 1e3 / 1e3), t.puzzle_left_min = Math.round(t.puzzle_left_min * s * 1e3 / 1e3), t.puzzle_top_min = Math.round(t.puzzle_top_min * s * 1e3 / 1e3), t.width = Math.ceil(t.width_float / e.piece_logical_scale), t.height = Math.ceil(t.height_float / e.piece_logical_scale), t.puzzle_width.forEach(function(i, e) {
     ...
     e.pieces_in_position_count += t.x.length, t.shape_string = J(t.side_set, [-t.puzzle_left_min, -t.puzzle_top_min]), bt.push(t);
   ...
   P();
   var k = ct(bt, r.jigsaw_combine_pieces),
    v = [];
