...
function() {
    function U(t) {
        function a(s, a, u) {
            if ("undefined" != typeof e.app_url_vars) {
                for (var d in e.app_url_vars) delete e.app_url_vars[d];
                h(e.app_url_vars, s)
            }
            var t = o(s, {
            ...
            var c = r[t].title,
                p = r[t].url,
                l = r[t].callback;
            delete e.url, delete e.callback, document.title = "undefined" != typeof c ? c : "", 1 == u && history[(n ? "replace" : "push") + "State"](s, c, p), 1 == n && (n = !1), "undefined" != typeof e.onstatechange ? e.onstatechange(s, function() {
        ...
        e.base_filename = "undefined" != typeof t.base_filename ? t.base_filename : "", e.onbeforestatechange = t.onbeforestatechange, e.onstatechange = t.onstatechange, e.initial_page = t.initial_page, e.app_url_vars = t.app_url_vars;
        var r = {},
            n = !0;
        window.addEventListener("popstate", function(e) {
            null != e.state && a(e.state, void 0, !1)
        }), e.load_page = function(t, r) {
            "undefined" == typeof t && (t = {}), "undefined" == typeof r && (r = {}), t = s(t), r = s(r), 1 == n && 1 == e.overwrite_first_state && (l(t), "undefined" == typeof e[i] && (e[i] = e.initial_page)), "undefined" == typeof t[i] && (t[i] = e[i]), "undefined" != typeof e.onbeforestatechange ? e.onbeforestatechange(t, r, function() {
                a(t, r, !0)
            }) : a(t, r, !0)
        }
    }
    ...
    function L(e) {
        ...
        if ("undefined" == typeof this || this === window) return new L(e);
        var t = e.target,
            i = !1,
            a = void 0,
            s = void 0;
    ...
    function i(e) {
        ...
        var a = "undefined" != typeof e.charset ? e.charset : "",
            s = ("undefined" != typeof e.data ? e.data : "", "undefined" != typeof e.ignore_request_status ? e.ignore_request_status : !1, H(e.file, e.data, n, a, t, void 0, void 0, e.request_method)),
            i = s.http_request;
    ...
    function m(i, t) {
        if ("undefined" == typeof t && (t = {}), t.play_howl) return new z(i, t);
    ...
    function z(r, t) {
        ...
        if ("undefined" == typeof this || this == window) return new z(r, t);
        var e = this;
    ...
    function pt(s) {
        function u() {
            ...
            n.innerHTML = h, n.children.forEach(function(e) {
                r(e)
            }), "undefined" != typeof t.intro_audio && "" != t.intro_audio && n.appendChild(c);
            var i = n.querySelector("span"),
                s = n.querySelector(".jt-game-header");
            if (null != s && (i.style.display = "none", M({
                    image: s,
                    fix_ie_bug: !0,
                    color: "#edd9a7",
                    callback: function(e) {
                ...
                function() {
                    ...
                    r.push(i), r.forEach(function(i) {
                        ...
                        var e = dt(window.getComputedStyle(i).backgroundImage);
        ...
        function o(t) {
            function i(t) {
                if ("undefined" == typeof e.pending_message) t();
                else {
                    var i = smoke.alert(e.pending_message, function() {
                        t()
                    });
                    i.dialog.text.style.textIndent = "1em", i.dialog.text.style.textAlign = "left", delete e.pending_message
                }
            }
    ...
    function ft(a) {
        function c() {
            function S() {
                ...
                y.innerHTML = '<span style="position:relative; margin-left: 18px; top: -6px; line-height: 0; font-family:lato; font-size: 60px; vertical-align: middle">' + t + '</span><span style="position:relative; top: -3px; line-height: 0; font-family: flyingsoft-icons; font-size: 106px; vertical-align: middle">g</span>', c.setTimeout(S, 250)
            }
            ...
            var n = {};
            s.innerHTML = "";
            var c = n.header = document.createElement("div");
            c.className = "jt-select_screen-header", s.appendChild(c), r(c);
            ...
            var E = n.sort_button = Tt({
                ...
                x = t.player_data,
                _ = n.difficulty_level_button = document.createElement("div");
            ...
            var M = n.challenge_a_friend_button = ut({
                select_screen: n,
                content_div: s,
                mr_jigtato: t,
                gs: e
            ...
            y.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-1 jt-button hoverable", y.addEventListener(e.events.POINT, A), c.appendChild(y), S();
            var g = 12,
            ...
            P();
            var f = n.selection_container = document.createElement("div");
            f.className = "jt-select_screen-selection-container", m.appendChild(f);
            var O = n.create_tab_container = function(t) {
                    function o(e) {
                        t.select_function({
                    ...
                    for (var s = 0; a > s; s++) {
                        ...
                        i.className = "jt-button", r(i), n.appendChild(i), i.innerHTML = s + 1, i.tab_index = s, t.select_function && i.addEventListener(e.events.POINT, o)
                    }
                    return 0 == a && l.classList.add("jt-select_screen-selection-container-center"), n
                },
                z = n.create_selection_tab_container = function() {
                    n.selection_tab_container = O({
                        parent: m,
            ...
            z(), "undefined" == typeof e.select_menu_current_page[i] && (e.select_menu_current_page[i] = 0), E.onsort = function() {
                b({
            ...
            if ("undefined" != typeof e.pending_message) {
                var C = smoke.alert(e.pending_message);
                C.dialog.text.style.textIndent = "1em", C.dialog.text.style.textAlign = "left", delete e.pending_message
            }
            h && h()
        }
    ...
    function x() {
        function l() {
            ...
            if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], s.forEach(function(n) {
                    ...
                    return (d ? "content://" + I + ".free.expansion/" : e["/"]) + "sets/" + t
                    ...
                    var i = (d ? "content://" + I + ".free.expansion/" : e["/"]) + "sets/" + r;
                    switch (n) {
                        case "mini":
                    ...
                    if (t.play_howl = !1, t.play_howl && "ambient_music" == a && (t.preload_buffer_file = r.substr(0, r.length - 4) + "-preview" + r.substr(-4)), o || "undefined" != typeof t.start && 0 == t.start)
            ...
            if (e.is_phone_or_tablet && (document.body.addEventListener("touchstart", function(e) {
                ...
                !e.account.IS_PREMIUM && e.IS_WEBVIEW && "undefined" != typeof u && (e.ad_control = u(), e.ad_control.gs = e, e.ad_control.init(), void
                    function() {
        ...
        window.onerror = function(t, n, a) {
            var e = "undefined" != typeof window.device ? window.device : e;
            "undefined" == typeof e.model && (e.model = ""), "undefined" == typeof e.uuid && (e.uuid = ""), i({
                file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (r.DEBUG ? "-beta" : "") + ".php?action=send_javascript_error&errormessage=" + t + "&url=" + n + "&linenumber=" + a + "&device_model=" + e.model + "&device_uuid=" + e.uuid,
                success: function() {},
                error: function() {},
                request_method: "GET"
            })
        ...
        t.load_game_data = function(l) {
            ...
            var e = "undefined" != typeof P ? P : "default";
            ...
            function a(o) {
                t.reset_player_data();
                var r = JSON.parse(e.decompressFromBase64(o.replace(/ /g, "+")));
                t.player_data = r.player_data, localStorage.player_data = JSON.stringify(t.player_data);
                var i = r.puzzle_states_keys,
                    l = r.puzzle_states;
                if ("undefined" != typeof i && (localStorage["puzzle_states.$keys"] = JSON.stringify(i)), "undefined" != typeof i)
                    for (var n in i) {
                        var a = JSON.stringify(l[n]);
                        "undefined" != typeof a && (localStorage["puzzle_states." + n] = a)
                    }
                s()
            }
            var n = n || {},
                s = ("function" == typeof n.error ? n.error : function() {}, "function" == typeof n.success ? n.success : function() {});
        ...
        var f = t.history_control = new U({
                onbeforestatechange: function(e, i, n) {
                    ...
                    i.title = p(e, i), "undefined" != typeof t.game_data ? n() : t.load_game_data({
                        new_state_page: e.page,
                        callback: n
                    })
                },
                onstatechange: function(i, n) {
                    if (console.log(866), "undefined" != typeof r && r.IS_CORDOVA && (console.dir(r.smoke_window_list), 0 != r.smoke_window_list.length)) {
                        var e = r.smoke_window_list[r.smoke_window_list.length - 1];
                        return void(e.cancel ? e.cancel() : e.ok ? e.ok() : e.close && e.close())
                    }
                    if (r.IS_CORDOVA || ("undefined" == typeof window.has_save_to_server_unload_event && (window.has_save_to_server_unload_event = {}), window.has_save_to_server_unload_event[i.page] || (window.has_save_to_server_unload_event[i.page] = !0, window.addEventListener("beforeunload", t.save_player_data_to_server))), s.cleanup) {
                        s.cleanup()
                    }
                    switch (i.page) {
                        case "select_mode":
                        ...
                        case "jigsaw":
                            ht({
                                ...
                                global_settings: r,
                                level_id: i.level
                            }), !r.account.IS_PREMIUM && r.IS_WEBVIEW && "undefined" != typeof u && gt({
                                gs: r,
                                mr_jigtato: t
                            });
                            break;
        ...
        if (s.className = "jt-content_div", t.parent = document.body, t.parent.appendChild(s), smoke.parent = s, r.is_phone_or_tablet) {
            smoke.custom_css = {
        ...
        return yt({
        ...
        }), Q(), t.play_intro_audio = function(a) {
            var c = a.level_id,
                s = a.count,
                i = t.game_data,
                o = i.entry_list[c],
            ...
            function s(i) {
                ...
                i = i.replace(/url\('/g, "url('" + s), i = i.replace(/url\(\"/g, 'url("' + s), e.innerHTML = i, e.charset = "utf-8", e.media = "screen", e.type = "text/css", e.rel = "stylesheet", o.insertBefore(e, o.lastChild), t.unload_set_css(), t.custom_css_div = e, n && n(e)
            }
    ...
    function gt(n) {
        ...
        var e = n.gs,
            ...
            u = e.show_ad_counter,
            t = Math.sqrt(h * c) / 3;
        return t > 1 && (t = 1), e.show_ad_counter += t, -1 != u && 0 == !!e.own_ad_shown ? void l() : void(e.show_ad_counter >= 1 && (e.show_ad_counter = e.show_ad_counter - parseInt(e.show_ad_counter), Math.random() > .1 ? e.ad_control.run() : 0 == e.account.game_was_rated ? o() : e.ad_control.run()))
    }
    ...
    function f(t) {
        ...
        return h.innerHTML = "Back", i.appendChild(h), h.addEventListener(n.events.POINT, function() {
            e.close({
                callback: t.callback
            })
        }), e.open = function() {
    ...
    function Y(e) {
        ...
        var t = smoke.confirm('<span style="color: #cc0000; font-weight: bold">Warning:</span> This will clear/reset all player data: progress, trophies, trophies, best times, etc. Continue?', function(t) {
            return 0 == t ? void e.callback() : (e.mr_jigtato.reset_player_data(), e.current_game && e.current_game.trophy_ribbon.update(), e.select_screen && e.select_screen.refresh_puzzle_list(), void smoke.alert("All player data has been reset.", e.callback))
        });
        l(t)
    }
    ...
    function J(r) {
        ...
        var n = r.gs,
            h = r.mr_jigtato.set_name,
            a = [];
        r.gs.is_kiosk || (n.contact_info = '<a href="mailto:' + n.contact_info + '">' + contact_info + "</a>"), a[0] = r.mr_jigtato.game_data.about_text + n.contact_info + ". </p>", r.callback, a[1] = "Loading...", i({
            success: function(e) {
                a[1] = e
            },
            error: function(e) {
                n.errormessage(e, r.callback)
            },
            file: n.get_set_directory(h) + "/" + h + "-credits.txt",
            charset: "utf-8",
            plaintext: !0,
            request_method: "GET",
            ignore_request_status: n.IS_WEBVIEW
        });
        var s = smoke.alert(r.mr_jigtato.game_data.about_text + n.contact_info + ". </p>", r.callback),
            e = s.buttons;
        e.back = s.buttons.ok.cloneNode(!0), e.back.style.cssFloat = "left", e.back.innerHTML = "< Back", e.appendChild(e.back), e.next = s.buttons.ok.cloneNode(!0), e.next.style.cssFloat = "right", e.next.innerHTML = "Next >", e.appendChild(e.next), e.back.addEventListener(n.events.POINT, function() {
            t = (t + a.length - 1) % a.length, o(t)
        }), e.next.addEventListener(n.events.POINT, function() {
            t = (t + a.length + 1) % a.length, o(t)
        });
        var t = 0;
        o(t), l(s), n.is_phone_or_tablet && (s.dialog.text.style.backgroundColor = "transparent")
    }
    ...
    function E(a) {
        function o(l) {
            ...
            t.innerHTML = "";
            var e = document.createElement("span");
            e.className = "jt-play-trophy_room-item_name", e.style.color = a.text_color, e.innerHTML = a.display_name.capitalizeFirstLetter(), t.appendChild(e), r.is_chromium || r.is_android ? (e.style.textShadow = "none", e.style.WebkitTextStrokeColor = a.text_outline_color, _({
                element: e,
                size: "3px",
                color: ""
            })) : O(e, a.text_outline_color || "black");
            var h = document.createTextNode(".. earned for completing the puzzle ");
            t.appendChild(h);
            var n = document.createElement("span");
            n.className = "jt-play-trophy_room-puzzle_name", n.style.color = s.title_color, n.innerHTML = '"' + s.name + '"', t.appendChild(n), r.is_chromium || r.is_android ? (n.style.textShadow = "none", n.style.WebkitTextStrokeColor = s.border_color, _({
                element: n,
                size: "3px",
                color: ""
            })) : O(n, s.border_color || "black");
    ...
    function h(t) {
        ...
        i.initialize({
            error: t.error,
            success: function(i) {
                e.IS_CORDOVA ? (e.google_play_access_token = i, k(t)) : e.get_google_play_access_token({
                    callback: function() {
                        k(t)
                    }
                })
    ...
    function ht(H) {
        ...
        function it(g, d) {
            ...
            if (e.do_screen_refresh_run) {
                ...
                if (!t.background_image_drawn && !F.initial_background_is_transparent) {
        ...
        function Pt(e) {
            return "undefined" == typeof e && (e = {}), P.stop(), 4 == h.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
                P.resume()
        ...
        function jt() {
            ...
            var n = o + (a.jigsaw_minimal_ui ? 0 : s(f)),
                c = a.jigsaw_minimal_ui || null == V.parentNode ? 0 : s(V);
            ...
            d.style.top = n + "px", d.style.height = r + "px", V.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", t.reposition_and_resize(), I(), "undefined" != typeof x && x.naturalHeight && (e.area && e.area.forEach(function(e) {
                e.height = r * e.height_ratio
            }), u.top = (r - x.height + (x.height - x.height)) / 2), K(), h.container.children.forEach(function(t) {
        ...
        function K() {
            if (!t.bg.image.complete) return void t.setTimeout(K, 50);
            if (0 == !!t.bg.refresh_bg && (t.bg.refresh_bg = !0, t.bg.width = "undefined" != typeof t.cached_width ? t.cached_width : t.width, t.bg.height = "undefined" != typeof t.cached_height ? t.cached_height : t.height, t.bg.getContext("2d").drawImage(t.bg.image, 0, 0, t.bg.image.naturalWidth, t.bg.image.naturalHeight, 0, 0, t.bg.width, t.bg.height), U({
                    ...
                    canvas: t.bg,
                    position: 0
                }), I()), t.background_image_drawn = !0, "undefined" == typeof u) return void t.setTimeout(K, 50);
            if ("undefined" == typeof u.left) return void t.setTimeout(K, 50);
            if (!u.base_image.complete) return void t.setTimeout(K, 50);
            t.bg.refresh_bg = !0;
            ...
            (1 == r.style.opacity || e.jigsaw_show_hint_rect) && (1 == r.style.opacity || e.jigsaw_show_hint_image ? (i.globalAlpha = r.style.opacity, i.drawImage(r, n, a, s, o), i.globalAlpha = 1) : (i.fillStyle = "white", i.fillRect(n, a, s, o))), U({
                parent: t.stage,
                logical_parent: t.bg,
                canvas: t.bg,
                position: 0
        ...
        function Nt() {
            ...
            e.jigsaw_initial_show_hint_image = a.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = a.jigsaw_show_hint_rect, e.jigsaw_show_hint_image = a.jigsaw_show_hint_image, e.piece_margin = a.jigsaw_get_scaled_piece_margin(e), e.piece_margin_style = a.jigsaw_piece_margin_style, d.inner.appendChild(k);
            ...
            if (i.set_size = function() {
                ...
                }, si(), "undefined" == typeof localStorage["puzzle_states." + Q + "." + R + "." + D.selected_difficulty]) {
                ft();
                ...
                Math.seedrandom(n), h.add_category("General"), Jt({
                    ...
                    draw_settings: F,
                    callback: function(t) {
                        B = t, ri(B, h.current_category.piece_container), O = Array.prototype.slice.call(h.current_category.piece_container.children), gt(O), rt(h.current_category.piece_container), e.pieces_in_position_count = 0, r()
                    }
                })
            } else Gt({
                callback: r
        ...
        function ni() {
            function r() {
                ...
                }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, k.addEventListener(a.events.POINT_START, Qt), document.addEventListener(a.events.POINT_MOVE, Dt), a.is_phone_or_tablet ? (L({
                    target: d.inner,
                    result_function: Lt,
                    start_effect: function() {
                        k.drag_active = !1, k.pinch_active = !0
                    },
                    end_effect: function() {
                        k.pinch_active = !1
                    }
                }), k.addEventListener("touchend", Y), k.addEventListener("touchcancel", Y), k.addEventListener("touchleave", Y), g.addEventListener("touchend", Y)) : (document.addEventListener("mouseup", Y), window.addEventListener("blur", ot), window.addEventListener("mouseout", It), d.inner.addEventListener("mousewheel", kt), d.inner.addEventListener("DOMMouseScroll", kt))), f.setTimeout(function() {
                    "undefined" != typeof a.ambient_music.last_on_state && (1 == a.ambient_music.last_on_state && (a.ambient_music_on = !0), delete a.ambient_music.last_on_state), C.play_intro_audio({
                        level_id: H.level_id,
                        parent: d.inner
                    })
                }, 400)
        ...
        function hi(l) {
            ...
            "undefined" == typeof r[R] && (r[R] = {});
            var t = r[R][e.difficulty_level];
            "undefined" == typeof t && (t = 86400), t > l && (t = r[R][e.difficulty_level] = l);
            ...
            var i = a + 1,
                ...
                s = D.jigsaw.ranks;
            "undefined" == typeof s[R] && (s[R] = {});
            var o = s[R][e.difficulty_level];
            return "undefined" == typeof o && (o = -1), i > o && (o = s[R][e.difficulty_level] = i), {
                best_time: t,
                rank_count: i,
                next_rank_point: c
            }
        ...
        function Zt(i) {
            ...
            }), pt(), d.inner.setTimeout(Et, 800), d.inner.setTimeout(function() {
                Wt({
                    callback: i.callback
                })
        ...
        function st(s) {
            ...
            function y() {
                ...
                if (r.innerHTML = i.display_name.capitalizeFirstLetter() + ("!" == u || "." == u ? "" : "."), "undefined" != typeof i.text_outline_color) {
                    ...
                    a.is_chromium || a.is_android ? (r.style.textShadow = "none", r.style.WebkitTextStrokeColor = n, _({
                        element: r,
                        size: "4px",
                        color: ""
            ...
            function p() {
                var e = tt.rank[tt.difficulty_levels[D.selected_difficulty].name];
                a.playAudio(a.get_set_directory(J) + "/audio/" + e.rank_audio[r] + ".m4a", {
                    audio_type: "music",
                    element: d.inner,
                    restart: !0
                });
                ...
                i.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + P.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + m + "</span> seconds.</p>", i.innerHTML += 0 == r ? '<p> No <span class="jt-play-show_rank-text-bright">' + u + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + x[r] + "</span> " + u + ".</p>";
                var o = document.createElement("div");
                o.className = "jt-play-show_rank-image-container";
                for (var c = 0; r > c; c++) {
                    var n = document.createElement("div");
                    n.className = "jt-play-show_rank-image-item", o.appendChild(n), n.style.opacity = .01, n.style.backgroundImage = 'url("' + a.get_set_directory(J) + "/gui/" + e.filename + '")', void
                    function(t, i) {
                        d.inner.setTimeout(function() {
                            TweenMax.to(t, 2, {
                                parseTransform: !0,
                                ...
                                t.addEventListener(a.events.POINT, function() {
                                    "undefined" != typeof e.click_audio && a.playAudio(a.get_set_directory(J) + "/audio/" + e.click_audio + ".ogg", {
                                        element: d.inner,
                                        audio_type: "music"
                                    })
                                })
            ...
            var s = s || {};
            localStorage.removeItem("puzzle_states." + Q + "." + R + "." + D.selected_difficulty);
            ...
            if (P.stop(), g.style.overflow = "hidden", e.zoom = {
                    scale: 1,
                    offset_x: 0,
                    offset_y: 0
                }, 1 != o) {
                ...
                localStorage.player_data = JSON.stringify(D), 0 == o ? d.inner.setTimeout(c, s.show_trophy_delay || 550) : d.inner.setTimeout(c, s.show_trophy_delay || 550)
            }
        }
        ...
        function Wt(e) {
            ...
            if (I(), u.children.forEach(function(e) {
                    ...
                    h.remove_category(e)
                }), u.base_image.style.opacity = 1, z(u.composite_image), K(), e.hide_controls) {
        ...
        function Ct(t, r) {
            ...
            var n = o(r, d.inner),
                l = n[0],
                c = n[1];
            t.left = (l / g.desired_scale - e.zoom.offset_x) / e.zoom.scale + (a.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (c / g.desired_scale - e.zoom.offset_y) / e.zoom.scale + (a.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), I();
        ...
        function Qt(n) {
            if (null == c) {
                ...
                if (!N(n)) {
                    ...
                    if (0 == l.length) return void(r == k && k.drag_start(n));
                    for (var r = l[0], y = +l[0].sprite.index, s = 1, m = l.length; m > s; s++) {
                        var i = l[s]; + i.zIndex <= y || (y = +i.zIndex, r = i)
                    }
                    I(), a.playAudio(a.audio_dir + "/global-pick up.ogg", {
                        audio_type: "sound_effect",
                        blocking: !1
                    });
                    ...
                    document.body.style.cursor = "pointer", r.visibility = "hidden", c.visibility = "visible", Ct(c, n)
                }
            }
        }
            ...
            if (null != k && (k.drag_end(), null != c)) {
                ...
                if (R.forEach(function(e) {
                    ...
                    return i.className = "jt-jigsaw-piece_deck-piece", i.piece_id = r.piece_id, i.x = [], i.y = [], i.puzzle_width = [], i.puzzle_height = [], i.puzzle_left = [], i.puzzle_top = [], i.puzzle_left_min = p, i.puzzle_top_min = l, i.side_set = _t(n), i.shape_string = q(i.side_set, [-p, -l]), i.dummy_canvas = document.createElement("canvas"), i.path = new Path2D(i.shape_string), O.push(i), r.parentNode.appendChild(i), i.width_float = Math.round(1e3 * (_ - p)) / 1e3, i.height_float = Math.round(1e3 * (m - l)) / 1e3, i.width = Math.ceil((i.width_float + 2 * e.piece_margin) / e.piece_logical_scale), i.height = Math.ceil((i.height_float + 2 * e.piece_margin) / e.piece_logical_scale), n.forEach(function(e) {
                        ...
                        z(e), O.splice(O.indexOf(e), 1), e.x.forEach(function(r, t) {
                            B[e.x[t]][e.y[t]] = i
                    ...
                    }), pt()), ut(i), z(c), c = null, Tt(), t.refresh_piece_styling = !0, void W()
                }
                if (y)
                ...
                if (ut(c), U({
                    ...
                    var P = o.puzzle_left_min + u.left,
                        I = o.puzzle_top_min + u.top;
                    pt(), o.placed = !0, TweenMax.to(o, .35, {
                        parseTransform: !0,
                        ease: Linear.ease,
                        left: P,
                        top: I,
        ...
        function Bt(r) {
            ...
            for (var T = [], b = [], S = [
                    ...
                    [2, -2, !1],
                    [-2, 2, !1]
                ], d = {}, w = r.x, o = u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale, _ = 0, l = u.composite_image.height - 2 * e.piece_margin / e.piece_logical_scale, m = 0, n = 0; n < w.length; n++) {
                var g = r.x[n],
                    v = r.y[n];
                B[g][v] = Mt(r)
            }
            ...
            var E = _t(T),
                x = q(E, [-Math.floor(o), -Math.floor(l)]),
                i = document.createElement("canvas");
            i.width_float = Math.round(1e3 * (_ - o)) / 1e3, i.height_float = Math.round(1e3 * (m - l)) / 1e3, i.width = Math.ceil((i.width_float + 2 * e.piece_margin) / e.piece_logical_scale), i.height = Math.ceil((i.height_float + 2 * e.piece_margin) / e.piece_logical_scale);
            ...
            }), s.restore(), s.save(), s.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), a.jigsaw_use_3d_effect && lt({
                canvas: i,
                stroke_width: F.stroke_width,
                cut_multiplier: F.cut_multiplier,
                shape_string: x,
                scale: 1 / e.piece_logical_scale,
                clear_stroke: "undefined" == typeof e.piece_margin_style
            }), ht(i), s.restore();
            var y = u.composite_image.getContext("2d");
            y.globalCompositeOperation = "source-over", y.drawImage(i, o / e.piece_logical_scale, l / e.piece_logical_scale, i.width, i.height), i.width = 0, i.height = 0;
            ...
            h.texture ? Rt(h) : U({
                ...
                position: 1,
                is_2d: !0
            }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, z(r), r == c && (c = null), Tt(), W(), Ot() && st()
        }

        function ot(i) {
            if (null != c) {
                I(), "undefined" == typeof i && (i = {}), document.body.style.cursor = "";
                var e = c;
                ...
                delete c.border_adjust_count, ut(c), U({
                    logical_parent: c,
                    canvas: c.canvas
                }), c.calc_width = c.width_float * a.jigsaw_piece_scale_to_actual, c.calc_height = c.height_float * a.jigsaw_piece_scale_to_actual, c = null, h.item_under_mouse = null, Tt(), W()
            }
        }
        ...
        function Dt(e) {
            ...
            if ("undefined" != typeof e.targetTouches) {
                if (e.touches.length > 1) return void ot();
                e = e.targetTouches[0]
            }
            k.drag_active && k.drag_update(e), null != c && Ct(c, e)
        }

        function Jt(_) {
            function Q(n, s, l, h, p, _, f, g) {
            ...
            for (var c = (_.success || function() {}, _.source_image), w = _.size_x, T = _.size_y, I = _.width, P = _.height, U = _.draw_settings, m = [], H = 100 / w, W = 100 / T, r = 0; w >= r; r++) {
                m[r] = [];
                for (var s = 0; T >= s; s++) {
                    var Y = 0 == r || r == w ? 0 : .25 * Math.randBMT(),
                        J = 0 == s || s == T ? 0 : .25 * Math.randBMT();
                    m[r][s] = [(r + Y) * H, (s + J) * W]
                }
            }
            for (var V = [
                ...
                for (var C = V[i], v = 0; v < C[4]; v++) R.push([C[0], C[1], C[2], C[3]]);
            var b = [];
            for (vh = 0; 2 > vh; vh++) {
                b[vh] = [];
                for (var r = 0; w + vh > r; r++) {
                    b[vh][r] = [];
                    for (var s = 0; T + (1 - vh) > s; s++) {
                        var t = [
                            [0, 0],
                            [220, 0],
                            [60, 80],
                        ...
                        if ((0 == s || s == T + 1 - vh - 1) && 0 == vh || (0 == r || r == w + vh - 1) && 1 == vh) t = [t[0], t[t.length - 1]];
                        else {
                            var X = Math.randInt(0, R.length - 1),
                                p = R[X];
                        ...
                        for (var i = 0, h = t.length; h > i; i++) {
                            ...
                            t[i][0] = t[i][0] / 300 * H + m[r][s][0], t[i][1] = t[i][1] / 300 * W + m[r][s][1]
                        }
                        var h = t.length;
                        t[h - 1] = 0 == vh ? [m[r + 1][s][0], m[r + 1][s][1]] : [m[r][s + 1][0], m[r][s + 1][1]];
                        for (var i = 0; h > i; i++) t[i][0] = t[i][0].toFixed(4), t[i][1] = t[i][1].toFixed(4);
                        for (var j = new Array(h), i = 0; h > i; i++) j[i] = [t[i][0] / 100 * I, t[i][1] / 100 * P];
                        b[vh][r][s] = j
                    }
                }
            }
            for (var O = [], D = "", N = 0, r = 0; w > r; r++) {
                O[r] = [];
                for (var s = 0; T > s; s++) {
                    for (var y = [], x = [], g = "", E = "", o = {
                            x0: I,
                            ...
                            x1: 0,
                            y1: 0
                        }, u = (b[0][r][s][0][0], b[0][r][s][0][1], []), d = 0; 4 > d; d++) {
                        var L = 0,
                            t = b[d % 2 == 0 ? 1 : 0][r + (2 == d ? 1 : 0)][s + (3 == d ? 1 : 0)],
                            h = t.length;
                        if (2 >= h) var o = {
                            ...
                            for (var i = 0; 4 > i; i += 3) var f = Q(t[0 + i][0], t[0 + i][1], t[1 + i][0], t[1 + i][1], t[2 + i][0], t[2 + i][1], t[3 + i][0], t[3 + i][1]),
                                o = {
                                    x0: f.x0 < o.x0 ? f.x0 : o.x0,
                                    y0: f.y0 < o.y0 ? f.y0 : o.y0,
                                    x1: f.x1 > o.x1 ? f.x1 : o.x1,
                                    y1: f.y1 > o.y1 ? f.y1 : o.y1
                                };
                        var M = 0 == d && h > 2 ? " M " : " L ";
                        h > 2 && 0 != d && (M = ""), E += M, "" != M && (x.length > 0 && ("M" != g && u.push({
                            type: g,
                            points: x
                        }), x = [], 0 == L && u.length > 0 && (y.push({
                            x: r,
                            y: s,
                            s: y.length,
                            p: u
                        }), u = []), L += 1), g = M.trim());
                        for (var i = d % 3 == 0 ? h - 1 : 0, v = 0; h > v; v++)(0 == d || 2 >= h || 0 != v) && (v % 3 == 1 && h > 2 && ("M" != g && u.push({
                            type: g,
                            points: x
                        }), x = [], 0 == L && u.length > 0 && (y.push({
                            x: r,
                            ...
                            s: y.length,
                            p: u
                        }), u = []), L += 1, g = "C", E += " C "), E += t[i][0].toFixed(4) + "," + t[i][1].toFixed(4), x.push([parseFloat(t[i][0].toFixed(4)), parseFloat(t[i][1].toFixed(4))]), v != h - 1 && (E += " ")), d % 3 == 0 ? i-- : i++
                    }
                    u.push({
                        type: g,
                        points: x
                    ...
                    var F = n(o),
                        ...
                        z = Math.round(1e3 * (o.x1 - o.x0)) / 1e3,
                        B = Math.round(1e3 * (o.y1 - o.y0)) / 1e3,
                        l = bt();
                    l.x = [r], l.y = [s], l.piece_id = N, l.width = Math.ceil(z + 2 * e.piece_margin) / e.piece_logical_scale, l.height = Math.ceil(B + 2 * e.piece_margin) / e.piece_logical_scale, l.width_float = z, l.height_float = B, l.puzzle_width = [z], l.puzzle_height = [B], l.puzzle_left_min = F.x0, l.puzzle_top_min = F.y0, l.puzzle_left = [o.x0], l.puzzle_top = [o.y0], l.side_set = [y], l.placed = !1, O[r][s] = l, N += 1
                }
            }
            var S = document.createElement("canvas"),
                A = S.getContext("2d");
            S.width = (I + 2 * e.piece_margin) / e.piece_logical_scale, S.height = (P + 2 * e.piece_margin) / e.piece_logical_scale;
            var k = c.naturalWidth / c.width,
                $ = k * c.width <= c.naturalWidth ? k * c.width : c.naturalWidth,
                Z = k * c.height <= c.naturalHeight ? k * c.height : c.naturalHeight;
            A.drawImage(c, 0, 0, $, Z, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), A.save(), A.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), a.jigsaw_use_3d_effect && lt({
                canvas: S,
        ...
        function Ut(i) {
            function u() {
                for (var i = 0; _ > i; i++) {
                    ...
                    if (1 == a || !e.placed) {
                        var m = !1;
                        0 == a && e.sprite && (m = !0, z(e)), e.shape_string = q(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), xt(e, p), U({
                            canvas: e.canvas,
                            logical_parent: e
        ...
        function lt(i) {
            {
                var n = i.canvas,
                    ...
                    d = i.shape_string,
                    u = i.scale,
                    h = i.outline_style || "transparent";
                i.clear_stroke
            }
            if (i.outline_width) var c = i.outline_width;
            else if (e.piece_margin_style && 0 != e.piece_margin) var c = e.piece_margin >= 5 ? 10 : 6;
            else var c = 10;
            var c = 8;
            c /= e.jigsaw_scale_low_power_sizer;
        ...
        function z(e, r) {
            if ("undefined" == typeof r && (r = !1), e.texture) {
        ...
        function Ht(e) {
            ...
            Object.defineProperty(e, "children", {
                ...
                t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), I()
            }, e.removeChild = function(t) {
                e.children.splice(e.children.indexOf(t), 1), I()
        ...
        function xt(t, h, r) {
            ...
            var f = q(t.side_set, [-t.puzzle_left_min + a + l, -t.puzzle_top_min + a + l], 1 / s);
            ...
            n.restore(), _ && (n.save(), n.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), lt({
                canvas: i,
                stroke_width: F.stroke_width,
                cut_multiplier: F.cut_multiplier,
                ...
                scale: 1 / e.piece_logical_scale,
                clear_stroke: !c
            }), n.restore()), c && (n.save(), ht(i, d), n.restore())
        }
        ...
        var g = H.content_div,
            ...
            R = H.level_id;
        g.innerHTML = "";
        var tt = C.game_data.jigsaw,
            ei = C.game_data.trophy_list,
            D = C.player_data,
            nt = C.game_data.entry_list[R],
            J = C.set_name,
            Q = a.game_type,
            y = {},
            F = {},
            e = y.game_instance = {},
            $ = tt.difficulty_levels[D.selected_difficulty];
        e.difficulty_level = D.selected_difficulty, e.get_piece_count = function() {
            return e.tile_x * e.tile_y
        }, e.intro_audio_count = 0, !a.is_kiosk && a.use_social_media_buttons && et();
        ...
        }), a.ambient_music.last_on_state = a.ambient_music_on, a.ambient_music_on = !1, a.ambient_music.load_ambient_music(C.game_data.ambient_music, C.game_data.ambient_music_start), Yt();
        ...
        if (e.force_screen_refresh = 0, li(), void
            function() {
            ...
            }(), g.style.overflow = "hidden", r(g), y.menu_item_list = [C.menu.generic.about, C.menu.generic.ogle_trophies, {
                text: "Restart",
                ...
                action: function() {
                    rt(h.current_category.piece_container), W(), y.help_menu_obj.close()
                }
            ...
            }, C.menu.jigsaw.open_visual_settings_menu, C.menu.generic.open_audio_settings_menu], !a.is_kiosk && a.use_social_media_buttons) {
            var vt = y.social_sharing_button_container = document.createElement("div");
            vt.className = "jt-play-social_sharing_button_container", g.appendChild(vt), S({
                parent: vt,
        ...
        V.className = "jt-play-bottom_bar jt-play-main_image_border_width", r(V), g.appendChild(f), f.hide_title = function(e) {
            var e = e || {};
            ...
            function r() {
                ...
                var n = e.childNodes[0],
                    ...
                    l = Math.floor(i.length / 2),
                    r = new TimelineLite,
                    s = !0;
                if (s)
                    for (var t = 0; t < i.length; t++) {
                        for (var o = i[t].children, a = 0; a < o.length; a++) o[a].style.opacity = 0;
                        r.from(i[t], 1.8, {
                            x: 40 * (t - l),
                            opacity: 0,
                            ease: Power2.easeOut
        ...
        h.className = "jt-jigsaw-category_deck", h.item_under_mouse = null, f.appendChild(h), h.edit_button = document.createElement("img"), h.edit_button.className = "jt-op_button jt-op_button-edit" + (a.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), h.edit_button.src = a["/"] + "images/gui/gui-item_edit.png", h.appendChild(h.edit_button), h.add_button = document.createElement("img"), h.add_button.className = "jt-op_button jt-op_button-add" + (a.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), h.add_button.src = a["/"] + "images/gui/gui-item_expand_or_add.png", h.appendChild(h.add_button), h.basket_button = document.createElement("img"), h.basket_button.className = "jt-op_button jt-op_button-basket" + (a.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), h.basket_button.piece_list = [], h.basket_button.is_selected = !1, h.basket_button.src = a["/"] + "images/gui/gui-basket.png", h.appendChild(h.basket_button), h.remove_button = document.createElement("img"), h.remove_button.className = "jt-op_button jt-op_button-remove" + (a.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), h.remove_button.src = a["/"] + "images/gui/gui-item_remove.png", h.appendChild(h.remove_button), h.container = document.createElement("div"), h.container.className = "jt-jigsaw-category_deck-container", h.appendChild(h.container), h.add_category = function(s) {
            ...
            f.style.display = "block", e.inner.innerHTML = t, e.style.padding = 0, e.style.border = "none", A(e.inner, {
                unit_type: "px",
            ...
            t.parentNode && t.parentNode.removeChild(t), h.original_category && (e != h.original_category ? rt(h.original_category.piece_container, i) : delete h.original_category), 1 == h.container.children.length && delete h.current_category, h.container.removeChild(e)
        }, h.select_category = function(i) {
            h.current_category = i, t.piece_container = i.piece_container, I();
            var r = O;
            if ("undefined" != typeof r)
            ...
            P.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
                return "" === t ? void smoke.alert("You can't set a blank name!", function() {
                    P.resume()
                }) : (P.resume(), void(t !== !1 && (h.set_category_name(e, t), W())))
            })
        }), h.add_button.addEventListener(a.events.POINT, Pt);
        var G = h.basket_button;
        G.addEventListener(a.events.POINT, function(i) {
            var e = i.currentTarget,
            ...
            function t(t) {
                P.resume(), 0 != t && (h.remove_category(e), h.select_category(h.original_category), W())
            }
            P.stop();
            var e = h.current_category;
        ...
        nt.use_image_title ? M({
            image_src: a.get_set_directory(J) + "/puzzle/" + R + "-title.png",
            fix_ie_bug: !0,
            color: "#edd9a7",
            callback: function(e) {
        ...
        }) : (f.inner = document.createElement("div"), f.inner.className = "jt-play-title-inner", f.appendChild(f.inner), f.inner.text = document.createElement("p"), f.inner.text.innerHTML = nt.name, f.inner.appendChild(f.inner.text), A(f.inner.text, {
            unit_type: "px",
            transform_scale: g.content_scale
        }));
        var d = document.createElement("div");
        ...
        var at = new PIXI.Stage,
            ...
            Ft = new PIXI.DisplayObjectContainer,
        ...
        t.renderer = Kt, t.stage = St, t.piece_sprite_container = Ft, t.real_stage = at, at.addChild(St), St.addChild(Ft), t.load_opacity_transition = .5, t.style.pointerEvents = "none", t.bg = document.createElement("canvas"), t.bg.image = new Image, t.bg.image.src = C.background_image_url, t.reposition_and_resize = function() {
            var i = j(g),
                r = s(g),
                e = g.content_scale,
                n = parseFloat(getComputedStyle(d).top),
                l = a.jigsaw_minimal_ui ? 0 : s(V);
        ...
        function() {
            switch (e.jigsaw_scale_low_power_sizer = e.difficulty_level >= a.jigsaw_reduce_texture_size ? 2 : 1, e.difficulty_level) {
                case 0:
                    F.cut_multiplier = 1, e.piece_logical_scale = 1 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 2;
                    break;
                case 1:
                    F.cut_multiplier = 1, e.piece_logical_scale = .75 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 2.666;
                    break;
                case 2:
                    F.cut_multiplier = 1, e.piece_logical_scale = .5 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 4;
                    break;
                case 3:
                    F.cut_multiplier = 1, e.piece_logical_scale = .5 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 6
            }
            F.stroke_width = e.piece_logical_scale / e.jigsaw_scale_low_power_sizer
        }();
        var u = y.main_image = document.createElement("div");
        u.className = "jt-play-main_image jt-jigsaw-main_image", r(u), Ht(u), u.classList.add("jt-jigsaw-main_image-active");
        var x = u.base_image = document.createElement("img"),
            k = document.createElement("div");
        k.className = "jt-jigsaw-piece_deck";
        var B, O, c = null;
        x.crossOrigin = "Anonymous", a.get_image(x, J, R, "default"), x.addEventListener("load", function() {
            d.inner.setTimeout(Nt, 30)
        });
        var m = new Image;
        m.src = a.get_set_directory(C.set_name) + "/gui/gui-loading.png", m.logical_parent = t, t.loading_animation = m, m.defer_start = function(e) {
            d.inner.setTimeout(function() {
                m && !m.game_initialized && (m.start(), it(void 0, !0))
            }, e)
        }, m.start = function() {
            1 != !!m.game_initialized && (m.stage.alpha = 1, m.display = !0, at.addChild(m.stage), I())
        }, m.stop = function() {
            m.stage && (m.stage.alpha = 1), m.game_initialized = !0, m.display && (m.display = !1, at.removeChild(m.stage)), I()
            ...
            if (d.isAttached()) {
                ...
                o.drawImage(m, e, 0, e, i, 0, 0, e, i), m.outer = {}, U({
                ...
                o.drawImage(m, 0, 0), m.inner = {}, U({
                    logical_parent: m.inner,
                    parent: m.stage,
                    canvas: n
                }), m.inner.sprite.x = a, m.inner.sprite.y = s, m.inner.sprite.width = e, m.inner.sprite.height = i, m.start(), it(void 0, !0)
            }
        ...
        g.cleanup = function() {
            ...
            C = null, a = null, R = null, tt = null, ei = null, D = null, nt = null, J = null, Q = null, y = null, F = null, e = null, $ = null, I = null, yt = null, f = null, h = null, G = null, P = null, Vt = null, zt = null, d = null, t = null, u = null, x = null, k = null, c = null, B = null, O = null, m = null, ft = null, gt = null, W = null, Gt = null, delete g.cleanup
        }, k.drag_active = !1, k.drag_start = function(e) {
            k.drag_active = !0, k.drag_update(e, !0)
        }, k.drag_update = function(s, l) {
            if (0 != k.drag_active) {
                var t = o(s, d),
                    ...
                    n = e.zoom.offset_x,
                    a = e.zoom.offset_y;
                l || (n += i - k.drag_initial_x, a += r - k.drag_initial_y), e.zoom.offset_x = n, e.zoom.offset_y = a, k.drag_initial_x = i, k.drag_initial_y = r, k.drag_initial_scale = h
            }
        }, k.drag_end = function() {
            k.drag_active = !1
        };
        var dt = void 0,
            W = y.save_puzzle_state = function() {
                ...
                i[Q + "." + R + "." + D.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + Q + "." + R + "." + D.selected_difficulty] = JSON.stringify(t)
            },
            Gt = y.load_puzzle_state = function(s) {
                function o() {
                    var e = {};
                ...
                var t = JSON.parse(localStorage["puzzle_states." + Q + "." + R + "." + D.selected_difficulty]);
        ...
        y.redraw_main_image_and_pieces = function(f) {
            function E() {
                ...
                i.save(), p({
                    ...
                    lineWidth: 0,
                    canvas: o
                }), i.clip(), i.drawImage(c, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), i.restore(), i.save(), i.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), ht(o), i.restore(), U({
                    parent: t.stage,
                    canvas: o,
                    position: 1,
                    is_2d: !0
            ...
            for (var b = [], m = [], d = 0; d < O.length; d++) {
                ...
                if ("undefined" != typeof s && (i.width_float = Math.round(i.width_float * s * 1e3 / 1e3), i.height_float = Math.round(i.height_float * s * 1e3 / 1e3), i.puzzle_left_min = Math.round(i.puzzle_left_min * s * 1e3 / 1e3), i.puzzle_top_min = Math.round(i.puzzle_top_min * s * 1e3 / 1e3), i.width = Math.ceil(i.width_float / e.piece_logical_scale), i.height = Math.ceil(i.height_float / e.piece_logical_scale), i.puzzle_width.forEach(function(t, e) {
                    ...
                    e.pieces_in_position_count += i.x.length, i.shape_string = q(i.side_set, [-i.puzzle_left_min, -i.puzzle_top_min]), b.push(i);
                    for (var l = 0, y = i.x.length; y > l; l++) B[i.x[l]][i.y[l]] = i
                } else {
                    if (m.push(i), O[d].canvas) var r = O[d];
                    else var r = bt();
                    ...
                    for (var l = 0, y = r.x.length; y > l; l++) B[r.x[l]][r.y[l]] = r
                }
            }
            I();
            var C = _t(b),
            ...
            var _ = c.getContext("2d"),
                A = h.naturalWidth,
                T = h.naturalHeight;
            _.drawImage(h, 0, 0, A, T, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, h.width / e.piece_logical_scale, h.height / e.piece_logical_scale), _.save(), _.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), a.jigsaw_use_3d_effect && lt({
                canvas: c,
                stroke_width: F.stroke_width,
                cut_multiplier: F.cut_multiplier,
                shape_string: M,
    ...
    function ct(i) {
        ...
        return e.destroy = function() {
            e.canvas.parentNode.removeChild(e.canvas), e.proton.destroy(), cancelAnimationFrame(e.requestAnimationFrameID)
    ...
    function D(e) {
        function i() {
            F(), t.challenge_code_request_asked = !0;
    ...
    var P = "safari",
        I = "com.flyingsoft.safari.jigsaw",
        a = !0,
        d = !0,
        e = {
    ...
    "undefined" != typeof module && null != module && (module.exports = e), window.addEventListener("load", function() {
        ...
        e.WEBGL_RENDERER = 0, e.CANVAS_RENDERER = 1, e.VERSION = "v1.6.1", e.blendModes = {
            ...
            if (0 !== t.length) {
                ...
                if (A.x === x.x && A.y === x.y) {
                    ...
                    var U = x.x + .5 * (A.x - x.x),
                        D = x.y + .5 * (A.y - x.y);
                    t.unshift(U, D), t.push(U, D)
                }
                var E, b, _, p, a, n, M, C, r, i, g, f, y, v, j, P, k, L, O, R, S, G, l, s = N.points,
                    I = N.indices,
                    T = t.length / 2,
                    F = t.length,
                    B = s.length / 6,
        ...
        function D(t, i, r) {
            D._super_.call(this), this.massPan = e.Util.setSpanValue(t, i, r)
        }
        ...
        e.POOL_MAX = 1e3, e.TIME_STEP = 60, e.MEASURE = 100, e.EULER = "euler", e.RK2 = "runge-kutta2", e.RK4 = "runge-kutta4", e.VERLET = "verlet", e.PARTICLE_CREATED = "partilcleCreated", e.PARTICLE_UPDATE = "partilcleUpdate", e.PARTICLE_SLEEP = "particleSleep", e.PARTICLE_DEAD = "partilcleDead", e.PROTON_UPDATE = "protonUpdate", e.PROTON_UPDATE_AFTER = "protonUpdateAfter", e.EMITTER_ADDED = "emitterAdded", e.EMITTER_REMOVED = "emitterRemoved", e.amendChangeTabsBug = !0, e.TextureBuffer = {}, e.TextureCanvasBuffer = {}, e.prototype = {
            ...
            destroy: function() {
                for (var i = this.emitters.length, t = 0; i > t; t++) this.emitters[t].destroy(), delete this.emitters[t];
        ...
        }, e.Velocity = b, e.V = b, e.Util.inherits(D, e.Initialize), D.prototype.initialize = function(e) {
            e.mass = this.massPan.getValue()
        }, e.Mass = D, e.Util.inherits(M, e.Initialize), M.prototype.reset = function(t, i, r) {
    ...
    if ((t._gsQueue || (t._gsQueue = [])).push(function() {
                ...
                function() {
                    ...
                    var ct = function(e, o, c, a) {
                            ...
                            return t ? r = o ? function(o) {
                                ...
                                if (_ = (o.match(x) || [s])[0], p = o.split(_).join("").match(D) || [], e = p.length, t > e--)
                    ...
                    var vt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
                        ...
                        E = u.getTransform = function(m, Q, P, J) {
                            ...
                            var o, t, y, L, X, R, z, w, v, q, Y, j, U, e = P ? m._gsTransform || new at : new at,
                                nt = 0 > e.scaleX,
                                M = 2e-5,
                                u = 1e5,
                                k = 179.99,
            ...
            if (!C.TweenLite) {
                ...
                var D = function() {
                    o && E() - S > 2e3 && r.wake(), setTimeout(D, 2e3)
                };
                D(), e.play = function(e, t) {
            ...
            var l = t.GreenSockGlobals || t,
                ...
                _ = function(i, v, B, X, F) {
                    ...
                    var w, p, b, s, _, E, x, n, f, l, m, z, O, M = r(i),
                        ...
                        R = a(v.wordsClass),
                        V = a(v.charsClass),
                        j = -1 !== (v.linesClass || "").indexOf("++"),
                        S = v.linesClass;
                    for (j && (S = S.split("++").join("")), b = R(), s = 0; u > s; s++) E = M.charAt(s), ")" === E && M.substr(s, 20) === h ? (b += L + "<BR/>", s !== u - 1 && (b += " " + R()), s += 19) : " " === E && " " !== M.charAt(s - 1) && s !== u - 1 ? (b += L, s !== u - 1 && (b += H + R())) : b += T && " " !== E ? V() + E + "</div>" : E;
        ...
        var xt = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").get,
            bt = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").set;
    ...
    var u = function() {
        if (typeof this == window) return new u;
        var e = this,
            t = void 0;
    ...
    var g;
    1 == !!window.IS_READY ? g = x() : window.addEventListener("load", function() {
