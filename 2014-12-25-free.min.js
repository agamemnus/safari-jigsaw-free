...
function() {
 ...
 function C(e) {
  ...
  function n(r) {
   ...
   var u = o(r.touches[0], t),
    n = u[0],
    l = u[1],
    d = o(r.touches[1], t),
    h = d[0],
    c = d[1];
   return (e.always_recalculate_zoom_target === !0 || 0 == i) && (a = (n + h) / 2, s = (l + c) / 2), i = Math.sqrt(Math.pow(Math.abs(n - h), 2) + Math.pow(Math.abs(l - c), 2)), "touchstart" == r.type ? void("undefined" != typeof e.start_effect && e.start_effect(r, n, l, h, c)) : (e.result_function(i / p, a, s), void("undefined" != typeof e.move_effect && e.move_effect(r)))
  }
  if ("undefined" == typeof this || this === window) return new C(e);
  var t = e.target,
   i = !1,
   a = void 0,
   s = void 0;
 ...
 function i(e) {
  ...
  var a = "undefined" != typeof e.charset ? e.charset : "",
   s = ("undefined" != typeof e.data ? e.data : "", "undefined" != typeof e.ignore_request_status ? e.ignore_request_status : !1, yt(e.file, e.data, n, a, t, void 0, void 0, e.request_method)),
   i = s.http_request;
 ...
 function _t(s) {
  function u() {
   if (1 == a.first_run && a.load_player_data_from_server(), e.ambient_music.load_ambient_music(t.ambient_music, t.ambient_music_start), "undefined" != typeof t.intro_audio && "" != t.intro_audio) {
    ...
    c.style.display = "none", r.appendChild(c);
   ...
   r.innerHTML = h, r.children.forEach(function(e) {
    n(e)
   }), "undefined" != typeof t.intro_audio && "" != t.intro_audio && r.appendChild(c);
   var i = r.querySelector("span"),
    s = r.querySelector(".jt-game-header");
   if (null != s && (i.style.display = "none", S({
     image: s,
     fix_ie_bug: !0,
     color: "#edd9a7",
     callback: function(e) {
      s.parentNode.appendChild(e), s.parentNode.removeChild(s), s = e, e.style.height = "100%", i.style.display = "block"
     }
    })), void
    function() {
     function t(t) {
     ...
     r.push(i), r.forEach(function(i) {
      ...
      var e = U(window.getComputedStyle(i).backgroundImage);
 ...
 function ft(a) {
  function c() {
   function T() {
    ...
    y.innerHTML = '<span style="position:relative; margin-left: 18px; top: -6px; line-height: 0; font-family:lato; font-size: 60px; vertical-align: middle">' + t + '</span><span style="position:relative; top: -3px; line-height: 0; font-family: flyingsoft-icons; font-size: 106px; vertical-align: middle">g</span>', c.setTimeout(T, 250)
   }
   ...
   var r = {};
   s.innerHTML = "";
   var c = r.header = document.createElement("div");
   c.className = "jt-select_screen-header", s.appendChild(c), n(c);
   var m = r.body = document.createElement("div");
   m.className = "jt-select_screen-body", s.appendChild(m), c.icon_list = document.createElement("div"), c.icon_list.className = "jt-select_screen-header-icon_list", c.appendChild(c.icon_list);
   var k = [t.menu.generic.about, t.menu.generic.ogle_trophies, t.menu.jigsaw.toggle_categories, t.menu.jigsaw.open_misc_config_menu, t.menu.jigsaw.open_visual_settings_menu, t.menu.generic.open_audio_settings_menu],
    M = j({
     gs: e,
     parent: s,
     menu_item_list: k,
   ...
   var w = r.sort_button = V({
    ...
    x = t.player_data,
    _ = r.difficulty_level_button = document.createElement("div");
   _.className = "jt-select_screen-header-difficulty_level jt-select_screen-header-size-1 jt-button hoverable", c.appendChild(_), _.update_text = function() {
    this.innerHTML = l.difficulty_levels[x.selected_difficulty].name.capitalize()
   }, _.update_text(), _.addEventListener(e.events.POINT, function() {
    var e = l.difficulty_levels.length;
    x.selected_difficulty = (x.selected_difficulty + 1) % e, localStorage.player_data = JSON.stringify(t.player_data), _.update_text()
   });
   var C = r.challenge_a_friend_button = dt({
    select_screen: r,
    content_div: s,
    mr_jigtato: t,
    gs: e
   ...
   c.appendChild(A);
   var y = r.gem_purchase_button = document.createElement("div");
   y.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-1 jt-button hoverable", y.addEventListener(e.events.POINT, S), c.appendChild(y), T();
   var g = 12,
    L = r.create_puzzle_selection_array = function() {
     p = [];
     for (var t in o) {
      var e = o[t];
   ...
   L();
   var f = r.selection_container = document.createElement("div");
   f.className = "jt-select_screen-selection-container", m.appendChild(f);
   var I = r.create_tab_container = function(t) {
     function o(e) {
      t.select_function({
     ...
     r.className = "jt-select_screen-selection-tab_container", t.parent.appendChild(r);
     var a = Math.ceil(t.item_list.length / t.items_per_page);
     1 == a && (a = 0);
     for (var s = 0; a > s; s++) {
      var i = document.createElement("div");
      i.className = "jt-button", n(i), r.appendChild(i), i.innerHTML = s + 1, i.tab_index = s, t.select_function && i.addEventListener(e.events.POINT, o)
     }
     return 0 == a && l.classList.add("jt-select_screen-selection-container-center"), r
    },
    O = r.create_selection_tab_container = function() {
     r.selection_tab_container = I({
      parent: m,
      selection_container: f,
      item_list: p,
      items_per_page: g,
   ...
   O(), "undefined" == typeof e.select_menu_current_page[i] && (e.select_menu_current_page[i] = 0), w.onsort = function() {
    b({
     ...
     level_array: p,
     items_per_page: g,
     selection_tab_container: r.selection_tab_container
    })
   }, w.sort_levels();
   r.refresh_puzzle_list = function() {
    b({
     page: 0,
     level_array: p,
     items_per_page: g,
  ...
  function d(i) {
   ...
   return n.challenge_a_friend_button.is_active ? void n.challenge_a_friend_button.select_puzzle(i.currentTarget) : void a()
  }
  var s = a.content_div,
   t = a.mr_jigtato,
   e = a.global_settings,
 ...
 function pt(l) {
  ...
  function d() {
   function u(a) {
    ...
    var m = s.game_data.entry_list,
     S = e.select_packs_menu_current_page[o] = a.page;
    e.select_packs_menu_current_page = e.select_packs_menu_current_page;
    var v = a.item_array,
     d = a.items_per_page,
     C = S * d,
     b = (S + 1) * d - 1;
    v.length - 1 < b && (b = v.length - 1);
    for (var g = 0, T = C; b >= T; T++) {
     var i = v[T],
      t = document.createElement("div");
     ...
     x.className = "jt-select_packs_screen-selection-item-info-description", x.innerHTML = i.description, l.appendChild(x);
     var c = document.createElement("div");
     c.className = "jt-button jt-select_packs_screen-selection-item-info-preview_button", c.innerHTML = "Preview", c.addEventListener(e.events.POINT, _), c.pack = i, l.appendChild(c);
   ...
   function d(n) {
    i({
     ...
     async: !0,
     success: function(i) {
      e.account.gem_amount = i.gem_amount, e.account.users_to_puzzle_packs[n.puzzle_pack_id] = n.puzzle_pack_id;
   ...
   function m(t) {
    function r(l) {
     ...
     var n = s.game_data.entry_list;
     h.forEach(function(t) {
      var a = document.createElement("div");
      a.className = "jt-select_screen-selection-item jt-pack_preview_screen-selection-item", r.appendChild(a);
      var s = document.createElement("div");
      s.className = "jt-select_screen-selection-item-image_wrapper jt-select_packs_screen-selection-item-image_wrapper", a.appendChild(s);
      var i = document.createElement("img");
      i.className = "jt-select_screen-selection-item-image-" + ("undefined" == typeof n[t].crop_margin ? "centered" : "cropped"), "undefined" != typeof n[t].crop_margin && (i.style.marginLeft = -n[t].crop_margin + "%"), e.get_image(i, o, t, "mini"), s.appendChild(i)
     });
   ...
   t.className = "jt-select_screen-selection-container", c.appendChild(t);
   var l = [];
  ...
  return t.activate = function() {
   h({
    ...
    success: function() {
     t.is_active = !0, u.querySelectorAll(".jt-button").forEach(function(e) {
      e != t && e != r.gem_purchase_button && (e.style.display = "none")
   ...
   t.is_active = !1, u.querySelectorAll(".jt-button").forEach(function(e) {
    e != t && e != r.gem_purchase_button && (e.style.display = "")
 ...
 function x() {
  function l() {
   ...
   if (e.jigsaw_piece_scale_to_actual_options = [.5, .6, .75, 1], e.jigsaw_heat_seeking_color_options = [void 0, "cyan", "red"], s.forEach(function(n) {
     var t = n.name,
      r = t.indexOf(".");
     ...
     return (f ? "content://" + M + ".free.expansion/" : e["/"]) + "sets/" + t
     ...
     var i = (f ? "content://" + M + ".free.expansion/" : e["/"]) + "sets/" + r;
     switch (n) {
      case "mini":
     ...
     var a = t.audio_type || "sound_effect",
      o = e[a + ("sound_effect" == a ? "s" : "") + "_on"];
     if (t.play_howl = !1, t.play_howl && "ambient_music" == a && (t.preload_buffer_file = n.substr(0, n.length - 4) + "-preview" + n.substr(-4)), o || "undefined" != typeof t.start && 0 == t.start)
   ...
   if (e.is_phone_or_tablet && (document.body.addEventListener("touchstart", function(e) {
    ...
    !e.account.IS_PREMIUM && e.IS_WEBVIEW && "undefined" != typeof u && (e.ad_control_list = [], e.ad_control_list.destroy = function() {
     e.ad_control_list.forEach(function(e) {
      e.destroy()
     }), e.ad_control_list = []
    }, Array.prototype.slice.call(["admob", "adbuddiz"]).forEach(function(r) {
     var i = u({
      gs: e,
      ad_network: r
     });
     console.dir(i), i.init(), e.ad_control_list.push(i), void
     function() {
  ...
  window.onerror = function(t, r, a, s) {
   var e = "undefined" != typeof window.device ? window.device : e;
   "undefined" == typeof e.model && (e.model = ""), "undefined" == typeof e.uuid && (e.uuid = ""), i({
    file: "http://www.flyingsoftgames.com/mr_jigtato/check-in_new" + (n.DEBUG ? "-beta" : "") + ".php?action=send_javascript_error&errormessage=" + t + "&url=" + r + "&line_number=" + a + "&column_number=" + s + "&device_model=" + e.model + "&device_uuid=" + e.uuid,
    success: function() {},
    error: function() {},
    request_method: "GET"
   })
  }, "undefined" == typeof a && (a = !1), "undefined" == typeof f && (f = !1), "undefined" == typeof window.device && (window.device = {
   version: "",
   uuid: "",
   model: ""
  }), a && ot();
  ...
  t.load_game_data = function(l) {
   ...
   function h() {
    if (t.game_data = r, t.game_data.trophy_list = a, void
     function() {
      var t = r.entry_list,
       a = 0;
      for (var i in t) {
       ...
       if ("undefined" == typeof e.puzzle_position && (e.puzzle_position = a), a += 1, "undefined" != typeof e.template) {
        var s = t[e.template];
        for (var n in s) "undefined" == typeof e[n] && (e[n] = g(s[n]));
        delete e.is_only_template
       }
      }
      for (var i in t) t[i].is_only_template && delete t[i]
     }(), "undefined" != typeof r.web_font_list) {
     var i = [];
     r.web_font_list.forEach(function(t) {
      i.push(n.get_set_directory(e) + "/" + t)
     }), mt(i)
    }
   ...
   i({
    ...
    file: n.get_set_directory(e) + "/" + e + "-trophies.json",
    request_method: "GET"
   });
   var r = void 0;
   i({
    file: n.get_set_directory(e) + "/" + e + ".json",
    request_method: "GET",
    async: !0,
    ignore_request_status: n.IS_WEBVIEW,
    error: n.errormessage,
    success: function(e) {
     r = e, s()
    }
   })
  }, t.update_game_data_from_server = function(r) {
   function e(e) {
   ...
   function s() {
    ...
    "undefined" != typeof n.free_puzzles && e.push(n.free_puzzles), "undefined" != typeof n.paid_puzzles && e.push(n.paid_puzzles), e.forEach(function(e) {
     "undefined" != typeof e && e.forEach(function(e) {
      if (typeof i[e] != "undefined") i[e].enabled = !0
     })
    }), l()
   }
   var r = r || {},
    o = r.new_state_page || "",
    l = r.callback || function() {},
    a = 3;
   i({
  ...
  }, t.save_player_data_to_server = function(r) {
   {
    var r = r || {};
  ...
  }, t.load_player_data_from_server = function(r) {
   function s(o) {
    t.reset_player_data();
   ...
   "undefined" != typeof n.account.internal_access_token && i({
  ...
  } + localStorage.game_version != o && (localStorage.game_version = o), "undefined" != typeof localStorage.player_data && "true" != c().force_reset && "true" != c().hard_reset ? t.player_data = JSON.parse(localStorage.player_data) : ("undefined" == typeof localStorage.player_data && (t.first_run = !0), t.reset_player_data()), t.set_name = localStorage.set_name;
  var n = t.gs = new l;
  t.parent = document.body, document.original_title = document.title, document.original_title = document.original_title.substring(0, document.original_title.indexOf(":")), n.url_vars = {};
  var p = t.history_control = new Et({
    onbeforestatechange: function(e, i, r) {
     n.try_requesting_fullscreen && !n.IS_WEBVIEW && n.is_phone_or_tablet && z(document.documentElement), "jigsaw" == e.page && "undefined" == typeof e.level && (e.page = "select_jigsaw"), "undefined" == typeof localStorage.set_name && (e.page = "select_mode"), ("" == e.page || "index.php" == e.page || "index.html" == e.page.substr(e.page.lastIndexOf("/") + 1)) && (e.page = "select_mode"), "jigsaw" != e.page && "undefined" != typeof e.level && delete e.level, "undefined" == typeof i.url && (i.url = e.page);
     var a = 1 == n.is_kiosk ? !0 : void 0;
     switch (i.url = e.page + ct({
      is_kiosk: a,
      level: e.level,
     ...
     i.title = d(e, i), "undefined" != typeof t.game_data ? r() : t.load_game_data({
    ...
    onstatechange: function(e, i) {
     ...
     switch (e.page) {
      case "select_mode":
       if (n.IS_CORDOVA && (n.select_mode_visited_count += 1, n.select_mode_visited_count > 1 && n.is_android)) return n.ad_control_list.destroy(), void t.save_player_data_to_server({
      ...
      case "jigsaw":
       ht({
        ...
        global_settings: n,
        level_id: e.level
       }), !n.account.IS_PREMIUM && n.IS_WEBVIEW && "undefined" != typeof u && st({
        gs: n,
        mr_jigtato: t
       });
       break;
  ...
  if (s.className = "jt-content_div", t.parent = document.body, t.parent.appendChild(s), smoke.parent = s, n.is_phone_or_tablet) {
   smoke.custom_css = {
  ...
  return K({
   ...
   var c = a.level_id,
    ...
    i = t.game_data,
    o = i.entry_list[c],
    e = "undefined" != typeof o.audio_template ? i.audio_template_list[o.audio_template] : o.audio;
   if ("undefined" != typeof e) {
    ...
    if ("undefined" == typeof i.entry_audio_directory) var r = n.get_set_directory(t.set_name) + "/audio/" + r + ".ogg";
    else var r = n.get_set_directory(t.set_name) + "/" + i.entry_audio_directory + "/" + r + ".ogg";
    n.sound_effects_on && (t.last_intro_audio = r, n.playAudio(r, {
     element: a.parent,
     restart: !0
    }))
   }
  }, t.load_set_css = function(r) {
   function s(i) {
    var s = n.get_set_directory(a) + "/";
    i = i.replace(/url\('/g, "url('" + s), i = i.replace(/url\(\"/g, 'url("' + s), e.innerHTML = i, e.charset = "utf-8", e.media = "screen", e.type = "text/css", e.rel = "stylesheet", o.insertBefore(e, o.lastChild), t.unload_set_css(), t.custom_css_div = e, r && r(e)
   }
   var a = localStorage.set_name;
   if (t.custom_css_div) return r && r(t.custom_css_div), t.custom_css_div;
   var o = document.getElementsByTagName("head")[0],
    l = i({
     success: s,
     error: function(e) {
      n.errormessage(e, init.callback)
     },
   ...
   get: function() {
    ...
    return n.get_set_directory(t.set_name) + "/" + i
   }
 ...
 function st(r) {
  function o() {
   ...
   var t = smoke.confirm(a, function(t) {
    ...
    r = t.dialog.text.childNodes[1];
   t.dialog.text.childNodes[0].classList.add("jt-common-instruction_text-title"), r.classList.add("jt-common-instruction_text"), r.style.fontSize = "55px", r.style.lineHeight = "150%", r.style.height = "auto", t.dialog.text.style.height = window.getComputedStyle(t.dialog.text).maxHeight, t.buttons.ok.innerHTML = "Rate it.", t.buttons.cancel.innerHTML = "Don't rate it.", n(t.buttons), t.buttons.ok.classList.add("hoverable"), t.buttons.cancel.classList.add("hoverable")
  }
  var e = r.gs,
   a = r.mr_jigtato,
  ...
  t > 1 && (t = 1), e.show_ad_counter += t, e.ad_control = e.ad_control_list[Math.floor(Math.random() * e.ad_control_list.length)], e.ad_control.present_count = 0, e.ad_control.receive_count = 0, e.ad_control.dismiss_count = 0, e.show_ad_counter >= 1 && (e.show_ad_counter = e.show_ad_counter - parseInt(e.show_ad_counter), Math.random() > .1 ? e.ad_control.run() : 0 == e.account.game_was_rated ? o() : e.ad_control.run())
 }
 ...
 function K(r) {
  ...
  if (e.original_width = e.clientWidth, e.original_height = e.clientHeight, e.desired_scale = 1, e.set_scale = function(t) {
    ...
    if (t && c())
     if (Math.abs(window.orientation) != Math.abs(h)) var p = o,
      f = a - i * !n;
     else var p = a,
      f = o - i * n;
 ...
 function q(n) {
  function o() {
   e.back.style.visibility = 0 == r ? "hidden" : "visible", e.next.style.visibility = r == a.length - 1 ? "hidden" : "visible", s.text.innerHTML = a[r], s.text.parentNode.classList[1 == r ? "add" : "remove"]("jt-play-show_credits-dialog")
  }
  "undefined" == typeof n.callback && (n.callback = function() {});
  var t = n.gs,
   h = n.mr_jigtato.set_name,
   a = [];
  n.gs.is_kiosk || (t.contact_info = '<a href="mailto:' + t.contact_info + '">' + t.contact_info + "</a>"), a[0] = n.mr_jigtato.game_data.about_text + t.contact_info + ". </p>", n.callback, a[1] = "Loading...", i({
   ...
   file: t.get_set_directory(h) + "/" + h + "-credits.txt",
   charset: "utf-8",
   plaintext: !0,
   request_method: "GET",
   ignore_request_status: t.IS_WEBVIEW
  });
  var s = smoke.alert(n.mr_jigtato.game_data.about_text + t.contact_info + ". </p>", n.callback),
   e = s.buttons;
  ...
  var r = 0;
  o(r), l(s), t.is_phone_or_tablet && (s.dialog.text.style.backgroundColor = "transparent")
 }
 ...
 function D(a) {
  function o(l) {
   ...
   t.innerHTML = "";
   var e = document.createElement("span");
   e.className = "jt-play-trophy_room-item_name", e.style.color = a.text_color, e.innerHTML = a.display_name.capitalizeFirstLetter(), t.appendChild(e), r.is_chromium || r.is_android ? (e.style.textShadow = "none", e.style.WebkitTextStrokeColor = a.text_outline_color, T({
    element: e,
    size: "3px",
    color: ""
   ...
   t.appendChild(h);
   var n = document.createElement("span");
   n.className = "jt-play-trophy_room-puzzle_name", n.style.color = s.title_color, n.innerHTML = '"' + s.name + '"', t.appendChild(n), r.is_chromium || r.is_android ? (n.style.textShadow = "none", n.style.WebkitTextStrokeColor = s.border_color, T({
    element: n,
    size: "3px",
    color: ""
  ...
  var h = document.createElement("div");
  h.className = "jt-play-trophy_room-title-image", n.appendChild(h);
  var s = document.createElement("div");
 ...
 function v(t) {
  var r = t.gs,
   ...
   n = t.level_id,
   a = t.mr_jigtato,
   o = ("undefined" != typeof t.game_type ? t.game_type : "jigsaw", a.game_data.jigsaw),
   i = a.get_trophy_item({
    game_type: o,
    level_id: n,
  ...
  return "undefined" != typeof i.trophy_image_padding && (e.style.padding = parseFloat(i.trophy_image_padding) * h / 356 + "px"), "undefined" != typeof i.trophy_image_border_color && (e.style.borderColor = i.trophy_image_border_color), e.src = r.get_trophy_directory(s, n) + "/" + i.filename + ".png", e
 }
 ...
 function ht(Y) {
  ...
  function at(g, d) {
   function l() {
    d || (e.show_pieces_deferred = window.requestAnimationFrame(at))
   }
   if (e.do_screen_refresh_run) {
    ...
    if (!t.background_image_drawn && !z.initial_background_is_transparent) {
    ...
    var n = e.zoom.scale,
     h = e.zoom.offset_x,
     u = e.zoom.offset_y;
    i.x = h, i.y = u, n && (i.scale.x = n, i.scale.y = n), i.alpha = 1;
  ...
  function It(e) {
   return "undefined" == typeof e && (e = {}), R.stop(), 4 == h.container.childNodes.length ? void smoke.alert("No more than 4 categories can be used at one time.", function() {
    R.resume()
  ...
  function jt() {
   var o = !a.jigsaw_minimal_ui && a.show_trophy_ribbon ? s(yt) : 0,
    l = s(d);
   ...
   var n = o + (a.jigsaw_minimal_ui ? 0 : s(f)),
    c = a.jigsaw_minimal_ui || null == X.parentNode ? 0 : s(X);
   if (d.style.height = "", a.jigsaw_minimal_ui) {
    e.area && e.area.forEach(function(e) {
     e.margin_top = 128
    });
    var r = s(d.parentNode)
   } else {
    e.area && e.area.forEach(function(e) {
     e.margin_top = 0
    });
    var r = s(d.parentNode) - n - c
   }
   d.style.top = n + "px", d.style.height = r + "px", X.style.top = parseFloat(d.style.top) + parseFloat(d.style.height) + "px", t.reposition_and_resize(), P(), "undefined" != typeof x && x.naturalHeight && (e.area && e.area.forEach(function(e) {
    e.height = r * e.height_ratio
   }), u.top = (r - x.height + (x.height - x.height)) / 2), Z(), h.container.children.forEach(function(t) {
  ...
  function Z() {
   if (!t.bg.image.complete) return void t.setTimeout(Z, 50);
   if (0 == !!t.bg.refresh_bg && (t.bg.refresh_bg = !0, t.bg.width = "undefined" != typeof t.cached_width ? t.cached_width : t.width, t.bg.height = "undefined" != typeof t.cached_height ? t.cached_height : t.height, t.bg.getContext("2d").drawImage(t.bg.image, 0, 0, t.bg.image.naturalWidth, t.bg.image.naturalHeight, 0, 0, t.bg.width, t.bg.height), G({
     ...
     canvas: t.bg,
     position: 0
    }), P()), t.background_image_drawn = !0, "undefined" == typeof u) return void t.setTimeout(Z, 50);
   if ("undefined" == typeof u.left) return void t.setTimeout(Z, 50);
   if (!u.base_image.complete) return void t.setTimeout(Z, 50);
   t.bg.refresh_bg = !0;
   ...
   (1 == r.style.opacity || e.jigsaw_show_hint_rect) && (1 == r.style.opacity || e.jigsaw_show_hint_image ? (i.globalAlpha = r.style.opacity, i.drawImage(r, n, a, s, o), i.globalAlpha = 1) : (i.fillStyle = "white", i.fillRect(n, a, s, o))), G({
    parent: t.stage,
    logical_parent: t.bg,
    canvas: t.bg,
    position: 0
  ...
  function ai(e) {
   var e = e || {},
    s = "undefined" != typeof e.jigsaw_minimal_ui ? e.jigsaw_minimal_ui : a.jigsaw_minimal_ui,
    o = "undefined" != typeof e.jigsaw_use_large_square_images ? e.jigsaw_use_large_square_images : a.jigsaw_use_large_square_images,
   ...
   return i.width = Math.round(r / 1.33333), t.naturalHeight == t.naturalWidth ? o && (i.width = r, i.height = r) : t.naturalHeight < t.naturalWidth && (i.width = n > 0 && s ? r * t.naturalWidth / t.naturalHeight : r), i.height = parseFloat(i.width * t.naturalHeight / t.naturalWidth), i
  }
  ...
  function Gt() {
   ...
   e.jigsaw_initial_show_hint_image = a.jigsaw_show_hint_image, e.jigsaw_show_hint_rect = a.jigsaw_show_hint_rect, e.jigsaw_show_hint_image = a.jigsaw_show_hint_image, e.piece_margin = a.jigsaw_get_scaled_piece_margin(e), e.piece_margin_style = a.jigsaw_piece_margin_style, d.inner.appendChild(M);
   ...
   if (i.set_size = function() {
    ...
    }, si(), "undefined" == typeof localStorage["puzzle_states." + et + "." + L + "." + B.selected_difficulty]) {
    ft();
    var n = Math.round(1e6 * Math.random());
    Math.seedrandom(n), h.add_category("General"), Jt({
     source_image: x,
     width: x.width,
     height: x.height,
     size_x: e.tile_x,
     ...
     draw_settings: z,
     callback: function(t) {
      U = t, ri(U, h.current_category.piece_container), I = Array.prototype.slice.call(h.current_category.piece_container.children), gt(I), nt(h.current_category.piece_container), e.pieces_in_position_count = 0, r()
     }
    })
   } else Wt({
    callback: r
  ...
  function ni() {
   function r() {
    a.jigsaw_minimal_ui ? f.show_title_animation({
     callback: R.resume
    }) : f.setTimeout(function() {
     f.autoshow_title({
      callback: R.resume
     })
    }, 1e3), y.event_listeners_loaded || (y.event_listeners_loaded = !0, M.addEventListener(a.events.POINT_START, Qt), document.addEventListener(a.events.POINT_MOVE, Ft), a.is_phone_or_tablet ? (C({
     target: d.inner,
     result_function: Pt,
     start_effect: function() {
      M.drag_active = !1, M.pinch_active = !0
     },
     end_effect: function() {
      M.pinch_active = !1
     }
    }), M.addEventListener("touchend", q), M.addEventListener("touchcancel", q), M.addEventListener("touchleave", q), g.addEventListener("touchend", q)) : (document.addEventListener("mouseup", q), window.addEventListener("blur", ht), window.addEventListener("mouseout", Ot), d.inner.addEventListener("mousewheel", Lt), d.inner.addEventListener("DOMMouseScroll", Lt))), f.setTimeout(function() {
   ...
   if (t.loading_animation.stop(), "undefined" == typeof e.pending_message || "" == e.pending_message) r();
   else {
  ...
  function ii() {
   ...
   return e.className = "jt-play-trophy_ribbon", e.addEventListener(a.events.POINT, function() {
    ...
    for (var n = 0; s > n; n++) {
     ...
     t.className = "jt-play-main_image_border_width", t.src = a.get_trophy_directory(c, l) + "/" + h.filename + ".png", t.style.backgroundColor = h.background_color, e.appendChild(t)
    }
  ...
  function Zt(i) {
   ...
   var r = (e.piece_margin, h.current_category.piece_container.children);
  ...
  function lt(s) {
   ...
   function m() {
    ...
    o.className = "jt-play-trophy_reward-text", o.innerHTML = f ? "This level gave you the following trophy:" : "You've acquired a trophy on this level and difficulty:", s.appendChild(o);
    var r = document.createElement("p");
    r.className = "jt-play-trophy_reward-trophy_name", r.style.color = "undefined" != typeof i.text_color ? i.text_color : i.background_color, s.appendChild(r);
    ...
    if (r.innerHTML = i.display_name.capitalizeFirstLetter() + ("!" == u || "." == u ? "" : "."), "undefined" != typeof i.text_outline_color) {
     ...
     a.is_chromium || a.is_android ? (r.style.textShadow = "none", r.style.WebkitTextStrokeColor = n, T({
      element: r,
      size: "4px",
      color: ""
    ...
    if ("undefined" != typeof i.subtitle) {
     var h = document.createElement("div");
     h.className = "jt-play-trophy_reward-text", h.innerHTML = i.subtitle, s.appendChild(h)
    }
    var _ = "jt-play-main_image_border_width jt-play-trophy_reward-trophy_image",
     m = a.is_phone_or_tablet ? "" : "jt-play-trophy_reward-trophy_image-expanded",
     c = v({
      mr_jigtato: w,
      gs: a,
      set_name: Q,
   ...
   function p() {
    ...
    a.playAudio(a.get_set_directory(Q) + "/audio/" + e.rank_audio[r] + ".m4a", {
     audio_type: "music",
     element: d.inner,
     restart: !0
    });
    var s = smoke.alert("");
    l(s), s.dialog.buttons.ok.addEventListener(a.events.POINT, function() {
     t.fireworks = new ut({
      gs: a,
      draw_area: t
     })
    ...
    i.innerHTML = '<p> You completed the puzzle in <span class="jt-play-show_rank-text-bright">' + R.counter + '</span> seconds.</p><p> Your personal best is <span class="jt-play-show_rank-text-bright">' + _ + "</span> seconds.</p>", i.innerHTML += 0 == r ? '<p> No <span class="jt-play-show_rank-text-bright">' + u + "</span> won this round!</p>" : '<p> Your reward: <span class="jt-play-show_rank-text-bright">' + y[r] + "</span> " + u + ".</p>";
    var o = document.createElement("div");
    o.className = "jt-play-show_rank-image-container";
    for (var c = 0; r > c; c++) {
     var n = document.createElement("div");
     n.className = "jt-play-show_rank-image-item", o.appendChild(n), n.style.opacity = .01, n.style.backgroundImage = 'url("' + a.get_set_directory(Q) + "/gui/" + e.filename + '")', void
     function(t, i) {
      d.inner.setTimeout(function() {
       TweenMax.to(t, 2, {
        parseTransform: !0,
        ...
        t.addEventListener(a.events.POINT, function() {
         "undefined" != typeof e.click_audio && a.playAudio(a.get_set_directory(Q) + "/audio/" + e.click_audio + ".ogg", {
          element: d.inner,
          audio_type: "music"
         })
        })
    ...
    if (i.appendChild(o), 0 == r) var f = 'Complete the puzzle in <span class="jt-play-show_rank-text-bright">' + h + "</span> seconds or less to gain a " + e.name + "!";
    else if (-1 != h) var f = 'Complete the puzzle in <span class="jt-play-show_rank-text-bright">' + h + "</span> seconds or less to gain more " + e.plural + "!";
    else var f = "You've achieved the highest rank for this puzzle and level!";
    var p = document.createElement("p");
    p.innerHTML = f, i.appendChild(p)
   }
   var s = s || {};
   localStorage.removeItem("puzzle_states." + et + "." + L + "." + B.selected_difficulty);
   ...
   if (R.stop(), g.style.overflow = "hidden", e.zoom = {
     scale: 1,
     offset_x: 0,
     offset_y: 0
    }, 1 != o) {
    var n = ti(),
     i = n.trophy_item,
     f = n.trophy_already_exists,
     n = hi(R.counter),
     _ = n.best_time,
     r = n.rank_count,
     h = n.next_rank_point,
     y = ["zero", "one", "two", "three"];
    localStorage.player_data = JSON.stringify(B), 0 == o ? d.inner.setTimeout(c, s.show_trophy_delay || 550) : d.inner.setTimeout(c, s.show_trophy_delay || 550)
   }
  }
  ...
  function Ct(e) {
   ...
   if (P(), u.children.forEach(function(e) {
     ...
     h.remove_category(e)
    }), u.base_image.style.opacity = 1, O(u.composite_image), Z(), e.hide_controls) {
    var t = a.use_categories;
    a.use_categories = !1, f.autoshow_title(), a.use_categories = t, zt.morph_to_back_button()
   }
  ...
  function At(t, r) {
   ...
   var n = o(r, d.inner),
    l = n[0],
    c = n[1];
   t.left = (l / g.desired_scale - e.zoom.offset_x) / e.zoom.scale + (a.jigsaw_center_piece_on_move ? -t.calc_width / 2 : -t.initial_offset_left - t.calc_width / 2), t.top = (c / g.desired_scale - e.zoom.offset_y) / e.zoom.scale + (a.jigsaw_center_piece_on_move ? -t.calc_height / 2 : -t.initial_offset_top - t.calc_height / 2), P();
   ...
   var s = a.jigsaw_heat_seeking_color_options[a.jigsaw_heat_seeking_color_index];
   "undefined" != typeof s && kt(s)
  }

  function kt(i, n) {
   if (null != c && (!n || c.last_border_color_x != c.left || c.last_border_color_y != c.top) && (c.last_border_color_x = c.left, c.last_border_color_y = c.top, d.inner.setTimeout(function() {
     kt(i, n)
    }, 500), c.border_adjust_count = "undefined" == typeof c.border_adjust_count ? 0 : c.border_adjust_count + 1, 10 == c.border_adjust_count && (c.border_adjust_count = 0), 0 == c.border_adjust_count)) {
    c.border_adjust_count = 0;
    var s = c.left - u.left,
     o = c.top - u.top,
     e = Math.abs(s - c.puzzle_left_min) / t.width + Math.abs(o - c.puzzle_top_min) / t.height;
   ...
   if (null == c) {
    ...
    if (!N(n)) {
     var u = o(n, d.inner),
      ...
      l = [],
      v = h.current_category;
     if (v)
      for (var _ = v.piece_container, s = 0, m = _.children.length; m > s; s++) {
       var i = _.children[s];
       if (!i.placed && !(f < i.left || p < i.top || f > i.left + i.calc_width || p > i.top + i.calc_height)) {
        var b = ((f - i.left) / a.jigsaw_piece_scale_to_actual + e.piece_margin) / e.piece_logical_scale,
         w = ((p - i.top) / a.jigsaw_piece_scale_to_actual + e.piece_margin) / e.piece_logical_scale,
         T = i.dummy_canvas.getContext("2d").isPointInPath(i.path, b, w);
        T && l.push(i)
       }
      }
     if (0 == l.length) return void(r == M && M.drag_start(n));
     for (var r = l[0], y = +l[0].sprite.index, s = 1, m = l.length; m > s; s++) {
      var i = l[s]; + i.zIndex <= y || (y = +i.zIndex, r = i)
     }
     P(), a.playAudio(a.audio_dir + "/global-pick up.ogg", {
      audio_type: "sound_effect",
      blocking: !1
     });
     var x = h.basket_button;
     if (x.is_selected) return void x.toggle_piece(r);
     if (O(r), G({
       logical_parent: r,
       canvas: r.canvas,
       is_2d: !0
      }), c = r, c.calc_width = c.width_float, c.calc_height = c.height_float, t.piece_sprite_container.removeChild(r.sprite), t.stage.addChild(r.sprite), 0 == a.jigsaw_center_piece_on_move) {
      var u = o(n, d.inner),
       f = u[0],
       p = u[1];
      c.initial_offset_left = (f / g.desired_scale - e.zoom.offset_x) / e.zoom.scale - r.virtual_left, c.initial_offset_top = (p / g.desired_scale - e.zoom.offset_y) / e.zoom.scale - r.virtual_top
     }
     document.body.style.cursor = "pointer", r.visibility = "hidden", c.visibility = "visible", At(c, n)
    }
   }
  }
  ...
  function q(g) {
   if (null != M && (M.drag_end(), null != c)) {
    "undefined" != typeof g.changedTouches && (g = g.changedTouches[0]);
    var y = !0,
     C = !1;
    if (null != h.item_under_mouse) {
     var k = h.current_category;
     if (k != h.item_under_mouse) {
      y = !1, C = !0;
      var b = h.item_under_mouse.piece_container;
      b.appendChild(c), nt(b, [c])
     }
    }
    var R = h.current_category.piece_container.children,
     r = c,
     s = a.jigsaw_piece_scale_to_actual,
     x = 2 * a.jigsaw_required_precision,
     n = [],
     L = c.left + (1 - s) / 2 * r.width_float - r.puzzle_left_min * s,
     A = c.top + (1 - s) / 2 * r.height_float - r.puzzle_top_min * s;
    if (R.forEach(function(e) {
      if (e != r)
       for (var c = e.virtual_left - e.width_float * s / 2 - e.puzzle_left_min * s, d = e.virtual_top - e.height_float * s / 2 - e.puzzle_top_min * s, a = Math.abs(c - L), o = Math.abs(d - A), t = 0, h = r.puzzle_width.length; h > t; t++)
        for (var g = r.puzzle_width[t], u = r.puzzle_height[t], i = 0, p = e.puzzle_width.length; p > i; i++)
         if (!e.placed) {
          var f = e.puzzle_width[i],
           ...
           m = (g + f) / x,
           l = (u + _) / x;
          if (!(a > m || o > l || Math.abs(e.x[i] - r.x[t]) + Math.abs(e.y[i] - r.y[t]) != 1)) {
     ...
     n.forEach(function(e) {
      p > e.puzzle_left_min && (p = e.puzzle_left_min), l > e.puzzle_top_min && (l = e.puzzle_top_min), _ < e.puzzle_left_min + e.width_float && (_ = e.puzzle_left_min + e.width_float), m < e.puzzle_top_min + e.height_float && (m = e.puzzle_top_min + e.height_float)
     });
     var i = xt();
     return i.className = "jt-jigsaw-piece_deck-piece", i.piece_id = r.piece_id, i.x = [], i.y = [], i.puzzle_width = [], i.puzzle_height = [], i.puzzle_left = [], i.puzzle_top = [], i.puzzle_left_min = p, i.puzzle_top_min = l, i.side_set = pt(n), i.shape_string = K(i.side_set, [-p, -l]), i.dummy_canvas = document.createElement("canvas"), i.path = new Path2D(i.shape_string), I.push(i), r.parentNode.appendChild(i), i.width_float = Math.round(1e3 * (_ - p)) / 1e3, i.height_float = Math.round(1e3 * (m - l)) / 1e3, i.width = Math.ceil((i.width_float + 2 * e.piece_margin) / e.piece_logical_scale), i.height = Math.ceil((i.height_float + 2 * e.piece_margin) / e.piece_logical_scale), n.forEach(function(e) {
      e.parentNode.removeChild(e)
     }), n.forEach(function(e) {
      O(e), I.splice(I.indexOf(e), 1), e.x.forEach(function(r, t) {
       U[e.x[t]][e.y[t]] = i
     ...
     }), bt()), st(i), O(c), c = null, wt(), t.refresh_piece_styling = !0, void V()
    }
    if (y)
     for (var f = c, v = !1, w = c.calc_width / a.jigsaw_required_precision, T = c.calc_height / a.jigsaw_required_precision, E = c.left - u.left, S = c.top - u.top;;) {
      if (E + w < f.puzzle_left_min) break;
      if (E - w > f.puzzle_left_min) break;
      if (S + T < f.puzzle_top_min) break;
      if (S - T > f.puzzle_top_min) break;
      v = !0;
      break
     }
    if (a.playAudio(a.audio_dir + "/global-put down.ogg", {
     ...
     is_transferred_to_different_category: C
    });
    if (st(c), G({
      logical_parent: c,
      canvas: c.canvas
     ...
     var o = c;
     t.piece_sprite_container.addChildAt(o.sprite, 0), c = null;
     var P = o.puzzle_left_min + u.left,
      z = o.puzzle_top_min + u.top;
     bt(), o.placed = !0, TweenMax.to(o, .35, {
      parseTransform: !0,
      ease: Linear.ease,
      left: P,
      top: z,
  ...
  function Dt(r) {
   ...
   for (var E = [], w = [], C = [
     ...
     [2, -2, !1],
     [-2, 2, !1]
    ], d = {}, T = r.x, o = u.composite_image.width - 2 * e.piece_margin / e.piece_logical_scale, m = 0, l = u.composite_image.height - 2 * e.piece_margin / e.piece_logical_scale, g = 0, n = 0; n < T.length; n++) {
    var v = r.x[n],
     y = r.y[n];
    U[v][y] = Mt(r)
   }
   for (var n = 0; n < T.length; n++) {
    ...
    C.forEach(function(t) {
     var i = v + t[0];
     if ("undefined" != typeof U[i]) {
      var n = y + t[1],
       e = U[i][n];
      if ("undefined" != typeof e && e.placed) {
       var r = !1;
       "undefined" == typeof d[e.piece_id] && (r = !0, d[e.piece_id] = t[2], E.push(e)), 1 == t[2] && (1 == r || 0 == d[e.piece_id]) && (d[e.piece_id] = !0, w.push(e), o > e.puzzle_left_min && (o = e.puzzle_left_min), l > e.puzzle_top_min && (l = e.puzzle_top_min), m < e.puzzle_left_min + e.width_float && (m = e.puzzle_left_min + e.width_float), g < e.puzzle_top_min + e.height_float && (g = e.puzzle_top_min + e.height_float))
      }
     }
    })
   }
   var S = pt(E),
    b = K(S, [-Math.floor(o), -Math.floor(l)]),
    i = document.createElement("canvas");
   i.width_float = Math.round(1e3 * (m - o)) / 1e3, i.height_float = Math.round(1e3 * (g - l)) / 1e3, i.width = Math.ceil((i.width_float + 2 * e.piece_margin) / e.piece_logical_scale), i.height = Math.ceil((i.height_float + 2 * e.piece_margin) / e.piece_logical_scale);
   ...
   w.forEach(function(t) {
    s.drawImage(u.base_image, t.puzzle_left_min / f, t.puzzle_top_min / f, t.width * e.piece_logical_scale / f, t.height * e.piece_logical_scale / f, (t.puzzle_left_min - o) / e.piece_logical_scale, (t.puzzle_top_min - l) / e.piece_logical_scale, t.width, t.height)
   }), s.restore(), s.save(), s.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), a.jigsaw_use_3d_effect && p({
    canvas: i,
   ...
   var x = u.composite_image.getContext("2d");
   x.globalCompositeOperation = "source-over", x.drawImage(i, o / e.piece_logical_scale, l / e.piece_logical_scale, i.width, i.height), i.width = 0, i.height = 0;
   ...
   h.texture ? Rt(h) : G({
    ...
    position: 1,
    is_2d: !0
   }), h.sprite.x = u.left - e.piece_margin, h.sprite.y = u.top - e.piece_margin, O(r), r == c && (c = null), wt(), V(), Bt() && lt()
  }

  function ht(i) {
   if (null != c) {
    P(), "undefined" == typeof i && (i = {}), document.body.style.cursor = "";
    var e = c;
    if (i.is_transferred_to_different_category || t.piece_sprite_container.addChild(e.sprite), e.visibility = "visible", a.freestyle_mode && !i.is_transferred_to_different_category) {
     if (e.left = c.left + (c.calc_width - e.calc_width) / 2, e.top = c.top + (c.calc_height - e.calc_height) / 2, e.virtual_left - .25 * c.calc_width < 0) e.virtual_left = .25 * c.calc_width;
     else {
      var r = parseFloat(window.getComputedStyle(d.inner).width);
      e.virtual_left + .25 * c.calc_width > r && (e.virtual_left = r - .25 * c.calc_width)
     }
     if (e.virtual_top - .25 * c.calc_height < 0) e.virtual_top = .25 * c.calc_height;
     else {
      var n = parseFloat(window.getComputedStyle(d.inner).height);
      e.virtual_top + .25 * c.calc_height > n && (e.virtual_top = n - .25 * c.calc_height)
     }
    }
    delete c.border_adjust_count, st(c), G({
     logical_parent: c,
     canvas: c.canvas
    }), c.calc_width = c.width_float * a.jigsaw_piece_scale_to_actual, c.calc_height = c.height_float * a.jigsaw_piece_scale_to_actual, c = null, h.item_under_mouse = null, wt(), V()
   }
  }
  ...
  function Ft(e) {
   ...
   if ("undefined" != typeof e.targetTouches) {
    if (e.touches.length > 1) return void ht();
    e = e.targetTouches[0]
   }
   M.drag_active && M.drag_update(e), null != c && At(c, e)
  }

  function Jt(m) {
   function K(n, s, l, h, p, _, f, g) {
   ...
   for (var c = (m.success || function() {}, m.source_image), T = m.size_x, E = m.size_y, O = m.width, I = m.height, N = m.draw_settings, g = [], X = 100 / T, V = 100 / E, n = 0; T >= n; n++) {
    g[n] = [];
    for (var s = 0; E >= s; s++) {
     var q = 0 == n || n == T ? 0 : .25 * Math.randBMT(),
      Q = 0 == s || s == E ? 0 : .25 * Math.randBMT();
     g[n][s] = [(n + q) * X, (s + Q) * V]
    }
   }
   for (var H = [
    ...
    for (var A = H[i], y = 0; y < A[4]; y++) P.push([A[0], A[1], A[2], A[3]]);
   var w = [];
   for (vh = 0; 2 > vh; vh++) {
    w[vh] = [];
    for (var n = 0; T + vh > n; n++) {
     w[vh][n] = [];
     for (var s = 0; E + (1 - vh) > s; s++) {
      var t = [
       [0, 0],
       [220, 0],
       [60, 80],
      ...
      if ((0 == s || s == E + 1 - vh - 1) && 0 == vh || (0 == n || n == T + vh - 1) && 1 == vh) t = [t[0], t[t.length - 1]];
      else {
       var Y = Math.randInt(0, P.length - 1),
        f = P[Y];
       ...
       if (1 == J) {
        var W = t[1][0];
        t[1][0] = 300 - t[5][0], t[5][0] = 300 - W
       }
       if ("undefined" != typeof f[3]) var tt = f[3] - 5 + 10 * Math.randBMT();
       else if (0 != Math.randInt(0, 4)) var tt = 70 + 20 * Math.randBMT();
       else var tt = 60 + 40 * Math.randBMT();
       t[2][1] = t[3][1] = t[4][1] = tt;
       var Z = Math.randInt(0, 1);
       if (1 == Z)
        for (var i = 1, h = t.length; h - 1 > i; i++) t[i][1] = -t[i][1]
      }
      for (var i = 0, h = t.length; h > i; i++) {
       if (1 == vh) {
        var W = t[i][0];
        t[i][0] = t[i][1], t[i][1] = W
       }
       t[i][0] = t[i][0] / 300 * X + g[n][s][0], t[i][1] = t[i][1] / 300 * V + g[n][s][1]
      }
      var h = t.length;
      t[h - 1] = 0 == vh ? [g[n + 1][s][0], g[n + 1][s][1]] : [g[n][s + 1][0], g[n][s + 1][1]];
      for (var i = 0; h > i; i++) t[i][0] = t[i][0].toFixed(4), t[i][1] = t[i][1].toFixed(4);
      for (var j = new Array(h), i = 0; h > i; i++) j[i] = [t[i][0] / 100 * O, t[i][1] / 100 * I];
      w[vh][n][s] = j
     }
    }
   }
   for (var z = [], F = "", G = 0, n = 0; T > n; n++) {
    z[n] = [];
    for (var s = 0; E > s; s++) {
     for (var x = [], b = [], v = "", S = "", o = {
       x0: O,
       ...
       x1: 0,
       y1: 0
      }, u = (w[0][n][s][0][0], w[0][n][s][0][1], []), d = 0; 4 > d; d++) {
      var R = 0,
       t = w[d % 2 == 0 ? 1 : 0][n + (2 == d ? 1 : 0)][s + (3 == d ? 1 : 0)],
       h = t.length;
      if (2 >= h) var o = {
       ...
       for (var i = 0; 4 > i; i += 3) var _ = K(t[0 + i][0], t[0 + i][1], t[1 + i][0], t[1 + i][1], t[2 + i][0], t[2 + i][1], t[3 + i][0], t[3 + i][1]),
        o = {
         x0: _.x0 < o.x0 ? _.x0 : o.x0,
         y0: _.y0 < o.y0 ? _.y0 : o.y0,
         x1: _.x1 > o.x1 ? _.x1 : o.x1,
         y1: _.y1 > o.y1 ? _.y1 : o.y1
        };
      var k = 0 == d && h > 2 ? " M " : " L ";
      h > 2 && 0 != d && (k = ""), S += k, "" != k && (b.length > 0 && ("M" != v && u.push({
       type: v,
       points: b
      }), b = [], 0 == R && u.length > 0 && (x.push({
       x: n,
       y: s,
       s: x.length,
       p: u
      }), u = []), R += 1), v = k.trim());
      for (var i = d % 3 == 0 ? h - 1 : 0, y = 0; h > y; y++)(0 == d || 2 >= h || 0 != y) && (y % 3 == 1 && h > 2 && ("M" != v && u.push({
       type: v,
       points: b
      }), b = [], 0 == R && u.length > 0 && (x.push({
       x: n,
       ...
       s: x.length,
       p: u
      }), u = []), R += 1, v = "C", S += " C "), S += t[i][0].toFixed(4) + "," + t[i][1].toFixed(4), b.push([parseFloat(t[i][0].toFixed(4)), parseFloat(t[i][1].toFixed(4))]), y != h - 1 && (S += " ")), d % 3 == 0 ? i-- : i++
     }
     u.push({
      type: v,
      points: b
     ...
     var U = r(o),
      ...
      B = Math.round(1e3 * (o.x1 - o.x0)) / 1e3,
      D = Math.round(1e3 * (o.y1 - o.y0)) / 1e3,
      l = xt();
     l.x = [n], l.y = [s], l.piece_id = G, l.width = Math.ceil(B + 2 * e.piece_margin) / e.piece_logical_scale, l.height = Math.ceil(D + 2 * e.piece_margin) / e.piece_logical_scale, l.width_float = B, l.height_float = D, l.puzzle_width = [B], l.puzzle_height = [D], l.puzzle_left_min = U.x0, l.puzzle_top_min = U.y0, l.puzzle_left = [o.x0], l.puzzle_top = [o.y0], l.side_set = [x], l.placed = !1, z[n][s] = l, G += 1
    }
   }
   var C = document.createElement("canvas"),
    M = C.getContext("2d");
   C.width = (O + 2 * e.piece_margin) / e.piece_logical_scale, C.height = (I + 2 * e.piece_margin) / e.piece_logical_scale;
   var L = c.naturalWidth / c.width,
    et = L * c.width <= c.naturalWidth ? L * c.width : c.naturalWidth,
    $ = L * c.height <= c.naturalHeight ? L * c.height : c.naturalHeight;
   M.drawImage(c, 0, 0, et, $, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, c.width / e.piece_logical_scale, c.height / e.piece_logical_scale), M.save(), M.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), a.jigsaw_use_3d_effect && p({
    canvas: C,
  ...
  function Nt(i) {
   function u() {
    for (var i = 0; _ > i; i++) {
     ...
     if (1 == a || !e.placed) {
      var m = !1;
      0 == a && e.sprite && (m = !0, O(e)), e.shape_string = K(e.side_set, [-e.puzzle_left_min, -e.puzzle_top_min]), _t(e, p), G({
       canvas: e.canvas,
       logical_parent: e
      }), 0 == m && t.piece_sprite_container.removeChild(e.sprite), 1 == a && (e.zIndex = l)
     }
     if (l += 1, n += 1, n == o && (n = 0, h += 1), h == c) break
    }
    l != c * o ? (t.refresh_piece_styling = !0, timeout = d.inner.setTimeout(u, 20)) : (dt = void 0, void
     function() {
      for (var n = {}, l = 0; c > l; l++)
       for (var h = 0; o > h; h++) {
        var e = s[l][h];
        0 == a && e.placed || (e.parentNode == t.piece_container || null == e.parentNode) && (n[e.zIndex] = e)
       }
      for (var u = r(t.piece_sprite_container.children), i = 0, d = u.length; d > i; i++) t.piece_sprite_container.removeChild(u[i]);
      for (var i in n) t.piece_sprite_container.addChild(n[i].sprite);
  ...
  function pt(w) {
   ...
   for (var b = [
     ...
     [1, 0],
     [0, 1]
    ], c = [], h = [], i = -1; i < e.tile_x + 2; i++) {
    h[i] = [];
    for (var s = -1; s < e.tile_y + 2; s++) h[i][s] = [0, 0, 0, 0]
   }
   for (var i = -1; i < e.tile_x + 1; i++) {
    c[i] = [];
    for (var s = -1; s < e.tile_y + 1; s++) c[i][s] = void 0
   }
   w.forEach(function(e) {
   ...
   for (var x = [], i = 0; i < e.tile_x; i++)
    for (var s = 0; s < e.tile_y; s++)
     if (c[i][s])
      for (var _ = 0; 4 > _; _++)
       if (!h[i][s][_]) {
        for (var v = [], t = _, g = 0, y = !1, n = i, r = s;;) {
         var l = n + b[t][0],
          o = r + b[t][1];
         if (h[n][r][t] = 1, h[l][o][(t + 2) % 4] = 1, c[l][o]) {
          if (3 == g) break;
          g += 1, t = (t + 3) % 4, n = l, r = o
         } else {
          if (0 == y) {
           ...
           var d = n,
            u = r;
           l > n && (d += 1, 2 == t && (u += 1)), o > r && (u += 1, 1 == t && (d += 1)), n > l && 2 == t && (u += 1), r > o && 1 == t && (d += 1);
           var f = d,
            m = u
          } else {
           var f = n,
            m = r;
           if (l > n && (f += 1, 2 == t && (m += 1)), o > r && (m += 1, 1 == t && (f += 1)), n > l && 2 == t && (m += 1), r > o && 1 == t && (f += 1), d == f && u == m) break
          }
          v.push([n, r, t]), h[n][r][t] = 1, h[l][o][(t + 2) % 4] = 1, t = (t + 1) % 4, g = 0
         }
        }
        v.length > 0 && x.push(v)
       }
  ...
  function xt() {
   ...
   Object.defineProperty(e, "left", {
    ...
    set: function(r) {
     i = r, n = i + s / 2, e != c && (t.refresh_piece_styling = !0, t.refresh_piece_styling = !0)
    }
    ...
    set: function(i) {
     r = i, a = r + o / 2, e != c && (t.refresh_piece_styling = !0, t.refresh_piece_styling = !0)
    }
   });
   var n, a;
   Object.defineProperty(e, "virtual_left", {
    ...
    set: function(r) {
     n = r, i = n - s / 2, e != c && (t.refresh_piece_styling = !0)
    }
    ...
    set: function(i) {
     a = i, r = a - o / 2, e != c && (t.refresh_piece_styling = !0)
    }
   });
   var s, o;
   return Object.defineProperty(e, "calc_width", {
    ...
    set: function(r) {
     s = r, i = n - s / 2, e != c && (t.refresh_piece_styling = !0)
    }
    ...
    set: function(i) {
     o = i, r = a - o / 2, e != c && (t.refresh_piece_styling = !0)
    }
   }), e
  }
  ...
  function Ht(e) {
   ...
   Object.defineProperty(e, "children", {
    ...
    t.parentNode && t.parentNode.removeChild(t), t.parentNode = e, e.children.push(t), P()
   }, e.removeChild = function(t) {
    e.children.splice(e.children.indexOf(t), 1), P()
  ...
  function _t(t, h, r) {
   ...
   var f = K(t.side_set, [-t.puzzle_left_min + a + l, -t.puzzle_top_min + a + l], 1 / s);
   if (t.path = new Path2D(f), h instanceof HTMLImageElement) {
   ...
   n.restore(), m && (n.save(), n.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), p({
    canvas: i,
    stroke_width: z.stroke_width,
    cut_multiplier: z.cut_multiplier,
    ...
    clear_stroke: !c,
    game_instance: e
   }), n.restore()), c && (n.save(), ct(i, d), n.restore())
  }

  function st(t) {
   O(t), t.canvas = document.createElement("canvas"), _t({
    element: t,
    parent: u.base_image,
  ...
  var tt = w.game_data.jigsaw,
   ...
   B = w.player_data,
   rt = w.game_data.entry_list[L],
   Q = w.set_name,
   et = a.game_type,
   y = {},
   z = {},
   e = y.game_instance = {},
   it = tt.difficulty_levels[B.selected_difficulty];
  e.difficulty_level = B.selected_difficulty, e.get_piece_count = function() {
   return e.tile_x * e.tile_y
  }, e.intro_audio_count = 0, !a.is_kiosk && a.use_social_media_buttons && $();
  var mt = ["answer-correct-10865990.ogg", "answer-correct-23303730.ogg", "answer-correct-25513672.ogg", "answer-correct-25513693.ogg", "answer-correct-37240671.ogg", "answer-correct-37240686.ogg", "answer-correct-37241588.ogg", "answer-correct-37241627.ogg"],
   Xt = ["global-pick up.ogg", "global-put down.ogg", "answer-give up.ogg", "fireworks-1.ogg", "fireworks-2.ogg", "fireworks-3.ogg", "fireworks-4.ogg"].concat(mt);
  H({
   parent: a,
   dir: a.audio_dir + "/",
   audio_list: Xt,
   type: "is_sound_effect"
  }), a.ambient_music.last_on_state = a.ambient_music_on, a.ambient_music_on = !1, a.ambient_music.load_ambient_music(w.game_data.ambient_music, w.game_data.ambient_music_start), Yt();
  ...
  if (e.force_screen_refresh = 0, li(), void
   function() {
   ...
   }(), g.style.overflow = "hidden", n(g), y.menu_item_list = [w.menu.generic.about, w.menu.generic.ogle_trophies, {
    text: "Restart",
    ...
    action: function(i, r, e) {
     ...
     e.close(), a.IS_WEBVIEW ? window.history.back() : t.mr_jigtato.history_control.load_page({
      page: "select_jigsaw"
     })
    }
   }, {
    ...
    action: function() {
     nt(h.current_category.piece_container), V(), y.help_menu_obj.close()
    }
   ...
   vt.className = "jt-play-social_sharing_button_container", g.appendChild(vt), E({
    parent: vt,
  ...
  X.className = "jt-play-bottom_bar jt-play-main_image_border_width", n(X), g.appendChild(f), f.hide_title = function(e) {
   var e = e || {};
   "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), a.jigsaw_minimal_ui && (e.duration = 0), h.style.display = "", 0 == e.duration ? (f.inner.style.top = f.hidden_top_value, h.style.top = 0, f.inner.style.display = "none", e.callback()) : (TweenMax.to(h, e.duration / 1e3, {
    parseTransform: !0,
    ease: Linear.ease,
    css: {
     top: 0
   ...
   var e = e || {};
   "undefined" == typeof e.callback && (e.callback = function() {}), "undefined" == typeof e.duration && (e.duration = 500), a.jigsaw_minimal_ui && (e.duration = 0), f.inner.style.display = "", 0 == e.duration ? (h.style.top = f.hidden_top_value, f.inner.style.top = 0, h.style.display = "none", e.callback()) : (TweenMax.to(f.inner, e.duration / 1e3, {
    parseTransform: !0,
    ease: Linear.ease,
    css: {
     top: 0
   ...
   f[a.use_categories ? "hide_title" : "show_title"](e)
  }, f.show_title_animation = function(i) {
   function n() {
    setTimeout(function() {
     g.appendChild(e)
    }, 0);
  ...
  h.className = "jt-jigsaw-category_deck", h.item_under_mouse = null, f.appendChild(h), h.edit_button = document.createElement("img"), h.edit_button.className = "jt-op_button jt-op_button-edit" + (a.is_phone_or_tablet ? " hoverable jt-op_button-edit-colored" : ""), h.edit_button.src = a["/"] + "images/gui/gui-item_edit.png", h.appendChild(h.edit_button), h.add_button = document.createElement("img"), h.add_button.className = "jt-op_button jt-op_button-add" + (a.is_phone_or_tablet ? " hoverable jt-op_button-add-colored" : ""), h.add_button.src = a["/"] + "images/gui/gui-item_expand_or_add.png", h.appendChild(h.add_button), h.basket_button = document.createElement("img"), h.basket_button.className = "jt-op_button jt-op_button-basket" + (a.is_phone_or_tablet ? " hoverable jt-op_button-basket-colored" : ""), h.basket_button.piece_list = [], h.basket_button.is_selected = !1, h.basket_button.src = a["/"] + "images/gui/gui-basket.png", h.appendChild(h.basket_button), h.remove_button = document.createElement("img"), h.remove_button.className = "jt-op_button jt-op_button-remove" + (a.is_phone_or_tablet ? " hoverable jt-op_button-remove-colored" : ""), h.remove_button.src = a["/"] + "images/gui/gui-item_remove.png", h.appendChild(h.remove_button), h.container = document.createElement("div"), h.container.className = "jt-jigsaw-category_deck-container", h.appendChild(h.container), h.add_category = function(s) {
   ...
   i.className = "jt-jigsaw-piece_container", Ht(i);
   ...
   return "undefined" == typeof h.current_category && (h.select_category(t), h.original_category = t), t.addEventListener(a.events.POINT, function(e) {
    h.select_category(e.currentTarget), V()
   }), t.is_category_deck_item = !0, t
  }, h.set_category_name = function(e, t) {
   var i = f.style.display;
   f.style.display = "block", e.inner.innerHTML = t, e.style.padding = 0, e.style.border = "none", k(e.inner, {
    unit_type: "px",
   ...
   t.parentNode && t.parentNode.removeChild(t), h.original_category && (e != h.original_category ? nt(h.original_category.piece_container, i) : delete h.original_category), 1 == h.container.children.length && delete h.current_category, h.container.removeChild(e)
  }, h.select_category = function(i) {
   h.current_category = i, t.piece_container = i.piece_container, P();
   var r = I;
   if ("undefined" != typeof r)
    for (var n = 0, s = r.length; s > n; n++) {
     ...
     if ("undefined" != typeof e && null != e)
      if (a.parentNode != h.current_category.piece_container) {
  ...
  }, h.edit_button.addEventListener(a.events.POINT, function() {
   ...
   R.stop(), smoke.prompt('Please enter a new name for category "' + e.inner.innerHTML + '".', function(t) {
    return "" === t ? void smoke.alert("You can't set a blank name!", function() {
     R.resume()
    }) : (R.resume(), void(t !== !1 && (h.set_category_name(e, t), V())))
   })
  }), h.add_button.addEventListener(a.events.POINT, It);
  var W = h.basket_button;
  W.addEventListener(a.events.POINT, function(i) {
   var e = i.currentTarget,
    r = 0 == e.piece_list.length;
   e.classList[e.is_selected ? "remove" : "add"]("jt-op_button-basket" + (a.is_phone_or_tablet ? "-colored" : "") + "-selected"), e.is_selected && !r && It({
    error: function() {
     e.piece_list = []
    },
    complete: function() {
    ...
    success: function(i) {
     ...
     }), nt(i.piece_container), e.piece_list = [], V()
    }
   ...
   O(e), e.canvas = document.createElement("canvas"), _t({
    element: e,
    parent: u.base_image,
    use_3d_effect: a.jigsaw_use_3d_effect,
    render_stroke: !0,
    ...
    canvas: e.canvas,
    invalidate: !0
   }), i && W.piece_list.push(e)
  }, h.remove_button.addEventListener(a.events.POINT, function() {
   function t(t) {
    R.resume(), 0 != t && (h.remove_category(e), h.select_category(h.original_category), V())
   }
   R.stop();
   var e = h.current_category;
  ...
  rt.use_image_title ? S({
   image_src: a.get_set_directory(Q) + "/puzzle/" + L + "-title.png",
   fix_ie_bug: !0,
   color: "#edd9a7",
   callback: function(e) {
  ...
  }) : (f.inner = document.createElement("div"), f.inner.className = "jt-play-title-inner", f.appendChild(f.inner), f.inner.text = document.createElement("p"), f.inner.text.innerHTML = rt.name, f.inner.appendChild(f.inner.text), k(f.inner.text, {
   unit_type: "px",
   transform_scale: g.content_scale
  }));
  var d = document.createElement("div");
  ...
  var Kt = new PIXI[1 == a.is_webgl ? "WebGLRenderer" : "CanvasRenderer"](1, 1, {
   transparent: !0,
   clearBeforeRender: !1,
   view: t
  });
  t.renderer = Kt, t.stage = St, t.piece_sprite_container = Ut, t.real_stage = ot, ot.addChild(St), St.addChild(Ut), t.load_opacity_transition = .5, t.style.pointerEvents = "none", t.bg = document.createElement("canvas"), t.bg.image = new Image, t.bg.image.src = w.background_image_url, t.reposition_and_resize = function() {
   var i = A(g),
    r = s(g),
    e = g.content_scale,
    n = parseFloat(getComputedStyle(d).top),
    l = a.jigsaw_minimal_ui ? 0 : s(X);
   ...
   t.cached_width = Math.round(parseFloat(o.width)), t.cached_height = Math.round(parseFloat(o.height))
  ...
  function() {
   switch (e.jigsaw_scale_low_power_sizer = e.difficulty_level >= a.jigsaw_reduce_texture_size ? 2 : 1, e.difficulty_level) {
    case 0:
     z.cut_multiplier = 1, e.piece_logical_scale = 1 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 2;
     break;
    case 1:
     z.cut_multiplier = 1, e.piece_logical_scale = .75 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 2.666;
     break;
    case 2:
     z.cut_multiplier = 1, e.piece_logical_scale = .5 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 4;
     break;
    case 3:
     z.cut_multiplier = 1, e.piece_logical_scale = .5 * e.jigsaw_scale_low_power_sizer, e.zoom.scalemax = 6
   }
   z.stroke_width = e.piece_logical_scale / e.jigsaw_scale_low_power_sizer
  }();
  var u = y.main_image = document.createElement("div");
  u.className = "jt-play-main_image jt-jigsaw-main_image", n(u), Ht(u), u.classList.add("jt-jigsaw-main_image-active");
  var x = u.base_image = document.createElement("img"),
   M = document.createElement("div");
  M.className = "jt-jigsaw-piece_deck";
  var U, I, c = null;
  x.crossOrigin = "Anonymous", a.get_image(x, Q, L, "default"), x.addEventListener("load", function() {
   null != d && d.inner.setTimeout(Gt, 30)
  });
  var m = new Image;
  m.src = a.get_set_directory(w.set_name) + "/gui/gui-loading.png", m.logical_parent = t, t.loading_animation = m, m.defer_start = function(e) {
   d.inner.setTimeout(function() {
    m && !m.game_initialized && (m.start(), at(void 0, !0))
   }, e)
  }, m.start = function() {
   1 != !!m.game_initialized && (m.stage.alpha = 1, m.display = !0, ot.addChild(m.stage), P())
  }, m.stop = function() {
   m.stage && (m.stage.alpha = 1), m.game_initialized = !0, m.display && (m.display = !1, ot.removeChild(m.stage)), P()
   ...
   if (null != d && d.isAttached()) {
    ...
    o.drawImage(m, e, 0, e, i, 0, 0, e, i), m.outer = {}, G({
     logical_parent: m.outer,
     parent: m.stage,
     canvas: r
    }), m.outer.sprite.x = a + e / 2, m.outer.sprite.y = s + i / 2, m.outer.sprite.width = e, m.outer.sprite.height = i, m.outer.sprite.pivot.x = e / 2, m.outer.sprite.pivot.y = i / 2;
    var n = document.createElement("canvas");
    n.width = e, n.height = i;
    var o = n.getContext("2d");
    o.drawImage(m, 0, 0), m.inner = {}, G({
     logical_parent: m.inner,
     parent: m.stage,
     canvas: n
    }), m.inner.sprite.x = a, m.inner.sprite.y = s, m.inner.sprite.width = e, m.inner.sprite.height = i, m.start(), at(void 0, !0)
   }
  }), y.refresh_gui_display(), at(void 0, !0);
  var ft = y.set_base_image_size = function() {
    var t = ai();
    ...
    }(), jt(), u.left = (parseFloat(window.getComputedStyle(g).width) - x.width) / 2, u.width = x.width, u.height = x.height;
  ...
  g.cleanup = function() {
   if (a.IS_CORDOVA && a.audio_container[w.last_intro_audio] && (a.audio_container[w.last_intro_audio].src = "", delete a.audio_container[w.last_intro_audio], w.last_intro_audio = ""), t.fireworks && t.fireworks.destroy(), oi(), null != t.parentNode && document.body.removeChild(t), R.destroy(), document.removeEventListener(a.events.POINT_MOVE, Ft), a.is_phone_or_tablet ? g.removeEventListener("touchend", q) : (document.removeEventListener("mouseup", q), window.addEventListener("blur", ht), window.removeEventListener("mouseout", Ot)), g.innerHTML = "", "undefined" != typeof a.ambient_music.last_on_state && (1 == a.ambient_music.last_on_state && (a.ambient_music_on = !0), delete a.ambient_music.last_on_state), "undefined" != typeof U)
    for (var i = 0; i < e.tile_x + 1; i++) {
     U[i] = [];
     for (var r = 0; r < e.tile_y + 1; r++) U[i][r] = void 0
    }
   ...
   w = null, a = null, L = null, tt = null, ei = null, B = null, rt = null, Q = null, et = null, y = null, z = null, e = null, it = null, P = null, yt = null, f = null, h = null, W = null, R = null, Vt = null, zt = null, d = null, t = null, u = null, x = null, M = null, c = null, U = null, I = null, m = null, ft = null, gt = null, V = null, Wt = null, delete g.cleanup
  }, M.drag_active = !1, M.drag_start = function(e) {
   M.drag_active = !0, M.drag_update(e, !0)
  }, M.drag_update = function(s, l) {
   if (0 != M.drag_active) {
    var t = o(s, d),
     ...
     n = e.zoom.offset_x,
     a = e.zoom.offset_y;
    l || (n += i - M.drag_initial_x, a += r - M.drag_initial_y), e.zoom.offset_x = n, e.zoom.offset_y = a, M.drag_initial_x = i, M.drag_initial_y = r, M.drag_initial_scale = h
   }
  }, M.drag_end = function() {
   M.drag_active = !1
  };
  var dt = void 0,
   V = y.save_puzzle_state = function() {
    ...
    i[et + "." + L + "." + B.selected_difficulty] = !0, localStorage["puzzle_states.$keys"] = JSON.stringify(i), localStorage["puzzle_states." + et + "." + L + "." + B.selected_difficulty] = JSON.stringify(t)
   },
   Wt = y.load_puzzle_state = function(s) {
    function o() {
     var e = {};
     ...
     r.forEach(function(t) {
      ...
      n.forEach(function(t) {
       var i = e[t.piece_id];
       a.appendChild(i)
      }), t.innerHTML == i && h.select_category(r), gt(r.piece_container.children)
     }), Bt() && lt(), s.callback()
    }
    var t = JSON.parse(localStorage["puzzle_states." + et + "." + L + "." + B.selected_difficulty]);
    ...
    y.timer_obj.counter = t.counter, ft();
    var c = x.width / x.naturalWidth / i;
    e.zoom = t.zoom, U = [];
    for (var r = 0; r < e.tile_x; r++) U[r] = [];
  ...
  y.redraw_main_image_and_pieces = function(f) {
   function S() {
    ...
    i.save(), _({
     ...
     lineWidth: 0,
     canvas: o
    }), i.clip(), i.drawImage(c, -e.piece_margin / e.piece_logical_scale, -e.piece_margin / e.piece_logical_scale), i.restore(), i.save(), i.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), ct(o), i.restore(), G({
     parent: t.stage,
     canvas: o,
     position: 1,
     is_2d: !0
    }), o.sprite.x = u.left - e.piece_margin, o.sprite.y = u.top - e.piece_margin, "undefined" != typeof T && T()
   }
   ...
   for (var w = [], g = [], d = 0; d < I.length; d++) {
    var i = I[d];
    if ("undefined" != typeof s && (i.width_float = Math.round(i.width_float * s * 1e3 / 1e3), i.height_float = Math.round(i.height_float * s * 1e3 / 1e3), i.puzzle_left_min = Math.round(i.puzzle_left_min * s * 1e3 / 1e3), i.puzzle_top_min = Math.round(i.puzzle_top_min * s * 1e3 / 1e3), i.width = Math.ceil(i.width_float / e.piece_logical_scale), i.height = Math.ceil(i.height_float / e.piece_logical_scale), i.puzzle_width.forEach(function(t, e) {
      i.puzzle_width[e] = Math.round(i.puzzle_width[e] * s * 1e3 / 1e3), i.puzzle_height[e] = Math.round(i.puzzle_height[e] * s * 1e3 / 1e3), i.puzzle_left[e] = Math.round(i.puzzle_left[e] * s * 1e3 / 1e3), i.puzzle_top[e] = Math.round(i.puzzle_top[e] * s * 1e3 / 1e3)
     }), i.side_set = qt(i.side_set, s)), i.width = Math.ceil((i.width_float + 2 * e.piece_margin) / e.piece_logical_scale), i.height = Math.ceil((i.height_float + 2 * e.piece_margin) / e.piece_logical_scale), i.placed) {
     e.pieces_in_position_count += i.x.length, i.shape_string = K(i.side_set, [-i.puzzle_left_min, -i.puzzle_top_min]), w.push(i);
     for (var l = 0, b = i.x.length; b > l; l++) U[i.x[l]][i.y[l]] = i
    } else {
     if (g.push(i), I[d].canvas) var n = I[d];
     else var n = xt();
     n.x = r(i.x), n.y = r(i.y), n.zIndex = r(i.zIndex), n.piece_id = i.piece_id, n.width_float = i.width_float, n.height_float = i.height_float, n.width = i.width, n.height = i.height, n.virtual_left = i.virtual_left, n.virtual_top = i.virtual_top * C, n.puzzle_width = r(i.puzzle_width), n.puzzle_height = r(i.puzzle_height), n.puzzle_left_min = i.puzzle_left_min, n.puzzle_top_min = i.puzzle_top_min, n.puzzle_left = r(i.puzzle_left), n.puzzle_top = r(i.puzzle_top), n.side_set = r(i.side_set), n.placed = !1, I[d] = n;
     for (var l = 0, b = n.x.length; b > l; l++) U[n.x[l]][n.y[l]] = n
    }
   }
   P();
   var A = pt(w),
   ...
   var m = c.getContext("2d"),
    M = h.naturalWidth,
    E = h.naturalHeight;
   m.drawImage(h, 0, 0, M, E, e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale, h.width / e.piece_logical_scale, h.height / e.piece_logical_scale), m.save(), m.translate(e.piece_margin / e.piece_logical_scale, e.piece_margin / e.piece_logical_scale), a.jigsaw_use_3d_effect && p({
    canvas: c,
    stroke_width: z.stroke_width,
    cut_multiplier: z.cut_multiplier,
    shape_string: k,
 ...
 function p(e) {
  function t(t) {
   {
    var n = t.game_instance,
     i = t.canvas,
     a = t.stroke_width / n.jigsaw_scale_low_power_sizer,
     p = t.cut_multiplier,
     d = t.shape_string,
     u = t.scale,
   ...
   if (t.outline_width) var c = t.outline_width;
   else if (n.piece_margin_style && 0 != n.piece_margin) var c = n.piece_margin >= 5 ? 10 : 6;
   else var c = 10;
   var c = 8;
   c /= n.jigsaw_scale_low_power_sizer;
   ...
   _({
    ...
    lineJoin: "round",
    lineCap: "round",
    lineWidth: 2 / n.jigsaw_scale_low_power_sizer,
    canvas: s
   }), e.shadowBlur = 16 * a, e.shadowColor = "rgba(0,0,0,.8)", e.shadowOffsetX = 3 * -a, e.shadowOffsetY = 3 * -a, e.stroke(), e.shadowColor = "rgba(255,255,255,.5)", e.shadowOffsetX = 3 * a, e.shadowOffsetY = 3 * a, e.stroke();
   var r = document.createElement("canvas");
   r.width = i.width, r.height = i.height;
   var l = r.getContext("2d");
   l.drawImage(s, 0, 0), l.drawImage(r, 0, 0), l.drawImage(r, 0, 0), l.drawImage(r, 0, 0), o.globalCompositeOperation = "source-atop", o.drawImage(r, 0, 0), e.clearRect(0, 0, i.width, i.height), e.lineWidth = c * a * p * n.jigsaw_scale_low_power_sizer / 2, e.shadowBlur = 0, "transparent" != h && (e.strokeStyle = h), e.shadowColor = "rgba(0,0,0,0)", e.shadowOffsetX = 0, e.shadowOffsetY = 0, e.stroke(), t.clear_stroke && (o.globalCompositeOperation = "transparent" == h ? "destination-out" : "source-atop", o.drawImage(s, 0, 0)), o.globalCompositeOperation = "source-over"
  }
  t(e)
 }
  ...
  return e.className = "jt-select_screen-header-show_hint_image jt-select_screen-header-size-2 jt-button hoverable", e.title_list = ["Challenge a friend!", "Earn extra puzzle packs!", "Get 9 gems per friend!"], e.title_index = e.title_list.length - 1, a(), e.addEventListener(t.events.POINT, function() {
   ...
   function f() {
    var n = smoke.prompt("Type in your frenemy's email(s) to send them your challenge!", function(n) {
     return n === !1 ? void e.deactivate() : void h({
      gs: t,
      error: function() {
   ...
   var r = g.level_id,
    c = s.player_data,
    a = c.selected_difficulty,
    d = s.game_data.jigsaw.difficulty_levels[a].name.capitalize(),
    n = t.jigsaw_show_hint_image,
    o = c.jigsaw.best_times[+n];
   if ("undefined" == typeof o[r] || "undefined" == typeof o[r][a]) {
    n = !n;
    var o = c.jigsaw.best_times[+n]
   }
   if ("undefined" == typeof o[r]) return void smoke.alert("You didn't finish this puzzle!");
   if ("undefined" == typeof o[r][a]) return void smoke.alert("You didn't finish the \"" + d + '" level for this puzzle! Select a different difficulty level.');
   var l = o[r][a],
    p = (l - l % 60) / 60,
    _ = l % 60,
    m = (p > 0 ? p + " minutes, " : "") + _ + " seconds",
    u = smoke.alert('Your best time on "' + r.capitalize().replace(/_/g, " ") + '" in ' + d + " mode is " + m + ", with the hint image " + (1 == n ? "ON" : "OFF") + ".", f);
 ...
 var L = "safari",
  M = "com.flyingsoft.safari.jigsaw",
  a = !0,
  f = !0,
  e = {
 ...
 "undefined" != typeof module && null != module && (module.exports = e), window.addEventListener("load", function() {
  ...
  e.WEBGL_RENDERER = 0, e.CANVAS_RENDERER = 1, e.VERSION = "v1.6.1", e.blendModes = {
   ...
   var E = this.texture.frame.width,
    ...
    t = 1 / 0,
    e = 1 / 0;
   t = t > f ? f : t, t = t > m ? m : t, t = t > v ? v : t, t = t > x ? x : t, e = e > _ ? _ : e, e = e > g ? g : e, e = e > y ? y : e, e = e > b ? b : e, i = f > i ? f : i, i = m > i ? m : i, i = v > i ? v : i, i = x > i ? x : i, r = _ > r ? _ : r, r = g > r ? g : r, r = y > r ? y : r, r = b > r ? b : r;
   var n = this._bounds;
   ...
   for (t = 0; f > t; t++) {
    ...
    r ? r.setTexture(n[t].texture) : r = new e.Sprite(n[t].texture), r.position.x = (n[t].position.x + _[n[t].line]) * l, r.position.y = n[t].position.y * l, r.scale.x = r.scale.y = l, r.tint = v, r.parent || this.addChild(r)
   }
   ...
   if (x) {
    var o, m = t.texture.frame.width,
     ...
     v = -m * t.anchor.x;
    if (s > v && v + m > s && (o = -g * t.anchor.y, u > o && o + g > u)) return r.target = t, !0
   }
   ...
   for (var n = a; n > 3;) {
    var c = i[(t + 0) % n],
     ...
     v = r[2 * l + 1],
     d = !1;
    if (e.PolyK._convex(f, _, y, m, g, v, u)) {
     d = !0;
     for (var p = 0; n > p; p++) {
      var s = i[p];
      if (s !== c && s !== h && s !== l && e.PolyK._PointInTriangle(r[2 * s], r[2 * s + 1], f, _, y, m, g, v)) {
       d = !1;
       break
      }
     }
  ...
  }, e.PolyK._PointInTriangle = function(b, m, a, s, x, y, v, g) {
   var t = v - a,
    i = g - s,
    r = x - a,
    e = y - s,
   ...
   if (i.fill) {
    var d = e.hex2rgb(i.fillColor),
     ...
     o = c.indices,
     a = p.length / 6;
    for (o.push(a), t = 0; l + 1 > t; t++) p.push(u, h, m, f, _, r), p.push(u + Math.sin(s * t) * v, h + Math.cos(s * t) * g, m, f, _, r), o.push(a++, a++);
    o.push(a - 1)
   }
   if (i.lineWidth) {
    var y = i.points;
    for (i.points = [], t = 0; l + 1 > t; t++) i.points.push(u + Math.sin(s * t) * v, h + Math.cos(s * t) * g);
    e.WebGLGraphics.buildLine(i, c), i.points = y
   }
   ...
   if (0 !== t.length) {
    ...
    var E, b, _, p, a, n, M, C, r, i, g, f, y, v, D, P, k, L, O, R, S, G, l, s = N.points,
     I = N.indices,
     T = t.length / 2,
     F = t.length,
     B = s.length / 6,
   ...
   if (r) {
    ...
    var t = 4 * this.currentBatchSize * this.vertSize,
     ...
     c = h.tx,
     _ = h.ty;
    e[t++] = m * a + v * s + c, e[t++] = y * s + g * a + _, e[t++] = r.x0, e[t++] = r.y0, e[t++] = u, e[t++] = p, e[t++] = m * o + v * s + c, e[t++] = y * s + g * o + _, e[t++] = r.x1, e[t++] = r.y1, e[t++] = u, e[t++] = p, e[t++] = m * o + v * l + c, e[t++] = y * l + g * o + _, e[t++] = r.x2, e[t++] = r.y2, e[t++] = u, e[t++] = p, e[t++] = m * a + v * l + c, e[t++] = y * l + g * a + _, e[t++] = r.x3, e[t++] = r.y3, e[t++] = u, e[t++] = p, this.textures[this.currentBatchSize] = n.texture.baseTexture, this.blendModes[this.currentBatchSize] = n.blendMode, this.currentBatchSize++
   }
   ...
   n.x0 = 0 - f, n.y0 = 0 - y, n.x1 = 1 * C - f, n.y1 = 0 - y, n.x2 = 1 * C - f, n.y2 = 1 * S - y, n.x3 = 0 - f, n.y3 = 1 * S - y;
   var l = t.worldAlpha,
    h = t.tint,
    i = this.vertices,
    E = t.width,
    ...
    b = s.tx,
    c = s.ty;
   i[r++] = p * m + u * v + b, i[r++] = o * v + d * m + c, i[r++] = n.x0, i[r++] = n.y0, i[r++] = l, i[r++] = h, i[r++] = p * _ + u * v + b, i[r++] = o * v + d * _ + c, i[r++] = n.x1, i[r++] = n.y1, i[r++] = l, i[r++] = h, i[r++] = p * _ + u * g + b, i[r++] = o * g + d * _ + c, i[r++] = n.x2, i[r++] = n.y2, i[r++] = l, i[r++] = h, i[r++] = p * m + u * g + b, i[r++] = o * g + d * m + c, i[r++] = n.x3, i[r++] = n.y3, i[r++] = l, i[r++] = h, this.textures[this.currentBatchSize] = a.baseTexture, this.blendModes[this.currentBatchSize] = t.blendMode, this.currentBatchSize++
   ...
   if (r.filterPasses.length > 1) {
    ...
    for (var p = 0; p < r.filterPasses.length - 1; p++) {
     ...
     t.bindFramebuffer(t.FRAMEBUFFER, n.frameBuffer), t.activeTexture(t.TEXTURE0), t.bindTexture(t.TEXTURE_2D, o.texture), this.applyFilterPass(y, i, i.width, i.height);
     var x = o;
     o = n, n = x
    }
   ...
   var u = i.x - h,
    l = i.y - d;
   t.bindBuffer(t.ARRAY_BUFFER, this.vertexBuffer), this.vertexArray[0] = u, this.vertexArray[1] = l + i.height, this.vertexArray[2] = u + i.width, this.vertexArray[3] = l + i.height, this.vertexArray[4] = u, this.vertexArray[5] = l, this.vertexArray[6] = u + i.width, this.vertexArray[7] = l, t.bufferSubData(t.ARRAY_BUFFER, 0, this.vertexArray), t.bindBuffer(t.ARRAY_BUFFER, this.uvBuffer), this.uvArray[2] = i.width / this.width, this.uvArray[5] = i.height / this.height, this.uvArray[6] = i.width / this.width, this.uvArray[7] = i.height / this.height, t.bufferSubData(t.ARRAY_BUFFER, 0, this.uvArray), t.viewport(0, 0, s, a), t.bindFramebuffer(t.FRAMEBUFFER, _), t.activeTexture(t.TEXTURE0), t.bindTexture(t.TEXTURE_2D, c.texture), this.applyFilterPass(v, i, s, a), this.renderSession.shaderManager.setShader(this.defaultShader), t.uniform2f(this.defaultShader.projectionVector, s / 2, -a / 2), t.uniform2f(this.defaultShader.offsetVector, -h, -d), this.texturePool.push(c), r._glFilterTexture = null
   ...
   for (var v = 1; y - 2 > v; v++) {
    ...
    var g = t * r + n * a + s * i - r * a - n * s - t * i,
     ...
     S = t * r * u + n * c * a + _ * s * i - _ * r * a - n * s * u - t * c * i;
   ...
   for (var o = b.worldAlpha, p = "", T = 0; T < b.graphicsData.length; T++) {
    ...
    if (t.strokeStyle = p = "#" + ("00000" + (0 | i.lineColor).toString(16)).substr(-6), t.lineWidth = i.lineWidth, i.type === e.Graphics.POLY) {
     ...
     var C = .5522848,
      ...
      d = u + y / 2,
      h = f + m / 2;
     t.moveTo(u, h), t.bezierCurveTo(u, h - x, d - v, f, d, f), t.bezierCurveTo(d + v, f, E, h - x, E, h), t.bezierCurveTo(E, h + x, d + v, w, d, w), t.bezierCurveTo(d - v, w, u, h + x, u, h), t.closePath(), i.fill && (t.globalAlpha = i.fillAlpha * o, t.fillStyle = p = "#" + ("00000" + (0 | i.fillColor).toString(16)).substr(-6), t.fill()), i.lineWidth && (t.globalAlpha = i.lineAlpha * o, t.stroke())
    ...
    for (var x = 0; 1 > x; x++) {
     ...
     if (l.type === e.Graphics.POLY) {
      ...
      var T = .5522848,
       ...
       u = c + g / 2,
       o = d + _ / 2;
      t.moveTo(c, o), t.bezierCurveTo(c, o - v, u - m, d, u, d), t.bezierCurveTo(u + m, d, w, o - v, w, o), t.bezierCurveTo(w, o + v, u + m, y, u, y), t.bezierCurveTo(u - m, y, c, o + v, c, o), t.closePath()
      ...
      var n = i[0],
       ...
       a = i[4],
       S = Math.min(h, s) / 2 | 0;
      a = a > S ? S : a, t.beginPath(), t.moveTo(n, r + a), t.lineTo(n, r + s - a), t.quadraticCurveTo(n, r + s, n + a, r + s), t.lineTo(n + h - a, r + s), t.quadraticCurveTo(n + h, r + s, n + h, r + s - a), t.lineTo(n + h, r + a), t.quadraticCurveTo(n + h, r, n + h - a, r), t.lineTo(n + a, r), t.quadraticCurveTo(n, r, n, r + a), t.closePath()
     }
    }
   }
  }, e.Graphics = function() {
   ...
   if (1e-8 > u || 0 === h) n.push(a, o);
    ...
    var p = t * t + e * e,
     ...
     E = i * (s + g),
     S = r * (s + g),
     C = Math.atan2(T - c, w - d),
     A = Math.atan2(S - c, E - d);
    this.arc(d + a, c + o, h, C, A, e * r > i * t)
   }
   return this.dirty = !0, this
   ...
   for (var r = o / (2 * c), b = 2 * r, p = Math.cos(r), f = Math.sin(r), l = c - 1, x = l % 1 / l, a = 0; l >= a; a++) {
    var y = a + x * a,
     ...
     d = Math.cos(m),
     v = -Math.sin(m);
    t.push((p * d + f * v) * n + g, (p * -v + f * d) * n + u)
   }
   return this.dirty = !0, this
   ...
   for (var E = 0; C - 2 > E; E++) {
    ...
    var g = w[t] * v.texture.width,
     ...
     _ = w[t + 4] * v.texture.width,
     f = w[t + 1] * v.texture.height,
     d = w[t + 3] * v.texture.height,
     o = w[t + 5] * v.texture.height;
    ...
    r.transform(A / b, L / b, M / b, R / b, k / b, P / b), r.drawImage(v.texture.baseTexture.source, 0, 0), r.restore()
   }
   ...
   var S = this._width,
    ...
    t = 1 / 0,
    e = 1 / 0;
   t = t > s ? s : t, t = t > _ ? _ : t, t = t > g ? g : t, t = t > y ? y : t, e = e > f ? f : e, e = e > m ? m : e, e = e > v ? v : e, e = e > x ? x : e, i = s > i ? s : i, i = _ > i ? _ : i, i = g > i ? g : i, i = y > i ? y : i, r = f > r ? f : r, r = m > r ? m : r, r = v > r ? v : r, r = x > r ? x : r;
   var n = this._bounds;
   return n.x = t, n.width = i - t, n.y = e, n.height = r - e, this._currentBounds = n, n
       ...
       if (_.hasOwnProperty(u)) {
        ...
        for (var c in y)
         if (y.hasOwnProperty(c)) {
          var b = this.readAttachment(o, c, y[c]);
   ...
   readAnimation: function(T, x, g) {
    ...
    for (var c in p)
     if (p.hasOwnProperty(c)) {
      var y = g.findBoneIndex(c);
      if (-1 == y) throw "Bone not found: " + c;
      var f = p[c];
      for (s in f)
       if (f.hasOwnProperty(s))
        if (n = f[s], "rotate" == s) {
         ...
         var _ = 1;
         for ("scale" == s ? e = new t.ScaleTimeline(n.length) : (e = new t.TranslateTimeline(n.length), _ = this.scale), e.boneIndex = y, a = 0, r = 0, l = n.length; l > r; r++) {
          i = n[r];
          var E = (i.x || 0) * _,
           w = (i.y || 0) * _;
       ...
       if (v.hasOwnProperty(s))
        if (n = v[s], "color" == s) {
         for (e = new t.ColorTimeline(n.length), e.slotIndex = b, a = 0, r = 0, l = n.length; l > r; r++) {
          ...
          e.setFrame(a, i.time, S, C, A, M), t.SkeletonJson.readCurve(e, a, i), a++
         }
  ...
  function v(e, t, i, r, n) {
   v._super_.call(this, r, n), this.reset(e, t, i), this.time = 0, this.name = "RandomDrift"
  }
  ...
  function y(e, t, i, r) {
   y._super_.call(this, i, r), this.reset(e, t), this.name = "CrossZone"
  }
  ...
  var G = G || {
   ...
   matrixMultiply: function(e, t) {
    var i = e[0],
     ...
     v = t[7],
     c = t[8];
    return [i * u + r * f + n * g, i * d + r * _ + n * v, i * p + r * m + n * c, a * u + s * f + o * g, a * d + s * _ + o * v, a * p + s * m + o * c, l * u + h * f + y * g, l * d + h * _ + y * v, l * p + h * m + y * c]
   }
  };
  e.WebGLUtil = G;
  var K = K || {
  ...
  }, e.Attraction = g, e.Util.inherits(v, e.Behavior), v.prototype.reset = function(i, r, n, t, a) {
   this.panFoce = new e.Vector2D(i, r), this.panFoce = this.normalizeForce(this.panFoce), this.delay = n, t && v._super_.prototype.reset.call(this, t, a)
  }, v.prototype.applyBehavior = function(t, i, r) {
   v._super_.prototype.applyBehavior.call(this, t, i, r), this.time += i, this.time >= this.delay && (t.a.addXY(e.MathUtils.randomAToB(-this.panFoce.x, this.panFoce.x), e.MathUtils.randomAToB(-this.panFoce.y, this.panFoce.y)), this.time = 0)
  }, e.RandomDrift = v, e.Util.inherits(P, e.Attraction), P.prototype.reset = function(e, t, i, r, n) {
  ...
  }, e.Collision = T, e.Util.inherits(y, e.Behavior), y.prototype.reset = function(i, r, t, n) {
   this.zone = i, this.zone.crossType = e.Util.initValue(r, "dead"), t && y._super_.prototype.reset.call(this, t, n)
  }, y.prototype.applyBehavior = function(e, t, i) {
   y._super_.prototype.applyBehavior.call(this, e, t, i), this.zone.crossing(e)
  }, e.CrossZone = y, e.Util.inherits(_, e.Behavior), _.prototype.reset = function(r, t, i, n) {
  ...
  }, e.PointZone = k, e.Util.inherits(L, e.Zone), L.prototype.getPosition = function() {
  ...
  }, e.RectZone = L, e.Util.inherits(c, e.Zone), c.prototype.reset = function(t, i, r, n) {
 ...
 if ((t._gsQueue || (t._gsQueue = [])).push(function() {
   ...
   t._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(n, u, t) {
     ...
     e.version = "1.13.1", i.constructor = e, i.kill()._gc = !1, e.killTweensOf = e.killDelayedCallsTo = t.killTweensOf, e.getTweensOf = t.getTweensOf, e.lagSmoothing = t.lagSmoothing, e.ticker = t.ticker, e.render = t.render, i.invalidate = function() {
      ...
      var u, c, n, _, e, d, p, m, y = this._dirty ? this.totalDuration() : this._totalDuration,
       g = this._time,
       f = this._totalTime,
       v = this._cycle,
       i = this._duration,
       l = this._rawPrevTime;
      if (t >= y ? (this._totalTime = y, this._cycle = this._repeat, this._yoyo && 0 !== (1 & this._cycle) ? (this._time = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0) : (this._time = i, this.ratio = this._ease._calcEnd ? this._ease.getRatio(1) : 1), this._reversed || (u = !0, c = "onComplete"), 0 === i && (this._initted || !this.vars.lazy || o) && (this._startTime === this._timeline._duration && (t = 0), (0 === t || 0 > l || l === r) && l !== t && (o = !0, l > r && (c = "onReverseComplete")), this._rawPrevTime = m = !h || t || l === t ? t : r)) : 1e-7 > t ? (this._totalTime = this._time = this._cycle = 0, this.ratio = this._ease._calcEnd ? this._ease.getRatio(0) : 0, (0 !== f || 0 === i && l > 0 && l !== r) && (c = "onReverseComplete", u = this._reversed), 0 > t ? (this._active = !1, 0 === i && (this._initted || !this.vars.lazy || o) && (l >= 0 && (o = !0), this._rawPrevTime = m = !h || t || l === t ? t : r)) : this._initted || (o = !0)) : (this._totalTime = this._time = t, 0 !== this._repeat && (_ = i + this._repeatDelay, this._cycle = this._totalTime / _ >> 0, 0 !== this._cycle && this._cycle === this._totalTime / _ && this._cycle--, this._time = this._totalTime - this._cycle * _, this._yoyo && 0 !== (1 & this._cycle) && (this._time = i - this._time), this._time > i ? this._time = i : 0 > this._time && (this._time = 0)), this._easeType ? (e = this._time / i, d = this._easeType, p = this._easePower, (1 === d || 3 === d && e >= .5) && (e = 1 - e), 3 === d && (e *= 2), 1 === p ? e *= e : 2 === p ? e *= e * e : 3 === p ? e *= e * e * e : 4 === p && (e *= e * e * e * e), this.ratio = 1 === d ? 1 - e : 2 === d ? e : .5 > this._time / i ? e / 2 : 1 - e / 2) : this.ratio = this._ease.getRatio(this._time / i)), g === this._time && !o && v === this._cycle) return void(f !== this._totalTime && this._onUpdate && (h || this._onUpdate.apply(this.vars.onUpdateScope || this, this.vars.onUpdateParams || a)));
      if (!this._initted) {
       if (this._init(), !this._initted || this._gc) return;
       if (!o && this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration)) return this._time = g, this._totalTime = f, this._rawPrevTime = l, this._cycle = v, s.lazyTweens.push(this), void(this._lazy = t);
      ...
      for (l(i) || ("string" == typeof i && (i = t.selector(i) || i), p(i) && (i = h(i))), c = i.length, n = 0; c > n; n++) {
       s = {};
       for (o in r) s[o] = r[o];
       s.delay = f, n === c - 1 && d && (s.onComplete = y), _[n] = new e(i[n], m, s), f += u
      }
      return _
     ...
     return e.constructor = r, e.kill()._gc = !1, r.version = "1.13.1", e.invalidate = function() {
      ...
      this._gc && this._enabled(!0, !1);
      var e, v, _, c, u, m, y = this._dirty ? this.totalDuration() : this._totalDuration,
       n = this._duration,
       h = this._time,
       g = this._totalTime,
       w = this._startTime,
       ...
       x = this._paused,
       f = this._cycle;
      if (r >= y ? (this._locked || (this._totalTime = y, this._cycle = this._repeat), this._reversed || this._hasPausedChild() || (v = !0, c = "onComplete", 0 === this._duration && (0 === r || 0 > s || s === i) && s !== r && this._first && (u = !0, s > i && (c = "onReverseComplete"))), this._rawPrevTime = this._duration || !a || r || this._rawPrevTime === r ? r : i, this._yoyo && 0 !== (1 & this._cycle) ? this._time = r = 0 : (this._time = n, r = n + 1e-4)) : 1e-7 > r ? (this._locked || (this._totalTime = this._cycle = 0), this._time = 0, (0 !== h || 0 === n && s !== i && (s > 0 || 0 > r && s >= 0) && !this._locked) && (c = "onReverseComplete", v = this._reversed), 0 > r ? (this._active = !1, s >= 0 && this._first && (u = !0), this._rawPrevTime = r) : (this._rawPrevTime = n || !a || r || this._rawPrevTime === r ? r : i, r = 0, this._initted || (u = !0))) : (0 === n && 0 > s && (u = !0), this._time = this._rawPrevTime = r, this._locked || (this._totalTime = r, 0 !== this._repeat && (m = n + this._repeatDelay, this._cycle = this._totalTime / m >> 0, 0 !== this._cycle && this._cycle === this._totalTime / m && this._cycle--, this._time = this._totalTime - this._cycle * m, this._yoyo && 0 !== (1 & this._cycle) && (this._time = n - this._time), this._time > n ? (this._time = n, r = n + 1e-4) : 0 > this._time ? this._time = r = 0 : r = this._time))), this._cycle !== f && !this._locked) {
    ...
    function() {
     var u = 180 / Math.PI,
      ...
      m = function(u, _, w, b, T) {
       var h, c, n, y, t, d, p, g, x, s, f, m, v, E = u.length - 1,
        l = 0,
        a = u[0].a;
       for (h = 0; E > h; h++) t = u[l], c = t.a, n = t.d, y = u[l + 1].d, T ? (f = e[h], m = i[h], v = .25 * (m + f) * _ / (b ? .5 : r[h] || .5), d = n - (n - c) * (b ? .5 * _ : 0 !== f ? v / f : 0), p = n + (y - n) * (b ? .5 * _ : 0 !== m ? v / m : 0), g = n - (d + ((p - d) * (3 * f / (f + m) + .5) / 4 || 0))) : (d = n - .5 * (n - c) * _, p = n + .5 * (y - n) * _, g = n - (d + p) / 2), d += g, p += g, t.c = x = d, t.b = 0 !== h ? a : a = t.a + .6 * (t.c - t.a), t.da = n - c, t.ca = x - c, t.ba = a - c, w ? (s = o(c, a, x, n), u.splice(l, 1, s[0], s[1], s[2], s[3]), l += 4) : l++, a = p;
      ...
      h = function(a, g, w, b, d, u) {
       ...
       if (!b) {
        for (t = l.length; --t > -1;)
         if (s[n])
          for (h = f[l[t]], y = h.length - 1, o = 0; y > o; o++) v = h[o + 1].da / i[o] + h[o].da / e[o], r[o] = (r[o] || 0) + v * v;
      ...
      d = function(r, c, p) {
       ...
       for (f = _.length; --f > -1;) {
        for (n = _[f], m[n] = t = [], i = 0, h = r.length, e = 0; h > e; e++) s = null == p ? r[e][n] : "string" == typeof(o = r[e][n]) && "=" === o.charAt(1) ? p[n] + Number(o.charAt(0) + o.substr(2)) : Number(o), v && e > 1 && h - 1 > e && (t[i++] = (s + t[i - 2]) / 2), t[i++] = s;
      ...
      n = t._gsDefine.plugin({
       ...
       set: function(t) {
        var l, y, e, s, i, r, o, _, d, a, c = this._segCount,
         x = this._func,
         g = this._target,
        ...
        for (y = 1 - r, e = this._props.length; --e > -1;) s = this._props[e], i = this._beziers[s][l], o = (r * r * i.da + 3 * y * (r * i.ca + y * i.ba)) * r + i.a, this._round[s] && (o = Math.round(o)), x[s] ? g[s](o) : g[s] = o;
        if (this._autoRotate) {
         var n, v, m, f, p, b, w, h = this._autoRotate;
         for (e = h.length; --e > -1;) s = h[e][2], b = h[e][3] || 0, w = h[e][4] === !0 ? 1 : u, i = this._beziers[h[e][0]], n = this._beziers[h[e][1]], i && n && (i = i[l], n = n[l], v = i.a + (i.b - i.a) * r, f = i.b + (i.c - i.b) * r, v += (f - v) * r, f += (i.c + (i.d - i.c) * r - f) * r, m = n.a + (n.b - n.a) * r, p = n.b + (n.c - n.b) * r, m += (p - m) * r, p += (n.c + (n.d - n.c) * r - p) * r, o = T ? Math.atan2(p - m, f - v) * w + b : this._initialRotations[e], x[s] ? g[s](o) : g[s] = o)
        }
       }
      }),
      l = n.prototype;
    ...
    }(), t._gsDefine("plugins.CSSPlugin", ["plugins.TweenPlugin", "TweenLite"], function(L, O) {
     ...
     var W, gt, H, _t, ft, A, P = /(?:\d|\-\d|\.\d|\-\.\d)+/g,
      ...
      M = v.defaultView ? v.defaultView.getComputedStyle : function() {},
      r = a.getStyle = function(i, t, r, a, n) {
       var e;
       return y || "opacity" !== t ? (!a && i.style[t] ? e = i.style[t] : (r = r || M(i)) ? e = r[t] || r.getPropertyValue(t) || r.getPropertyValue(t.replace(lt, "-$1").toLowerCase()) : i.currentStyle && (e = i.currentStyle[t]), null == n || e && "none" !== e && "auto" !== e && "auto auto" !== e ? e : n) : nt(i)
      },
      p = u.convertToPixels = function(o, c, e, t, f) {
       if ("px" === t || !t) return e;
       if ("auto" === t || !e) return 0;
       var s, i, h, l = yt.test(c),
        n = o,
        u = m.style,
        d = 0 > e;
       if (d && (e = -e), "%" === t && -1 !== c.indexOf("border")) s = e / 100 * (l ? o.clientWidth : o.clientHeight);
        ...
        if (u.cssText = "border:0 solid red;position:" + r(o, "position") + ";line-height:0;", "%" !== t && n.appendChild) u[l ? "borderLeftWidth" : "borderTopWidth"] = e + t;
         ...
         if (n = o.parentNode || v.body, i = n._gsCache, h = O.ticker.frame, i && l && i.time === h) return i.width * e / 100;
      ...
      S = function(n, t) {
       ...
       return y || (e.opacity = nt(n)), r = E(n, t, !1), e.rotation = r.rotation, e.skewX = r.skewX, e.scaleX = r.scaleX, e.scaleY = r.scaleY, e.x = r.x, e.y = r.y, _ && (e.z = r.z, e.rotationX = r.rotationX, e.rotationY = r.rotationY, e.scaleZ = r.scaleZ), e.filters && delete e.filters, e
      },
     ...
     var ct = function(e, o, c, a) {
      ...
      B = a.parseComplex = function(k, S, u, _, M, T, e, A, C, b) {
       u = u || T || "", e = new s(k, S, 0, 0, e, b ? 2 : 1, null, !1, A, u, _), _ += "";
       var r, h, c, t, i, g, v, f, l, x, o, a, n = u.split(", ").join(",").split(" "),
       ...
       for ((-1 !== _.indexOf(",") || -1 !== u.indexOf(",")) && (n = n.join(" ").replace(d, ", ").split(" "), p = p.join(" ").replace(d, ", ").split(" "), m = n.length), m !== p.length && (n = (T || "").split(" "), m = n.length), e.plugin = C, e.setRatio = b, r = 0; m > r; r++)
        ...
        else if (M && ("#" === t.charAt(0) || w[t] || ot.test(t))) a = "," === i.charAt(i.length - 1) ? ")," : ")", t = q(t), i = q(i), l = t.length + i.length > 6, l && !y && 0 === i[3] ? (e["xs" + e.l] += e.l ? " transparent" : "transparent", e.e = e.e.split(p[r]).join("transparent")) : (y || (l = !1), e.appendXtra(l ? "rgba(" : "rgb(", t[0], i[0] - t[0], ",", !0, !0).appendXtra("", t[1], i[1] - t[1], ",", !0).appendXtra("", t[2], i[2] - t[2], l ? "," : a, !0), l && (t = 4 > t.length ? 1 : t[3], e.appendXtra("", t, (4 > i.length ? 1 : i[3]) - t, a, !1)));
       else if (g = t.match(P)) {
        if (v = i.match(pt), !v || v.length !== g.length) return e;
        for (c = 0, h = 0; g.length > h; h++) o = g[h], x = t.indexOf(o, c), e.appendXtra(t.substr(c, x - c), Number(o), rt(v[h], o), "", E && "px" === t.substr(x + o.length, 2), 0 === h), c = x + o.length;
        e["xs" + e.l] += t.substr(c)
     ...
     var vt = "scaleX,scaleY,scaleZ,x,y,z,skewX,skewY,rotation,rotationX,rotationY,perspective,xPercent,yPercent".split(","),
      ...
      E = u.getTransform = function(m, Q, P, J) {
       ...
       var o, t, y, L, X, R, z, w, v, q, Y, D, U, e = P ? m._gsTransform || new at : new at,
        nt = 0 > e.scaleX,
        M = 2e-5,
        u = 1e5,
        k = 179.99,
       ...
       if (l ? o = r(m, bt, Q, !0) : m.currentStyle && (o = m.currentStyle.filter.match(Lt), o = o && 4 === o.length ? [o[0].substr(4), Number(o[2].substr(4)), Number(o[1].substr(4)), o[3].substr(4), e.x || 0, e.y || 0].join(",") : ""), o && "none" !== o && "matrix(1, 0, 0, 1, 0, 0)" !== o) {
        for (t = (o || "").match(/(?:\-|\b)[\d\-\.e]+\b/gi) || [], y = t.length; --y > -1;) L = Number(t[y]), t[y] = (X = L - (L |= 0)) ? (0 | X * u + (0 > X ? -.5 : .5)) / u + L : L;
        if (16 === t.length) {
         var S = t[8],
          p = t[9],
          h = t[10],
          ...
          Z = t[13],
          C = t[14];
         if (e.zOrigin && (C = -e.zOrigin, tt = S * C - t[12], Z = p * C - t[13], C = h * C + e.zOrigin - t[14]), !P || J || null == e.rotationX) {
      ...
      Ct = function(S) {
       ...
       if (y) {
        _ = n, n = -r, r = -_, d = y.filter, v.filter = "";
        ...
        if (null != e.ox && (t = (e.oxp ? .01 * h * e.ox : e.ox) - h / 2, i = (e.oyp ? .01 * u * e.oy : e.oy) - u / 2, w += t - (t * s + i * n), T += i - (t * r + i * l)), b ? (t = h / 2, i = u / 2, m += ", Dx=" + (t - (t * s + i * n) + w) + ", Dy=" + (i - (t * r + i * l) + T) + ")") : m += ", sizingMethod='auto expand')", v.filter = -1 !== d.indexOf("DXImageTransform.Microsoft.Matrix(") ? d.replace(Tt, m) : m + " " + d, (0 === S || 1 === S) && 1 === s && 0 === n && 0 === r && 1 === l && (b && -1 === m.indexOf("Dx=0, Dy=0") || K.test(d) && 100 !== parseFloat(RegExp.$1) || -1 === d.indexOf("gradient(" && d.indexOf("Alpha")) && v.removeAttribute("filter")), !b) {
         var g, f, C, M = 8 > A ? 1 : -1;
         for (t = e.ieOffsetX || 0, i = e.ieOffsetY || 0, e.ieOffsetX = Math.round((h - ((0 > s ? -s : s) * h + (0 > n ? -n : n) * u)) / 2 + w), e.ieOffsetY = Math.round((u - ((0 > l ? -l : l) * u + (0 > r ? -r : r) * h)) / 2 + T), o = 0; 4 > o; o++) f = Ot[o], g = y[f], _ = -1 !== g.indexOf("px") ? parseFloat(g) : p(this.t, f, parseFloat(g), g.replace(Q, "")) || 0, C = _ !== e[f] ? 2 > o ? -e.ieOffsetX : -e.ieOffsetY : 2 > o ? t - e.ieOffsetX : i - e.ieOffsetY, v[f] = (e[f] = Math.round(_ - C * (0 === o || 2 === o ? 1 : M))) + "px"
        }
       }
      },
      N = u.set3DTransformRatio = function(L) {
       var w, y, v, m, b, x, p, f, M, T, d, s, A, E, _, C, t, r, i, n, B, I, P, e = this.data,
        R = this.t.style,
        a = e.rotation * c,
        o = e.scaleX,
        h = e.scaleY,
        ...
        k = e.z,
        g = e.perspective;
       if (!(1 !== L && 0 !== L || "auto" !== e.force3D || e.rotationY || e.rotationX || 1 !== u || g || k)) return void it.call(this, L);
       if (_t) {
        var S = 1e-4;
        S > o && o > -S && (o = u = 2e-5), S > h && h > -S && (h = u = 2e-5), !g || e.z || e.rotationX || e.rotationY || (g = 0)
       }
       if (a || e.skewX) r = Math.cos(a), i = Math.sin(a), w = r, b = i, e.skewX && (a -= e.skewX * c, r = Math.cos(a), i = Math.sin(a), "simple" === e.skewType && (n = Math.tan(e.skewX * c), n = Math.sqrt(1 + n * n), r *= n, i *= n)), y = -i, x = r;
       else {
        if (!(e.rotationY || e.rotationX || 1 !== u || g)) return void(R[l] = (e.xPercent || e.yPercent ? "translate(" + e.xPercent + "%," + e.yPercent + "%) translate3d(" : "translate3d(") + O + "px," + z + "px," + k + "px)" + (1 !== o || 1 !== h ? " scale(" + o + "," + h + ")" : ""));
        w = x = 1, y = b = 0
       }
       d = 1, v = m = p = f = M = T = s = A = E = 0, _ = g ? -1 / g : 0, C = e.zOrigin, t = 1e5, a = e.rotationY * c, a && (r = Math.cos(a), i = Math.sin(a), M = d * -i, A = _ * -i, v = w * i, p = b * i, d *= r, _ *= r, w *= r, b *= r), a = e.rotationX * c, a && (r = Math.cos(a), i = Math.sin(a), n = y * r + v * i, B = x * r + p * i, I = T * r + d * i, P = E * r + _ * i, v = y * -i + v * r, p = x * -i + p * r, d = T * -i + d * r, _ = E * -i + _ * r, y = n, x = B, T = I, E = P), 1 !== u && (v *= u, p *= u, d *= u, _ *= u), 1 !== h && (y *= h, x *= h, T *= h, E *= h), 1 !== o && (w *= o, b *= o, M *= o, A *= o), C && (s -= C, m = v * s, f = p * s, s = d * s + C), m = (n = (m += O) - (m |= 0)) ? (0 | n * t + (0 > n ? -.5 : .5)) / t + m : m, f = (n = (f += z) - (f |= 0)) ? (0 | n * t + (0 > n ? -.5 : .5)) / t + f : f, s = (n = (s += k) - (s |= 0)) ? (0 | n * t + (0 > n ? -.5 : .5)) / t + s : s, R[l] = (e.xPercent || e.yPercent ? "translate(" + e.xPercent + "%," + e.yPercent + "%) matrix3d(" : "matrix3d(") + [(0 | w * t) / t, (0 | b * t) / t, (0 | M * t) / t, (0 | A * t) / t, (0 | y * t) / t, (0 | x * t) / t, (0 | T * t) / t, (0 | E * t) / t, (0 | v * t) / t, (0 | p * t) / t, (0 | d * t) / t, (0 | _ * t) / t, m, f, s, g ? 1 + -s / g : 1].join(",") + ")"
      },
     ...
     i("transform,scale,scaleX,scaleY,scaleZ,x,y,z,rotation,rotationX,rotationY,rotationZ,skewX,skewY,shortRotation,shortRotationX,shortRotationY,shortRotationZ,transformOrigin,transformPerspective,directionalRotation,parseTransform,force3D,skewType,xPercent,yPercent", {
      parser: function(w, L, u, x, i, k, M) {
       if (x._transform) return i;
       var o, b, d, c, g, y, p, t = x._transform = E(w, n, !0, M.parseTransform),
        T = w.style,
        S = 1e-6,
        A = vt.length,
        e = M,
        f = {};
       if ("string" == typeof e.transform && l) d = m.style, d[l] = e.transform, d.display = "block", d.position = "absolute", v.body.appendChild(m), o = E(m, null, !1), v.body.removeChild(m);
       ...
       for (_ && null != e.force3D && (t.force3D = e.force3D, y = !0), t.skewType = e.skewType || t.skewType || a.defaultSkewType, g = t.force3D || t.z || t.rotationX || t.rotationY || o.z || o.rotationX || o.rotationY || o.perspective, g || null == e.scale || (o.scaleZ = 1); --A > -1;) u = vt[A], c = o[u] - t[u], (c > S || -S > c || null != z[u]) && (y = !0, i = new s(t, u, t[u], c, i), u in f && (i.e = f[u]), i.xs0 = 0, i.plugin = k, x._overwriteProps.push(i.n));
     ...
     i("className", {
      parser: function(t, r, f, h, e, p, d) {
       var a, u, c, l, i, o = t.getAttribute("class") || "",
        _ = t.style.cssText;
       if (e = h._classNamePT = new s(t, f, 0, 0, e, 2), e.setRatio = Rt, e.pr = -11, T = !0, e.b = o, u = S(t, n), c = t._gsClassPT) {
        for (l = {}, i = c.data; i;) l[i.p] = 1, i = i._next;
        c.setRatio(1)
       }
       return t._gsClassPT = e, e.e = "=" !== r.charAt(1) ? r : o.replace(RegExp("\\s*\\b" + r.substr(2) + "\\b"), "") + ("+" === r.charAt(0) ? " " + r.substr(2) : ""), h._tween._duration && (t.setAttribute("class", e.e), a = Z(t, u, S(t), d, l), t.setAttribute("class", o), e.data = a.firstMPT, t.style.cssText = _, e = e.xfirst = h.parse(t, a.difs, e, p)), e
      }
     });
     var Pt = function(a) {
     ...
     e = a.prototype, e._firstPT = null, e._onInitTween = function(i, c, v) {
      if (!i.nodeType) return !1;
      this._target = i, this._tween = v, this._vars = c, W = c.autoRound, T = !1, R = c.suffixMap || a.suffixMap, n = M(i, ""), G = this._overwriteProps;
      var h, t, e, u, m, g, p, d, f, o = i.style;
      if (gt && "" === o.zIndex && (h = r(i, "zIndex", n), ("auto" === h || "" === h) && this._addLazySet(o, "zIndex", 0)), "string" == typeof c && (u = o.cssText, h = S(i, n), o.cssText = u + ";" + c, h = Z(i, h, S(i)).difs, !y && St.test(c) && (h.opacity = parseFloat(RegExp.$1)), c = h, o.cssText = u), this._firstPT = t = this.parse(i, c, null), this._transformType) {
       ...
       d = new s(i, "transform", 0, 0, null, 2), this._linkCSSP(d, null, e), d.setRatio = f && _ ? N : l ? it : Ct, d.data = this._transform || E(i, n, !0), G.pop()
      }
      if (T) {
       for (; t;) {
   ...
   if (!C.TweenLite) {
    var n, a, e, r, o, U = function(r) {
     ...
     F = function(e, r, t, a) {
      ...
      this.check = function(d) {
       for (var l, h, c, o, s = r.length, u = s; --s > -1;)(l = v[r[s]] || new F(r[s], [])).gsClass ? (n[s] = l.gsClass, u--) : d && l.sc.push(this);
       if (0 === u && t)
        for (h = ("com.greensock." + e).split("."), c = h.pop(), o = U(h.join("."))[c] = this.gsClass = t.apply(t, n), a && (C[c] = o, "function" == typeof define && define.amd ? define((i.GreenSockAMDPath ? i.GreenSockAMDPath + "/" : "") + e.split(".").pop(), [], function() {
          return o
    ...
    u("Ticker", function(_, f) {
     var i, c, t, l, a, e = this,
      ...
      u = function(s) {
       var r, o, n = E() - S;
       n > h && (d += n - p), S += n, e.time = (S - d) / 1e3, r = e.time - a, (!i || r > 0 || s === !0) && (e.frame++, a += r + (r >= l ? .004 : l - r), o = !0), s !== !0 && (t = c(u)), o && e.dispatchEvent("tick")
      };
     D.call(e), e.time = e.frame = 0, e.tick = function() {
      ...
      null !== t ? e.sleep() : e.frame > 10 && (S = E() - h + 5), c = 0 === i ? H : n && T ? T : function(t) {
    ...
    var j = function() {
     o && E() - S > 2e3 && r.wake(), setTimeout(j, 2e3)
    };
    ...
    var t = u("TweenLite", function(e, h, c) {
      ...
      if (this._overwrite = o = null == o ? N[t.defaultOverwrite] : "number" == typeof o ? o >> 0 : N[o], (u || e instanceof Array || e.push && y(e)) && "number" != typeof e[0])
    ...
    e._init = function() {
     ...
     for (t in this.vars) {
      if (r = this.vars[t], z[t]) r && (r instanceof Array || r.push && y(r)) && -1 !== r.join("").indexOf("{self}") && (this.vars[t] = r = this._swapSelfInParams(r, this));
     ...
     return l && this._kill(l, e) ? this._initProps(e, s, o, l) : this._overwrite > 1 && this._firstPT && o.length > 1 && R(e, this, s, this._overwrite, o) ? (this._kill(s, e), this._initProps(e, s, o, l)) : (this._firstPT && (this.vars.lazy !== !1 && this._duration || this.vars.lazy && !this._duration) && (P[e._gsTweenID] = !0), c)
   ...
   var l = t.GreenSockGlobals || t,
    ...
    _ = function(i, v, B, X, F) {
     ...
     var w, p, b, s, _, E, x, n, f, l, m, z, O, M = r(i),
      ...
      R = a(v.wordsClass),
      V = a(v.charsClass),
      D = -1 !== (v.linesClass || "").indexOf("++"),
      S = v.linesClass;
     for (D && (S = S.split("++").join("")), b = R(), s = 0; u > s; s++) E = M.charAt(s), ")" === E && M.substr(s, 20) === h ? (b += L + "<BR/>", s !== u - 1 && (b += " " + R()), s += 19) : " " === E && " " !== M.charAt(s - 1) && s !== u - 1 ? (b += L, s !== u - 1 && (b += H + R())) : b += T && " " !== E ? V() + E + "</div>" : E;
     for (i.innerHTML = b + L, _ = i.getElementsByTagName("*"), u = _.length, x = [], s = 0; u > s; s++) x[s] = _[s];
     if (g || c)
      for (s = 0; u > s; s++) n = x[s], p = n.parentNode === i, (p || c || T && !y) && (f = n.offsetTop, g && p && f !== P && "BR" !== n.nodeName && (w = [], g.push(w), P = f), c && (n._x = n.offsetLeft, n._y = f, n._w = n.offsetWidth, n._h = n.offsetHeight), g && (y !== p && (T || (w.push(n), n._x -= I)), p && s && (x[s - 1]._wordEnd = !0)));
     for (s = 0; u > s; s++) n = x[s], p = n.parentNode === i, "BR" !== n.nodeName ? (c && (m = n.style, y || p || (n._x += n.parentNode._x, n._y += n.parentNode._y), m.left = n._x + "px", m.top = n._y + "px", m.position = "absolute", m.display = "block", m.width = n._w + 1 + "px", m.height = n._h + "px"), y ? p ? X.push(n) : T && B.push(n) : p ? (i.removeChild(n), x.splice(s--, 1), u--) : !p && T && (f = !g && !c && n.nextSibling, i.appendChild(n), f || i.appendChild(document.createTextNode(" ")), B.push(n))) : g || c ? (i.removeChild(n), x.splice(s--, 1), u--) : y || i.appendChild(n);
     if (g) {
      ...
      for (O = !c || !y && !T, s = 0; s < g.length; s++) {
       for (w = g[s], l = document.createElement("div"), l.style.cssText = "display:block;text-align:" + j + ";position:" + (c ? "absolute;" : "relative;"), S && (l.className = S + (D ? s + 1 : "")), F.push(l), u = w.length, _ = 0; u > _; _++) "BR" !== w[_].nodeName && (n = w[_], l.appendChild(n), O && (n._wordEnd || y) && l.appendChild(document.createTextNode(" ")), c && (0 === _ && (l.style.top = n._y + "px", l.style.left = I + f + "px"), n.style.top = "0px", f && (n.style.left = n._x - f + "px")));
       y || T || (l.innerHTML = r(l).split(String.fromCharCode(160)).join(" ")), c && (l.style.width = z, l.style.height = n._h + "px"), i.appendChild(l)
      }
      i.style.cssText = m
     }
     c && (A > i.clientHeight && (i.style.height = A - G + "px", A > i.clientHeight && (i.style.height = A + U + "px")), C > i.clientWidth && (i.style.width = C - W + "px", C > i.clientWidth && (i.style.width = C + N + "px")))
    },
    n = i.prototype;
   n.split = function(t) {
  ...
  function() {
   ...
   e.ok = "Ok", e.cancel = "Cancel", e.point_event = "click", e.parent = document.body, e.zindex = 1e4, e.reverse_buttons = !1, e.autofocus = !0, e.autoexit = !0, e.custom_css = {}, e.css_prefix = "smoke", e.value = void 0, e.callback = void 0, e.observe_mutation = !0, e.window_opened = void 0, e.window_closed = void 0, e.build = function(h, t) {
    ...
    t.point_event = v, t.callback = x;
    var i = document.createElement("div");
    i.className = n + "-base", i.style.zIndex = E, p.appendChild(i);
    var c = i.dialog_wrapper = document.createElement("div");
    c.className = n + "-dialog_wrapper", i.appendChild(c), w && c.addEventListener(v, function(r) {
    ...
    if (d.className = n + "-dialog-text", d.innerHTML = h, s.appendChild(d), "prompt" == t.type) {
     ...
     a.className = n + "-prompt", a.input = document.createElement("input"), a.input.type = "text", a.input.className = n + "-prompt-input", "undefined" != typeof y && (a.input.value = y), a.appendChild(a.input), s.appendChild(a)
    }
  ...
  var bt = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").get,
   wt = Object.getOwnPropertyDescriptor(HTMLElement.prototype, "innerHTML").set;
 ...
 var u = function(r) {
  ...
  return e.gs = r.gs, e.ad_network = r.ad_network, e.init = function() {
   ...
   e.present_count > 1 || (e.present_count += 1, e.displayed = !0, e.ondisplay && e.ondisplay())
  }, e.on_receive_interstitial_ad = function() {
   e.receive_count > 1 || (e.receive_count += 1, e.loaded = !0)
  }, e.on_dismiss_interstitial_ad = function() {
   e.dismiss_count > 1 || (e.dismiss_count += 1, e.displayed = !1, e.loaded = !1, e.callback())
 ...
 var m;
 1 == !!window.IS_READY ? m = x() : window.addEventListener("load", function() {
