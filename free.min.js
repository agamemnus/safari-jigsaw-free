     ...
     switch (e.page) {
      ...
      case "jigsaw":
       pt({
        ...
        global_settings: r,
        level_id: e.level
       }), !r.account.purchased_ad_removal && r.IS_WEBVIEW && "undefined" != typeof f && ct({
        gs: r,
        mr_jigtato: i
       });
       break;
 ...
 function ct(r) {
  function a() {
   ...
   var i = smoke.confirm(a, function(i) {
     e.ad_control && (e.ad_control.running = !1), 0 != i && ("undefined" != typeof e.google_play_access_token && t({
     ...
     }), e.account.game_was_rated = !1, e.open_url(e.google_play_store_url))
    }),
    r = i.dialog.text.childNodes[1];
   i.dialog.text.childNodes[0].classList.add("jt-common-instruction_text-title"), r.classList.add("jt-common-instruction_text"), r.style.fontSize = "55px", r.style.lineHeight = "150%", r.style.height = "auto", i.dialog.text.style.height = window.getComputedStyle(i.dialog.text).maxHeight, i.buttons.ok.innerHTML = "Rate it.", i.buttons.cancel.innerHTML = "Don't rate it.", n(i.buttons), i.buttons.ok.classList.add("hoverable"), i.buttons.cancel.classList.add("hoverable")
  }
  var e = r.gs,
   s = r.mr_jigtato,
   ...
   l = o.tile_x,
   c = o.tile_y,
   i = (e.show_ad_counter, Math.sqrt(l * c) / 12);
